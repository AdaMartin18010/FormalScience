...
- [1 提出批判](#1-提出批判)
  - [1.1 为什么批判最重要](#11-为什么批判最重要)
  - [1.2 如何提出高质量批判](#12-如何提出高质量批判)
    - [2.2.1 第1步：检查已有批判](#221-第1步检查已有批判)
    - [2.2.2 第2步：撰写批判](#222-第2步撰写批判)
- [2 批判标题简洁描述问题](#2-批判标题简洁描述问题)
  - [2.1 问题陈述](#21-问题陈述)
  - [2.2 论证](#22-论证)
  - [2.3 影响评估](#23-影响评估)
  - [2.4 可能的解决方案可选](#24-可能的解决方案可选)
    - [4.4.1 第3步：提交批判](#441-第3步提交批判)
    - [4.4.2 示例：好的批判](#442-示例好的批判)
- [3 [批判] 框架忽视了具身认知](#3-批判-框架忽视了具身认知)
  - [3.1 问题陈述](#31-问题陈述)
  - [3.2 论证](#32-论证)
  - [3.3 影响评估](#33-影响评估)
  - [3.4 可能的解决方案](#34-可能的解决方案)
    - [4.4.1 示例：需要改进的批判](#441-示例需要改进的批判)
- [4 改进文档](#4-改进文档)
  - [4.1 文档改进类型](#41-文档改进类型)
    - [1.1.1 修正错误](#111-修正错误)
    - [1.1.2 完善解释](#112-完善解释)
    - [1.1.3 重构结构](#113-重构结构)
  - [4.2 文档规范](#42-文档规范)
    - [2.2.1 格式规范](#221-格式规范)
- [5 标题2主要章节](#5-标题2主要章节)
  - [5.1 标题3次级章节](#51-标题3次级章节)
    - [1.1.1 标题4细节章节](#111-标题4细节章节)
    - [1.1.2 术语规范](#112-术语规范)
    - [1.1.3 引用规范](#113-引用规范)
    - [1.1.4 代码块规范](#114-代码块规范)
- [6 形式化验证](#6-形式化验证)
  - [6.1 为什么需要形式化验证](#61-为什么需要形式化验证)
  - [6.2 如何开始形式化验证](#62-如何开始形式化验证)
    - [2.2.1 第1步：学习工具](#221-第1步学习工具)
    - [2.2.2 第2步：选择定理](#222-第2步选择定理)
    - [2.2.3 第3步：实现验证](#223-第3步实现验证)
    - [2.2.4 第4步：提交验证](#224-第4步提交验证)
- [7 新增案例](#7-新增案例)
  - [7.1 好案例的标准](#71-好案例的标准)
  - [7.2 案例模板](#72-案例模板)
- [8 引言](#8-引言)
  - [8.1 系统概述](#81-系统概述)
  - [8.2 分析目标](#82-分析目标)
- [9 视角1：形式语言分析](#9-视角1形式语言分析)
  - [9.1 语法结构](#91-语法结构)
  - [9.2 语义模型](#92-语义模型)
  - [9.3 关键特性](#93-关键特性)
- [10 视角2-8](#10-视角2-8)
- [11 跨视角映射](#11-跨视角映射)
  - [11.1 映射1：AB](#111-映射1ab)
  - [11.2 映射2：CD](#112-映射2cd)
- [12 实证数据](#12-实证数据)
  - [12.1 性能数据](#121-性能数据)
  - [12.2 案例验证](#122-案例验证)
- [13 批判性反思](#13-批判性反思)
  - [13.1 框架的适用性](#131-框架的适用性)
  - [13.2 框架的局限](#132-框架的局限)
- [14 总结](#14-总结)
  - [14.1 核心洞察](#141-核心洞察)
  - [14.2 未来方向](#142-未来方向)
  - [14.3 提交新案例](#143-提交新案例)
- [15 代码贡献](#15-代码贡献)
  - [15.1 可视化实现D3js](#151-可视化实现d3js)
  - [15.2 测试工具](#152-测试工具)
- [16 行为准则](#16-行为准则)
  - [16.1 社区价值观](#161-社区价值观)
  - [16.2 不可接受的行为](#162-不可接受的行为)
  - [16.3 报告问题](#163-报告问题)
- [17 贡献者认可](#17-贡献者认可)
  - [17.1 贡献等级](#171-贡献等级)
  - [17.2 贡献类型权重](#172-贡献类型权重)
  - [17.3 致谢方式](#173-致谢方式)
- [18 致谢](#18-致谢)
  - [18.1 核心贡献者](#181-核心贡献者)
  - [18.2 贡献者](#182-贡献者)
  - [18.3 特别感谢](#183-特别感谢)
- [19 联系方式](#19-联系方式)
  - [19.1 讨论和提问](#191-讨论和提问)
  - [19.2 项目维护团队](#192-项目维护团队)
  - [19.3 响应时间](#193-响应时间)
- [20 许可协议](#20-许可协议)
- [21 感谢您的贡献](#21-感谢您的贡献)

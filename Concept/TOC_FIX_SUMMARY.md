...
- [2 已完成的工作](#2-已完成的工作)
  - [2.1 问题分析](#21-问题分析)
  - [2.2 内容重复分析](#22-内容重复分析)
  - [2.3 自动化工具开发](#23-自动化工具开发)
  - [2.4 使用指南编写](#24-使用指南编写)
  - [2.5 示例修复](#25-示例修复)
- [3 统计数据](#3-统计数据)
  - [3.1 文件扫描结果](#31-文件扫描结果)
  - [3.2 问题分布](#32-问题分布)
- [4 推荐执行方案](#4-推荐执行方案)
  - [4.1 方案A：快速全量修复推荐](#41-方案a快速全量修复推荐)
  - [4.2 方案B：分批审查修复谨慎](#42-方案b分批审查修复谨慎)
  - [4.3 方案C：手动精细修复不推荐](#43-方案c手动精细修复不推荐)
- [5 重要注意事项](#5-重要注意事项)
  - [5.1 执行前必读](#51-执行前必读)
  - [5.2 已知限制](#52-已知限制)
- [6 预期效果](#6-预期效果)
...
- [7 下一步行动](#7-下一步行动)
  - [7.1 立即执行](#71-立即执行)
  - [7.2 后续优化可选](#72-后续优化可选)
- [8 相关文档](#8-相关文档)
- [9 任务清单](#9-任务清单)
  - [9.1 已完成](#91-已完成)
  - [9.2 待用户执行](#92-待用户执行)
- [10 常见问题](#10-常见问题)
  - [10.1 Q1 脚本会修改我的原始内容吗](#101-q1-脚本会修改我的原始内容吗)
  - [10.2 Q2 如果修复后不满意怎么办](#102-q2-如果修复后不满意怎么办)
  - [10.3 Q3 哪个脚本最好](#103-q3-哪个脚本最好)
  - [10.4 Q4 需要多长时间](#104-q4-需要多长时间)
  - [10.5 Q5 序号不一致会自动修复吗](#105-q5-序号不一致会自动修复吗)
- [11 总结](#11-总结)
  - [11.1 核心成果](#111-核心成果)
  - [11.2 用户价值](#112-用户价值)
  - [11.3 立即开始](#113-立即开始)

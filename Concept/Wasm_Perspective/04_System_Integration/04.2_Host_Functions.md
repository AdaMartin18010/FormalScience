...
- [4.2 Host Functions](#42-host-functions)
  - [目录](#目录)
  - [1 核心命题](#1-核心命题)
    - [1 主定理](#1-主定理)
  - [2 FFI 语义](#2-ffi-语义)
  ...
  - [6 安全边界](#6-安全边界)
    ...
    - [6.3 时间侧信道](#63-时间侧信道)
  - [7 批判性分析](#7-批判性分析)
    - [1 FFI 的本质困境](#1-ffi-的本质困境)
    - [7.2 宿主函数的语义陷阱](#72-宿主函数的语义陷阱)
    - [7.3 性能不可预测性](#73-性能不可预测性)
  - [8 实践案例](#8-实践案例)
    - [1 案例1：Lucet (Fastly)](#1-案例1lucet-fastly)
    - [8.2 案例2：Node.js N-API](#82-案例2nodejs-n-api)
  - [9 未来方向](#9-未来方向)
    - [1 组件模型接口类型](#1-组件模型接口类型)
    - [9.2 异步宿主函数](#92-异步宿主函数)
  - [参考文献](#参考文献)

...
- [1.5 Security Model](#15-security-model)
  ...
  - [3 能力安全](#3-能力安全)
    - [1 能力模型](#1-能力模型)
    - [3.2 WASI 能力系统](#32-wasi-能力系统)
    - [3.3 最小权限原则](#33-最小权限原则)
  - [4 内存安全](#4-内存安全)
    - [1 边界检查](#1-边界检查)
    - [4.2 类型混淆防护](#42-类型混淆防护)
    - [4.3 无悬垂指针](#43-无悬垂指针)
  - [5 控制流完整性](#5-控制流完整性)
    - [1 前向边保护](#1-前向边保护)
    - [5.2 后向边保护](#52-后向边保护)
    - [5.3 结构化控制流](#53-结构化控制流)
  - [6 侧信道防御](#6-侧信道防御)
    - [1 时序侧信道](#1-时序侧信道)
    - [6.2 Spectre 防御](#62-spectre-防御)
    - [6.3 缓存侧信道](#63-缓存侧信道)
  - [7 形式化验证](#7-形式化验证)
    - [1 安全性质](#1-安全性质)
    - [7.2 定理证明](#72-定理证明)
  ...
  - [10 批判性分析](#10-批判性分析)
    - [1 沙箱的本质局限](#1-沙箱的本质局限)
    - [10.2 信任边界](#102-信任边界)
    - [10.3 形式化的盲区](#103-形式化的盲区)
  - [11 案例研究：OPA 策略沙箱](#11-案例研究opa-策略沙箱)
    - [1 问题](#1-问题)
    - [11.2 解决方案](#112-解决方案)
    - [11.3 安全性分析](#113-安全性分析)
  - [12 未来方向](#12-未来方向)
    - [1 内存标记（Memory Tagging）](#1-内存标记memory-tagging)
    - [12.2 线性类型（Linear Types）](#122-线性类型linear-types)
    - [12.3 信息流控制（IFC）](#123-信息流控制ifc)
  - [参考文献](#参考文献)

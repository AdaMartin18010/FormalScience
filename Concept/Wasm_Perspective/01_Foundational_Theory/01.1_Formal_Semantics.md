...
- [1.1 Formal Semantics](#11-formal-semantics)
  ...
  - [1 核心命题](#1-核心命题)
    - [1 主定理](#1-主定理)
    - [1.2 语义设计目标](#12-语义设计目标)
  - [2 操作语义 (Operational Semantics)](#2-操作语义-operational-semantics)
    - [1 小步语义 (Small-Step Semantics)](#1-小步语义-small-step-semantics)
      - [1 抽象机器模型](#1-抽象机器模型)
      - [2 核心指令语义](#2-核心指令语义)
  ...
  - [4 公理语义 (Axiomatic Semantics)](#4-公理语义-axiomatic-semantics)
    - [1 Hoare 逻辑](#1-hoare-逻辑)
    - [4.2 分离逻辑 (Separation Logic)](#42-分离逻辑-separation-logic)
  - [5 语义等价性](#5-语义等价性)
    - [1 行为等价](#1-行为等价)
    - [5.2 优化正确性](#52-优化正确性)
  - [6 批判性分析](#6-批判性分析)
    - [1 形式化的边界](#1-形式化的边界)
    - [6.2 抽象的成本](#62-抽象的成本)
    - [6.3 规范的政治经济学](#63-规范的政治经济学)
  - [7 案例研究：`select` 指令](#7-案例研究select-指令)
    - [1 语义定义](#1-语义定义)
    - [7.2 等价性定理](#72-等价性定理)
  - [8 形式化工具链](#8-形式化工具链)
  - [参考文献](#参考文献)

...
- [3.1 Compilation Strategies](#31-compilation-strategies)
  - [目录](#目录)
  - [1 核心命题](#1-核心命题)
    - [1 主定理](#1-主定理)
  - [2 解释执行](#2-解释执行)
  ...
  - [6 分层编译](#6-分层编译)
    ...
    - [6.2 热度计数](#62-热度计数)
    - [6.3 性能模型](#63-性能模型)
    - [6.4 案例：V8 策略](#64-案例v8-策略)
  - [7 批判性分析](#7-批判性分析)
    - [1 编译的本质权衡](#1-编译的本质权衡)
    - [7.2 JIT 的不确定性](#72-jit-的不确定性)
    - [7.3 编译器复杂度的代价](#73-编译器复杂度的代价)
  - [8 实证对比](#8-实证对比)
    - [1 性能基准（Shootout Benchmark）](#1-性能基准shootout-benchmark)
    - [8.2 实际应用数据](#82-实际应用数据)
  - [参考文献](#参考文献)

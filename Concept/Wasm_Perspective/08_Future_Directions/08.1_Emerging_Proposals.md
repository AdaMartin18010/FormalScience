...
- [8.1 新兴提案 (Emerging Proposals)](#81-新兴提案-emerging-proposals)
  - [📋 目录](#-目录)
  - [1 核心命题](#1-核心命题)
  - [2 GC 提案Garbage Collection](#2-gc-提案garbage-collection)
    - [2.1 动机](#21-动机)
    - [2.2 类型扩展](#22-类型扩展)
    - [2.3 挑战](#23-挑战)
  - [3 Memory64](#3-memory64)
    - [3.1 动机](#31-动机)
    - [3.2 设计](#32-设计)
  - [4 组件模型Component Model](#4-组件模型component-model)
    - [4.1 愿景](#41-愿景)
    - [4.2 状态2025](#42-状态2025)
  - [5 异步支持AsyncAwait](#5-异步支持asyncawait)
    - [5.1 问题](#51-问题)
    - [5.2 提案](#52-提案)
  - [6 批判性分析](#6-批判性分析)
  - [参考文献](#参考文献)

...
- [WebAssembly 架构概览](#webassembly-架构概览)
  ...
  - [2 🧩 核心组件架构](#2--核心组件架构)
    ...
    - [2 . 线性内存（Linear Memory）](#2--线性内存linear-memory)
    - [3 . 执行栈（Execution Stack）](#3--执行栈execution-stack)
    - [4 . 表（Table）](#4--表table)
    - [5 . 全局变量（Globals）](#5--全局变量globals)
  - [3 🔄 执行模型](#3--执行模型)
    - [3.1 指令执行流程](#31-指令执行流程)
    - [3.2 编译策略对比](#32-编译策略对比)
  - [4 🔗 互操作架构](#4--互操作架构)
    - [4.1 Wasm ↔ 宿主通信](#41-wasm--宿主通信)
    - [4.2 跨边界调用开销](#42-跨边界调用开销)
  - [5 🔒 安全架构](#5--安全架构)
    - [5.1 多层安全模型](#51-多层安全模型)
    - [5.2 威胁模型](#52-威胁模型)
  - [6 📊 性能架构](#6--性能架构)
    - [6.1 性能瓶颈分析](#61-性能瓶颈分析)
    - [6.2 优化策略](#62-优化策略)
  - [7 🏗️ 系统集成架构](#7-️-系统集成架构)
    - [7.1 典型部署架构：边缘 Serverless](#71-典型部署架构边缘-serverless)
  - [8 🔮 演化方向](#8--演化方向)
    - [8.1 提案阶段（Stage 4 → Stage 0）](#81-提案阶段stage-4--stage-0)
  - [9 🎯 设计权衡](#9--设计权衡)
    - [9.1 核心决策及其影响](#91-核心决策及其影响)
  - [10 📖 参考架构文档](#10--参考架构文档)

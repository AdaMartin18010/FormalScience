...
- [WebAssembly 常见问题（FAQ）](#webassembly-常见问题faq)
  - [目录](#目录)
  - [1 基础概念](#1-基础概念)
    - [1.1 Q1：WebAssembly 到底是什么？](#11-q1webassembly-到底是什么)
    - [1.2 Q2：Wasm 与 JavaScript 的关系？](#12-q2wasm-与-javascript-的关系)
    - [1.3 Q3：Wasm 能替代 JavaScript 吗？](#13-q3wasm-能替代-javascript-吗)
  - [2 技术原理](#2-技术原理)
    - [2.1 Q4：为什么是栈式虚拟机而非寄存器机？](#21-q4为什么是栈式虚拟机而非寄存器机)
    - [2.2 Q5：线性时间验证如何实现？](#22-q5线性时间验证如何实现)
    - [2.3 Q6：浮点确定性如何保证？](#23-q6浮点确定性如何保证)
  - [3 性能与优化](#3-性能与优化)
    - [3.1 Q7：Wasm 性能到底如何？](#31-q7wasm-性能到底如何)
    - [3.2 Q8：如何优化 Wasm 性能？](#32-q8如何优化-wasm-性能)
    - [3.3 Q9：冷启动为何如此快？](#33-q9冷启动为何如此快)
  - [4 安全与隔离](#4-安全与隔离)
    - [4.1 Q10：Wasm 沙箱真的安全吗？](#41-q10wasm-沙箱真的安全吗)
    - [4.2 Q11：如何防御侧信道攻击？](#42-q11如何防御侧信道攻击)
    - [4.3 Q12：内存安全如何保证？](#43-q12内存安全如何保证)
  - [5 应用场景](#5-应用场景)
    - [5.1 Q13：Wasm 适合哪些场景？](#51-q13wasm-适合哪些场景)
    - [5.2 Q14：为什么区块链选择 Wasm？](#52-q14为什么区块链选择-wasm)
    - [5.3 Q15：Wasm 能用于移动端吗？](#53-q15wasm-能用于移动端吗)
  - [6 工程实践](#6-工程实践)
    - [6.1 Q16：如何调试 Wasm？](#61-q16如何调试-wasm)
    - [6.2 Q17：如何与现有代码集成？](#62-q17如何与现有代码集成)
    - [6.3 Q18：Wasm 的文件格式细节？](#63-q18wasm-的文件格式细节)
  - [7 批判性问题](#7-批判性问题)
    - [7.1 Q19：Wasm 是否是技术乐观主义的又一次失败？](#71-q19wasm-是否是技术乐观主义的又一次失败)
    - [7.2 Q20：形式化验证真的有用吗？](#72-q20形式化验证真的有用吗)
    - [7.3 Q21：Wasm 会取代 Docker 吗？](#73-q21wasm-会取代-docker-吗)
    - [7.4 Q22：抽象税值得吗？](#74-q22抽象税值得吗)
  - [8 参考资料](#8-参考资料)
    - [8.1 官方资源](#81-官方资源)
    - [8.2 学术论文](#82-学术论文)
    - [8.3 工具链](#83-工具链)

...
- [2.4 验证规则 (Validation Rules)](#24-验证规则-validation-rules)
  ...
  - [核心命题](#核心命题)
  - [验证层次结构](#验证层次结构)
    - [Level 1: 结构验证](#level-1-结构验证)
    - [Level 2: 类型验证](#level-2-类型验证)
      - [类型系统基础](#类型系统基础)
      - [Value Types 验证](#value-types-验证)
      - [Function Types 验证](#function-types-验证)
    - [Level 3: 指令验证](#level-3-指令验证)
      - [类型栈模型](#类型栈模型)
      - [算术指令](#算术指令)
      - [内存指令](#内存指令)
      - [控制流验证](#控制流验证)
    - [Level 4: 引用验证](#level-4-引用验证)
      - [函数引用](#函数引用)
      - [表引用](#表引用)
    - [Level 5: 控制流完整性](#level-5-控制流完整性)
      - [可达性分析](#可达性分析)
      - [结束块验证](#结束块验证)
  - [验证算法实现](#验证算法实现)
    - [类型栈验证器](#类型栈验证器)

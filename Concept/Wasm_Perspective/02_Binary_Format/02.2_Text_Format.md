...
- [2.2 文本格式 (Text Format)](#22-文本格式-text-format)
  ...
  - [1 S-表达式语法](#1-s-表达式语法)
    - [1 基本结构](#1-基本结构)
    - [1.2 折叠指令（Folded Instructions）](#12-折叠指令folded-instructions)
  - [2 模块声明](#2-模块声明)
    - [1 Type Section](#1-type-section)
    - [2.2 Function 声明](#22-function-声明)
  - [3 控制流结构](#3-控制流结构)
    - [1 Block 与 Label](#1-block-与-label)
    - [3.2 Loop 结构](#32-loop-结构)
    - [3.3 If-Else](#33-if-else)
  - [4 内存与表](#4-内存与表)
    - [1 Linear Memory](#1-linear-memory)
    - [4.2 Table](#42-table)
  - [5 导入与导出](#5-导入与导出)
    - [1 Import](#1-import)
  ...
  - [7 注释与元数据](#7-注释与元数据)
    - [1 注释语法](#1-注释语法)
    - [7.2 Custom Section](#72-custom-section)
  - [8 名称解析](#8-名称解析)
    - [1 标识符规则](#1-标识符规则)
    - [8.2 索引与名称混用](#82-索引与名称混用)
  - [9 工具链集成](#9-工具链集成)
    - [1 wat2wasm](#1-wat2wasm)
    - [9.2 wasm2wat](#92-wasm2wat)
  - [10 性能考量](#10-性能考量)
    - [1 解析复杂度](#1-解析复杂度)
    - [10.2 生产环境策略](#102-生产环境策略)
  - [11 批判性分析](#11-批判性分析)
    - [1 优势](#1-优势)
    - [11.2 局限性](#112-局限性)
    - [11.3 设计反思](#113-设计反思)
  - [12 扩展提案](#12-扩展提案)
    - [1 Multi-Memory](#1-multi-memory)
    - [12.2 Component Model](#122-component-model)
  - [参考文献](#参考文献)
  - [13 相关文档](#13-相关文档)

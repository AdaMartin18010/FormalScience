...
- [1.4 Composability Modularity](#14-composability-modularity)
  - [📋 目录](#-目录)
  - [1 概念定义](#1-概念定义)
  ...
  - [5 模块化设计](#5-模块化设计)
    - [1 模块的五个关键属性](#1-模块的五个关键属性)
    - [5.2 耦合类型（从低到高）](#52-耦合类型从低到高)
  - [6 边界设计](#6-边界设计)
    - [1 如何划分模块边界](#1-如何划分模块边界)
  ...
  - [7 反模式](#7-反模式)
    - [1 反模式 1：上帝对象（God Object）](#1-反模式-1上帝对象god-object)
    - [7.2 反模式 2：散弹式修改（Shotgun Surgery）](#72-反模式-2散弹式修改shotgun-surgery)
    - [7.3 反模式 3：过度设计（Over-Engineering）](#73-反模式-3过度设计over-engineering)
  - [8 实践案例](#8-实践案例)
    - [1 案例 1：Unix 哲学](#1-案例-1unix-哲学)
    - [8.2 案例 2：微服务架构](#82-案例-2微服务架构)
    - [8.3 案例 3：React 组件](#83-案例-3react-组件)
  - [9 未来趋势](#9-未来趋势)
    - [1 声明式组合](#1-声明式组合)
    - [2 AI 辅助组合](#2-ai-辅助组合)
    - [3 动态组合](#3-动态组合)
  - [10 评估标准](#10-评估标准)
    ...
    - [10.2 代码度量](#102-代码度量)
  - [11 关键洞察](#11-关键洞察)
    - [1 洞察 1：组合是力量倍增器](#1-洞察-1组合是力量倍增器)
    - [11.2 洞察 2：接口是关键](#112-洞察-2接口是关键)
    - [11.3 洞察 3：模块边界 = 团队边界](#113-洞察-3模块边界--团队边界)
  - [12 实践建议](#12-实践建议)
    - [1 对于架构师](#1-对于架构师)
    - [12.2 对于开发者](#122-对于开发者)
    - [12.3 对于团队](#123-对于团队)
  - [13 相关主题](#13-相关主题)
...
### 7.2 反模式 2：散弹式修改（Shotgun Surgery）
...
### 7.3 反模式 3：过度设计（Over-Engineering）
...
- [概念交叉索引（七视角版）](../../CONCEPT_CROSS_INDEX.md) - 查看相关概念的七视角分析：
  - [隔离](../../CONCEPT_CROSS_INDEX.md#112-隔离-isolation-七视角) - 模块化的隔离机制
  - [虚拟化](../../CONCEPT_CROSS_INDEX.md#212-虚拟化-virtualization-七视角) - 模块边界的抽象
  - [反身性](../../CONCEPT_CROSS_INDEX.md#31-反身性-reflexivity-七视角) - 模块系统的元层级操作

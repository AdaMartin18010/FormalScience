...
- [9.4 Service Mesh](#94-service-mesh)
  - [📋 目录](#-目录)
  ...
  - [3 核心功能](#3-核心功能)
    - [3.1 流量管理](#31-流量管理)
      - [1 金丝雀发布（Canary Deployment）](#1-金丝雀发布canary-deployment)
      - [2 流量镜像（Traffic Mirroring）](#2-流量镜像traffic-mirroring)
    - [3.2 安全](#32-安全)
      - [1 自动mTLS](#1-自动mtls)
      - [2 授权策略](#2-授权策略)
    - [3.3 可观测性](#33-可观测性)
      - [1 自动Metrics](#1-自动metrics)
      - [2 Distributed Tracing](#2-distributed-tracing)
      - [3 访问日志](#3-访问日志)
    - [3.4 弹性](#34-弹性)
      - [1 超时和重试](#1-超时和重试)
      - [2 熔断（Circuit Breaking）](#2-熔断circuit-breaking)
  - [4 主流实现](#4-主流实现)
    - [4.1 Istio](#41-istio)
    - [4.2 Linkerd](#42-linkerd)
    - [4.3 对比](#43-对比)
  - [5 实施策略](#5-实施策略)
    - [1 阶段1：评估（1-2周）](#1-阶段1评估1-2周)
    - [5.2 阶段2：试点（1个月）](#52-阶段2试点1个月)
    - [5.3 阶段3：推广（3-6个月）](#53-阶段3推广3-6个月)
  - [6 最佳实践](#6-最佳实践)
    - [1 部署](#1-部署)
    - [6.2 配置](#62-配置)
    - [6.3 监控](#63-监控)
...
- [概念交叉索引（七视角版）](../../CONCEPT_CROSS_INDEX.md) - 查看相关概念的七视角分析：
  - [隔离](../../CONCEPT_CROSS_INDEX.md#112-隔离-isolation-七视角) - 服务网格中的Sidecar隔离机制
  - [虚拟化](../../CONCEPT_CROSS_INDEX.md#212-虚拟化-virtualization-七视角) - 服务网格的网络虚拟化
  - [通信复杂度](../../CONCEPT_CROSS_INDEX.md#56-通信复杂度-communication-complexity-七视角) - 服务网格的通信成本

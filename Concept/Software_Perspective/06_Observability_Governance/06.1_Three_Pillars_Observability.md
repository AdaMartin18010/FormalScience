# 6.1 Three Pillars Observability
...
- [6.1 Three Pillars Observability](#61-three-pillars-observability)
  - [📋 目录](#-目录)
...
- [概念交叉索引（七视角版）](../../CONCEPT_CROSS_INDEX.md) - 查看相关概念的七视角分析：
  - [熵](../../CONCEPT_CROSS_INDEX.md#71-熵-entropy-七视角) - 可观测性中的信息不确定性度量
  - [互信息](../../CONCEPT_CROSS_INDEX.md#111-互信息-mutual-information-七视角) - Metrics/Logs/Traces之间的信息关联
  - [通信复杂度](../../CONCEPT_CROSS_INDEX.md#56-通信复杂度-communication-complexity-七视角) - 可观测性数据的传输成本

...
- [1 核心定义](#1-核心定义)
- [2 为什么需要 GitOps](#2-为什么需要-gitops)
  - [2.1 传统部署的问题](#21-传统部署的问题)
  - [2.2 GitOps 解决方案](#22-gitops-解决方案)
- [3 GitOps 架构](#3-gitops-架构)
  - [3.1 核心组件](#31-核心组件)
- [4 ArgoCD 深度解析](#4-argocd-深度解析)
  - [4.1 安装](#41-安装)
  - [4.2 创建 Application](#42-创建-application)
  - [4.3 自动修复演示](#43-自动修复演示)
- [5 声明式修复策略](#5-声明式修复策略)
  - [5.1 策略 1：基于 Git 提交的回滚](#51-策略-1基于-git-提交的回滚)
  - [5.2 策略 2：基于 Metric 的自动回滚](#52-策略-2基于-metric-的自动回滚)
  - [5.3 策略 3：基于 OTLP 的智能修复](#53-策略-3基于-otlp-的智能修复)
- [6 Kustomize 多环境管理](#6-kustomize-多环境管理)
- [7 金丝雀发布 GitOps](#7-金丝雀发布-gitops)
- [8 GitOps 最佳实践](#8-gitops-最佳实践)
  - [8.1 单一 Git 仓库 vs 多 Git 仓库](#81-单一-git-仓库-vs-多-git-仓库)
  - [8.2 Git 分支策略](#82-git-分支策略)
  - [8.3 Secrets 管理](#83-secrets-管理)
  ...
  - [8.4 审计与合规](#84-审计与合规)
- [9 关键洞察](#9-关键洞察)
  - [9.1 洞察 1：Git 是时间机器](#91-洞察-1git-是时间机器)
  - [9.2 洞察 2：声明式 命令式](#92-洞察-2声明式-命令式)
  - [9.3 洞察 3：自动化 可靠性](#93-洞察-3自动化-可靠性)
  - [9.4 GitOps起源与定义](#94-gitops起源与定义)
  - [9.5 核心工具](#95-核心工具)
  - [9.6 学术与工业白皮书](#96-学术与工业白皮书)
  - [9.7 企业实践案例](#97-企业实践案例)
  - [9.8 标准与规范](#98-标准与规范)
  - [9.9 Helm与Kustomize](#99-helm与kustomize)
  - [9.10 Git工作流理论](#910-git工作流理论)
  - [9.11 声明式基础设施](#911-声明式基础设施)
  - [9.12 安全与合规](#912-安全与合规)
  - [9.13 在线资源](#913-在线资源)
  - [9.14 验证与采用统计截至2025-10-27](#914-验证与采用统计截至2025-10-27)
- [10 相关主题](#10-相关主题)

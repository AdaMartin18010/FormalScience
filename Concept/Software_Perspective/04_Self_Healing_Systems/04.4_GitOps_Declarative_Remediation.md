# 4.4 GitOps Declarative Remediation
...
- [4.4 GitOps Declarative Remediation](#44-gitops-declarative-remediation)
  - [📋 目录](#-目录)
  - [2 核心定义](#2-核心定义)
  - [3 为什么需要 GitOps](#3-为什么需要-gitops)
    - [3.1 传统部署的问题](#31-传统部署的问题)
    - [3.2 GitOps 解决方案](#32-gitops-解决方案)
  - [4 GitOps 架构](#4-gitops-架构)
    - [4.1 核心组件](#41-核心组件)
  - [5 ArgoCD 深度解析](#5-argocd-深度解析)
    - [5.1 安装](#51-安装)
    - [5.2 创建 Application](#52-创建-application)
    - [5.3 自动修复演示](#53-自动修复演示)
  - [6 声明式修复策略](#6-声明式修复策略)
    - [6.1 策略 1：基于 Git 提交的回滚](#61-策略-1基于-git-提交的回滚)
    - [6.2 策略 2：基于 Metric 的自动回滚](#62-策略-2基于-metric-的自动回滚)
    - [6.3 策略 3：基于 OTLP 的智能修复](#63-策略-3基于-otlp-的智能修复)
  - [7 Kustomize 多环境管理](#7-kustomize-多环境管理)
  - [8 金丝雀发布 GitOps](#8-金丝雀发布-gitops)
  - [9 GitOps 最佳实践](#9-gitops-最佳实践)
    - [9.1 单一 Git 仓库 vs 多 Git 仓库](#91-单一-git-仓库-vs-多-git-仓库)
    - [9.2 Git 分支策略](#92-git-分支策略)
    - [9.3 Secrets 管理](#93-secrets-管理)
      - [3.3.1 正确方法 1：Sealed Secrets](#331-正确方法-1sealed-secrets)
      - [3.3.2 正确方法 2：External Secrets Operator](#332-正确方法-2external-secrets-operator)
    - [9.4 审计与合规](#94-审计与合规)
  - [10 关键洞察](#10-关键洞察)
    - [10.1 洞察 1：Git 是时间机器](#101-洞察-1git-是时间机器)
    - [10.2 洞察 2：声明式 命令式](#102-洞察-2声明式-命令式)
    - [10.3 洞察 3：自动化 可靠性](#103-洞察-3自动化-可靠性)
  - [11 权威参考与标准 | Authoritative References](#11-权威参考与标准--authoritative-references)
    - [10.4 GitOps起源与定义](#104-gitops起源与定义)
    - [10.5 核心工具](#105-核心工具)
    - [10.6 学术与工业白皮书](#106-学术与工业白皮书)
    - [10.7 企业实践案例](#107-企业实践案例)
    - [10.8 标准与规范](#108-标准与规范)
    - [10.9 Helm与Kustomize](#109-helm与kustomize)
    - [10.10 Git工作流理论](#1010-git工作流理论)
    - [10.11 声明式基础设施](#1011-声明式基础设施)
    - [10.12 安全与合规](#1012-安全与合规)
    - [10.13 在线资源](#1013-在线资源)
    - [10.14 验证与采用统计截至2025-10-27](#1014-验证与采用统计截至2025-10-27)
  - [11 相关主题](#11-相关主题)
...
#### 3.3.2 正确方法 2：External Secrets Operator
...
- [概念交叉索引（七视角版）](../../CONCEPT_CROSS_INDEX.md) - 查看相关概念的七视角分析：
  - [反身性](../../CONCEPT_CROSS_INDEX.md#31-反身性-reflexivity-七视角) - GitOps系统在元层级操作自身的能力
  - [隔离](../../CONCEPT_CROSS_INDEX.md#112-隔离-isolation-七视角) - GitOps中的环境隔离机制
  - [虚拟化](../../CONCEPT_CROSS_INDEX.md#212-虚拟化-virtualization-七视角) - 声明式基础设施的抽象层

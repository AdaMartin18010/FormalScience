...
- [4.4 GitOps 声明式修复](#44-gitops-声明式修复)
  ...
  - [6 声明式修复策略](#6-声明式修复策略)
    - [1 策略 1：基于 Git 提交的回滚](#1-策略-1基于-git-提交的回滚)
  ...
  - [9 GitOps 最佳实践](#9-gitops-最佳实践)
    ...
    - [3 . Secrets 管理](#3--secrets-管理)
      - [1 正确方法 1：Sealed Secrets](#1-正确方法-1sealed-secrets)
      - [2 正确方法 2：External Secrets Operator](#2-正确方法-2external-secrets-operator)
    - [4 . 审计与合规](#4--审计与合规)
  - [10 关键洞察](#10-关键洞察)
    - [1 洞察 1：Git 是时间机器](#1-洞察-1git-是时间机器)
  ...
  - [11 权威参考与标准 | Authoritative References](#11-权威参考与标准--authoritative-references)
    - [1 GitOps起源与定义](#1-gitops起源与定义)
    - [11.2 核心工具](#112-核心工具)
    - [11.3 学术与工业白皮书](#113-学术与工业白皮书)
    - [11.4 企业实践案例](#114-企业实践案例)
    - [11.5 标准与规范](#115-标准与规范)
    - [11.6 Helm与Kustomize](#116-helm与kustomize)
    - [11.7 Git工作流理论](#117-git工作流理论)
    - [11.8 声明式基础设施](#118-声明式基础设施)
    - [11.9 安全与合规](#119-安全与合规)
    - [11.10 在线资源](#1110-在线资源)
    - [11.11 验证与采用统计（截至2025-10-27）](#1111-验证与采用统计截至2025-10-27)
  - [12 相关主题](#12-相关主题)
...
#### 2 正确方法 2：External Secrets Operator

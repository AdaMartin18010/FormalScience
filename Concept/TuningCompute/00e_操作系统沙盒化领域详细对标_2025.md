...
- [操作系统-沙盒化领域详细对标 (2025版)](#操作系统-沙盒化领域详细对标-2025版)
  ...
  - [5 🔬 12项理论详细对标](#5--12项理论详细对标)
    - [5.1 核心理论组1: Seccomp沙盒 (4项)](#51-核心理论组1-seccomp沙盒-4项)
      - [5.1.1 理论1: Seccomp-BPF沙盒模型](#511-理论1-seccomp-bpf沙盒模型)
      - [5.1.2 理论2: 带子分类理论](#512-理论2-带子分类理论)
    - [5.2 核心理论组2: Wasm沙盒 (3项)](#52-核心理论组2-wasm沙盒-3项)
      - [5.2.1 理论3: Wasm线性内存模型](#521-理论3-wasm线性内存模型)
      - [5.2.2 理论4: Wasm类型安全沙盒](#522-理论4-wasm类型安全沙盒)
    - [5.3 核心理论组3: 用户态内核 (3项)](#53-核心理论组3-用户态内核-3项)
      - [5.3.1 理论5: gVisor用户态内核模型](#531-理论5-gvisor用户态内核模型)
      - [5.3.2 理论6: 包装状态转移函数](#532-理论6-包装状态转移函数)
    - [5.4 核心理论组4: 浏览器沙盒 (2项)](#54-核心理论组4-浏览器沙盒-2项)
      - [5.4.1 理论7: Chrome多层沙盒模型](#541-理论7-chrome多层沙盒模型)
  - [6 📊 12项理论统计](#6--12项理论统计)
    - [6.1 按对标来源分类](#61-按对标来源分类)
    - [6.2 按技术分类](#62-按技术分类)
  - [7 🎓 学习路径](#7--学习路径)
    - [7.1 初学者路径 (2-3个月)](#71-初学者路径-2-3个月)
    - [7.2 进阶路径](#72-进阶路径)
  - [8 📖 推荐阅读](#8--推荐阅读)
    - [8.1 必读文档](#81-必读文档)
    - [8.2 必读论文](#82-必读论文)
...
### 5.1 核心理论组1: Seccomp沙盒 (4项)

#### 5.1.1 理论1: Seccomp-BPF沙盒模型
...
### 5.2 核心理论组2: Wasm沙盒 (3项)

#### 5.2.1 理论3: Wasm线性内存模型

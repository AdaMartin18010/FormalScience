...
- [编程算法设计视角 - 主索引](#编程算法设计视角---主索引)
  ...
  - [1 📋 文档导航](#1--文档导航)
    ...
    - [1.2 辅助文档](#12-辅助文档)
  - [2 🎯 核心理念](#2--核心理念)
    - [2.1 统一形式化框架：UH-Cost = ⟨Σ, ⟶, κ, Φ⟩](#21-统一形式化框架uh-cost--σ--κ-φ)
    - [2.2 三元视角：控制·执行·数据](#22-三元视角控制执行数据)
  - [3 📚 章节详细内容](#3--章节详细内容)
    ...
    - [05 . 形式验证与工具](#05--形式验证与工具)
      - [05.1 子主题](#051-子主题)
  - [4 🔗 跨领域关联](#4--跨领域关联)
    - [4.1 与其他视角的关系](#41-与其他视角的关系)
    - [4.2 与项目其他部分的联系](#42-与项目其他部分的联系)
  - [5 📖 推荐学习路径](#5--推荐学习路径)
    - [5.1 路径 1：形式化入门 (初学者)](#51-路径-1形式化入门-初学者)
    - [5.2 路径 2：算法理论 (进阶)](#52-路径-2算法理论-进阶)
    - [5.3 路径 3：架构设计 (实践者)](#53-路径-3架构设计-实践者)
  - [6 🎓 对标国际课程](#6--对标国际课程)
    - [6.1 顶级大学课程映射](#61-顶级大学课程映射)
    - [6.2 教材对标](#62-教材对标)
  - [7 📊 统计信息](#7--统计信息)
  - [8 🔄 更新日志](#8--更新日志)
  - [9 📮 贡献指南](#9--贡献指南)

...
- [5.3 K Framework](#53-k-framework)
  ...
  - [12 快速参考](#12-快速参考)
    ...
    - [12.2 工具链](#122-工具链)
    - [12.3 实战建议](#123-实战建议)
  - [13 附录 A：K-Framework 安装](#13-附录-ak-framework-安装)
    - [1 Linux/macOS](#1-linuxmacos)
    - [13.2 Windows (WSL)](#132-windows-wsl)
    - [13.3 Docker](#133-docker)
...
- [概念交叉索引（七视角版）](../../CONCEPT_CROSS_INDEX.md) - 查看相关概念的七视角分析：
  - [操作语义](../../CONCEPT_CROSS_INDEX.md) - K-Framework定义操作语义的核心方法
  - [图灵完备性](../../CONCEPT_CROSS_INDEX.md#191-图灵完备性-turing-completeness-七视角) - K定义语言的计算能力
  - [Chomsky层级](../../CONCEPT_CROSS_INDEX.md#51-chomsky层级-chomsky-hierarchy-七视角) - K定义语言的形式语言基础

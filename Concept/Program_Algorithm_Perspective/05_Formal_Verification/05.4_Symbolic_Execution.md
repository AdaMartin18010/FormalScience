...
- [5.4 Symbolic Execution](#54-symbolic-execution)
  ...
  - [11 快速参考](#11-快速参考)
    - [1 核心概念](#1-核心概念)
    - [11.2 工具链速查](#112-工具链速查)
    - [11.3 实战建议](#113-实战建议)
  - [12 附录 A：安装指南](#12-附录-a安装指南)
...
- [概念交叉索引（七视角版）](../../CONCEPT_CROSS_INDEX.md) - 查看相关概念的七视角分析：
  - [停机问题](../../CONCEPT_CROSS_INDEX.md#102-停机问题-halting-problem-七视角) - 符号执行中的路径终止性判定
  - [Rice定理](../../CONCEPT_CROSS_INDEX.md#171-rice定理-rices-theorem-七视角) - 程序性质验证的不可判定性
  - [P vs NP问题](../../CONCEPT_CROSS_INDEX.md#151-p-vs-np问题-p-versus-np-problem-七视角) - 约束求解的复杂度

...
- [2.5 Architecture Patterns](#25-architecture-patterns)
  ...
  - [9 快速参考](#9-快速参考)
    ...
    - [9.2 形式化工具](#92-形式化工具)
    - [9.3 实战建议](#93-实战建议)
  - [10 附录 A：Wikipedia 概念对照](#10-附录-awikipedia-概念对照)
  - [跨视角链接](#跨视角链接)
...
- [概念交叉索引（七视角版）](../../CONCEPT_CROSS_INDEX.md) - 查看相关概念的七视角分析：
  - [隔离](../../CONCEPT_CROSS_INDEX.md#112-隔离-isolation-七视角) - 架构模式中的隔离机制

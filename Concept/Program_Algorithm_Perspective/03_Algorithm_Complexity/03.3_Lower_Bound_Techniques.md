...
- [3.3 Lower Bound Techniques](#33-lower-bound-techniques)
...
- [概念交叉索引（七视角版）](../../CONCEPT_CROSS_INDEX.md) - 查看相关概念的七视角分析：
  - [通信复杂度](../../CONCEPT_CROSS_INDEX.md#56-通信复杂度-communication-complexity-七视角) - 下界证明中的通信复杂度技术
  - [P vs NP问题](../../CONCEPT_CROSS_INDEX.md#151-p-vs-np问题-p-versus-np-problem-七视角) - 下界证明与计算复杂度类的关系
  - [熵](../../CONCEPT_CROSS_INDEX.md#71-熵-entropy-七视角) - 信息论下界的基础

# 3.6 Formal Algorithm Specification
...
- [3.6 Formal Algorithm Specification](#36-formal-algorithm-specification)
...
- [概念交叉索引（七视角版）](../../CONCEPT_CROSS_INDEX.md) - 查看相关概念的七视角分析：
  ...
  - [停机问题](../../CONCEPT_CROSS_INDEX.md#102-停机问题-halting-problem-七视角) - 算法终止性验证的根本挑战

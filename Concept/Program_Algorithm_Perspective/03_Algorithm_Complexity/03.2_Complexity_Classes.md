...
- [复杂度类（Complexity Classes）](#复杂度类complexity-classes)
  ...
  - [13 . 总结](#13--总结)
    - [1 核心洞察](#1-核心洞察)
    - [13.2 工具链推荐](#132-工具链推荐)
    - [13.3 实战建议](#133-实战建议)
  - [14 附录 A：21 个 NP-完全问题（Karp 1972）](#14-附录-a21-个-np-完全问题karp-1972)
...
## 14 附录 A：21 个 NP-完全问题（Karp 1972）
...
- [概念交叉索引（七视角版）](../../CONCEPT_CROSS_INDEX.md) - 查看相关概念的七视角分析：
  - [P vs NP问题](../../CONCEPT_CROSS_INDEX.md#151-p-vs-np问题-p-versus-np-problem-七视角) - 复杂度类的核心问题
  - [并行复杂度类](../../CONCEPT_CROSS_INDEX.md#54-并行复杂度类-nc-p-完全性-七视角) - 并行计算的复杂度分类
  - [通信复杂度](../../CONCEPT_CROSS_INDEX.md#56-通信复杂度-communication-complexity-七视角) - 分布式计算的复杂度度量

...
- [04.3 事件驱动架构 (Event-Driven Architecture, EDA)](#043-事件驱动架构-event-driven-architecture-eda)
  ...
  - [7 . 最佳实践 (Best Practices)](#7--最佳实践-best-practices)
    ...
    - [7.2 幂等性保证](#72-幂等性保证)
      - [1 方案1：基于事件ID去重](#1-方案1基于事件id去重)
      - [2 方案2：业务逻辑幂等](#2-方案2业务逻辑幂等)
    - [7.3 监控与告警](#73-监控与告警)
...
- [概念交叉索引（七视角版）](../../CONCEPT_CROSS_INDEX.md) - 查看相关概念的七视角分析：
  - [CAP定理](../../CONCEPT_CROSS_INDEX.md#53-cap定理-cap-theorem-七视角) - 事件驱动架构中的可用性与一致性权衡
  - [一致性模型详解](../../CONCEPT_CROSS_INDEX.md#55-一致性模型详解-consistency-models-七视角) - 事件驱动架构的最终一致性保证
  - [通信复杂度](../../CONCEPT_CROSS_INDEX.md#56-通信复杂度-communication-complexity-七视角) - 事件总线的通信成本

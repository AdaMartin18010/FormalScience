...
- [4.3 微服务 Architecture](#43-微服务-architecture)
  ...
  - [10 快速参考](#10-快速参考)
    - [1 核心组件](#1-核心组件)
    - [10.2 工具链](#102-工具链)
  - [11 附录：Wikipedia 概念对照](#11-附录wikipedia-概念对照)
  - [跨视角链接](#跨视角链接)
...
- [概念交叉索引（七视角版）](../../CONCEPT_CROSS_INDEX.md) - 查看相关概念的七视角分析：
  - [CAP定理](../../CONCEPT_CROSS_INDEX.md#53-cap定理-cap-theorem-七视角) - 微服务架构的核心权衡
  - [一致性模型详解](../../CONCEPT_CROSS_INDEX.md#55-一致性模型详解-consistency-models-七视角) - 微服务间的数据一致性保证
  - [通信复杂度](../../CONCEPT_CROSS_INDEX.md#56-通信复杂度-communication-complexity-七视角) - 微服务间通信的成本

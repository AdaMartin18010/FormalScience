...
- [分层架构（Layered Architecture）](#分层架构layered-architecture)
  ...
  - [1 . 经典分层模型](#1--经典分层模型)
    ...
    - [1.2 三层 Web 应用](#12-三层-web-应用)
      - [1 示例（Spring MVC）](#1-示例spring-mvc)
  ...
  - [13 . 总结](#13--总结)
    ...
    - [13.3 实战建议](#133-实战建议)
  - [14 附录 A：分层架构 Checklist](#14-附录-a分层架构-checklist)
...
- [概念交叉索引（七视角版）](../../CONCEPT_CROSS_INDEX.md) - 查看相关概念的七视角分析：
  - [隔离](../../CONCEPT_CROSS_INDEX.md#112-隔离-isolation-七视角) - 分层架构中的层次隔离机制
  - [虚拟化](../../CONCEPT_CROSS_INDEX.md#212-虚拟化-virtualization-七视角) - 分层架构的抽象与虚拟化
  - [反身性](../../CONCEPT_CROSS_INDEX.md#31-反身性-reflexivity-七视角) - 分层系统在元层级操作自身的能力

...
- [1 标题A](#1-标题a)
- [2 标题B](#2-标题b)
- [3 标题C -- 应该是 13 --](#3-标题c----应该是-13)
- [4 解决方案](#4-解决方案)
  - [4.1 设计原则](#41-设计原则)
- [5 已提供的工具](#5-已提供的工具)
  - [5.1 Python 脚本推荐](#51-python-脚本推荐)
  - [5.2 PowerShell 脚本Windows](#52-powershell-脚本windows)
  - [5.3 Nodejs 脚本跨平台](#53-nodejs-脚本跨平台)
- [6 使用方法](#6-使用方法)
  - [6.1 方案A：使用 Python 脚本推荐](#61-方案a使用-python-脚本推荐)
  - [6.2 方案B：使用 PowerShellWindows原生](#62-方案b使用-powershellwindows原生)
  - [6.3 方案C：使用 Nodejs如果安装了Node](#63-方案c使用-nodejs如果安装了node)
  - [6.4 方案D：手动修复针对少量文件](#64-方案d手动修复针对少量文件)
- [7 示例修复](#7-示例修复)
  - [7.1 修复前](#71-修复前)
- [8 概述](#8-概述)
- [9 核心技术突破](#9-核心技术突破)
  - [9.1 分布式词表示](#91-分布式词表示)
  - [9.2 循环神经网络](#92-循环神经网络)
- [10 重要里程碑](#10-重要里程碑)
  - [10.1 Bengio 2003](#101-bengio-2003)
  - [10.2 Mikolov 2010](#102-mikolov-2010)
- [11 批量执行建议](#11-批量执行建议)
  - [11.1 策略1：全量修复推荐](#111-策略1全量修复推荐)
  - [11.2 策略2：分批修复谨慎](#112-策略2分批修复谨慎)
  - [11.3 策略3：先测试再全量最安全](#113-策略3先测试再全量最安全)
- [12 注意事项](#12-注意事项)
  - [12.1 安全措施](#121-安全措施)
  - [12.2 已知限制](#122-已知限制)
  - [12.3 手动修复序号](#123-手动修复序号)
- [13 第一节](#13-第一节)
- [14 第二节](#14-第二节)
- [15 第三节](#15-第三节)
- [16 第一节](#16-第一节)

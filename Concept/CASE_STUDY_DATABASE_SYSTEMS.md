...
- [案例研究：数据库系统的八视角分析](#案例研究数据库系统的八视角分析)
  ...
  - [2 案例背景](#2-案例背景)
    - [2.1 数据库系统的核心挑战](#21-数据库系统的核心挑战)
    - [2.2 主要数据库类型](#22-主要数据库类型)
  - [3 八视角综合分析](#3-八视角综合分析)
  ...
  - [8 视角5：分布式系统视角](#8-视角5分布式系统视角)
    ...
    - [5.3 分片与复制](#53-分片与复制)
  - [9 ACID vs BASE权衡](#9-acid-vs-base权衡)
    - [9.1 ACID（传统关系数据库）](#91-acid传统关系数据库)
    - [9.2 BASE（NoSQL）](#92-basenosql)
    - [9.3 对比表](#93-对比表)
  - [10 数据库类型对比](#10-数据库类型对比)
    - [10.1 综合对比](#101-综合对比)
    - [10.2 选择指南](#102-选择指南)
  - [11 总结](#11-总结)
    - [11.1 核心洞察](#111-核心洞察)
    - [11.2 未来趋势](#112-未来趋势)
    - [11.3 八视角框架的价值](#113-八视角框架的价值)

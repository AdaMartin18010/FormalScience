...
## 📋 目录
  ...
  - [1.1 报告文档元数据推荐](#11-报告文档元数据推荐)
- [1 章节标题规范](#1-章节标题规范)
  - [1.1 基本规则](#11-基本规则)
- [2 二级标题](#2-二级标题)
  - [2.1 三级标题](#21-三级标题)
    - [1.1.1 四级标题尽量避免使用](#111-四级标题尽量避免使用)
- [3 标题： 不要加中文冒号](#3-标题-不要加中文冒号)
- [4 标题 不要加英文冒号](#4-标题-不要加英文冒号)
- [5 标题 标题本身不带编号除非特殊需要](#5-标题-标题本身不带编号除非特殊需要)
  - [5.1 标题命名建议](#51-标题命名建议)
  - [5.2 特殊标题约定](#52-特殊标题约定)
- [6 代码块规范](#6-代码块规范)
  - [6.1 语言标记必需](#61-语言标记必需)
  - [6.2 语言标记选择指南](#62-语言标记选择指南)
  - [6.3 代码块缩进](#63-代码块缩进)
- [7 引用格式规范](#7-引用格式规范)
  - [7.1 内部文档引用](#71-内部文档引用)
  - [7.2 公式引用](#72-公式引用)
  - [7.3 概念引用](#73-概念引用)
  - [7.4 外部引用](#74-外部引用)
- [8 导航元素规范](#8-导航元素规范)
  - [8.1 返回顶部链接](#81-返回顶部链接)
- [9 第一章](#9-第一章)
- [10 第二章](#10-第二章)
  - [10.1 快速导航可选](#101-快速导航可选)
- [11 快速导航](#11-快速导航)
  - [11.1 文档末尾元信息](#111-文档末尾元信息)
- [12 完整模板](#12-完整模板)
  - [12.1 核心理论文档模板](#121-核心理论文档模板)
- [13 核心定义](#13-核心定义)
  - [13.1 子标题1](#131-子标题1)
- [14 七视角分析](#14-七视角分析)
- [15 应用实例](#15-应用实例)
- [16 相关文档](#16-相关文档)
  - [16.1 报告文档模板](#161-报告文档模板)
- [17 任务目标](#17-任务目标)
- [18 完成情况](#18-完成情况)
- [19 总结](#19-总结)
- [20 标准实施检查清单](#20-标准实施检查清单)
  - [20.1 核心文档检查清单](#201-核心文档检查清单)
  - [20.2 报告文档检查清单](#202-报告文档检查清单)
- [21 标准更新历史](#21-标准更新历史)
- [22 注意事项](#22-注意事项)

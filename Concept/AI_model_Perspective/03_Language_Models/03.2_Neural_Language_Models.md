...
- [核心概念深度分析](#核心概念深度分析)
  ...
  - [5️⃣ LSTM内部机制详解](#5️⃣-lstm内部机制详解)
  - [6️⃣ 神经语言模型的信息论分析](#6️⃣-神经语言模型的信息论分析)
  - [7️⃣ 典型训练配置](#7️⃣-典型训练配置)
  - [8️⃣ 历史里程碑时间线](#8️⃣-历史里程碑时间线)
  - [9️⃣ 神经语言模型的哲学启示](#9️⃣-神经语言模型的哲学启示)
- [概述](#概述)
- [核心技术突破](#核心技术突破)
  - [1. 分布式词表示 (Distributed Word Representations)](#1-分布式词表示-distributed-word-representations)
  - [2. 循环神经网络 (Recurrent Neural Networks, RNN)](#2-循环神经网络-recurrent-neural-networks-rnn)
  - [3. 长短时记忆网络 (LSTM)](#3-长短时记忆网络-lstm)
- [重要里程碑](#重要里程碑)
  - [Bengio 2003: FFNN-LM](#bengio-2003-ffnn-lm)
  - [Mikolov 2010-2012: RNN-LM](#mikolov-2010-2012-rnn-lm)
  - [Sundermeyer 2012: LSTM-LM](#sundermeyer-2012-lstm-lm)
  - [ELMo 2018: 上下文化词表示](#elmo-2018-上下文化词表示)
- [从统计到神经的转变](#从统计到神经的转变)
- [总结](#总结)
  - [核心要点](#核心要点)
  - [关键引用](#关键引用)

...
- [Transformer 大语言模型理论 | Transformer Large Language Model Theory](#transformer-大语言模型理论--transformer-large-language-model-theory)
  ...
  - [2 📊 核心概念深度分析](#2--核心概念深度分析)
    - [1 ️⃣ 大语言模型概念定义卡](#1-️⃣-大语言模型概念定义卡)
    - [2 ️⃣ LLM发展历史全景图](#2-️⃣-llm发展历史全景图)
    - [3 ️⃣ LLM训练范式对比矩阵](#3-️⃣-llm训练范式对比矩阵)
    - [4 ️⃣ Scaling Laws（缩放定律）思维导图](#4-️⃣-scaling-laws缩放定律思维导图)
    - [5 ️⃣ 上下文学习(ICL)能力层次](#5-️⃣-上下文学习icl能力层次)
    - [6 ️⃣ RLHF对齐流程图](#6-️⃣-rlhf对齐流程图)
    - [7 ️⃣ LLM能力与局限对比表](#7-️⃣-llm能力与局限对比表)
    - [8 ️⃣ 不同规模LLM性能对比](#8-️⃣-不同规模llm性能对比)
    - [9 ️⃣ LLM理论理解框架](#9-️⃣-llm理论理解框架)

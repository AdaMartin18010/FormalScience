# 3.4 Token Generation Mechanisms
...
- [3.4 Token Generation Mechanisms](#34-token-generation-mechanisms)
  - [📋 目录](#-目录)
...
- [概念交叉索引（七视角版）](../../CONCEPT_CROSS_INDEX.md) - 查看相关概念的七视角分析：
  - [熵](../../CONCEPT_CROSS_INDEX.md#71-熵-entropy-七视角) - Token生成的熵与随机性
  - [互信息](../../CONCEPT_CROSS_INDEX.md#111-互信息-mutual-information-七视角) - Token之间的信息依赖
  - [Kolmogorov复杂度](../../CONCEPT_CROSS_INDEX.md#121-kolmogorov复杂度-kolmogorov-complexity-七视角) - Token序列的复杂度

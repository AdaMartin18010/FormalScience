...
- [3.6 Context Window Memory](#36-context-window-memory)
  - [📋 目录](#-目录)
...
- [概念交叉索引（七视角版）](../../CONCEPT_CROSS_INDEX.md) - 查看相关概念的七视角分析：
  - [互信息](../../CONCEPT_CROSS_INDEX.md#111-互信息-mutual-information-七视角) - 上下文窗口的信息关联
  - [熵](../../CONCEPT_CROSS_INDEX.md#71-熵-entropy-七视角) - 记忆状态的不确定性
  - [通信复杂度](../../CONCEPT_CROSS_INDEX.md#56-通信复杂度-communication-complexity-七视角) - 上下文信息的传输成本

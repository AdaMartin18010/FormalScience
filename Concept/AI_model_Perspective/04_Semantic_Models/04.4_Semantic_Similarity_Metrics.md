...
- [2 基于路径的相似度度量](#2-基于路径的相似度度量)
  - [2.1 WordNet简介](#21-wordnet简介)
  - [2.2 路径长度Path Length](#22-路径长度path-length)
  - [2.3 Leacock-Chodorow相似度](#23-leacock-chodorow相似度)
  - [2.4 Wu-Palmer相似度](#24-wu-palmer相似度)
  - [2.5 Resnik相似度](#25-resnik相似度)
- [3 深度学习时代的相似度度量](#3-深度学习时代的相似度度量)
  - [3.1 学习的相似度函数](#31-学习的相似度函数)
  - [3.2 孪生网络Siamese Networks](#32-孪生网络siamese-networks)
  - [3.3 三元组损失Triplet Loss](#33-三元组损失triplet-loss)
  - [3.4 对比学习Contrastive Learning](#34-对比学习contrastive-learning)
- [4 句子和文档级别的相似度](#4-句子和文档级别的相似度)
  - [4.1 平均词向量Averaged Word Embeddings](#41-平均词向量averaged-word-embeddings)
  - [4.2 Sentence-BERT](#42-sentence-bert)
  - [4.3 BERTScore](#43-bertscore)
  - [4.4 文档相似度：TF-IDF 余弦](#44-文档相似度tf-idf-余弦)
- [5 跨模态相似度度量](#5-跨模态相似度度量)
  - [5.1 图像-文本相似度](#51-图像-文本相似度)
  - [5.2 多模态相似度](#52-多模态相似度)
- [6 相似度度量的评估](#6-相似度度量的评估)
  - [6.1 内在评估Intrinsic Evaluation](#61-内在评估intrinsic-evaluation)
    - [1.1.1 人类判断相关性](#111-人类判断相关性)
    - [1.1.2 类比任务](#112-类比任务)
  - [6.2 外在评估Extrinsic Evaluation](#62-外在评估extrinsic-evaluation)
- [7 总结](#7-总结)
  - [7.1 核心要点](#71-核心要点)
  - [7.2 选择指南](#72-选择指南)
  - [7.3 未来方向](#73-未来方向)

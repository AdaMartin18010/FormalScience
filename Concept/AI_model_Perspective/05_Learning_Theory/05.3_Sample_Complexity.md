...
- [5.3 Sample Complexity](#53-sample-complexity)
  ...
  - [1 核心概念深度分析](#1-核心概念深度分析)
    - [1 样本复杂度概念定义卡](#1-样本复杂度概念定义卡)
    - [2 样本复杂度理论全景图谱](#2-样本复杂度理论全景图谱)
    - [3 VC维界vs Rademacher界深度对比](#3-vc维界vs-rademacher界深度对比)
    - [4 有限vs无限假设空间样本复杂度](#4-有限vs无限假设空间样本复杂度)
    - [5 深度学习的样本复杂度悖论](#5-深度学习的样本复杂度悖论)
...
| **VC维d** | ~ p（最坏） | ~ p（最坏） | 一致 |
| **理论样本需求** | m ~ d/ε² ~ 10^15 | [待理论验证] | [待理论验证] |

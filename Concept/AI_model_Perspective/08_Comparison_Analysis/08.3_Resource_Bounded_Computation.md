# 8.3 Resource Bounded Computation
...
- [8.3 Resource Bounded Computation](#83-resource-bounded-computation)
  ...
  - [3 三、AI vs 传统算法：资源效率对比](#3-三ai-vs-传统算法资源效率对比)
    - [3.1 排序任务](#31-排序任务)
      - [1 传统算法](#1-传统算法)
      - [2 神经网络方法](#2-神经网络方法)
    - [3.2 图搜索任务](#32-图搜索任务)
  ...
  - [4 四、资源限制的实际影响](#4-四资源限制的实际影响)
    - [4.1 训练成本](#41-训练成本)
    - [4.2 推理成本](#42-推理成本)
    - [4.3 上下文窗口限制](#43-上下文窗口限制)
    - [4.4 能源效率](#44-能源效率)
  - [5 五、资源受限下的能力边界](#5-五资源受限下的能力边界)
    - [5.1 参数效率](#51-参数效率)
    - [5.2 数据效率](#52-数据效率)
    - [5.3 泛化与过拟合的权衡](#53-泛化与过拟合的权衡)
  - [6 六、理论vs实践的鸿沟](#6-六理论vs实践的鸿沟)

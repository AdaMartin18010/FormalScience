...
- [2.5 Universal Approximation Theorem](#25-universal-approximation-theorem)
  - [📋 目录](#-目录)
...
- [概念交叉索引（七视角版）](../../CONCEPT_CROSS_INDEX.md) - 查看相关概念的七视角分析：
  - [VC维](../../CONCEPT_CROSS_INDEX.md#211-vc维-vapnik-chervonenkis-dimension-七视角) - 通用逼近定理与模型容量的关系
  - [PAC学习框架](../../CONCEPT_CROSS_INDEX.md) - 逼近误差与学习理论
  - [互信息](../../CONCEPT_CROSS_INDEX.md#111-互信息-mutual-information-七视角) - 信息论视角的逼近能力

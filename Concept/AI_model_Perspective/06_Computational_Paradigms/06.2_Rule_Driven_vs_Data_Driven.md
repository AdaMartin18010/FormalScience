# 6.2 Rule Driven vs Data Driven
...
- [概念交叉索引（七视角版）](../../CONCEPT_CROSS_INDEX.md) - 查看相关概念的七视角分析：
  - [Gold可学习性理论](../../CONCEPT_CROSS_INDEX.md#91-gold可学习性-gold-learnability-theory-七视角) - 数据驱动学习的理论限制
  - [VC维](../../CONCEPT_CROSS_INDEX.md#211-vc维-vapnik-chervonenkis-dimension-七视角) - 数据驱动模型的容量度量
  - [PAC学习框架](../../CONCEPT_CROSS_INDEX.md) - 数据驱动学习的理论基础

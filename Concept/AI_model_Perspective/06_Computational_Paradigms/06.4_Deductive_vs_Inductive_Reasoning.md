# 6.4 Deductive vs Inductive Reasoning
...
- [6.4 Deductive vs Inductive Reasoning](#64-deductive-vs-inductive-reasoning)
  - [1 核心概念深度分析](#1-核心概念深度分析)
    - [1 演绎vs归纳推理概念定义卡](#1-演绎vs归纳推理概念定义卡)
    - [2 演绎vs归纳vs溯因推理全景对比](#2-演绎vs归纳vs溯因推理全景对比)
    - [3 演绎vs归纳十二维深度对比矩阵](#3-演绎vs归纳十二维深度对比矩阵)
    - [4 Hume归纳问题深度剖析](#4-hume归纳问题深度剖析)
    - [5 AI中的演绎vs归纳应用矩阵](#5-ai中的演绎vs归纳应用矩阵)
    - [6 演绎vs归纳的哲学基础](#6-演绎vs归纳的哲学基础)
  ...
  - [4 归纳推理](#4-归纳推理)
    - [1 定义1](#1-定义1)
    - [2 归纳的类型](#2-归纳的类型)
      - [1 枚举归纳（Enumerative Induction）](#1-枚举归纳enumerative-induction)
      - [2 消除归纳（Eliminative Induction）](#2-消除归纳eliminative-induction)
      - [3 统计归纳](#3-统计归纳)
...
- [概念交叉索引（七视角版）](../../CONCEPT_CROSS_INDEX.md) - 查看相关概念的七视角分析：
  - [Gold可学习性理论](../../CONCEPT_CROSS_INDEX.md#91-gold可学习性-gold-learnability-theory-七视角) - 归纳推理的理论限制，仅从正例学习的不可行性
  - [Gödel不完备定理](../../CONCEPT_CROSS_INDEX.md#101-gödel不完备定理-gödels-incompleteness-theorems-七视角) - 演绎推理的局限性，形式系统的根本限制
  - [VC维](../../CONCEPT_CROSS_INDEX.md#211-vc维-vapnik-chervonenkis-dimension-七视角) - PAC学习的核心概念，归纳推理的样本复杂度度量
  - [Chomsky层级](../../CONCEPT_CROSS_INDEX.md#51-chomsky层级-chomsky-hierarchy-七视角) - 形式语言与推理能力的关系

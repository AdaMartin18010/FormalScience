...
<details>
<summary><b>🧱🏗️ 点击展开：建构主义核心洞察</b></summary>

**终极洞察**: 建构主义：知识非发现而是建构。核心主张：①认识论建构：知识由主体建构（Piaget/Vygotsky）②社会建构：知识=社会过程产物（Berger/Luckmann）③激进建构：实在不可知（von Glasersfeld）。关键理论：①Piaget发生认识论：图式→同化/顺应→平衡②Vygotsky社会文化理论：最近发展区ZPD、脚手架③知识社会学（Mannheim）：知识与意识形态。vs实在论：建构≠虚构，但实在依赖认识框架。应用：建构主义教学（探究学习）、科学哲学（Kuhn范式）、技术哲学（SCOT社会建构）。批评：相对主义、自反悖论（建构主义本身是建构？）。关键：知识=主体+客体交互，非纯粹主观或客观。
...
- [5.3 Constructivism](#53-constructivism)
...
_本文档是信息论多视角分析中建构主义的详细阐述，为理解知识建构过程提供了理论基础和实践指导。_
...
- [概念交叉索引（七视角版）](../../CONCEPT_CROSS_INDEX.md) - 查看相关概念的七视角分析：
  - [DIKWP模型](../../CONCEPT_CROSS_INDEX.md#61-dikwp模型-七视角) - 知识建构的认知层次
  - [反身性](../../CONCEPT_CROSS_INDEX.md#31-反身性-reflexivity-七视角) - 建构主义的知识自反性
  - [熵](../../CONCEPT_CROSS_INDEX.md#71-熵-entropy-七视角) - 知识建构中的信息不确定性

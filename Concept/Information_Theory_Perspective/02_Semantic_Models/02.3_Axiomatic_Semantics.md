...
- [公理语义模型](#公理语义模型)
  ...
  - [概述](#概述)
  - [📊 核心概念深度分析](#-核心概念深度分析)
    - [1 ️⃣ 公理语义概念定义卡](#1-公理语义概念定义卡)
    - [2 ️⃣ 公理语义全景图谱](#2-公理语义全景图谱)
    - [3 ️⃣ Hoare逻辑推理规则深度对比](#3-hoare逻辑推理规则深度对比)
...
- [公理语义模型](#公理语义模型)
  ...
  - [概述](#概述)
  - [📊 核心概念深度分析](#-核心概念深度分析)
    - [1️⃣ 公理语义概念定义卡](#1️⃣-公理语义概念定义卡)
    - [2️⃣ 公理语义全景图谱](#2️⃣-公理语义全景图谱)
    - [3️⃣ Hoare逻辑推理规则深度对比](#3️⃣-hoare逻辑推理规则深度对比)
    - [🔟 核心洞察与终极评估](#-核心洞察与终极评估)
  - [1. 30秒电梯说明](#1-30秒电梯说明)
  - [2. 核心对象](#2-核心对象)
    - [2.1 基本组件](#21-基本组件)

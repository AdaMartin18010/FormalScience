...
- [7.2 Deep Learning Information](#72-deep-learning-information)
...
- [概念交叉索引（七视角版）](../../CONCEPT_CROSS_INDEX.md) - 查看相关概念的七视角分析：
  - [VC维](../../CONCEPT_CROSS_INDEX.md#211-vc维-vapnik-chervonenkis-dimension-七视角) - 深度学习模型的容量与泛化能力
  - [熵](../../CONCEPT_CROSS_INDEX.md#71-熵-entropy-七视角) - 深度学习中的信息不确定性
  - [互信息](../../CONCEPT_CROSS_INDEX.md#111-互信息-mutual-information-七视角) - 信息瓶颈理论与特征学习

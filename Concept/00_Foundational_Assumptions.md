...
- [形式科学基石假设](#形式科学基石假设)
  ...
  - [4 H₀.2 可形式化假设](#4-h₀2-可形式化假设)
    ...
    - [4.5.1 回应策略：分层形式化 + 承认局限](#451-回应策略分层形式化-承认局限)
      - [1 回应策略：分层形式化 + 承认局限](#1-回应策略分层形式化-承认局限)
    - [4.7 如果假设不成立](#47-如果假设不成立)
    - [4.7 如果假设不成立](#47-如果假设不成立)
  - [5 H₀.3 反身性驱动假设](#5-h₀3-反身性驱动假设)
    - [5.2 直觉解释](#52-直觉解释)
    ...
    - [5.5.1 回应策略：实用主义 + 多层次因果](#551-回应策略实用主义-多层次因果)
      - [1 回应策略：实用主义 + 多层次因果](#1-回应策略实用主义-多层次因果)
    - [5.7 如果假设不成立](#57-如果假设不成立)
    - [5.7 如果假设不成立](#57-如果假设不成立)
  - [6 H₀.4 计算主义假设](#6-h₀4-计算主义假设)
    - [6.2 直觉解释](#62-直觉解释)
    ...
    - [6.5.1 回应策略：功能主义 + 承认感质界限](#651-回应策略功能主义-承认感质界限)
      - [1 回应策略：功能主义 + 承认感质界限](#1-回应策略功能主义-承认感质界限)
    - [6.7 如果假设不成立](#67-如果假设不成立)
    - [6.7 如果假设不成立](#67-如果假设不成立)
  - [7 H₀.5 语义客观性假设](#7-h₀5-语义客观性假设)
    - [7.2 直觉解释](#72-直觉解释)
    ...
    - [7.5.1 回应策略：相对主义 + 实用主义](#751-回应策略相对主义-实用主义)
      - [1 回应策略：相对主义 + 实用主义](#1-回应策略相对主义-实用主义)

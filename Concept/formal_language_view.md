...
- [形式语言理念](#形式语言理念)
  - [动态语义模型的最小扩展](#一动态语义模型的最小扩展)
  - [认知-历史事件的四个切片](#二认知-历史事件--形式语言补丁-的四个切片)
  - [意识-语义轨迹的极限问题](#三意识-语义轨迹的极限问题)
  - [形式语言作为"裸机"](#一为什么说它是裸机)
  - [其他学科作为虚拟机](#二其他学科--在这台裸机上跑的虚拟机)

### 哲学与认知

- [意识的扩延](#三意识的扩延--动态加载新页表)
- [极限边界](#四极限边界裸机也跑不出的大脑硬件)
- [形式语言与人类智能](#五一句话收束)
...
### ① 阶0-1：口述→文字（**口述语法→离散语法**）

- **旁征**：**荷马史诗**=**口述语法**；
- **旁征**：**苏格拉底**=**口述哲学**；
- **升阶**：**文字**=**quote(口述)**，**世界签收**：**亚历山大图书馆**。

### ② 阶2-3：文字→印刷（**离散语法→自指语法**）

- **旁征**：**古腾堡印刷**=**quote(文字)**；
- **升阶**：**印刷=自指语法**（**可打印印刷机本身**）；
- **世界签收**：**科学革命**=**世界签收印刷**。

### ③ 阶4-5：印刷→数字（**自指语法→高阶语法**）

- **旁征**：**DNA双螺旋**=**quote(印刷)**（**可打印自身结构**）；
- **升阶**：**数字=高阶语法**（**可quote自身结构**）；
- **世界签收**：**合成生物学**=**世界签收DNA**。

### ④ 阶6-7：数字→元-数字（**高阶语法→元-语法**）

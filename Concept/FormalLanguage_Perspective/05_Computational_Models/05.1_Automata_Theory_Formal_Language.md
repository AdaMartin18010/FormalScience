# 5.1 Automata Theory Formal Language
...
- [5.1 Automata Theory Formal Language](#51-automata-theory-formal-language)
  ...
  - [参考文献](#参考文献)
    - [1 基础理论文献](#1-基础理论文献)
    - [1.2 自动机类型文献](#12-自动机类型文献)
    - [1.3 乔姆斯基层次文献](#13-乔姆斯基层次文献)
    - [1.4 历史文献](#14-历史文献)
    - [1.5 应用领域文献](#15-应用领域文献)
    - [1.6 未来发展方向文献](#16-未来发展方向文献)
    - [1.7 相关概念链接](#17-相关概念链接)
...
- [概念交叉索引（七视角版）](../../CONCEPT_CROSS_INDEX.md) - 查看相关概念的七视角分析：
  - [Chomsky层级](../../CONCEPT_CROSS_INDEX.md#51-chomsky层级-chomsky-hierarchy-七视角) - 自动机理论的形式语言分类基础
  - [图灵完备性](../../CONCEPT_CROSS_INDEX.md#191-图灵完备性-turing-completeness-七视角) - 自动机的计算能力边界
  - [Church-Turing论题](../../CONCEPT_CROSS_INDEX.md#103-church-turing论题-church-turing-thesis-七视角) - 自动机理论的计算理论基础

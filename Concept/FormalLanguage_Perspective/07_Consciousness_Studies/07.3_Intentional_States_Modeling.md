# 7.3 Intentional States Modeling
...
- [7.3 Intentional States Modeling](#73-intentional-states-modeling)
  - [1 📊 核心概念深度分析](#1--核心概念深度分析)
  - [📋 目录](#-目录)
  - [2 意向性的哲学基础](#2-意向性的哲学基础)
  - [3 信念-欲望-意图(BDI)模型](#3-信念-欲望-意图bdi模型)
  - [4 意向态度的逻辑](#4-意向态度的逻辑)
  - [5 意向状态的动态更新](#5-意向状态的动态更新)
  - [6 集体意向性](#6-集体意向性)
  - [7 结论](#7-结论)
  - [参考文献](#参考文献)
...
- [概念交叉索引（七视角版）](../../CONCEPT_CROSS_INDEX.md) - 查看相关概念的七视角分析：
  - [DIKWP模型](../../CONCEPT_CROSS_INDEX.md#61-dikwp模型-七视角) - 意向状态从数据到意图的认知升链
  - [反身性](../../CONCEPT_CROSS_INDEX.md#31-反身性-reflexivity-七视角) - 意向状态的自指结构
  - [互信息](../../CONCEPT_CROSS_INDEX.md#111-互信息-mutual-information-七视角) - 意向状态中的信息关联

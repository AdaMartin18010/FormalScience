# 7.4 Consciousness Unity Problem
...
- [7.4 Consciousness Unity Problem](#74-consciousness-unity-problem)
  - [1 📊 核心概念深度分析](#1--核心概念深度分析)
  - [📋 目录](#-目录)
  - [2 意识统一性的哲学问题](#2-意识统一性的哲学问题)
  - [3 绑定问题](#3-绑定问题)
  - [4 整合信息论](#4-整合信息论)
  - [5 全局工作空间理论](#5-全局工作空间理论)
  - [6 主体性与第一人称视角](#6-主体性与第一人称视角)
  - [7 结论](#7-结论)
  - [参考文献](#参考文献)
...
- [概念交叉索引（七视角版）](../../CONCEPT_CROSS_INDEX.md) - 查看相关概念的七视角分析：
  - [反身性](../../CONCEPT_CROSS_INDEX.md#31-反身性-reflexivity-七视角) - 意识统一性的自指结构
  - [DIKWP模型](../../CONCEPT_CROSS_INDEX.md#61-dikwp模型-七视角) - 意识统一性的认知升链
  - [Gödel不完备定理](../../CONCEPT_CROSS_INDEX.md#101-gödel不完备定理-gödels-incompleteness-theorems-七视角) - 意识统一性的形式系统限制

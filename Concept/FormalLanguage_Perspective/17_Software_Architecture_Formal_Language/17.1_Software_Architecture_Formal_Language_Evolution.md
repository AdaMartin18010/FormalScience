...
2. **模块化设计**
   ...
   - [David Parnas - Wikipedia](https://en.wikipedia.org/wiki/David_Parnas)
...
2. **设计模式**
   ...
   - [Gang of Four (Software) - Wikipedia](https://en.wikipedia.org/wiki/Gang_of_Four_(software))
...
3. **企业架构模式**
   ...
   - [Martin Fowler - Wikipedia](https://en.wikipedia.org/wiki/Martin_Fowler)
   - [Enterprise Application - Wikipedia](https://en.wikipedia.org/wiki/Enterprise_application)
   - [Enterprise Integration Pattern - Wikipedia](https://en.wikipedia.org/wiki/Enterprise_Integration_Pattern)

### 组件化与微服务文献

1. **组件化架构**
   - [Component-based Software Engineering - Wikipedia](https://en.wikipedia.org/wiki/Component-based_software_engineering)
   - [Software Component - Wikipedia](https://en.wikipedia.org/wiki/Software_component)
   - [Component Model - Wikipedia](https://en.wikipedia.org/wiki/Component_model)
   - [Interface (Computing) - Wikipedia](https://en.wikipedia.org/wiki/Interface_(computing))

2. **微服务架构**
    - Newman, S. (2015). *Building Microservices*. O'Reilly Media.
    - [Sam Newman - Wikipedia](https://en.wikipedia.org/wiki/Sam_Newman)
...
1. **云原生架构**
    - [Cloud Native - Wikipedia](https://en.wikipedia.org/wiki/Cloud_native)
...
2. **Serverless架构**
    ...
    - [Azure Functions - Wikipedia](https://en.wikipedia.org/wiki/Azure_Functions)
...
1. **响应式架构**
    ...
    - [Reactive Systems - Wikipedia](https://en.wikipedia.org/wiki/Reactive_systems)
    - [Actor Model - Wikipedia](https://en.wikipedia.org/wiki/Actor_model)
    - [Reactive Streams - Wikipedia](https://en.wikipedia.org/wiki/Reactive_Streams)

2. **领域驱动设计**
    - [Domain-driven Design - Wikipedia](https://en.wikipedia.org/wiki/Domain-driven_design)
    - [Eric Evans - Wikipedia](https://en.wikipedia.org/wiki/Eric_Evans)
    - [Domain Model - Wikipedia](https://en.wikipedia.org/wiki/Domain_model)
    - [Bounded Context - Wikipedia](https://en.wikipedia.org/wiki/Bounded_context)

3. **六边形架构**
    - [Hexagonal Architecture - Wikipedia](https://en.wikipedia.org/wiki/Hexagonal_architecture)
    - [Alistair Cockburn - Wikipedia](https://en.wikipedia.org/wiki/Alistair_Cockburn)
    - [Port and Adapter Pattern - Wikipedia](https://en.wikipedia.org/wiki/Port_and_adapter_pattern)
    - [Clean Architecture - Wikipedia](https://en.wikipedia.org/wiki/Clean_architecture)
...
1. **AI驱动的架构**
    ...
    - [Intelligent Systems - Wikipedia](https://en.wikipedia.org/wiki/Intelligent_systems)
...
3. **量子计算架构**
    ...
    - [Quantum Software - Wikipedia](https://en.wikipedia.org/wiki/Quantum_software)
    - [Quantum Programming - Wikipedia](https://en.wikipedia.org/wiki/Quantum_programming)
    - [Quantum Architecture - Wikipedia](https://en.wikipedia.org/wiki/Quantum_architecture)

### 相关概念链接

- [Software Development Life Cycle - Wikipedia](https://en.wikipedia.org/wiki/Software_development_life_cycle)
...
- [Refactoring - Wikipedia](https://en.wikipedia.org/wiki/Refactoring)
- [Technical Debt - Wikipedia](https://en.wikipedia.org/wiki/Technical_debt)
- [Software Metrics - Wikipedia](https://en.wikipedia.org/wiki/Software_metrics)

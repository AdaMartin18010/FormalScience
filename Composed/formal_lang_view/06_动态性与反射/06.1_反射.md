...
- [6.1 反射（Reflection）](#61-反射reflection)
  ...
  - [11 延伸阅读与参考文献](#11-延伸阅读与参考文献)
    ...
    - [12 核心概念](#2-核心概念)
                - [12.1 Downward API作为反射](#21-downward-api作为反射)
                - [12.2 监控指标暴露作为内省](#22-监控指标暴露作为内省)
                - [12.3 kubectl exec作为运行时反射](#23-kubectl-exec作为运行时反射)
    - [12 反射映射表](#3-反射映射表)
    - [12 技术细节](#4-技术细节)
                - [12.1 Downward API实现](#41-downward-api实现)
                - [12.2 Prometheus监控指标](#42-prometheus监控指标)
                - [12.3 kubectl exec运行时检查](#43-kubectl-exec运行时检查)
    - [12 实际应用](#5-实际应用)
                - [12.1 容器元数据获取](#51-容器元数据获取)
                - [12.2 监控指标收集](#52-监控指标收集)
                - [12.3 容器调试](#53-容器调试)
  - [12 相关概念](#12-相关概念)
---

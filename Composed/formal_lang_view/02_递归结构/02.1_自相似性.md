...
- [2.1 自相似性（Fractal Architecture）](#21-自相似性fractal-architecture)
  ...
  - [12 延伸阅读与参考文献](#12-延伸阅读与参考文献)
    ...
    - [13 核心概念](#2-核心概念)
                - [13.1 分形架构](#21-分形架构)
                - [13.2 自相似性层次](#22-自相似性层次)
    - [13 层次对应表](#3-层次对应表)
    - [13 技术细节](#4-技术细节)
                - [13.1 资源抽象Monad](#41-资源抽象monad)
                - [13.2 同构映射](#42-同构映射)
    - [13 实际应用](#5-实际应用)
                - [13.1 Docker in Docker](#51-docker-in-docker)
                - [13.2 Kubernetes in Kubernetes](#52-kubernetes-in-kubernetes)
                - [13.3 WASM in Container](#53-wasm-in-container)
  - [13 相关概念](#13-相关概念)
---

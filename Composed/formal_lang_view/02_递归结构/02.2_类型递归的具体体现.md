...
- [2.2 类型递归的具体体现](#22-类型递归的具体体现)
  ...
  - [11 延伸阅读与参考文献](#11-延伸阅读与参考文献)
    ...
    - [12 核心概念](#2-核心概念)
                - [12.1 Docker in Docker](#21-docker-in-docker)
                - [12.2 Kubernetes in Kubernetes](#22-kubernetes-in-kubernetes)
                - [12.3 WASM in Container](#23-wasm-in-container)
                - [12.4 VCluster作为类型构造器](#24-vcluster作为类型构造器)
    - [12 递归类型映射表](#3-递归类型映射表)
    - [12 技术细节](#4-技术细节)
                - [12.1 Docker in Docker实现](#41-docker-in-docker实现)
                - [12.2 vCluster架构](#42-vcluster架构)
                - [12.3 WASM组件模型](#43-wasm组件模型)
    - [12 实际应用](#5-实际应用)
                - [12.1 CICD构建场景](#51-cicd构建场景)
                - [12.2 多租户集群场景](#52-多租户集群场景)
                - [12.3 函数级隔离场景](#53-函数级隔离场景)
  - [12 相关概念](#12-相关概念)
---

...
- [3.2 变量作用域与生命周期](#32-变量作用域与生命周期)
  ...
  - [📊 思维表征体系](#-思维表征体系)
    ...
    - [📊 2. 多维对比矩阵](#-2-多维对比矩阵)
      - [2.1 作用域 vs Kubernetes资源对比矩阵](#21-作用域-vs-kubernetes资源对比矩阵)
      - [2.2 生命周期管理对比矩阵](#22-生命周期管理对比矩阵)
      - [2.3 资源管理策略对比矩阵](#23-资源管理策略对比矩阵)
    - [🌲 3. 决策树](#-3-决策树)
      - [3.1 作用域与生命周期应用选择决策树](#31-作用域与生命周期应用选择决策树)
    - [🛤️ 4. 决策逻辑路径](#️-4-决策逻辑路径)
      - [4.1 作用域与生命周期应用路径](#41-作用域与生命周期应用路径)
    - [🕸️ 5. 概念关系网络](#️-5-概念关系网络)
      - [5.1 作用域与生命周期概念关系网络](#51-作用域与生命周期概念关系网络)
    - [🗺️ 6. 知识图谱](#️-6-知识图谱)
      - [6.1 作用域与生命周期知识图谱](#61-作用域与生命周期知识图谱)
  - [📚 理论体系](#-理论体系)
    - [理论基础](#理论基础)
      - [程序语义学/内存管理/Kubernetes基础](#程序语义学内存管理kubernetes基础)
      - [历史发展](#历史发展)
    - [理论框架](#理论框架)
      - [核心假设](#核心假设)
      - [基本概念体系](#基本概念体系)

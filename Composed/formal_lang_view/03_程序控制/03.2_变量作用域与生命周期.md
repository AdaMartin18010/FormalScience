...
- [3.2 变量作用域与生命周期](#32-变量作用域与生命周期)
  ...
  - [11 延伸阅读与参考文献](#11-延伸阅读与参考文献)
    ...
    - [12 核心概念](#2-核心概念)
                - [12.1 栈帧与Pod生命周期](#21-栈帧与pod生命周期)
                - [12.2 堆与PersistentVolume](#22-堆与persistentvolume)
                - [12.3 RAII与Init Container](#23-raii与init-container)
                - [12.4 垃圾回收与Pod清理](#24-垃圾回收与pod清理)
    - [12 生命周期映射表](#3-生命周期映射表)
    - [12 技术细节](#4-技术细节)
                - [12.1 Pod生命周期阶段](#41-pod生命周期阶段)
                - [12.2 Cgroups资源限制](#42-cgroups资源限制)
                - [12.3 Init Container初始化](#43-init-container初始化)
                - [12.4 垃圾回收机制](#44-垃圾回收机制)
    - [12 实际应用](#5-实际应用)
                - [12.1 Pod生命周期管理](#51-pod生命周期管理)
                - [12.2 资源清理策略](#52-资源清理策略)
  - [12 相关概念](#12-相关概念)
---

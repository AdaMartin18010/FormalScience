...
- [3.1 控制流映射](#31-控制流映射)
  ...
  - [📊 思维表征体系](#-思维表征体系)
    ...
    - [📊 2. 多维对比矩阵](#-2-多维对比矩阵)
      - [2.1 控制流 vs Kubernetes资源对比矩阵](#21-控制流-vs-kubernetes资源对比矩阵)
      - [2.2 控制流类型对比矩阵](#22-控制流类型对比矩阵)
      - [2.3 应用场景对比矩阵](#23-应用场景对比矩阵)
    - [🌲 3. 决策树](#-3-决策树)
      - [3.1 控制流应用选择决策树](#31-控制流应用选择决策树)
    - [🛤️ 4. 决策逻辑路径](#️-4-决策逻辑路径)
      - [4.1 控制流应用路径](#41-控制流应用路径)
    - [🕸️ 5. 概念关系网络](#️-5-概念关系网络)
      - [5.1 控制流概念关系网络](#51-控制流概念关系网络)
    - [🗺️ 6. 知识图谱](#️-6-知识图谱)
      - [6.1 控制流知识图谱](#61-控制流知识图谱)
  - [📚 理论体系](#-理论体系)
    - [理论基础](#理论基础)
      - [程序语义学/类型论/Kubernetes基础](#程序语义学类型论kubernetes基础)
      - [历史发展](#历史发展)
    - [理论框架](#理论框架)
      - [核心假设](#核心假设)
      - [基本概念体系](#基本概念体系)

...
- [3.3 多租户：高阶类型](#33-多租户高阶类型)
  ...
  - [11 延伸阅读与参考文献](#11-延伸阅读与参考文献)
    ...
    - [12 核心概念](#2-核心概念)
                - [12.1 租户隔离与模块系统](#21-租户隔离与模块系统)
                - [12.2 资源配额与线性类型](#22-资源配额与线性类型)
                - [12.3 NetworkPolicy与能力类型](#23-networkpolicy与能力类型)
    - [12 多租户映射表](#3-多租户映射表)
    - [12 技术细节](#4-技术细节)
                - [12.1 Namespace作为模块系统](#41-namespace作为模块系统)
                - [12.2 ResourceQuota作为线性类型](#42-resourcequota作为线性类型-1)
                - [12.3 NetworkPolicy作为能力类型](#43-networkpolicy作为能力类型-1)
    - [12 实际应用](#5-实际应用)
                - [12.1 多租户隔离](#51-多租户隔离)
                - [12.2 资源配额管理](#52-资源配额管理)
                - [12.3 网络策略控制](#53-网络策略控制)
  - [12 相关概念](#12-相关概念)
---

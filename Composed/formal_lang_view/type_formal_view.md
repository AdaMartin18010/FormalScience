...
## 四、语义学对应：操作语义 vs 资源语义

### 4.1 **小步语义（Small-Step Semantics）**
...
### 9.1 **Cubical Type Theory → 拓扑感知调度**
...
### 5.3 **长期（2030+）：基础设施证明助手（Infrastructure Coq）**

...
- [8.2 Curry-Howard 同构在DevOps](#82-curry-howard-同构在devops)
  ...
  - [📑 目录](#-目录)
  - [🔑 核心概念](#-核心概念)
    - [Curry-Howard同构基础](#curry-howard同构基础)
    - [Infrastructure as Code ≈ Code as Proof](#infrastructure-as-code--code-as-proof)
    - [Terraform Plan作为类型检查证明](#terraform-plan作为类型检查证明)
    - [GitOps期望状态作为类型规范](#gitops期望状态作为类型规范)
  - [📊 同构映射表](#-同构映射表)
  - [🔍 技术细节](#-技术细节)
    - [Terraform Plan实现](#terraform-plan实现)
    - [GitOps期望状态](#gitops期望状态)
    - [证明求解器](#证明求解器)
  - [💡 实际应用](#-实际应用)
    - [IaC类型验证](#iac类型验证)
    - [GitOps类型规范](#gitops类型规范)
    - [证明即配置](#证明即配置)
  - [🔗 相关概念](#-相关概念)

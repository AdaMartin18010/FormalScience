...
- [4.1 编译期检查 ↔ CI/CD 流水线](#41-编译期检查--cicd-流水线)
  ...
  - [11 延伸阅读与参考文献](#11-延伸阅读与参考文献)
    ...
    - [12 核心概念](#2-核心概念)
                - [12.1 静态类型检查](#21-静态类型检查)
                - [12.2 模式匹配](#22-模式匹配)
                - [12.3 类型推断](#23-类型推断)
    - [12 编译期检查映射表](#3-编译期检查映射表)
    - [12 技术细节](#4-技术细节)
                - [12.1 docker build作为语法分析](#41-docker-build作为语法分析)
                - [12.2 trivy扫描作为类型错误检查](#42-trivy扫描作为类型错误检查)
                - [12.3 OPARego策略验证](#43-oparego策略验证)
                - [12.4 Cluster Autoscaler类型推断](#44-cluster-autoscaler类型推断)
    - [12 实际应用](#5-实际应用)
                - [12.1 CICD流水线](#51-cicd流水线)
                - [12.2 镜像安全扫描](#52-镜像安全扫描)
                - [12.3 策略验证](#53-策略验证)
  - [12 相关概念](#12-相关概念)
---

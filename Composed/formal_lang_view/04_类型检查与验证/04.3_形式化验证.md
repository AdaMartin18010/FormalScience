...
- [4.3 形式化验证](#43-形式化验证)
  ...
  - [11 延伸阅读与参考文献](#11-延伸阅读与参考文献)
    ...
    - [12 核心概念](#2-核心概念)
                - [12.1 TLAPlusCal验证](#21-tlapluscal验证)
                - [12.2 Coq证明](#22-coq证明)
                - [12.3 形式化验证方法](#23-形式化验证方法)
    - [12 形式化验证映射表](#3-形式化验证映射表)
    - [12 技术细节](#4-技术细节)
                - [12.1 TLA验证调度算法](#41-tla验证调度算法)
                - [12.2 Coq证明容器运行时](#42-coq证明容器运行时-1)
                - [12.3 形式化验证工具](#43-形式化验证工具)
    - [12 实际应用](#5-实际应用)
                - [12.1 调度算法验证](#51-调度算法验证)
                - [12.2 容器运行时验证](#52-容器运行时验证)
                - [12.3 系统正确性证明](#53-系统正确性证明)
  - [12 相关概念](#12-相关概念)
---

...
- [4.2 运行时检查 ↔ 准入控制器](#42-运行时检查--准入控制器)
  ...
  - [11 延伸阅读与参考文献](#11-延伸阅读与参考文献)
    ...
    - [12 核心概念](#2-核心概念)
                - [12.1 运行时类型断言](#21-运行时类型断言)
                - [12.2 能力类型强制检查](#22-能力类型强制检查)
                - [12.3 JIT编译优化](#23-jit编译优化)
    - [12 运行时检查映射表](#3-运行时检查映射表)
    - [12 技术细节](#4-技术细节)
                - [12.1 Admission Webhook作为运行时类型断言](#41-admission-webhook作为运行时类型断言)
                - [12.2 SeccompAppArmor作为能力类型](#42-seccompapparmor作为能力类型)
                - [12.3 eBPF作为JIT编译](#43-ebpf作为jit编译)
    - [12 实际应用](#5-实际应用)
                - [12.1 准入控制器配置](#51-准入控制器配置)
                - [12.2 安全策略实施](#52-安全策略实施)
                - [12.3 运行时优化](#53-运行时优化)
  - [12 相关概念](#12-相关概念)
---

...
- [5.3 依赖类型（Dependent Types）](#53-依赖类型dependent-types)
  ...
  - [12 核心概念](#12-核心概念)
  - [13 依赖类型映射表](#13-依赖类型映射表)
  - [14 技术细节](#14-技术细节)
    - [15.1 HPA依赖类型实现](#41-hpa依赖类型实现)
    - [15.2 类型依赖运行时值](#42-类型依赖运行时值)
    - [15.3 证明即程序实现](#43-证明即程序实现)
  - [15 实际应用](#15-实际应用)
    - [16.1 HPA自动扩缩容](#51-hpa自动扩缩容)
    - [16.2 类型依赖值验证](#52-类型依赖值验证)
    - [16.3 证明即程序应用](#53-证明即程序应用)
  - [16 相关概念](#16-相关概念)

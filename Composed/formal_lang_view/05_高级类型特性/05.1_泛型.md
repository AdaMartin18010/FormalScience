...
- [5.1 泛型（Generics）](#51-泛型generics)
  ...
  - [12 核心概念](#12-核心概念)
    - [12.1 Helm Charts作为类型参数](#21-helm-charts作为类型参数)
    - [12.2 Kustomize作为泛型特化](#22-kustomize作为泛型特化)
    - [12.3 Crossplane作为泛型资源](#23-crossplane作为泛型资源)
  - [13 泛型映射表](#13-泛型映射表)
  - [14 技术细节](#14-技术细节)
    - [14.1 Helm Charts实现](#41-helm-charts实现)
    - [14.2 Kustomize overlay机制](#42-kustomize-overlay机制)
    - [14.3 Crossplane Composite Resource](#43-crossplane-composite-resource)
  - [15 实际应用](#15-实际应用)
    - [15.1 Helm Chart模板化](#51-helm-chart模板化)
    - [15.2 Kustomize环境配置](#52-kustomize环境配置)
    - [15.3 Crossplane资源组合](#53-crossplane资源组合)
  - [16 相关概念](#16-相关概念)

...
- [7.1 效应管理基础](#71-效应管理基础)
  ...
  - [11 延伸阅读与参考文献](#11-延伸阅读与参考文献)
    ...
    - [12 核心概念](#2-核心概念)
                - [12.1 容器化作为效应管理](#21-容器化作为效应管理)
                - [12.2 网络IO效应](#22-网络io效应)
                - [12.3 文件系统效应](#23-文件系统效应)
                - [12.4 进程fork效应](#24-进程fork效应)
    - [12 效应映射表](#3-效应映射表)
    - [12 技术细节](#4-技术细节)
                - [12.1 网络效应管理](#41-网络效应管理)
                - [12.2 存储效应管理](#42-存储效应管理-1)
                - [12.3 进程效应管理](#43-进程效应管理-1)
    - [12 实际应用](#5-实际应用)
                - [12.1 效应隔离](#51-效应隔离)
                - [12.2 效应控制](#52-效应控制)
                - [12.3 效应监控](#53-效应监控)

...
- [1.2 复合类型与组合运算符](#12-复合类型与组合运算符)
  ...
  - [11 延伸阅读与参考文献](#11-延伸阅读与参考文献)
    ...
    - [12 核心概念](#2-核心概念)
                - [12.1 编程语言中的复合类型](#21-编程语言中的复合类型)
                - [12.2 基础设施中的对应](#22-基础设施中的对应)
    - [12 组合运算符映射](#3-组合运算符映射)
    - [12 技术细节](#4-技术细节)
                - [12.1 Pod作为乘积类型](#41-pod作为乘积类型)
                - [12.2 Deployment作为和类型](#42-deployment作为和类型-1)
                - [12.3 Service作为函数类型](#43-service作为函数类型-1)
    - [12 实际应用](#5-实际应用)
                - [12.1 Sidecar模式积类型](#51-sidecar模式积类型)
                - [12.2 蓝绿部署和类型](#52-蓝绿部署和类型)
                - [12.3 服务调用函数类型](#53-服务调用函数类型)
  - [12 相关概念](#12-相关概念)
---

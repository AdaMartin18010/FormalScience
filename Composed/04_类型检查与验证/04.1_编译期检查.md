...
- [4.1 编译期检查 ↔ CI/CD 流水线](#41-编译期检查--cicd-流水线)
  ...
  - [📊 编译期检查映射表](#-编译期检查映射表)
  - [🔍 技术细节](#-技术细节)
    - [docker build作为语法分析](#docker-build作为语法分析)
    - [trivy扫描作为类型错误检查](#trivy扫描作为类型错误检查)
    - [OPA/Rego策略验证](#oparego策略验证)
    - [Cluster Autoscaler类型推断](#cluster-autoscaler类型推断)
  - [💡 实际应用](#-实际应用)
    - [CI/CD流水线](#cicd流水线)
    - [镜像安全扫描](#镜像安全扫描)
    - [策略验证](#策略验证)

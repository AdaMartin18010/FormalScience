...
- [27 机密计算调度](#27-机密计算调度)
  ...
  - [1 概述](#1-概述)
    - [1.1 核心洞察](#11-核心洞察)
    - [1.2 机密计算特性](#12-机密计算特性)
    - [1.3 形式化定义](#13-形式化定义)
  - [2 思维导图](#2-思维导图)
  - [3 TEE调度架构](#3-tee调度架构)
    - [3.1 整体架构](#31-整体架构)
    - [3.2 Enclave生命周期调度](#32-enclave生命周期调度)
    - [3.3 SGX调度器实现](#33-sgx调度器实现)
  - [4 内存调度](#4-内存调度)
    - [4.1 EPC内存管理](#41-epc内存管理)
    - [4.2 EPC调度算法](#42-epc调度算法)
  - [5 K8s集成](#5-k8s集成)
    - [5.1 SGX设备插件](#51-sgx设备插件)
    - [5.2 机密Pod调度](#52-机密pod调度)
    - [5.3 机密容器架构](#53-机密容器架构)
  - [6 知识矩阵](#6-知识矩阵)
    - [6.1 TEE技术对比](#61-tee技术对比)
...
| 相关主题 | 关联内容 | 链接 |
|---------|---------|------|
| OS调度 | 进程/内存调度 | [03_OS抽象层](../03_OS抽象层/README.md) |
| 虚拟化 | VM调度 | [05_虚拟化容器化沙盒化](../05_虚拟化容器化沙盒化/README.md) |
| K8s调度 | 设备插件 | [06_调度模型](../06_调度模型/README.md) |
| 安全调度 | 隔离策略 | **24_安全调度** |

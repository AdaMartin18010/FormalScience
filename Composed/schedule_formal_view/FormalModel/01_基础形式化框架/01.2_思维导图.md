...
- [01.2 思维导图](#012-思维导图)
  ...
  - [📊 思维表征体系](#-思维表征体系)
    ...
    - [📊 2. 多维对比矩阵](#-2-多维对比矩阵)
      - [2.1 01.2 思维导图对比矩阵](#21-012-思维导图对比矩阵)
      - [2.2 技术特性对比矩阵](#22-技术特性对比矩阵)
      - [2.3 实现方式对比矩阵](#23-实现方式对比矩阵)
    - [🌲 3. 决策树](#-3-决策树)
      - [3.1 01.2 思维导图应用选择决策树](#31-012-思维导图应用选择决策树)
    - [🛤️ 4. 决策逻辑路径](#️-4-决策逻辑路径)
      - [4.1 01.2 思维导图应用路径](#41-012-思维导图应用路径)
    - [🕸️ 5. 概念关系网络](#️-5-概念关系网络)
      - [5.1 01.2 思维导图概念关系网络](#51-012-思维导图概念关系网络)
    - [🗺️ 6. 知识图谱](#️-6-知识图谱)
      - [6.1 01.2 思维导图知识图谱](#61-012-思维导图知识图谱)
  - [📚 理论体系](#-理论体系)
    - [理论基础](#理论基础)

...
- [08.4 单子与余单子](#084-单子与余单子)
  ...
  - [4. 单子与余单子的实际应用](#4-单子与余单子的实际应用)
    - [4.3 单子-余单子的实际应用](#43-单子-余单子的实际应用)
      - [4.3.1 调度决策的组合](#431-调度决策的组合)
      - [4.3.2 监控数据的历史查询](#432-监控数据的历史查询)
      - [步骤1：伴随定义](#步骤1伴随定义)
      - [步骤2：唯一性证明](#步骤2唯一性证明)
      - [步骤3：主定理证明](#步骤3主定理证明-1)
    - [5.1 单子-余单子的对偶性](#51-单子-余单子的对偶性)
      - [步骤1：对偶性定义](#步骤1对偶性定义)
      - [步骤2：对偶性证明](#步骤2对偶性证明)
      - [步骤3：主定理证明](#步骤3主定理证明-2)
    - [5.2 单子与余单子的实际应用](#52-单子与余单子的实际应用)
      - [5.2.1 调度决策组合](#521-调度决策组合)
  - [5. 相关文档](#5-相关文档)
...
**定义**（伴随）：
单子 $\mathbb{T}$ 和余单子 $\mathbb{D}$ 构成伴随对，当且仅当存在自然同构：
$$
\text{Hom}(\mathbb{T}(X), Y) \cong \text{Hom}(X, \mathbb{D}(Y))
$$
...
func ComposeSchedulingDecisions(
    ...
    for i := 1; i < len(decisions); i++ {
        result = monad.Bind(result, func(d SchedulingDecision) SchedulingDecision {
            return monad.Combine(d, decisions[i])
        })
    }

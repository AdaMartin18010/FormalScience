...
- [Cursor/VSCode Markdown 自动格式化配置指南](#cursorvscode-markdown-自动格式化配置指南)
  - [📋 目录](#-目录)
  - [1 配置已完成](#1-配置已完成)
  - [2 快速开始](#2-快速开始)
    - [2.1 步骤 1 安装必需扩展](#21-步骤-1-安装必需扩展)
    - [2.2 步骤 2 重新加载窗口](#22-步骤-2-重新加载窗口)
    - [2.3 步骤 3 测试自动格式化](#23-步骤-3-测试自动格式化)
  - [3 配置详情](#3-配置详情)
    - [3.1 自动修复的问题](#31-自动修复的问题)
    - [3.2 允许的格式不会报错](#32-允许的格式不会报错)
  - [6 常用快捷键](#6-常用快捷键)
  - [7 使用技巧](#7-使用技巧)
    - [7.1 查看 Linter 错误](#71-查看-linter-错误)
    - [7.2 禁用某个文件的检查](#72-禁用某个文件的检查)
    - [7.3 禁用某行的检查](#73-禁用某行的检查)
    - [7.4 批量格式化多个文件](#74-批量格式化多个文件)
  - [8 自定义配置](#8-自定义配置)
    - [8.1 修改 Markdownlint 规则](#81-修改-markdownlint-规则)
    - [8.2 修改 VSCode 设置](#82-修改-vscode-设置)
  - [9 规则参考](#9-规则参考)
    - [9.1 常用 Markdownlint 规则](#91-常用-markdownlint-规则)
  - [10 故障排除](#10-故障排除)
    - [10.1 问题 1 保存时没有自动格式化](#101-问题-1-保存时没有自动格式化)
    - [10.2 问题 2 某些规则不生效](#102-问题-2-某些规则不生效)
    - [10.3 问题 3 格式化后文件变乱](#103-问题-3-格式化后文件变乱)
    - [10.4 问题 4 中文字符显示问题](#104-问题-4-中文字符显示问题)
  - [11 更多资源](#11-更多资源)
  - [12 下一步](#12-下一步)

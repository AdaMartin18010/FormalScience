- --
topic: "Cubical类型论：可计算的Univalence"
dependencies: []
status: "review"
...
## 1. 问题：HoTT的计算困境 {#问题hott的计算困境} {#问题hott的计算困境-问题hott的计算困境}

### 1 0 概念分析：Cubical类型论 {#0-概念分析cubical类型论} {#0-概念分析cubical类型论-0-概念分析cubical}
...
### 1 1 Univalence不可计算？ {#1-univalence不可计算} {#1-univalence不可计算-1-univalence不}

- _HoTT Book (2013)_* 中的Univalence:
...
### 1 2 为什么重要？ {#2-为什么重要} {#2-为什么重要-2-为什么重要}
...
## 2. Cubical类型论的解决方案 {#cubical类型论的解决方案} {#cubical类型论的解决方案-cubical类型论的解决方}

### 2 1 历史突破 {#1-历史突破} {#1-历史突破-1-历史突破}
...
### 2 2 与HoTT的关系 {#2-与hott的关系} {#2-与hott的关系-2-与hott的关系}
...
## 3. 核心机制：间隔类型 {#核心机制间隔类型} {#核心机制间隔类型-核心机制间隔类型}

### 3 1 间隔 I {#1-间隔-i} {#1-间隔-i-1-间隔-i}
...
## 4. Kan组合条件 {#kan组合条件} {#kan组合条件-kan组合条件}

### 4 1 动机：填充问题 {#1-动机填充问题} {#1-动机填充问题-1-动机填充问题}
...
- _Kan条件_*: 任意"开盒"都可以被填充

### 4 2 形式化 {#2-形式化} {#2-形式化-2-形式化}
...
### 4 3 传输 (transport) {#3-传输-transport} {#3-传输-transport-3-传输-transport}
...
## 5. 实现与工具 {#实现与工具} {#实现与工具-实现与工具}

### 5 1 Cubical Agda {#1-cubical-agda} {#1-cubical-agda-1-cubical-agda}
...
### 5 2 cubicaltt {#2-cubicaltt} {#2-cubicaltt-2-cubicaltt}
...
### 5 3 RedPRL (已停止) {#3-redprl-已停止} {#3-redprl-已停止-3-redprl-已停止}
...
## 6. 实例：计算Univalence {#实例计算univalence} {#实例计算univalence-实例计算univalence}

### 6 1 布尔值的对称性 {#1-布尔值的对称性} {#1-布尔值的对称性-1-布尔值的对称性}

- _目标_*: 证明 `not : Bool ≃ Bool` 传输可计算
...
## 7. 批判性评估 {#批判性评估} {#批判性评估-批判性评估}

### 7 1 突破 {#1-突破} {#1-突破-1-突破}
...
### 7 3 未解决问题 {#3-未解决问题} {#3-未解决问题-3-未解决问题}
...
## 9. 📚 学习路径 {#-学习路径} {#-学习路径--学习路径}

### 9 1 入门（理解思想） {#入门理解思想} {#1-入门理解思想-入门理解思想}
...
### 9 2 实践（动手写代码） {#实践动手写代码} {#2-实践动手写代码-实践动手写代码}
...
### 9 3 进阶（深入理论） {#进阶深入理论} {#3-进阶深入理论-进阶深入理论}
...
## 8. 思维表征：Cubical类型论 {#思维表征cubical类型论} {#思维表征cubical类型论-思维表征cubical类型论}
...
- _Wikipedia词条_*: [Cubical type theory](https://en.wikipedia.org/wiki/Cubical_type_theory)
...
### 12 3 # 9.2.1 CMU 15-819 (Advanced Topics in Programming Languages) {#-921-cmu-15-819-advanced-topic} {#3--921-cmu-15-819-advanced-top}
...
### 12 4 # 9.2.2 Oxford Type Theory Course {#-922-oxford-type-theory-course} {#4--922-oxford-type-theory-cour}
...
### 12 6 # 9.3.1 The HoTT Book (2013) {#-931-the-hott-book-2013} {#6--931-the-hott-book-2013--931}
...
### 12 7 # 9.3.2 CCHM论文 (2015) {#-932-cchm论文-2015} {#7--932-cchm论文-2015--932-cchm论文}
...
## 13. 📚 参考文献 {#-参考文献} {#-参考文献--参考文献}

### 13 1 核心论文 {#核心论文} {#1-核心论文-核心论文}
...
### 13 3 应用与扩展 {#应用与扩展} {#3-应用与扩展-应用与扩展}
...
### 13 4 工具与实践 {#工具与实践} {#4-工具与实践-工具与实践}
...
- _实现_*: Cubical Agda 2.6.4, cubicaltt
- _批判性_*: ⭐⭐⭐⭐
- _未来_*: 有前景，但道路漫长

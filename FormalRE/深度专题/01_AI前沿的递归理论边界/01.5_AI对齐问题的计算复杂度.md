...
- [AI对齐问题的计算复杂度](#ai对齐问题的计算复杂度)
  ...
  - [9. 权威资源对标](#9-权威资源对标)
    ...
    - [9.3 权威教材对标](#93-权威教材对标)
      - [9.3.1 Russell (2019) "Human Compatible: AI and the Problem of Control"](#931-russell-2019-human-compatible-ai-and-the-problem-of-control)
      - [9.3.2 Russell \& Norvig (2020) "Artificial Intelligence: A Modern Approach"](#932-russell--norvig-2020-artificial-intelligence-a-modern-approach)
...
| **等价定义** | 1. 价值对齐问题<br>2. 目标对齐问题<br>3. AI控制问题 |
| **历史定义** | 对齐概念：Russell (2019)<br>Arrow定理：Arrow (1951)<br>Constitutional AI：Bai et al. (2022) |
...
#### 9.3.1 Russell (2019) "Human Compatible: AI and the Problem of Control"
...
#### 9.3.2 Russell & Norvig (2020) "Artificial Intelligence: A Modern Approach"

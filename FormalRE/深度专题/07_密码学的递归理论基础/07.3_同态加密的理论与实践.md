...
- [同态加密的理论与实践](#同态加密的理论与实践)
  - [📋 目录](#-目录)
  - [1.0 概念分析：同态加密的理论与实践](#10-概念分析同态加密的理论与实践)
    - [1.0.1 定义矩阵](#101-定义矩阵)
    - [1.0.2 属性分析](#102-属性分析)
    - [1.0.3 外延分析](#103-外延分析)
    - [1.0.4 内涵分析](#104-内涵分析)
  ...
  - [5. 应用场景](#5-应用场景)
    ...
    - [5.2 云计算](#52-云计算)
  - [6. 递归理论分析](#6-递归理论分析)
  - [7. 思维表征：同态加密的理论与实践](#7-思维表征同态加密的理论与实践)
  ...
  - [9. 权威资源对标](#9-权威资源对标)
    ...
    - [9.3 权威教材对标](#93-权威教材对标)
      ...
      - [9.3.2 Gentry (2009) "Computing Arbitrary Functions of Encrypted Data"](#932-gentry-2009-computing-arbitrary-functions-of-encrypted-data)

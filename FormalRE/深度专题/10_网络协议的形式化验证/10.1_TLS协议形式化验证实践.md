...
#### 8.2.3 CMU 15-441 (Computer Networks)
...
#### 8.3.1 Rescorla (2018) "The Transport Layer Security (TLS) Protocol Version 1.3" (RFC 8446)
...
#### 8.3.2 Blanchet (2016) "Modeling and Verifying Security Protocols with ProVerif"

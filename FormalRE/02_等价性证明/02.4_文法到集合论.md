...
1. **Soare, R. I.** (2016). _Turing Computability: Theory and Applications_
   - Springer. ISBN 978-3540186800
   - 递归论权威教材

2. **Rogers, H.** (1987). _Theory of Recursive Functions and Effective Computability_
   - MIT Press. ISBN 978-0262680523
   - 递归函数理论教材

3. **Enderton, H. B.** (2011). _Computability Theory: An Introduction to Recursion Theory_
   - Academic Press. ISBN 978-0123849588
   - 递归论入门教材

### 11.3 在线资源

1. **Wikipedia - Post's theorem**
   - https://en.wikipedia.org/wiki/Post%27s_theorem
   - Post定理基本概念

2. **Wikipedia - Arithmetic hierarchy**

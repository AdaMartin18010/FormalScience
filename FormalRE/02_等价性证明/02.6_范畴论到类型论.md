...
1. **Lambek, J.** (1980). "From λ-Calculus to Cartesian Closed Categories"
   - In _To H.B. Curry: Essays on Combinatory Logic, Lambda Calculus and Formalism_
   - Academic Press. pp. 375-402
   - CCC与类型论对应原始论文

2. **Curry, H. B., & Feys, R.** (1958). _Combinatory Logic, Volume I_
   - North-Holland. ISBN 978-0720422086
   - Curry-Howard对应基础

3. **Howard, W. A.** (1980). "The Formulae-as-Types Notion of Construction"
   - In _To H.B. Curry: Essays on Combinatory Logic, Lambda Calculus and Formalism_
   - Academic Press. pp. 479-490
   - 证明即程序
...
2. **Crole, R. L.** (1993). _Categories for Types_
   - Cambridge University Press. ISBN 978-0521457019
   - 类型论范畴语义教材

3. **Awodey, S.** (2010). _Category Theory_
...
2. **Wikipedia - Cartesian closed category**
   - https://en.wikipedia.org/wiki/Cartesian_closed_category
   - CCC基本概念

3. **nLab - Categorical semantics**

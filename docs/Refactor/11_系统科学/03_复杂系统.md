...
difficulty: "高级"
status: "已完成"
tags: ["图灵机", "可计算性", "临界现象", "系统科学", "相变", "复杂系统"]
related: ["03.1 系统动力学", "11.6 稳定性分析", "11.12 混沌理论", "10.4.1 Kolmogorov复杂度", "11.11 分形与幂律"]
math: true
code: true
...
本文档深入探讨复杂系统的核心原理和关键方法。内容涵盖系统科学领域的主要知识点，包括图灵机, 可计算性, 临界现象, 相变等关键主题。适合具备相关基础的学习者进行深入研究。
...
- [11.12 混沌理论](03_复杂系统/03.4_混沌理论.md)

...
difficulty: "高级"
status: "已完成"
tags: ["决策理论", "风险", "最终一致性", "一致性模型", "一致性", "共识算法"]
related: ["04.2 共识算法", "04.3 分布式时钟", "04.1 一致性模型", "04.1 分布式基础", "04.1 一致性模型"]
math: true
code: true
...
本文档深入探讨共识算法形式化的核心原理和关键方法。内容涵盖分布式系统领域的主要知识点，包括决策理论, 风险, 最终一致性, 一致性模型, 一致性等关键主题。适合具备相关基础的学习者进行深入研究。
...
📄 `examples/lean/ConsensusAlgorithm.lean`

...
difficulty: "初级"
status: "已完成"
tags: ["最终一致性", "一致性模型", "一致性", "共识算法", "强一致性", "分布式系统"]
related: ["04.1 分布式基础", "目录", "1. 概述", "2. CAP 定理", "2.1 形式化定义"]
math: true
code: true
...
本文档系统介绍分布式的基础理论和核心概念。内容涵盖分布式系统领域的主要知识点，包括最终一致性, 一致性模型, 一致性, 共识算法, 强一致性等关键主题。适合具备相关基础的学习者进行深入研究。

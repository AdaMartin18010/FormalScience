---
title: "03.2 编排与编排 (Orchestration vs Choreography)"
category: "软件工程"
subcategory: "工作流系统"
order: 3
difficulty: "中级"
status: "已完成"
tags: ["工作流系统", "软件工程"]
related: ["03.2 编排与编排 (Orchestration vs Choreography)", "目录", "1. 概述", "2. 编排 (Orchestration)", "2.1 形式化定义"]
math: true
code: true
...
本文档深入探讨编排与编排的核心原理和关键方法。内容涵盖工作流系统领域的主要知识点，包括相关理论、方法及应用。适合有一定基础的学习者系统学习。

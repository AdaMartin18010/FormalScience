...
| 模块 | 依赖内容 | 在本模块的应用 |
|:-----|:---------|:---------------|
| [02_形式化方法](../02_形式化方法/) | 形式化规约、验证 | 博弈形式化、均衡存在性证明 |
| [05_数理逻辑](../05_数理逻辑/) | 模态逻辑、公共知识 | 博弈的认知基础 |
| [06_集合论与范畴论](../06_集合论与范畴论/) | 集合运算、函数 | 博弈空间的数学结构 |
| [09_概率论与统计](../09_概率论与统计/) | 概率分布、期望 | 随机博弈、贝叶斯博弈 |
| [10_最优化理论](../10_最优化理论/) | 凸优化、对偶理论 | 机制设计优化 |

### 5.2 后续延伸模块

| 模块 | 延伸内容 | 关联章节 |
|:-----|:---------|:---------|
| [13_经济学](../13_经济学/) | 市场均衡、一般均衡 | 02, 03, 05 |
| [14_计算机科学](../14_计算机科学/) | 算法博弈论、机制设计 | 02, 03 |
| [15_系统科学](../15_系统科学/) | 复杂系统、涌现 | 06 |

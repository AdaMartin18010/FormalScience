...
- [21.3 证据合成 (Evidence Synthesis)](#213-证据合成-evidence-synthesis)
  - [📋 目录](#-目录)
  - [1 模块概述](#1-模块概述)
  - [🏗️ 目录结构](#️-目录结构)
  - [2 核心理论](#2-核心理论)
    - [2.1 固定效应模型理论](#21-固定效应模型理论)
    - [2.2 随机效应模型理论](#22-随机效应模型理论)
    - [2.3 网络元分析理论](#23-网络元分析理论)
    - [2.4 贝叶斯元分析理论](#24-贝叶斯元分析理论)
  - [3 重构进度](#3-重构进度)

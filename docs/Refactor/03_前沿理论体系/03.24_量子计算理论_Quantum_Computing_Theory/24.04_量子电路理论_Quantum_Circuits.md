...
- [24.04 量子电路理论](#2404-量子电路理论)
  - [📋 目录](#-目录)
  - [1 理论概述](#1-理论概述)
  - [2 学习目标](#2-学习目标)
  - [3 理论内容](#3-理论内容)
    - [3.1 量子电路的基本理论](#31-量子电路的基本理论)
      - [1.1.1 量子电路的定义](#111-量子电路的定义)
      - [1.1.2 量子电路的数学表示](#112-量子电路的数学表示)
      - [1.1.3 量子电路的层次结构](#113-量子电路的层次结构)
    - [3.2 量子电路的设计原则](#32-量子电路的设计原则)
      - [2.2.1 基本设计原则](#221-基本设计原则)
      - [2.2.2 量子电路的优化](#222-量子电路的优化)
      - [2.2.3 量子电路的并行化](#223-量子电路的并行化)
    - [3.3 量子电路的容错性](#33-量子电路的容错性)
      - [3.3.1 量子误差模型](#331-量子误差模型)
      - [3.3.2 量子纠错码](#332-量子纠错码)
      - [3.3.3 容错量子计算](#333-容错量子计算)
    - [3.4 量子电路的复杂度分析](#34-量子电路的复杂度分析)
      - [4.4.1 量子电路的复杂度度量](#441-量子电路的复杂度度量)
      - [4.4.2 量子电路的复杂度下界](#442-量子电路的复杂度下界)
      - [4.4.3 量子电路的近似复杂度](#443-量子电路的近似复杂度)
    - [3.5 量子电路的应用](#35-量子电路的应用)
      - [5.5.1 量子算法实现](#551-量子算法实现)
      - [5.5.2 量子模拟](#552-量子模拟)
      - [5.5.3 量子机器学习](#553-量子机器学习)
  - [4 形式化证明](#4-形式化证明)
    - [4.1 证明 2441 量子电路的幺正性](#41-证明-2441-量子电路的幺正性)
    - [4.2 证明 2442 量子电路的并行化](#42-证明-2442-量子电路的并行化)
    - [4.3 证明 2443 量子纠错码的存在性](#43-证明-2443-量子纠错码的存在性)
  - [5 应用实例](#5-应用实例)
    - [5.1 实例 2441 量子加法器电路](#51-实例-2441-量子加法器电路)
    - [5.2 实例 2442 量子傅里叶变换电路](#52-实例-2442-量子傅里叶变换电路)
    - [5.3 实例 2443 量子纠错电路](#53-实例-2443-量子纠错电路)
  - [6 理论验证](#6-理论验证)
    - [6.1 验证 2441 量子电路幺正性验证](#61-验证-2441-量子电路幺正性验证)
    - [6.2 验证 2442 量子纠错验证](#62-验证-2442-量子纠错验证)
  - [7 相关理论](#7-相关理论)
    - [7.1 基础理论](#71-基础理论)
    - [7.2 算法理论](#72-算法理论)
    - [7.3 纠错理论](#73-纠错理论)
  - [📚 参考文献](#-参考文献)
    ...
    - [7.6 标准文档](#76-标准文档)
  - [8 练习题目](#8-练习题目)
    - [8.1 练习 2441 量子电路设计](#81-练习-2441-量子电路设计)
    - [8.2 练习 2442 量子电路优化](#82-练习-2442-量子电路优化)
    - [8.3 练习 2443 量子纠错](#83-练习-2443-量子纠错)
...
3. Shor, P. W. (1995). Scheme for reducing decoherence in quantum computer memory. _Physical review A_, 52(4), R2493.

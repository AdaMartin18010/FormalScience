...
difficulty: "高级"
status: "已完成"
tags: ["函子", "类型论", "结构型", "类型推断", "类型系统", "范畴论"]
related: ["01.3 工程与数学对应", "目录", "1. 工程概念的数学本质", "1.1 引言：工程即应用数学", "1.2 工程的数学抽象层次"]
math: true
code: true
...
本文档深入探讨工程与数学对应的核心原理和关键方法。内容涵盖形式化方法统一领域的主要知识点，包括函子, 类型论, 结构型, 类型推断, 类型系统等关键主题。适合具备相关基础的学习者进行深入研究。
...
- [01.3 工程与数学对应](#013-工程与数学对应)
  ...
  - [参考与延伸](#参考与延伸)
    - [相关章节](#相关章节)
    - [关键文献](#关键文献)
  - [_工程与数学的对应不是理论的强加，而是实践的升华。当我们用范畴论理解系统设计、用类型论保证代码正确、用逻辑验证需求满足时，工程就变成了可以严格推理的应用数学——这正是形式科学追求的境界。_](#工程与数学的对应不是理论的强加而是实践的升华当我们用范畴论理解系统设计用类型论保证代码正确用逻辑验证需求满足时工程就变成了可以严格推理的应用数学这正是形式科学追求的境界)
  - [📋 前置知识](#-前置知识)
  - [📚 延伸阅读](#-延伸阅读)
...
- [01.2 多语言融合](../01_形式化方法统一/01.2_多语言融合.md)

...
status: "已完成"
tags: ["多视角映射", "交叉视角"]
related: ["01.3 工程与数学对应", "04.1 范畴基本概念", "4.1 范畴基础 (Category Theory Foundations)", "1. 单子与函子", "04.3 单子与函子"]
math: true
code: true
...
本文档深入探讨数学-程序映射的核心原理和关键方法。内容涵盖多视角映射领域的主要知识点，包括相关理论、方法及应用。适合初学者建立基础知识体系。
...
- [01.3 工程与数学对应](../01_形式化方法统一/01.3_工程与数学对应.md)

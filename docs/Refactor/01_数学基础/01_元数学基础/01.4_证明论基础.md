...
difficulty: "初级"
status: "已完成"
tags: ["元数学", "相继式", "自然演绎", "证明论", "数学基础", "元数学基础"]
related: ["1.4 证明论基础", "目录", "1.4.1 引言", "1.4.2 自然演绎系统", "1.4.2.1 系统结构"]
math: true
code: true
...
本文档系统介绍证明论的基础理论和核心概念。内容涵盖元数学领域的主要知识点，包括相继式, 自然演绎, 证明论等关键主题。适合具备相关基础的学习者进行深入研究。
...
| ZFC | 无（更大） | 超出皮亚诺算术的证明论强度，无确定的证明论序数 |

...
difficulty: "初级"
status: "已完成"
tags: ["谓词逻辑", "相继式", "元数学", "命题逻辑", "数理逻辑", "自然演绎"]
related: ["1.2 数理逻辑", "目录", "1.2.1 引言", "1.2.2 命题逻辑", "1.2.2.1 语法结构"]
math: true
code: true
...
本文档深入探讨数理逻辑的核心原理和关键方法。内容涵盖元数学领域的主要知识点，包括谓词逻辑, 相继式, 命题逻辑, 数理逻辑等关键主题。适合初学者建立基础知识体系。
...
$M \models Pt_1, ..., t_n$ iff $(t_1^M[s], ..., t_n^M[s]) \in P^M$

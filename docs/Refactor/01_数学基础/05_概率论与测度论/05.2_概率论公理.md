...
difficulty: "初级"
status: "已完成"
tags: ["概率分布", "概率论", "随机变量", "概率论与测度论", "数学基础"]
related: ["5.2 概率论公理", "目录", "5.2.1 引言", "5.2.2 柯尔莫哥洛夫公理", "5.2.2.1 概率空间"]
math: true
code: true
...
本文档深入探讨概率论公理的核心原理和关键方法。内容涵盖概率论与测度论领域的主要知识点，包括概率分布, 概率论, 随机变量等关键主题。适合具备相关基础的学习者进行深入研究。
...
- [5.4 数理统计](../05_概率论与测度论/05.4_数理统计.md)

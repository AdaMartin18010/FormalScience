...
- [05.2.2 最优控制理论](#0522-最优控制理论)
  ...
  - [📚 目录](#-目录-1)
  - [3 基本概念](#3-基本概念)
    - [3.1 最优控制问题](#31-最优控制问题)
    - [3.2 性能指标分类](#32-性能指标分类)
    - [3.3 最优性条件](#33-最优性条件)
  - [4 变分法基础](#4-变分法基础)
    - [4.1 欧拉-拉格朗日方程](#41-欧拉-拉格朗日方程)
    - [4.2 横截条件](#42-横截条件)
    - [4.3 约束变分法](#43-约束变分法)
  - [5 极大值原理](#5-极大值原理)
    - [5.1 庞特里亚金极大值原理](#51-庞特里亚金极大值原理)
    - [5.2 横截条件](#52-横截条件)
    - [5.3 极大值原理的应用](#53-极大值原理的应用)
  - [6 动态规划](#6-动态规划)
    - [6.1 贝尔曼最优性原理](#61-贝尔曼最优性原理)
    - [6.2 哈密顿-雅可比-贝尔曼方程](#62-哈密顿-雅可比-贝尔曼方程)
    - [6.3 线性二次型问题的解](#63-线性二次型问题的解)
  - [7 线性二次型问题](#7-线性二次型问题)
    - [7.1 有限时间LQ问题](#71-有限时间lq问题)
    - [7.2 无限时间LQ问题](#72-无限时间lq问题)
    - [7.3 跟踪问题](#73-跟踪问题)
  - [8 数值方法](#8-数值方法)
    - [8.1 梯度法](#81-梯度法)
    - [8.2 共轭梯度法](#82-共轭梯度法)
    - [8.3 直接法](#83-直接法)
  - [9 代码实现](#9-代码实现)
    - [9.1 最优控制问题框架](#91-最优控制问题框架)
    - [9.2 线性二次型问题求解器](#92-线性二次型问题求解器)
    - [9.3 动态规划求解器](#93-动态规划求解器)
  - [10 应用示例](#10-应用示例)
    - [10.1 倒立摆最优控制](#101-倒立摆最优控制)
    - [10.2 时间最优控制](#102-时间最优控制)
  - [11 相关理论](#11-相关理论)
    - [11.1 与变分法的关系](#111-与变分法的关系)
    - [11.2 与动态规划的关系](#112-与动态规划的关系)

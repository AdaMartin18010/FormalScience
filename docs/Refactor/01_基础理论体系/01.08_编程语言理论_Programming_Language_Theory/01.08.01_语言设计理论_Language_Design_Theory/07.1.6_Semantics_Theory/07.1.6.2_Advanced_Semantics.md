...
- [2 理论基础](#2-理论基础)
  - [2.1 形式化定义](#21-形式化定义)
- [3 操作语义 (Operational Semantics)](#3-操作语义-operational-semantics)
  - [3.1 小步语义 (Small-Step Semantics)](#31-小步语义-small-step-semantics)
  - [3.2 大步语义 (Big-Step Semantics)](#32-大步语义-big-step-semantics)
- [4 指称语义 (Denotational Semantics)](#4-指称语义-denotational-semantics)
  - [4.1 语义域理论](#41-语义域理论)
- [5 公理语义 (Axiomatic Semantics)](#5-公理语义-axiomatic-semantics)
  - [5.1 Hoare逻辑](#51-hoare逻辑)
- [6 语义等价性](#6-语义等价性)
  - [6.1 等价性证明](#61-等价性证明)
- [7 形式化验证](#7-形式化验证)
  - [7.1 语义保持性证明](#71-语义保持性证明)
- [8 总结](#8-总结)
- [9 相关链接](#9-相关链接)
- [10 批判性分析](#10-批判性分析)

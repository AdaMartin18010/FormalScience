...
- [编译理论 (Compilation Theory)](#编译理论-compilation-theory)
  - [📋 目录](#-目录)
  - [1 概述](#1-概述)
  - [2 理论基础](#2-理论基础)
    - [2.1 形式化定义](#21-形式化定义)
  - [3 编译阶段](#3-编译阶段)
    - [3.1 词法分析 (Lexical Analysis)](#31-词法分析-lexical-analysis)
    - [3.2 语法分析 (Syntax Analysis)](#32-语法分析-syntax-analysis)
    - [3.3 语义分析 (Semantic Analysis)](#33-语义分析-semantic-analysis)
    - [3.4 代码生成 (Code Generation)](#34-代码生成-code-generation)
  - [4 优化技术](#4-优化技术)
    - [4.1 常量折叠](#41-常量折叠)
    - [4.2 死代码消除](#42-死代码消除)
    - [4.3 寄存器分配](#43-寄存器分配)
  - [5 实现示例](#5-实现示例)
    - [5.1 完整编译器实现](#51-完整编译器实现)
  - [6 形式化验证](#6-形式化验证)

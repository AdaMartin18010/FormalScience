...
- [04.4.3 同伦等价](#0443-同伦等价)
  - [📋 目录](#-目录)
  - [1 概述](#1-概述)
  - [2 核心目标](#2-核心目标)
  - [3 基本概念](#3-基本概念)
    - [3.1 同伦等价基础](#31-同伦等价基础)
    - [3.2 同伦等价特征](#32-同伦等价特征)
  - [4 形式化定义](#4-形式化定义)
    - [4.1 同伦等价系统](#41-同伦等价系统)
    - [4.2 等价函数系统](#42-等价函数系统)
  - [5 定理与证明](#5-定理与证明)
    - [5.1 同伦等价基本定理](#51-同伦等价基本定理)
    - [5.2 等价函数定理](#52-等价函数定理)
  - [6 代码实现](#6-代码实现)
    - [6.1 同伦等价基础实现](#61-同伦等价基础实现)
    - [6.2 等价证明系统](#62-等价证明系统)
  - [7 应用示例](#7-应用示例)
    - [7.1 同伦等价使用](#71-同伦等价使用)
  - [8 相关理论](#8-相关理论)
    - [8.1 与同伦类型论的关系](#81-与同伦类型论的关系)

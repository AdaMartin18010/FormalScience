...
- [04.4.1 同伦理论](#0441-同伦理论)
  - [📋 目录](#-目录)
  - [1 概述](#1-概述)
  - [2 核心目标](#2-核心目标)
  - [📚 目录](#-目录-1)
  - [3 基本概念](#3-基本概念)
    - [3.1 同伦理论基础](#31-同伦理论基础)
    - [3.2 同伦理论特征](#32-同伦理论特征)
  - [4 形式化定义](#4-形式化定义)
    - [4.1 路径类型系统](#41-路径类型系统)
    - [4.2 同伦等价系统](#42-同伦等价系统)
  - [5 定理与证明](#5-定理与证明)
    - [5.1 同伦理论基本定理](#51-同伦理论基本定理)
    - [5.2 同伦等价定理](#52-同伦等价定理)
  - [6 代码实现](#6-代码实现)
    - [6.1 路径类型实现](#61-路径类型实现)
    - [6.2 同伦等价实现](#62-同伦等价实现)
    - [6.3 高阶归纳类型实现](#63-高阶归纳类型实现)
  - [7 应用示例](#7-应用示例)
    - [7.1 同伦类型系统使用](#71-同伦类型系统使用)
  - [8 相关理论](#8-相关理论)
    - [8.1 与类型理论的关系](#81-与类型理论的关系)
    - [8.2 与拓扑学的关系](#82-与拓扑学的关系)

...
- [04.4.5 同伦不变量](#0445-同伦不变量)
  - [📋 目录](#-目录)
  - [1 概述](#1-概述)
  - [2 核心目标](#2-核心目标)
  - [3 基本概念](#3-基本概念)
    - [3.1 同伦不变量基础](#31-同伦不变量基础)
    - [3.2 同伦不变量特征](#32-同伦不变量特征)
  - [4 形式化定义](#4-形式化定义)
    - [4.1 基本群系统](#41-基本群系统)
    - [4.2 同伦群系统](#42-同伦群系统)
  - [5 定理与证明](#5-定理与证明)
    - [5.1 同伦不变量基本定理](#51-同伦不变量基本定理)
    - [5.2 同伦群定理](#52-同伦群定理)
  - [6 代码实现](#6-代码实现)
    - [6.1 同伦不变量基础实现](#61-同伦不变量基础实现)
    - [6.2 同伦群计算系统](#62-同伦群计算系统)
  - [7 应用示例](#7-应用示例)
    - [7.1 同伦不变量使用](#71-同伦不变量使用)
  - [8 相关理论](#8-相关理论)
    - [8.1 与同伦类型论的关系](#81-与同伦类型论的关系)
    - [8.2 与拓扑学的关系](#82-与拓扑学的关系)
    - [8.3 与代数几何的关系](#83-与代数几何的关系)
  - [7. 参考文献](#7-参考文献)
  - [9 批判性分析](#9-批判性分析)

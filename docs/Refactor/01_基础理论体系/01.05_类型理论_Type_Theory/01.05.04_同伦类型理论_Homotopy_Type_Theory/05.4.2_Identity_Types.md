...
- [04.4.2 同一性类型](#0442-同一性类型)
  - [📋 目录](#-目录)
  - [1 概述](#1-概述)
  - [2 核心目标](#2-核心目标)
  - [📚 目录](#-目录-1)
  - [3 基本概念](#3-基本概念)
    - [3.1 同一性类型基础](#31-同一性类型基础)
    - [3.2 同一性类型特征](#32-同一性类型特征)
  - [4 形式化定义](#4-形式化定义)
    - [4.1 同一性类型系统](#41-同一性类型系统)
    - [4.2 同一性消除系统](#42-同一性消除系统)
  - [5 定理与证明](#5-定理与证明)
    - [5.1 同一性类型基本定理](#51-同一性类型基本定理)
  - [6 代码实现](#6-代码实现)
    - [6.1 同一性类型基础实现](#61-同一性类型基础实现)
    - [6.2 同一性证明系统](#62-同一性证明系统)
  - [7 应用示例](#7-应用示例)
    - [7.1 同一性类型使用](#71-同一性类型使用)
  - [8 相关理论](#8-相关理论)

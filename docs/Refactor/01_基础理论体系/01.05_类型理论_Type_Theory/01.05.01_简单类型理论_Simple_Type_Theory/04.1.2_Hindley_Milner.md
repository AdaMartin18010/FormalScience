...
- [04.1.2 Hindley-Milner类型系统](#0412-hindley-milner类型系统)
  - [📋 目录](#-目录)
  - [1 概述](#1-概述)
  - [2 核心目标](#2-核心目标)
  - [📚 目录](#-目录-1)
  - [3 基本概念](#3-基本概念)
    - [3.1 Hindley-Milner类型系统的直观理解](#31-hindley-milner类型系统的直观理解)
    - [3.2 核心特征](#32-核心特征)
    - [3.3 类型表达式](#33-类型表达式)
  - [4 形式化定义](#4-形式化定义)
    - [4.1 类型环境](#41-类型环境)
    - [4.2 类型规则](#42-类型规则)
    - [4.3 类型推断算法](#43-类型推断算法)
  - [5 定理与证明](#5-定理与证明)
    - [5.1 主要性质](#51-主要性质)
    - [5.2 统一算法](#52-统一算法)
  - [6 代码实现](#6-代码实现)

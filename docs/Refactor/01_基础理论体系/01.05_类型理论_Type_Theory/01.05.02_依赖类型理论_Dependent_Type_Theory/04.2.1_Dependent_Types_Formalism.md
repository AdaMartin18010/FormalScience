...
- [04.1.4 依赖类型](#0414-依赖类型)
  - [📋 目录](#-目录)
  - [1 概述](#1-概述)
  - [2 核心目标](#2-核心目标)
  - [3 基本概念](#3-基本概念)
    - [3.1 依赖类型的基本思想](#31-依赖类型的基本思想)
    - [3.2 马丁-洛夫类型论](#32-马丁-洛夫类型论)
  - [4 形式化定义](#4-形式化定义)
    - [4.1 依赖类型语法](#41-依赖类型语法)
    - [4.2 类型形成规则](#42-类型形成规则)
  - [5 定理与证明](#5-定理与证明)
    - [5.1 类型安全定理](#51-类型安全定理)
  - [6 代码实现](#6-代码实现)
    - [6.1 Rust 实现](#61-rust-实现)
    - [6.2 Haskell 实现](#62-haskell-实现)
  - [7 应用示例](#7-应用示例)
    - [7.1 形式化验证中的应用](#71-形式化验证中的应用)
  - [8 相关理论](#8-相关理论)
    - [8.1 与简单类型λ演算的关系](#81-与简单类型λ演算的关系)
    - [8.2 与同伦类型论的关系](#82-与同伦类型论的关系)
    - [8.3 与证明理论的关系](#83-与证明理论的关系)
  - [7. 参考文献](#7-参考文献)
  - [9 批判性分析](#9-批判性分析)
...
2. **Coquand, T., & Huet, G.** (1988). _The Calculus of Constructions_. Information and Computation.
3. **Barendregt, H.** (1992). _Lambda Calculi with Types_. Handbook of Logic in Computer Science.
4. **Pierce, B. C.** (2002). _Types and Programming Languages_. MIT Press.
5. **Univalent Foundations Program.** (2013). _Homotopy Type Theory: Univalent Foundations of Mathematics_. Institute for Advanced Study.

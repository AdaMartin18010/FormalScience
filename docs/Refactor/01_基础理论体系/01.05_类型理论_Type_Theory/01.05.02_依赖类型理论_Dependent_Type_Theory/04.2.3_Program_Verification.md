...
- [04.4.2 程序验证](#0442-程序验证)
  - [📋 目录](#-目录)
  - [1 概述](#1-概述)
  - [2 核心目标](#2-核心目标)
  - [3 基本概念](#3-基本概念)
    - [3.1 程序验证基础](#31-程序验证基础)
    - [3.2 程序验证方法](#32-程序验证方法)
  - [4 形式化定义](#4-形式化定义)
    - [4.1 程序规范系统](#41-程序规范系统)
    - [4.2 程序证明系统](#42-程序证明系统)
  - [5 定理与证明](#5-定理与证明)
    - [5.1 程序验证基本定理](#51-程序验证基本定理)
    - [5.2 程序安全定理](#52-程序安全定理)
  - [6 代码实现](#6-代码实现)
    - [6.1 程序规范系统](#61-程序规范系统)
    - [6.2 程序证明系统](#62-程序证明系统)
    - [6.3 分离逻辑实现](#63-分离逻辑实现)
  - [7 应用示例](#7-应用示例)
    - [7.1 程序规范示例](#71-程序规范示例)
  - [8 相关理论](#8-相关理论)

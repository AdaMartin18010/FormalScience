...
- [04.3.4 线性数据结构](#0434-线性数据结构)
  - [📋 目录](#-目录)
  - [1 概述](#1-概述)
  - [2 核心目标](#2-核心目标)
  - [3 基本概念](#3-基本概念)
    - [3.1 线性数据结构原理](#31-线性数据结构原理)
    - [3.2 线性性与访问模式](#32-线性性与访问模式)
  - [4 形式化定义](#4-形式化定义)
    - [4.1 线性数据结构类型](#41-线性数据结构类型)
    - [4.2 线性性约束](#42-线性性约束)
  - [5 类型规则](#5-类型规则)
    - [5.1 基本类型规则](#51-基本类型规则)
    - [5.2 线性性检查](#52-线性性检查)
  - [6 代码实现](#6-代码实现)
    - [6.1 完整的线性数据结构实现](#61-完整的线性数据结构实现)
    - [6.2 Haskell实现版本](#62-haskell实现版本)
  - [7 应用示例](#7-应用示例)
    - [7.1 资源管理](#71-资源管理)
    - [7.2 内存安全](#72-内存安全)
  - [8 相关理论](#8-相关理论)
    - [8.1 与其他数据结构的关系](#81-与其他数据结构的关系)
    - [8.2 理论联系](#82-理论联系)
  - [7. 参考文献](#7-参考文献)
  - [9 批判性分析](#9-批判性分析)
...
6. Melliès, P. A. (2009). _Categorical semantics of linear logic_. Panoramas et synthèses, 27, 15-215.

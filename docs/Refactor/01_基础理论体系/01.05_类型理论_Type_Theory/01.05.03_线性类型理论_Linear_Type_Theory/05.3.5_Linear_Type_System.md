...
- [04.3.5 线性类型系统](#0435-线性类型系统)
  ...
  - [3 基本概念](#3-基本概念)
    ...
    - [3.2 线性类型](#32-线性类型)
    - [3.3 线性类型系统规则](#33-线性类型系统规则)
  - [4 形式化定义](#4-形式化定义)
    - [4.1 线性λ演算](#41-线性λ演算)
    - [4.2 线性类型系统的语义](#42-线性类型系统的语义)
    - [4.3 线性类型系统的性质](#43-线性类型系统的性质)
  - [5 定理与证明](#5-定理与证明)
    - [5.1 线性类型系统的基本性质](#51-线性类型系统的基本性质)
    - [5.2 线性类型系统的等价性](#52-线性类型系统的等价性)
    - [5.3 线性类型系统的完备性](#53-线性类型系统的完备性)
  - [6 代码实现](#6-代码实现)
    - [6.1 Rust线性类型系统实现](#61-rust线性类型系统实现)
    - [6.2 Haskell线性类型系统实现](#62-haskell线性类型系统实现)
  - [7 应用示例](#7-应用示例)
    - [7.1 Rust所有权系统](#71-rust所有权系统)
    - [7.2 线性资源管理](#72-线性资源管理)
  - [8 相关理论](#8-相关理论)

...
- [04.3.7 所有权系统](#0437-所有权系统)
  - [📋 目录](#-目录)
  - [1 概述](#1-概述)
  - [2 核心目标](#2-核心目标)
  - [3 基本概念](#3-基本概念)
    - [3.1 所有权基础](#31-所有权基础)
    - [3.2 所有权系统的基本特征](#32-所有权系统的基本特征)
  - [4 形式化定义](#4-形式化定义)
    - [4.1 所有权类型系统](#41-所有权类型系统)
    - [4.2 生命周期系统](#42-生命周期系统)
  - [5 定理与证明](#5-定理与证明)
    - [5.1 所有权系统基本定理](#51-所有权系统基本定理)
    - [5.2 类型安全定理](#52-类型安全定理)
  - [6 代码实现](#6-代码实现)
    - [6.1 所有权系统基础实现](#61-所有权系统基础实现)
    - [6.2 借用检查器实现](#62-借用检查器实现)
    - [6.3 内存安全保证](#63-内存安全保证)
  - [7 应用示例](#7-应用示例)
    - [7.1 所有权系统使用](#71-所有权系统使用)
    - [7.2 内存安全示例](#72-内存安全示例)
  - [8 相关理论](#8-相关理论)
    - [8.1 与仿射类型理论的关系](#81-与仿射类型理论的关系)
    - [8.2 与类型理论的关系](#82-与类型理论的关系)

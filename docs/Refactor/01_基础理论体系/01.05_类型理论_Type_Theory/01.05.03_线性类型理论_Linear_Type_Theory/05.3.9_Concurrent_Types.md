...
- [04.3.9 并发类型](#0439-并发类型)
  ...
  - [3 基本概念](#3-基本概念)
    - [3.1 并发基础](#31-并发基础)
    - [3.2 并发类型系统特征](#32-并发类型系统特征)
  - [4 形式化定义](#4-形式化定义)
    - [4.1 并发类型系统](#41-并发类型系统)
    - [4.2 会话类型](#42-会话类型)
  - [5 定理与证明](#5-定理与证明)
    - [5.1 并发安全定理](#51-并发安全定理)
    - [5.2 并发类型安全定理](#52-并发类型安全定理)
  - [6 代码实现](#6-代码实现)
    - [6.1 并发类型系统实现](#61-并发类型系统实现)
    - [6.2 会话类型实现](#62-会话类型实现)
    - [6.3 并发安全检查器](#63-并发安全检查器)
  - [7 应用示例](#7-应用示例)
    - [7.1 并发类型系统使用](#71-并发类型系统使用)
    - [7.2 会话类型示例](#72-会话类型示例)
    - [7.3 并发安全检查示例](#73-并发安全检查示例)
  - [8 相关理论](#8-相关理论)
    - [8.1 与类型理论的关系](#81-与类型理论的关系)
    - [8.2 与并发理论的关系](#82-与并发理论的关系)
    - [8.3 与系统编程的关系](#83-与系统编程的关系)
  - [7. 参考文献](#7-参考文献)
  - [9 批判性分析](#9-批判性分析)
...
- 哲学维度：并发类型作为并发计算的抽象；时间与空间的哲学关系。
- 方法论维度：并发类型系统的设计原则；与经典类型系统的理论关系。
- 工程维度：并发类型在并发编程中的应用；并发安全的形式化保证。
- 社会技术维度：并发类型对编程语言设计的影响；并发编程教育的革新。

...
- [01. 线性控制理论 (Linear Control Theory)](#01-线性控制理论-linear-control-theory)
  - [目录](#目录)
  - [基本概念](#基本概念)
    - [1.1 线性系统](#11-线性系统)
    - [1.2 系统表示](#12-系统表示)
  ...
  - [可控性与可观性](#可控性与可观性)
    ...
    - [5.3 标准形](#53-标准形)
  - [形式化表示](#形式化表示)
    - [6.1 一阶逻辑表示](#61-一阶逻辑表示)
    - [6.2 类型论表示](#62-类型论表示)
  - [证明系统](#证明系统)
    - [7.1 稳定性证明](#71-稳定性证明)
    - [7.2 可控性证明](#72-可控性证明)
  - [与其他学科的关联](#与其他学科的关联)
    - [8.1 与哲学的关联](#81-与哲学的关联)
    - [8.2 与数学的关联](#82-与数学的关联)
    - [8.3 与工程学的关联](#83-与工程学的关联)
  - [应用示例](#应用示例)
    - [9.1 倒立摆控制](#91-倒立摆控制)
    - [9.2 稳定性分析工具](#92-稳定性分析工具)
  - [总结](#总结)
  - [批判性分析](#批判性分析)
    - [多元理论视角](#多元理论视角)
    - [局限性](#局限性)

...
- [05.1.1 基础控制理论](#0511-基础控制理论)
  ...
  - [4 形式化定义](#4-形式化定义)
    - [4.1 线性系统](#41-线性系统)
    - [4.2 稳定性](#42-稳定性)
    - [4.3 可控性和可观性](#43-可控性和可观性)
  - [5 定理与证明](#5-定理与证明)
    - [5.1 稳定性定理](#51-稳定性定理)
    - [5.2 可控性和可观性定理](#52-可控性和可观性定理)
    - [5.3 反馈控制定理](#53-反馈控制定理)
  - [6 稳定性分析](#6-稳定性分析)
    - [6.1 劳斯-赫尔维茨判据](#61-劳斯-赫尔维茨判据)
    - [6.2 奈奎斯特判据](#62-奈奎斯特判据)
    - [6.3 根轨迹分析](#63-根轨迹分析)
  - [7 代码实现](#7-代码实现)
    - [7.1 Rust 实现](#71-rust-实现)
    - [7.2 Haskell 实现](#72-haskell-实现)
  - [8 应用示例](#8-应用示例)
    - [8.1 一阶系统控制](#81-一阶系统控制)
    - [8.2 二阶系统控制](#82-二阶系统控制)
    - [8.3 倒立摆控制](#83-倒立摆控制)
  - [9 相关理论](#9-相关理论)
    - [9.1 与现代控制理论的关系](#91-与现代控制理论的关系)
    - [9.2 与系统理论的关系](#92-与系统理论的关系)
    - [9.3 与信号处理的关系](#93-与信号处理的关系)
  - [8. 参考文献](#8-参考文献)
  - [10 批判性分析](#10-批判性分析)
    - [10.1 多元理论视角](#101-多元理论视角)
    - [10.2 局限性分析](#102-局限性分析)

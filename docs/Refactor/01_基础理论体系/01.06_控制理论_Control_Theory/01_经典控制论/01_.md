...
- [经典控制论基础理论 (Classical Control Theory Foundation)](#经典控制论基础理论-classical-control-theory-foundation)
  - [📋 目录](#-目录)
  - [1 概述](#1-概述)
  - [📚 **目录**](#-目录-1)
    - [1.1 控制系统基础架构](#11-控制系统基础架构)
    - [1.2 稳定性理论](#12-稳定性理论)
    - [1.3 控制器设计](#13-控制器设计)
    - [1.4 系统性能分析](#14-系统性能分析)
    - [1.5 系统辨识与建模](#15-系统辨识与建模)
  - [2 控制系统基础架构1](#2-控制系统基础架构1)
    - [2.1 系统分类与层次结构](#21-系统分类与层次结构)
    - [2.2 状态空间表示](#22-状态空间表示)
    - [2.3 传递函数表示](#23-传递函数表示)
  - [3 稳定性理论1](#3-稳定性理论1)
    - [3.1 李雅普诺夫稳定性](#31-李雅普诺夫稳定性)
    - [3.2 频域稳定性](#32-频域稳定性)
  - [4 控制器设计1](#4-控制器设计1)
    - [4.1 PID控制器](#41-pid控制器)
    - [4.2 状态反馈控制](#42-状态反馈控制)
  - [5 系统性能分析1](#5-系统性能分析1)
    - [5.1 时域性能指标](#51-时域性能指标)
    - [5.2 频域性能指标](#52-频域性能指标)
  - [6 系统辨识与建模1](#6-系统辨识与建模1)
    - [6.1 参数辨识](#61-参数辨识)
  - [7 理论关系图](#7-理论关系图)
  - [8 相关理论链接](#8-相关理论链接)
  - [📚 **参考文献**](#-参考文献)

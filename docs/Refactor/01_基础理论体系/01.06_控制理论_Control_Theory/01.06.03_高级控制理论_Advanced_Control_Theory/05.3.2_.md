...
- [05.3.2 自适应控制理论](#0532-自适应控制理论)
  ...
  - [📚 目录](#-目录-1)
  - [3 基本概念](#3-基本概念)
    - [3.1 自适应控制定义](#31-自适应控制定义)
    - [3.2 自适应控制分类](#32-自适应控制分类)
    - [3.3 自适应控制问题](#33-自适应控制问题)
  - [4 参数自适应控制](#4-参数自适应控制)
    - [4.1 线性参数化系统](#41-线性参数化系统)
    - [4.2 参数估计律](#42-参数估计律)
    - [4.3 自适应控制律](#43-自适应控制律)
  - [5 模型参考自适应控制](#5-模型参考自适应控制)
    - [5.1 参考模型](#51-参考模型)
    - [5.2 MRAC控制律](#52-mrac控制律)
    - [5.3 稳定性分析](#53-稳定性分析)
  - [6 神经网络自适应控制](#6-神经网络自适应控制)
    - [6.1 神经网络逼近](#61-神经网络逼近)
    - [6.2 神经网络自适应律](#62-神经网络自适应律)
    - [6.3 鲁棒神经网络控制](#63-鲁棒神经网络控制)
  - [7 鲁棒自适应控制](#7-鲁棒自适应控制)
    - [7.1 死区自适应控制](#71-死区自适应控制)
    - [7.2 σ修正](#72-σ修正)
    - [7.3 投影算法](#73-投影算法)
  - [8 自适应观测器](#8-自适应观测器)
    - [8.1 自适应观测器设计](#81-自适应观测器设计)
    - [8.2 输出反馈自适应控制](#82-输出反馈自适应控制)
  - [9 代码实现](#9-代码实现)
    - [9.1 自适应控制系统框架](#91-自适应控制系统框架)
    - [9.2 鲁棒自适应控制](#92-鲁棒自适应控制)
    - [9.3 自适应观测器](#93-自适应观测器)
  - [10 应用示例](#10-应用示例)
    - [10.1 倒立摆自适应控制](#101-倒立摆自适应控制)
    - [10.2 模型参考自适应控制示例](#102-模型参考自适应控制示例)
    - [10.3 神经网络自适应控制示例](#103-神经网络自适应控制示例)
  - [11 相关理论](#11-相关理论)
    - [11.1 与线性控制理论的关系](#111-与线性控制理论的关系)
    - [11.2 与非线性控制理论的关系](#112-与非线性控制理论的关系)

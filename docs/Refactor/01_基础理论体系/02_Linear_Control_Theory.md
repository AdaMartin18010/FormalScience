...
- [2 核心目标](#2-核心目标)
- [3 基本概念](#3-基本概念)
  - [3.1 线性系统定义](#31-线性系统定义)
  - [3.2 传递函数](#32-传递函数)
  - [3.3 系统性质](#33-系统性质)
- [4 线性系统建模](#4-线性系统建模)
  - [4.1 连续时间系统](#41-连续时间系统)
  - [4.2 离散时间系统](#42-离散时间系统)
  - [4.3 系统转换](#43-系统转换)
- [5 系统分析](#5-系统分析)
  - [5.1 稳定性分析](#51-稳定性分析)
  - [5.2 可控性分析](#52-可控性分析)
  - [5.3 可观性分析](#53-可观性分析)
- [6 控制器设计](#6-控制器设计)
  - [6.1 状态反馈控制](#61-状态反馈控制)
  - [6.2 输出反馈控制](#62-输出反馈控制)
  - [6.3 最优控制](#63-最优控制)
- [7 观测器设计](#7-观测器设计)
  - [7.1 全阶观测器](#71-全阶观测器)
  - [7.2 降阶观测器](#72-降阶观测器)
- [8 算法实现](#8-算法实现)
  - [8.1 线性系统类](#81-线性系统类)
  - [8.2 控制器设计工具](#82-控制器设计工具)
- [9 应用示例](#9-应用示例)
  - [9.1 基本系统分析示例](#91-基本系统分析示例)
  - [9.2 控制器设计示例](#92-控制器设计示例)
  - [9.3 LQR控制器设计示例](#93-lqr控制器设计示例)
  - [9.4 观测器设计示例](#94-观测器设计示例)
- [10 批判性分析](#10-批判性分析)
  - [10.1 多元理论视角](#101-多元理论视角)
  - [10.2 局限性](#102-局限性)
  - [10.3 争议与分歧](#103-争议与分歧)
  - [10.4 应用前景](#104-应用前景)
  - [10.5 改进建议](#105-改进建议)
- [11 总结](#11-总结)

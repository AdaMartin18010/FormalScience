...
1. Gilbert, Seth, and Lynch, Nancy. "Brewer's conjecture and the feasibility of consistent, available, partition-tolerant web services." _ACM SIGACT News_, 2002.
2. Fischer, Michael J., Lynch, Nancy A., and Paterson, Michael S. "Impossibility of distributed consensus with one faulty process." _Journal of the ACM_, 1985.
3. Lamport, Leslie. "Time, clocks, and the ordering of events in a distributed system." _Communications of the ACM_, 1978.

...
- [1 概述](#1-概述)
- [2 理论基础](#2-理论基础)
  - [2.1 算法形式化定义](#21-算法形式化定义)
  - [2.2 复杂度分析理论](#22-复杂度分析理论)
- [3 设计模式](#3-设计模式)
  - [3.1 分治法 (Divide and Conquer)](#31-分治法-divide-and-conquer)
  - [3.2 动态规划 (Dynamic Programming)](#32-动态规划-dynamic-programming)
  - [3.3 贪心算法 (Greedy Algorithm)](#33-贪心算法-greedy-algorithm)
- [4 性能测试框架](#4-性能测试框架)

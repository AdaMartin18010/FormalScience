...
- [16.1.2 复杂度分析 (Complexity Analysis)](#1612-复杂度分析-complexity-analysis)
  - [📋 目录](#-目录)
  - [1 概述](#1-概述)
  - [2 理论基础](#2-理论基础)
    - [2.1 时间复杂度理论](#21-时间复杂度理论)
    - [2.2 空间复杂度理论](#22-空间复杂度理论)
  - [3 复杂度分析工具](#3-复杂度分析工具)
    - [3.1 Rust 复杂度分析框架](#31-rust-复杂度分析框架)
    - [3.2 常见算法复杂度分析](#32-常见算法复杂度分析)
    - [3.3 性能测试和基准测试](#33-性能测试和基准测试)
  - [4 复杂度分析示例](#4-复杂度分析示例)
    - [4.1 示例1 排序算法比较](#41-示例1-排序算法比较)
    - [4.2 示例2 搜索算法比较](#42-示例2-搜索算法比较)
...
4. Kleinberg, J., & Tardos, É. (2006). _Algorithm Design_. Pearson.

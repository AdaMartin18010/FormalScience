...
[参见：07.2.5 存在主义哲学分析](./存在主义哲学分析.md)｜[07.2.1 信息本体论分析](./信息本体论分析.md)｜[07.2.2 现实本体论分析](./现实本体论分析.md)｜[07.2.3 数学本体论分析](./数学本体论分析.md)

## 目录

1. [1 概述](#1-概述)
2. [2 核心概念](#2-核心概念)
    1. [2.1 意向性](#21-意向性-intentionality)
    2. [2.2 现象学还原](#22-现象学还原-phenomenological-reduction)
    3. [2.3 生活世界](#23-生活世界-lebenswelt)
3. [3 主要代表人物](#3-主要代表人物)
    1. [3.1 胡塞尔](#31-埃德蒙德胡塞尔-edmund-husserl-1859-1938)
    2. [3.2 海德格尔](#32-马丁海德格尔-martin-heidegger-1889-1976)
...
### 3.1 埃德蒙德·胡塞尔 (Edmund Husserl, 1859-1938)
...
### 3.2 马丁·海德格尔 (Martin Heidegger, 1889-1976)
...
### 3.3 莫里斯·梅洛-庞蒂 (Maurice Merleau-Ponty, 1908-1961)
...
### 3.4 让-保罗·萨特 (Jean-Paul Sartre, 1905-1980)
...
## 07.2.4.2 现象学主要流派与方法对比 {#07242-现象学主要流派与方法对比}

### 现象学主要流派对比表

| 流派         | 代表人物         | 核心观点                   | 方法论特征         | 主要贡献           |
|--------------|------------------|----------------------------|--------------------|--------------------|
| 胡塞尔现象学 | 胡塞尔           | 意向性、还原、本质直观     | 悬置、还原、直观   | 现象学方法奠基     |
| 海德格尔现象学 | 海德格尔         | 此在、存在论、世界-内-存在 | 解释学循环、存在分析 | 存在论转向         |
| 梅洛-庞蒂现象学 | 梅洛-庞蒂       | 身体性、知觉、具身性       | 身体现象学、知觉分析 | 具身认知理论       |
| 萨特现象学   | 萨特             | 自由、存在先于本质         | 意识流、否定性     | 存在主义现象学     |
| 施特劳斯现象学 | 施特劳斯         | 生活世界、社会建构         | 生活世界分析、社会现象学 | 社会现象学         |

### 现象学方法对比表

| 方法         | 关键步骤         | 目标                     | 适用领域           |
|--------------|------------------|--------------------------|--------------------|
| 直观描述     | 体验描述、避免预设 | 捕捉现象本身             | 意识、心理学       |
| 还原         | 悬置、转向本质     | 揭示本质结构             | 哲学、认知科学     |
| 本质直观     | 直观、普遍化       | 建立本质知识             | 数学、逻辑         |
| 生活世界分析 | 日常经验、前理论   | 理解经验基础             | 社会学、教育学     |
| 具身分析     | 身体、知觉、行动   | 解释具身认知             | 认知科学、AI       |

### Mermaid结构图：现象学理论体系

```mermaid
graph TD
  Husserl[胡塞尔现象学] -->|方法论基础| Reduction[还原]
  Husserl -->|本质直观| Eidetic[本质直观]
  Heidegger[海德格尔现象学] -->|存在论| Dasein[此在分析]
  Merleau[梅洛-庞蒂现象学] -->|身体性| Embodiment[具身分析]
  Sartre[萨特现象学] -->|自由| Freedom[存在主义]
  Schutz[施特劳斯现象学] -->|生活世界| Lebenswelt[生活世界分析]
  Reduction --> Eidetic
  Dasein --> Lebenswelt
  Embodiment --> Eidetic
```
...
---
> 交叉引用：[07.2.1 信息本体论分析](./信息本体论分析.md)｜[07.2.2 现实本体论分析](./现实本体论分析.md)｜[07.2.3 数学本体论分析](./数学本体论分析.md)｜[07.2.6 规范伦理学分析](./规范伦理学分析.md)

...
1. Pnueli, A. (1977). _The Temporal Logic of Programs_. IEEE Symposium on Foundations of Computer Science.
2. Emerson, E. A. (1990). _Temporal and Modal Logic_. Handbook of Theoretical Computer Science.
3. Clarke, E. M., Grumberg, O., & Peled, D. A. (1999). _Model Checking_. MIT Press.
4. Alur, R., & Dill, D. L. (1994). _A Theory of Timed Automata_. Theoretical Computer Science.
5. Lamport, L. (1978). _Time, Clocks, and the Ordering of Events in a Distributed System_. Communications of the ACM.

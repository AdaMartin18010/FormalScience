...
2. Martin, R. C. (2000). _Design Principles and Design Patterns_. Object Mentor.
3. Bass, L., Clements, P., & Kazman, R. (2012). _Software Architecture in Practice_. Addison-Wesley.
4. Fowler, M. (2002). _Patterns of Enterprise Application Architecture_. Addison-Wesley.
5. Buschmann, F., Meunier, R., Rohnert, H., Sommerlad, P., & Stal, M. (1996). _Pattern-Oriented Software Architecture: A System of Patterns_. Wiley.
6. Shaw, M., & Garlan, D. (1996). _Software Architecture: Perspectives on an Emerging Discipline_. Prentice Hall.

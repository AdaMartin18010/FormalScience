...
1. Hohpe, G., & Woolf, B. (2003). _Enterprise Integration Patterns: Designing, Building, and Deploying Messaging Solutions_. Addison-Wesley.
2. Richardson, C. (2018). _Microservices Patterns: With Examples in Java_. Manning.
3. Garcia-Molina, H., & Salem, K. (1987). Sagas. _ACM SIGMOD Record_, 16(3), 249-259.
4. van der Aalst, W. M. P. (2016). _Process Mining: Data Science in Action_. Springer.

...
- [认证理论](#认证理论)
  - [1 基础定义与概念模型](#1-基础定义与概念模型)
  - [引言](#引言)
  - [基础定义与概念模型](#基础定义与概念模型)
    - [1 认证的基本概念](#1-认证的基本概念)
    - [1.2 认证的分类](#12-认证的分类)
    - [1.3 认证的形式化模型](#13-认证的形式化模型)
    - [1.4 认证的安全属性](#14-认证的安全属性)
  - [2 主流认证协议与机制](#2-主流认证协议与机制)
    - [1 口令认证机制](#1-口令认证机制)
    - [2.2 基于令牌的认证](#22-基于令牌的认证)
    - [2.3 OAuth 2.0协议](#23-oauth-20协议)
    - [2.4 JWT（JSON Web Token）](#24-jwtjson-web-token)
    - [2.5 SAML（Security Assertion Markup Language）](#25-samlsecurity-assertion-markup-language)
    - [2.6 零信任架构](#26-零信任架构)
  - [3 形式化理论与安全性分析](#3-形式化理论与安全性分析)
    - [1 密码学基础](#1-密码学基础)
      - [1 哈希函数](#1-哈希函数)
      - [2 数字签名](#2-数字签名)
    - [3.2 协议安全性证明](#32-协议安全性证明)
      - [1 形式化安全模型](#1-形式化安全模型)
      - [2 零知识证明](#2-零知识证明)
    - [3.3 攻击模型与威胁分析](#33-攻击模型与威胁分析)
      - [1 常见攻击类型](#1-常见攻击类型)
      - [2 时间攻击](#2-时间攻击)
      - [3 侧信道攻击](#3-侧信道攻击)
    - [3.4 协议组合安全性](#34-协议组合安全性)
      - [1 协议组合定理](#1-协议组合定理)
      - [2 安全协议设计原则](#2-安全协议设计原则)
    - [3.5 形式化验证](#35-形式化验证)
      - [1 模型检测](#1-模型检测)
      - [2 定理证明](#2-定理证明)
  - [4 Rust实现与工程实践](#4-rust实现与工程实践)
    ...
    - [4.5 工程实践建议与安全注意事项](#45-工程实践建议与安全注意事项)

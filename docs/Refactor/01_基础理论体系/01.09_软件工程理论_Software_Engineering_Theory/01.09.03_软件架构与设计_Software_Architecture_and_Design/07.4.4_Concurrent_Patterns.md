...
- [07.4.4 并发模式 (Concurrent Patterns)](#0744-并发模式-concurrent-patterns)
  ...
  - [理论基础](#理论基础)
    ...
    - [2.2 并发理论](#22-并发理论)
  - [3 模式详解](#3-模式详解)
    - [1 线程池模式 (Thread Pool Pattern)](#1-线程池模式-thread-pool-pattern)
    - [3.2 Future/Promise 模式 (Future/Promise Pattern)](#32-futurepromise-模式-futurepromise-pattern)
    - [3.3 反应器模式 (Reactor Pattern)](#33-反应器模式-reactor-pattern)
    - [3.4 提议者模式 (Proactor Pattern)](#34-提议者模式-proactor-pattern)
    - [3.5 Monitor Object 模式 (Monitor Object Pattern)](#35-monitor-object-模式-monitor-object-pattern)
    - [3.6 Actor 模式 (Actor Pattern)](#36-actor-模式-actor-pattern)
    - [3.7 工作窃取模式 (Work Stealing Pattern)](#37-工作窃取模式-work-stealing-pattern)
    - [3.8 读写锁模式 (Reader-Writer Lock Pattern)](#38-读写锁模式-reader-writer-lock-pattern)
    - [3.9 屏障模式 (Barrier Pattern)](#39-屏障模式-barrier-pattern)
    - [3.10 双重检查锁定模式 (Double-Checked Locking Pattern)](#310-双重检查锁定模式-double-checked-locking-pattern)
  - [4 形式化定义](#4-形式化定义)
    - [1 类型理论视角](#1-类型理论视角)
    - [4.2 进程代数视角](#42-进程代数视角)
  - [5 实现示例](#5-实现示例)
    - [1 异步运行时](#1-异步运行时)

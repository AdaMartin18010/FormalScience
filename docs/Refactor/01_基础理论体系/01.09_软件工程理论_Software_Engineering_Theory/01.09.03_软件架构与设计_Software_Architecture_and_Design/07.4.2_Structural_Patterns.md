...
- [07.4.2 结构型设计模式 (Structural Design Patterns)](#0742-结构型设计模式-structural-design-patterns)
  ...
  - [3 模式详解](#3-模式详解)
    ...
    - [3.2 桥接模式 (Bridge Pattern)](#32-桥接模式-bridge-pattern)
    - [3.3 组合模式 (Composite Pattern)](#33-组合模式-composite-pattern)
    - [3.4 装饰器模式 (Decorator Pattern)](#34-装饰器模式-decorator-pattern)
    - [3.5 外观模式 (Facade Pattern)](#35-外观模式-facade-pattern)
    - [3.6 享元模式 (Flyweight Pattern)](#36-享元模式-flyweight-pattern)
    - [3.7 代理模式 (Proxy Pattern)](#37-代理模式-proxy-pattern)
  - [4 形式化定义](#4-形式化定义)
    - [1 类型理论视角](#1-类型理论视角)
    - [4.2 范畴论视角](#42-范畴论视角)
  - [5 实现示例](#5-实现示例)

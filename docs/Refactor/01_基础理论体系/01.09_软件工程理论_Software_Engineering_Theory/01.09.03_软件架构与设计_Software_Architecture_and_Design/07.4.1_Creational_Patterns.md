...
- [07.4.1 创建型设计模式 (Creational Design Patterns)](#0741-创建型设计模式-creational-design-patterns)
  ...
  - [3 模式详解](#3-模式详解)
    ...
    - [3.2 工厂方法模式 (Factory Method Pattern)](#32-工厂方法模式-factory-method-pattern)
    - [3.3 抽象工厂模式 (Abstract Factory Pattern)](#33-抽象工厂模式-abstract-factory-pattern)
    - [3.4 建造者模式 (Builder Pattern)](#34-建造者模式-builder-pattern)
    - [3.5 原型模式 (Prototype Pattern)](#35-原型模式-prototype-pattern)
  - [4 形式化定义](#4-形式化定义)
    - [1 类型理论视角](#1-类型理论视角)
    - [4.2 范畴论视角](#42-范畴论视角)
  - [5 实现示例](#5-实现示例)

...
- [10.1.1 线性时态逻辑理论](#1011-线性时态逻辑理论)
  - [📋 目录](#-目录)
  - [1 概述](#1-概述)
  - [2 核心目标](#2-核心目标)
  - [📚 目录](#-目录-1)
  - [3 基本概念](#3-基本概念)
    - [3.1 线性时态逻辑的定义](#31-线性时态逻辑的定义)
    - [3.2 时间结构](#32-时间结构)
  - [4 语法定义](#4-语法定义)
    - [4.1 LTL语法](#41-ltl语法)
    - [4.2 操作符含义](#42-操作符含义)
  ...
  - [7 模型检查](#7-模型检查)
    - [7.1 自动机构造](#71-自动机构造)
    - [7.2 模型检查算法](#72-模型检查算法)
  - [8 等价变换](#8-等价变换)
    - [8.1 范式转换](#81-范式转换)
  - [9 应用示例](#9-应用示例)
    - [9.1 LTL公式表示](#91-ltl公式表示)
    - [9.2 模型检查示例](#92-模型检查示例)
  - [10 相关理论](#10-相关理论)
    - [10.1 与分支时态逻辑的关系](#101-与分支时态逻辑的关系)
    - [10.2 与自动机理论的关系](#102-与自动机理论的关系)
    - [10.3 与模型检查的关系](#103-与模型检查的关系)
  - [9. 参考文献](#9-参考文献)
  - [11 批判性分析](#11-批判性分析)

...
- [10.2 概率时态逻辑 (Probabilistic Temporal Logic)](#102-概率时态逻辑-probabilistic-temporal-logic)
  - [📋 目录](#-目录)
  - [1 文档信息](#1-文档信息)
  - [2 理论概述](#2-理论概述)
  - [3 核心概念](#3-核心概念)
    - [3.1 基础模型：马尔可夫链与决策过程](#31-基础模型马尔可夫链与决策过程)
      - [1.1.1 定义 1021 (离散时间马尔可夫链 - DTMC)](#111-定义-1021-离散时间马尔可夫链---dtmc)
      - [1.1.2 示例 1021 (DTMC 实现 - Rust)](#112-示例-1021-dtmc-实现---rust)
    - [3.2 概率计算树逻辑 (PCTL)](#32-概率计算树逻辑-pctl)
      - [2.2.1 定义 1022 (PCTL 语法)](#221-定义-1022-pctl-语法)
      - [2.2.2 示例 1022 (PCTL 模型检测 - 概念)](#222-示例-1022-pctl-模型检测---概念)
    - [3.3 概率线性时态逻辑 (PLTL)](#33-概率线性时态逻辑-pltl)
      - [3.3.1 定义 1023 (PLTL 语法)](#331-定义-1023-pltl-语法)
      - [3.3.2 示例 1023 (PLTL 模型检测 - 概念)](#332-示例-1023-pltl-模型检测---概念)
  - [4 应用](#4-应用)
    - [4.1 可靠性工程](#41-可靠性工程)
    - [4.2 通信协议验证](#42-通信协议验证)
    - [4.3 随机化算法分析](#43-随机化算法分析)
  - [参考文献](#参考文献)
  - [5 批判性分析](#5-批判性分析)
...
1. Baier, C., & Katoen, J. P. (2008). _Principles of Model Checking_. MIT Press. (This is the primary reference for this topic).
2. Hansson, H., & Jonsson, B. (1994). A logic for reasoning about time and reliability. _Formal Aspects of Computing_, 6(5), 512-535.
3. Vardi, M. Y. (1985). _An automata-theoretic approach to automatic program verification_. In Proceedings of the First Symposium on Logic in Computer Science (LICS '86).
...
- 计算代价：直到/有界直到的概率计算需解线性方程或迭代，规模受限。

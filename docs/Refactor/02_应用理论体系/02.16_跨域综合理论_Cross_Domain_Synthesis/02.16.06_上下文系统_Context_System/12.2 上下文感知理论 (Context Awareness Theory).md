...
- [12.2 上下文感知理论 (Context Awareness Theory)](#122-上下文感知理论-context-awareness-theory)
  - [📋 目录](#-目录)
  - [1 核心概念 (Core Concepts)](#1-核心概念-core-concepts)
    - [1.1 上下文的分类 (Categories of Context)](#11-上下文的分类-categories-of-context)
  - [2 上下文感知系统的架构 (Architectures for Context-Aware Systems)](#2-上下文感知系统的架构-architectures-for-context-aware-systems)
  - [3 关键挑战 (Key Challenges)](#3-关键挑战-key-challenges)
  - [4 形式化模型 (Formal Models)](#4-形式化模型-formal-models)
  - [5 Rust 代码示例：概念性的上下文感知应用](#5-rust-代码示例概念性的上下文感知应用)
  - [6 结论](#6-结论)
  - [7 批判性分析](#7-批判性分析)

...
- [16.04 信息处理理论](#1604-信息处理理论)
  - [📋 目录](#-目录)
  - [1 理论概述](#1-理论概述)
  - [2 学习目标](#2-学习目标)
  - [3 理论内容](#3-理论内容)
    - [3.1 信息处理理论的基本概念](#31-信息处理理论的基本概念)
      - [1.1.1 信息处理的定义](#111-信息处理的定义)
      - [1.1.2 信息处理的特征](#112-信息处理的特征)
      - [1.1.3 信息处理的类型](#113-信息处理的类型)
    - [3.2 信息处理模型](#32-信息处理模型)
      - [2.2.1 多存储模型](#221-多存储模型)
      - [2.2.2 工作记忆模型](#222-工作记忆模型)
      - [2.2.3 连接主义模型](#223-连接主义模型)
    - [3.3 信息处理过程](#33-信息处理过程)
      - [3.3.1 信息输入过程](#331-信息输入过程)
      - [3.3.2 信息编码过程](#332-信息编码过程)
      - [3.3.3 信息存储过程](#333-信息存储过程)
      - [3.3.4 信息检索过程](#334-信息检索过程)
      - [3.3.5 信息输出过程](#335-信息输出过程)
    - [3.4 信息处理能力](#34-信息处理能力)
      - [4.4.1 处理容量](#441-处理容量)
      - [4.4.2 处理速度](#442-处理速度)
      - [4.4.3 处理准确性](#443-处理准确性)
    - [3.5 信息处理在人机交互中的应用](#35-信息处理在人机交互中的应用)
      - [5.5.1 界面设计应用](#551-界面设计应用)
      - [5.5.2 交互设计应用](#552-交互设计应用)
      - [5.5.3 可用性设计应用](#553-可用性设计应用)
  - [4 形式化证明](#4-形式化证明)
    - [4.1 证明 1641 信息处理系统的完整性](#41-证明-1641-信息处理系统的完整性)
    - [4.2 证明 1642 信息处理容量的有限性](#42-证明-1642-信息处理容量的有限性)
    - [4.3 证明 1643 信息处理过程的可预测性](#43-证明-1643-信息处理过程的可预测性)
  - [5 应用实例](#5-应用实例)
    - [5.1 实例 1641 基于信息处理理论的界面设计](#51-实例-1641-基于信息处理理论的界面设计)
    - [5.2 实例 1642 基于信息处理理论的交互设计](#52-实例-1642-基于信息处理理论的交互设计)
    - [5.3 实例 1643 信息处理能力评估与优化](#53-实例-1643-信息处理能力评估与优化)
  - [6 理论验证](#6-理论验证)
    - [6.1 验证 1641 信息处理系统验证](#61-验证-1641-信息处理系统验证)
    - [6.2 验证 1642 信息处理能力评估](#62-验证-1642-信息处理能力评估)
  - [7 相关理论](#7-相关理论)
    - [7.1 基础理论](#71-基础理论)
    - [7.2 应用理论](#72-应用理论)
    - [7.3 评估理论](#73-评估理论)
  - [📚 参考文献](#-参考文献)
    ...
    - [7.6 标准文档](#76-标准文档)
  - [8 练习题目](#8-练习题目)
    - [8.1 练习 1641 信息处理理论应用](#81-练习-1641-信息处理理论应用)
    - [8.2 练习 1642 信息处理能力评估](#82-练习-1642-信息处理能力评估)
    - [8.3 练习 1643 信息处理模型应用](#83-练习-1643-信息处理模型应用)

...
- [18.1 信息熵理论 (Information Entropy Theory)](#181-信息熵理论-information-entropy-theory)
  - [📋 目录](#-目录)
  - [1 概述](#1-概述)
  - [2 理论基础](#2-理论基础)
    - [2.1 信息熵形式化定义](#21-信息熵形式化定义)
    - [2.2 熵的基本性质](#22-熵的基本性质)
    - [2.3 互信息和相对熵](#23-互信息和相对熵)
  - [3 熵计算和编码实现](#3-熵计算和编码实现)
    - [3.1 Python 信息熵框架](#31-python-信息熵框架)
  - [4 性能分析和评估](#4-性能分析和评估)
    - [4.1 熵编码性能分析](#41-熵编码性能分析)

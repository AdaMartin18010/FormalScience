...
- [17.2 统计学习理论 (Statistical Learning Theory)](#172-统计学习理论-statistical-learning-theory)
  - [📋 目录](#-目录)
  - [1 概述](#1-概述)
  - [2 理论基础](#2-理论基础)
    - [2.1 统计学习形式化定义](#21-统计学习形式化定义)
    - [2.2 VC维理论](#22-vc维理论)
    - [2.3 Rademacher复杂度](#23-rademacher复杂度)
    - [2.4 统计推断理论](#24-统计推断理论)
  - [3 统计学习算法实现](#3-统计学习算法实现)
    - [3.1 Python 统计学习框架](#31-python-统计学习框架)
  - [4 性能分析和评估](#4-性能分析和评估)
    - [4.1 统计学习评估指标](#41-统计学习评估指标)
  - [5 与模块内主题的关系](#5-与模块内主题的关系)
  - [6 批判性分析](#6-批判性分析)
    - [6.1 哲学维度](#61-哲学维度)
    - [6.2 方法论维度](#62-方法论维度)
    - [6.3 工程维度](#63-工程维度)
    - [6.4 社会技术维度](#64-社会技术维度)
  - [7 参见](#7-参见)
  - [📖 参考文献](#-参考文献)
...
3. Wasserman, L. (2004). _All of Statistics_. Springer.
4. Casella, G., & Berger, R. L. (2002). _Statistical Inference_. Duxbury.
5. Efron, B., & Tibshirani, R. J. (1994). _An Introduction to the Bootstrap_. CRC Press.

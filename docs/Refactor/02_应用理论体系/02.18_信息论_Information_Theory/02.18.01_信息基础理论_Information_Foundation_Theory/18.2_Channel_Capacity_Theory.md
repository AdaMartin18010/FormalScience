...
- [18.2 信道容量理论 (Channel Capacity Theory)](#182-信道容量理论-channel-capacity-theory)
  - [📋 目录](#-目录)
  - [1 概述](#1-概述)
  - [2 理论基础](#2-理论基础)
    - [2.1 信道容量形式化定义](#21-信道容量形式化定义)
    - [2.2 香农信道编码定理](#22-香农信道编码定理)
    - [2.3 常见信道模型](#23-常见信道模型)
  - [3 信道容量计算实现](#3-信道容量计算实现)
    - [3.1 Python 信道容量框架](#31-python-信道容量框架)
  - [4 性能分析和评估](#4-性能分析和评估)
    - [4.1 信道编码性能分析](#41-信道编码性能分析)
...
4. Proakis, J. G. (2001). _Digital Communications_. McGraw-Hill.
5. Lin, S., & Costello, D. J. (2004). _Error Control Coding_. Pearson.

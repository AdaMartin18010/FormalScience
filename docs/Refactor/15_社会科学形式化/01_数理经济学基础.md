...
title: "15.1 数理经济学基础"
category: "社会科学形式化"
subcategory: "数理经济学基础.md"
order: 1
difficulty: "初级"
status: "已完成"
tags: ["社会科学形式化", "纳什均衡", "博弈", "博弈表示", "均衡", "数理经济学"]
related: ["15.1 数理经济学基础", "目录", "1.1 一般均衡理论", "1.1.1 Arrow-Debreu模型", "1.1.2 均衡存在性定理"]
math: true
code: true
...
本文档系统介绍数理经济学的基础理论和核心概念。内容涵盖社会科学形式化领域的主要知识点，包括纳什均衡, 博弈, 博弈表示, 均衡等关键主题。适合具备相关基础的学习者进行深入研究。
...
- [12.3.4 匹配理论](../12_决策与博弈论/03_机制设计/03.4_匹配理论.md)

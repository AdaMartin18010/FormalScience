...
> **重要提示**: 本文件的内容已被重构到 [03.2_Formal_Grammars](./03.2_Formal_Grammars/) 目录中。请访问该目录获取最新的、结构化的文法理论内容。
>
> 新的目录结构包括:
>
> - [03.2.1_Regular_Grammar.md](./03.2_Formal_Grammars/03.2.1_Regular_Grammar.md) - 正则文法
> - [03.2.2_Context_Free_Grammar.md](./03.2_Formal_Grammars/03.2.2_Context_Free_Grammar.md) - 上下文无关文法
> - [03.2.3_Context_Sensitive_Grammar.md](./03.2_Formal_Grammars/03.2.3_Context_Sensitive_Grammar.md) - 上下文相关文法
> - [03.2.4_Unrestricted_Grammar.md](./03.2_Formal_Grammars/03.2.4_Unrestricted_Grammar.md) - 无限制文法
>
> 此文件保留作为历史参考。
>
> **更新时间**: 2024-12-26

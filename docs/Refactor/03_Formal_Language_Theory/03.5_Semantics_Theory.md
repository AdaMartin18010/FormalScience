...
>
> 新的目录结构包括:
> - [03.5.1_操作语义](./03.5_Semantics_Theory/03.5.1_操作语义/03.5.1_操作语义.md)
> - [03.5.2_指称语义](./03.5_Semantics_Theory/03.5.2_指称语义/03.5.2_指称语义.md)
> - [03.5.3_公理语义](./03.5_Semantics_Theory/03.5.3_公理语义/03.5.3_公理语义.md)
> - [03.5.4_代数语义](./03.5_Semantics_Theory/03.5.4_代数语义/03.5.4_代数语义.md)
>
> 此文件保留作为历史参考。
>
> **更新时间**: 2024-12-22

...
difficulty: "中级"
status: "已完成"
tags: ["贝叶斯统计", "后验", "统计计算", "先验", "统计学"]
related: ["9.5.3 指数族", "9.5.2 充分统计量", "10.1.2 熵的定义与性质", "9.4.4 马尔可夫链蒙特卡洛", "9.4.3 贝叶斯推断"]
math: true
code: true
...
本文档深入探讨计算贝叶斯方法的核心原理和关键方法。内容涵盖统计计算领域的主要知识点，包括贝叶斯统计, 后验, 先验等关键主题。适合有一定基础的学习者系统学习。
...
- [9.4.4 马尔可夫链蒙特卡洛](./09_统计学/04_贝叶斯统计/04.4_马尔可夫链蒙特卡洛.md)

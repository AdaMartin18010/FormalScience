...
difficulty: "高级"
status: "已完成"
tags: ["贝叶斯统计", "决策理论", "风险", "后验", "先验", "效用"]
related: ["9.3.1 点估计", "05_数理统计 - Mathematical Statistics", "9.3.1 点估计", "05_数理统计 - Mathematical Statistics"]
math: true
code: true
...
本文档深入探讨统计决策理论的核心原理和关键方法。内容涵盖数理统计领域的主要知识点，包括贝叶斯统计, 决策理论, 风险, 后验, 先验等关键主题。适合具备相关基础的学习者进行深入研究。
...
- [05_数理统计 - Mathematical Statistics](../05_数理统计.md)

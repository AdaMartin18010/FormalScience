---
title: "03.4 HoTT与数学基础"
category: "形式语言"
subcategory: "同伦类型论_HoTT"
order: 3
difficulty: "初级"
status: "已完成"
tags: ["恒等类型", "HoTT", "同伦类型论", "ZFC公理", "集合论", "序数"]
related: ["03.1 HoTT基础", "03.2 高阶归纳类型", "03.3 同伦层次", "02.4 类型论与逻辑", "03.3 同伦层次"]
math: false
code: true
...
本文档系统介绍HoTT与数学的基础理论和核心概念。内容涵盖同伦类型论领域的主要知识点，包括恒等类型, HoTT, ZFC公理, 集合论等关键主题。适合具备相关基础的学习者进行深入研究。

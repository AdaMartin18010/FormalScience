...
related: ["3.2 恒等类型 (Identity Types)", "目录", "3.2.1 引言", "3.2.2 恒等类型的定义", "3.2.2.1 形成规则"]
math: true
code: true
...
本文档深入探讨恒等类型的核心原理和关键方法。内容涵盖同伦类型论领域的主要知识点，包括相关理论、方法及应用。适合具备相关基础的学习者进行深入研究。
...
- [03.1 HoTT基础](../03_同伦类型论_HoTT/03.1_HoTT基础.md)
- [03.4 HoTT与数学基础](../03_同伦类型论_HoTT/03.4_HoTT与数学基础.md)
- [3.1 同伦基础 (Homotopy Foundations)](../03_同伦类型论_HoTT/03.1_同伦基础.md)

...
difficulty: "初级"
status: "已完成"
tags: ["形式语言基础", "复杂性", "图灵机", "可计算性", "形式语言"]
related: ["01.1 文法与语言", "01.2 有限自动机", "01.3 下推自动机", "02.1 简单类型系统", "1.3 λ演算 (Lambda Calculus)"]
math: true
code: true
...
本文档深入探讨图灵机与计算的核心原理和关键方法。内容涵盖形式语言基础领域的主要知识点，包括复杂性, 图灵机, 可计算性等关键主题。适合初学者建立基础知识体系。

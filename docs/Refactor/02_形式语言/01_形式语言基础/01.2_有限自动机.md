...
difficulty: "初级"
status: "已完成"
tags: ["NFA", "有限自动机", "形式语言基础", "DFA", "形式语言"]
related: ["01.1 文法与语言", "01.3 下推自动机", "01.4 图灵机与计算", "01.3 下推自动机", "01.4 图灵机与计算"]
math: true
code: true
...
本文档深入探讨有限自动机的核心原理和关键方法。内容涵盖形式语言基础领域的主要知识点，包括NFA, 有限自动机, DFA等关键主题。适合初学者建立基础知识体系。
...
完整的有限自动机形式化定义和等价性证明框架，参见：
📄 [`examples/lean/FiniteAutomaton.lean`](../../../examples/lean/FiniteAutomaton.lean)
...
-- NFA与DFA等价性定理
theorem NFA_DFA_equivalence {S A : Type} [BEq S] [BEq A]
    (nfa : NFA S A) (w : List A) :
...
- [01.3 下推自动机](../01_形式语言基础/01.3_下推自动机.md)

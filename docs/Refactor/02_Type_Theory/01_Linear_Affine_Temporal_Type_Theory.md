# 02. 线性仿射时态类型理论：资源管理与时间约束

## 目录

1. [2.1 类型理论基础](#21-类型理论基础)
2. [2.2 线性类型系统](#22-线性类型系统)
3. [2.3 仿射类型系统](#23-仿射类型系统)
4. [2.4 时态类型系统](#24-时态类型系统)
5. [2.5 线性逻辑与类型](#25-线性逻辑与类型)
6. [2.6 资源管理理论](#26-资源管理理论)
7. [2.7 并发类型系统](#27-并发类型系统)
8. [2.8 系统设计应用](#28-系统设计应用)

...
difficulty: "初级"
status: "已完成"
tags: ["知识逻辑", "形式认识论", "认知科学", "认知科学形式模型"]
related: ["1.2 数理逻辑", "13.1.1 信念的逻辑", "12.2.2 纳什均衡", "1.2 数理逻辑", "13.1.1 信念的逻辑"]
math: true
code: true
...
本文档深入探讨知识逻辑的核心原理和关键方法。内容涵盖形式认识论领域的主要知识点，包括知识逻辑, 认知科学等关键主题。适合初学者建立基础知识体系。
...
- [13.1.1 信念的逻辑](../01_形式认识论/01.1_信念的逻辑.md)

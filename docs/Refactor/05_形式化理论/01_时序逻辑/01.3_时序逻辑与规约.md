...
difficulty: "高级"
status: "已完成"
tags: ["最终一致性", "临界现象", "相变", "一致性模型", "LTL", "复杂系统"]
related: ["01.2 计算树逻辑 (CTL)", "01.3 时序逻辑应用", "01.1 线性时序逻辑 (Linear Temporal Logic, LTL)", "01.2 计算树逻辑 (CTL)", "01.1_线性时序逻辑_LTL.md"]
math: true
code: true
...
本文档深入探讨时序逻辑与规约的核心原理和关键方法。内容涵盖时序逻辑领域的主要知识点，包括最终一致性, 临界现象, 相变, 一致性模型, LTL等关键主题。适合具备相关基础的学习者进行深入研究。
...
- [01.3 时序逻辑应用](../01_时序逻辑/01.3_时序逻辑应用.md)

---
title: "02.3 高级 Petri 网"
category: "形式化理论"
subcategory: "Petri网理论"
order: 2
difficulty: "高级"
status: "已完成"
tags: ["临界现象", "并发", "相变", "位置", "复杂系统", "Petri网"]
related: ["02.2 Petri 网分析方法", "02.1 Petri 网基础", "01.4 性能指标", "02.2 Petri 网分析方法", "02.1 Petri 网基础"]
math: true
code: true
...
本文档深入探讨高级 Petri 网的核心原理和关键方法。内容涵盖Petri网理论领域的主要知识点，包括临界现象, 并发, 相变, 位置, 复杂系统等关键主题。适合具备相关基础的学习者进行深入研究。

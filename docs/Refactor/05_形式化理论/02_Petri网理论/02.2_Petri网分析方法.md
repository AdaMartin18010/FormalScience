---
title: "02.2 Petri 网分析方法"
category: "形式化理论"
subcategory: "Petri网理论"
order: 2
difficulty: "高级"
status: "已完成"
tags: ["Petri网理论", "位置", "Petri网", "并发", "形式化理论"]
related: ["02.1 Petri 网基础", "02.1 Petri 网基础", "04.3 计算复杂性理论", "02.1 Petri 网基础", "02.1 Petri 网基础"]
math: true
code: true
...
本文档深入探讨Petri 网分析方法的核心原理和关键方法。内容涵盖Petri网理论领域的主要知识点，包括位置, Petri网, 并发等关键主题。适合具备相关基础的学习者进行深入研究。
...
- [02.1 Petri 网基础](../02_Petri网理论/02.1_Petri网基础.md)
- [04.3 计算复杂性理论](../04_计算理论/04.3_计算复杂性.md)

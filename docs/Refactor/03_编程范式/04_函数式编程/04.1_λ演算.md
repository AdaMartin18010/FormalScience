...
difficulty: "高级"
status: "已完成"
tags: ["函数式", "λ演算", "图灵机", "可计算性", "函数式编程", "纯函数"]
related: ["04.2 高阶函数", "04.3 单子与函子", "1. 单子与函子", "04.3 单子与函子", "04.2 高阶函数"]
math: true
code: true
...
本文档深入探讨λ演算的核心原理和关键方法。内容涵盖函数式编程领域的主要知识点，包括函数式, λ演算, 图灵机, 可计算性等关键主题。适合具备相关基础的学习者进行深入研究。

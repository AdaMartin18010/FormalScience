...
```text
15_Cross_Domain_Synthesis/
├── README.md                           # 模块总览
├── 01_Unified_Framework.md             # 统一框架
├── 02_Cross_Domain_Application_Theory.md # 跨域应用理论
├── 13.1_.md                           # 综合理论1
├── 13.1-.md                           # 综合理论1-
├── 13.2-.md                           # 综合理论2-
├── 13.3-.md                           # 综合理论3-
...
├── 13.5-.md                           # 综合理论5-
├── 13.6-.md                           # 综合理论6-
└── 16.1_Context_System/               # 上下文系统
    ├── 16.1.1_Context_Theory.md       # 上下文理论
    ├── 16.1.2_Knowledge_Integration.md # 知识整合
    └── 16.1.3_Cross_Domain_Reasoning.md # 跨域推理
```

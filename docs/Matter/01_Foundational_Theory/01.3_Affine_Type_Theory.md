...
- [1. 仿射类型理论](#1-仿射类型理论)
  - [目录](#目录)
  - [1.1 概述](#11-概述)
    - [1.1.1 仿射逻辑基础](#111-仿射逻辑基础)
    - [1.1.2 与线性类型的关系](#112-与线性类型的关系)
    - [1.1.3 应用动机](#113-应用动机)
    - [1.1.4 实际应用](#114-实际应用)
  - [1.2 基础概念](#12-基础概念)
    - [1.2.1 仿射类型](#121-仿射类型)
    - [1.2.2 仿射项](#122-仿射项)
    - [1.2.3 仿射上下文](#123-仿射上下文)
    - [1.2.4 弱化规则](#124-弱化规则)
  - [1.3 形式化定义](#13-形式化定义)
    - [1.3.1 仿射类型语法](#131-仿射类型语法)
    - [1.3.2 仿射项语法](#132-仿射项语法)
    - [1.3.3 仿射类型规则](#133-仿射类型规则)
    - [1.3.4 仿射归约规则](#134-仿射归约规则)
  - [1.4 核心定理](#14-核心定理)
    - [1.4.1 仿射类型保持性](#141-仿射类型保持性)
    - [1.4.2 资源安全](#142-资源安全)
    - [1.4.3 仿射强正规化](#143-仿射强正规化)
    - [1.4.4 弱化一致性](#144-弱化一致性)
  - [1.5 实现示例](#15-实现示例)
    - [1.5.1 Rust 仿射类型系统](#151-rust-仿射类型系统)
    - [1.5.2 Haskell 仿射类型实现](#152-haskell-仿射类型实现)
    - [1.5.3 形式化验证](#153-形式化验证)
  - [1.6 应用与扩展](#16-应用与扩展)
    - [1.6.1 所有权系统](#161-所有权系统)
    - [1.6.2 内存管理](#162-内存管理)
    - [1.6.3 并发编程](#163-并发编程)
    - [1.6.4 系统编程](#164-系统编程)
  - [1.7 参考文献](#17-参考文献)
...
1. Tov, J. A., & Pucella, R. (2011). _Practical Affine Types_. ACM SIGPLAN Notices, 46(1), 87-98.
2. Walker, D. (2005). _Substructural Type Systems_. Advanced Topics in Types and Programming Languages, 3-43.
3. Mazurak, K., & Zdancewic, S. (2010). _Fable: A Language for Enforcing User-Defined Security Policies_. IEEE Symposium on Security and Privacy, 369-383.
4. Jung, R., Dang, H. H., Kang, J., & Dreyer, D. (2018). _Stacked Borrows: An Aliasing Model for Rust_. ACM SIGPLAN Notices, 54(1), 41-56.
5. Jung, R., Krebbers, R., Birkedal, L., & Dreyer, D. (2018). _Higher-order ghost state_. ACM SIGPLAN Notices, 53(4), 217-231.

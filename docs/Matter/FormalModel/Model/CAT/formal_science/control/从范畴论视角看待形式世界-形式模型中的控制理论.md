# 1. 从范畴论视角看待形式世界-形式模型中的控制理论

## 目录

- [1. 从范畴论视角看待形式世界-形式模型中的控制理论](#1-从范畴论视角看待形式世界-形式模型中的控制理论)
  - [目录](#目录)
  - [1.1 范畴论基础](#11-范畴论基础)
  - [1.2 控制相关理论的范畴论视角](#12-控制相关理论的范畴论视角)
    - [1.2.1 控制论](#121-控制论)
    - [1.2.2 设计论与控制流](#122-设计论与控制流)
    - [1.2.3 分布式控制论](#123-分布式控制论)
    - [1.2.4 系统控制论](#124-系统控制论)
  - [1.3 物理世界理论的范畴化](#13-物理世界理论的范畴化)
    - [1.3.1 物理规则的函子表示](#131-物理规则的函子表示)
    - [1.3.2 结构论与机构论](#132-结构论与机构论)
    - [1.3.3 机械动力论](#133-机械动力论)
  - [1.4 层次关系与整体联系](#14-层次关系与整体联系)
  - [1.5 形式证明与代码实现](#15-形式证明与代码实现)
  - [1.6 从范畴论视角看待形式世界-形式模型中的控制理论（续）](#16-从范畴论视角看待形式世界-形式模型中的控制理论续)
  - [1.7 高级范畴结构与控制系统](#17-高级范畴结构与控制系统)
    - [1.7.1 伴随与控制对偶性](#171-伴随与控制对偶性)
    - [1.7.2 单子变换与控制流抽象](#172-单子变换与控制流抽象)
    - [1.7.3 限制与余限制在控制系统中的应用](#173-限制与余限制在控制系统中的应用)
  - [1.8 物理-控制系统的统一形式化](#18-物理-控制系统的统一形式化)
    - [1.8.1 拓扑控制论](#181-拓扑控制论)
    - [1.8.2 控制系统的代数拓扑表示](#182-控制系统的代数拓扑表示)
    - [1.8.3 物理-控制系统的共同函子结构](#183-物理-控制系统的共同函子结构)
  - [1.9 面向程序的控制范畴论](#19-面向程序的控制范畴论)
    - [1.9.1 程序语义作为控制范畴](#191-程序语义作为控制范畴)
    - [1.9.2 类型论与控制流](#192-类型论与控制流)
    - [1.9.3 范畴化的工作流引擎](#193-范畴化的工作流引擎)
  - [1.10 形式证明与定理](#110-形式证明与定理)
    - [1.10.1 控制系统的范畴论定理](#1101-控制系统的范畴论定理)
    - [1.10.2 物理-控制系统同构定理](#1102-物理-控制系统同构定理)
    - [1.10.3 分布式控制系统的范畴定理](#1103-分布式控制系统的范畴定理)
  - [1.11 综合应用：范畴化的智能控制系统](#111-综合应用范畴化的智能控制系统)
    - [1.11.1 学习控制系统的单子变换](#1111-学习控制系统的单子变换)
    - [1.11.2 多层次控制系统的范畴合成](#1112-多层次控制系统的范畴合成)
    - [1.11.3 物理约束下的形式化控制合成](#1113-物理约束下的形式化控制合成)

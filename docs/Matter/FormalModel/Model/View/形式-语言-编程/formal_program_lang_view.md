# 1. 与Rust、Haskell、Lean类似关注形式模型设计验证的语言

## 目录

- [1. 与Rust、Haskell、Lean类似关注形式模型设计验证的语言](#1-与rusthaskelllean类似关注形式模型设计验证的语言)
  - [目录](#目录)
  - [1.1 定理证明助理](#11-定理证明助理)
  - [1.2 形式化建模语言](#12-形式化建模语言)
  - [1.3 函数式编程语言(带验证特性)](#13-函数式编程语言带验证特性)
  - [1.4 专门的验证导向语言](#14-专门的验证导向语言)
  - [1.5 形式化验证工具链](#15-形式化验证工具链)
  - [1.6 实用工业语言中的形式化特性](#16-实用工业语言中的形式化特性)
  - [1.7 实验性和研究语言](#17-实验性和研究语言)
  - [1.8 趋势与未来方向](#18-趋势与未来方向)

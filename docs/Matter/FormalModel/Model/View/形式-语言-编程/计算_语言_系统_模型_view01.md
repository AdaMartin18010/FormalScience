# 1. 计算科学的统一视角：可计算性、语言、系统与模型的交织

## 目录

- [1. 计算科学的统一视角：可计算性、语言、系统与模型的交织](#1-计算科学的统一视角可计算性语言系统与模型的交织)
  - [目录](#目录)
  - [1.1 引言：计算范式的演化](#11-引言计算范式的演化)
  - [1.2 可计算性：从理论到实践](#12-可计算性从理论到实践)
  - [1.3 程序设计语言的形式基础](#13-程序设计语言的形式基础)
  - [1.4 计算系统的组织原理](#14-计算系统的组织原理)
  - [1.5 工作流：计算过程的编排](#15-工作流计算过程的编排)
  - [1.6 算法：思想的形式表达](#16-算法思想的形式表达)
  - [1.7 模式与范式：抽象的多层次结构](#17-模式与范式抽象的多层次结构)
  - [1.8 计算模型的交互与转换](#18-计算模型的交互与转换)
  - [1.9 形式系统间的映射关系](#19-形式系统间的映射关系)
  - [1.10 案例分析：Rust中的表达](#110-案例分析rust中的表达)
  - [1.11 未来展望：计算范式的融合](#111-未来展望计算范式的融合)

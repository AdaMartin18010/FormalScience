# 1. 计算、形式与数学：概念统一与深层联系

## 目录

- [1. 计算、形式与数学：概念统一与深层联系](#1-计算形式与数学概念统一与深层联系)
  - [目录](#目录)
  - [1.1 引言：概念统一的必要性](#11-引言概念统一的必要性)
  - [1.2 计算范式与形式基础](#12-计算范式与形式基础)
    - [1.2.1 计算作为形式变换](#121-计算作为形式变换)
    - [1.2.2 类型系统作为逻辑](#122-类型系统作为逻辑)
    - [1.2.3 范畴论视角下的程序](#123-范畴论视角下的程序)
  - [1.3 抽象代数与计算结构](#13-抽象代数与计算结构)
    - [1.3.1 代数数据类型与群论](#131-代数数据类型与群论)
    - [1.3.2 函子、单子与计算效应](#132-函子单子与计算效应)
    - [1.3.3 格理论与程序分析](#133-格理论与程序分析)
  - [1.4 拓扑与计算空间](#14-拓扑与计算空间)
    - [1.4.1 连续性与离散计算](#141-连续性与离散计算)
    - [1.4.2 同伦类型论](#142-同伦类型论)
    - [1.4.3 空间计算模型](#143-空间计算模型)
  - [1.5 信息流动与微积分思想](#15-信息流动与微积分思想)
    - [1.5.1 梯度下降与优化算法](#151-梯度下降与优化算法)
    - [1.5.2 信息度量与熵](#152-信息度量与熵)
    - [1.5.3 微分隐私与信息控制](#153-微分隐私与信息控制)
  - [1.6 线性代数与计算模型](#16-线性代数与计算模型)
    - [1.6.1 张量计算与神经网络](#161-张量计算与神经网络)
    - [1.6.2 线性变换作为计算抽象](#162-线性变换作为计算抽象)
    - [1.6.3 特征空间与数据表示](#163-特征空间与数据表示)
  - [1.7 统一视角：计算-形式-数学三位一体](#17-统一视角计算-形式-数学三位一体)
    - [1.7.1 同构与等价关系](#171-同构与等价关系)
    - [1.7.2 计算即证明：柯里-霍华德同构](#172-计算即证明柯里-霍华德同构)
    - [1.7.3 量子计算：物理与信息的统一](#173-量子计算物理与信息的统一)
  - [1.8 结论与展望](#18-结论与展望)

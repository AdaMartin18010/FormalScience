...
- [1. 计算、形式与认知的深层联系](#1-计算形式与认知的深层联系)
  - [目录](#目录)
  - [1.1 引言](#11-引言)
  - [1.2 计算科学的形式基础](#12-计算科学的形式基础)
    - [1.2.1 计算与可计算性](#121-计算与可计算性)
    - [1.2.2 信息、算法与模型的本质](#122-信息算法与模型的本质)
  - [1.3 形式科学的深层结构](#13-形式科学的深层结构)
    - [1.3.1 类型论与范畴论](#131-类型论与范畴论)
    - [1.3.2 形式语言与语义](#132-形式语言与语义)
  - [1.4 认知与智能的形式化](#14-认知与智能的形式化)
    - [1.4.1 人脑认知的计算模型](#141-人脑认知的计算模型)
    - [1.4.2 智能的形式化表达](#142-智能的形式化表达)
  - [1.5 三域交叉：形式转换与关系模型](#15-三域交叉形式转换与关系模型)
    - [1.5.1 同态映射与模型转换](#151-同态映射与模型转换)
    - [1.5.2 计算、形式与认知的统一模型](#152-计算形式与认知的统一模型)

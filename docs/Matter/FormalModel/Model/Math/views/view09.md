...
- [1. 数学逻辑](#1-数学逻辑)
  - [目录](#目录)
  - [1.1 数理逻辑概述](#11-数理逻辑概述)
  - [1.2 模型论 (Model Theory)](#12-模型论-model-theory)
    - [1.2.1 核心概念：形式语言与结构](#121-核心概念形式语言与结构)
    - [1.2.2 定义：模型](#122-定义模型)
    - [1.2.3 解释与示例](#123-解释与示例)
    - [1.2.4 元模型与论证：可靠性、完备性、紧致性](#124-元模型与论证可靠性完备性紧致性)
    - [1.2.5 拓展与关联](#125-拓展与关联)
  - [1.3 递归论 (Recursion Theory / Computability Theory)](#13-递归论-recursion-theory--computability-theory)
    - [1.3.1 核心概念：算法与可计算性](#131-核心概念算法与可计算性)
    - [1.3.2 形式模型：图灵机、递归函数](#132-形式模型图灵机递归函数)
    - [1.3.3 解释与示例](#133-解释与示例)
    - [1.3.4 元模型与论证：丘奇-图灵论题、不可判定性](#134-元模型与论证丘奇-图灵论题不可判定性)
    - [1.3.5 拓展与关联](#135-拓展与关联)
  - [1.4 证明论 (Proof Theory)](#14-证明论-proof-theory)
    - [1.4.1 核心概念：形式证明系统](#141-核心概念形式证明系统)
    - [1.4.2 形式模型：希尔伯特系统、自然演绎、相继式演算](#142-形式模型希尔伯特系统自然演绎相继式演算)
    - [1.4.3 解释与示例](#143-解释与示例)
    - [1.4.4 元模型与论证：一致性、哥德尔不完备定理](#144-元模型与论证一致性哥德尔不完备定理)
    - [1.4.5 拓展与关联](#145-拓展与关联)
  - [1.5 层次与关联性分析](#15-层次与关联性分析)
    - [1.5.1 层次间关联 (语法 - 语义 - 计算)](#151-层次间关联-语法---语义---计算)
    - [1.5.2 层次内关联](#152-层次内关联)
  - [1.6 视角切换与论证方式](#16-视角切换与论证方式)
  - [1.7 思维导图 (Text)](#17-思维导图-text)
  - [1.8 扩展](#18-扩展)
  - [1.9 哥德尔不完备定理的深远影响：超越局限性](#19-哥德尔不完备定理的深远影响超越局限性)
  - [1.10 模型论的构造性力量：超越“是否存在”](#110-模型论的构造性力量超越是否存在)
  - [1.11 从可计算性到计算复杂性：递归论的自然延伸](#111-从可计算性到计算复杂性递归论的自然延伸)
  - [1.12 元数学的视角：逻辑作为研究数学的工具](#112-元数学的视角逻辑作为研究数学的工具)
  - [1.13 关联性的再强化：思想的交织与共振](#113-关联性的再强化思想的交织与共振)
  - [1.14 在特定数学理论中的应用](#114-在特定数学理论中的应用)
    - [1.14.1 集合论 (Set Theory)](#1141-集合论-set-theory)
    - [1.14.2 代数 (Algebra)](#1142-代数-algebra)
  - [1.15 关键证明技巧与哲学意涵](#115-关键证明技巧与哲学意涵)
    - [1.15.1 关键证明技巧](#1151-关键证明技巧)
    - [1.15.2 哲学意涵](#1152-哲学意涵)
  - [1.16 现代逻辑分支](#116-现代逻辑分支)
    - [1.16.1 模态逻辑 (Modal Logic)](#1161-模态逻辑-modal-logic)
    - [1.16.2 非经典逻辑 (Non-Classical Logics)](#1162-非经典逻辑-non-classical-logics)
    - [1.16.3 范畴逻辑 (Categorical Logic) / 范畴论与逻辑 (Category Theory and Logic)](#1163-范畴逻辑-categorical-logic--范畴论与逻辑-category-theory-and-logic)
  - [1.17 Curry-Howard 同构：证明、程序与类型的统一](#117-curry-howard-同构证明程序与类型的统一)
  - [1.18 有限模型论：逻辑与计算复杂性的直接对话](#118-有限模型论逻辑与计算复杂性的直接对话)
  - [1.19 描述集合论：逻辑、集合论与分析学的交汇](#119-描述集合论逻辑集合论与分析学的交汇)
  - [1.20 逆向数学：寻找定理的“恰当”公理](#120-逆向数学寻找定理的恰当公理)
  - [1.21 可计算分析：将算法带入连续世界](#121-可计算分析将算法带入连续世界)
  - [1.22 逻辑的普遍性与持续影响](#122-逻辑的普遍性与持续影响)
  - [1.23 同伦类型论 (HoTT)：作为数学新基础的潜力](#123-同伦类型论-hott作为数学新基础的潜力)
  - [1.24 自动推理：让机器进行逻辑演绎](#124-自动推理让机器进行逻辑演绎)
  - [1.25 总结与展望](#125-总结与展望)
  - [1.26 HoTT：从路径到高维同伦的直觉](#126-hott从路径到高维同伦的直觉)
  - [1.27 归结法：一阶逻辑自动推理的引擎](#127-归结法一阶逻辑自动推理的引擎)
  - [1.28 HoTT：单一性公理的形式与推论](#128-hott单一性公理的形式与推论)
  - [1.29 归结法：具体示例与方法比较](#129-归结法具体示例与方法比较)
  - [1.30 逻辑与人工智能：知识表示与规划](#130-逻辑与人工智能知识表示与规划)
  - [1.31 非经典逻辑：缺省逻辑与回答集编程 (ASP)](#131-非经典逻辑缺省逻辑与回答集编程-asp)
    - [1.31.1 缺省逻辑 (Default Logic)](#1311-缺省逻辑-default-logic)
    - [1.31.2 回答集编程 (Answer Set Programming, ASP)](#1312-回答集编程-answer-set-programming-asp)
  - [1.32 自动规划算法：SATPlan 的工作原理](#132-自动规划算法satplan-的工作原理)
  - [1.33 逻辑与自然语言处理 (NLP) 及机器学习 (ML) 的交叉](#133-逻辑与自然语言处理-nlp-及机器学习-ml-的交叉)
    - [1.33.1 逻辑与自然语言处理 (NLP)](#1331-逻辑与自然语言处理-nlp)
    - [1.33.2 逻辑与机器学习 (ML)](#1332-逻辑与机器学习-ml)
  - [1.34 描述逻辑 (DL) 与本体工程](#134-描述逻辑-dl-与本体工程)
  - [1.35 神经符号方法：结合学习与推理](#135-神经符号方法结合学习与推理)
  - [1.36 逻辑在伦理 AI 与 AI 安全中的作用](#136-逻辑在伦理-ai-与-ai-安全中的作用)
  - [1.37 描述逻辑 (DL) 推理：表算法 (Tableau Algorithm) 详解](#137-描述逻辑-dl-推理表算法-tableau-algorithm-详解)
  - [1.38 神经符号架构示例：神经定理证明器 (NTPs)](#138-神经符号架构示例神经定理证明器-ntps)
  - [1.39 AI 安全挑战：工具性趋同 (Instrumental Convergence)](#139-ai-安全挑战工具性趋同-instrumental-convergence)
  - [1.40 概率逻辑与马尔可夫逻辑网络 (MLNs)：融合逻辑与概率](#140-概率逻辑与马尔可夫逻辑网络-mlns融合逻辑与概率)
  - [1.41 AI 安全：价值对齐与逆向强化学习 (IRL)](#141-ai-安全价值对齐与逆向强化学习-irl)
  - [1.42 超越图灵？超计算与丘奇-图灵论题的物理限制](#142-超越图灵超计算与丘奇-图灵论题的物理限制)
  - [1.43 马尔可夫逻辑网络 (MLNs)：推理与学习算法概览](#143-马尔可夫逻辑网络-mlns推理与学习算法概览)
    - [1.43.1 推理算法](#1431-推理算法)
    - [1.43.2 学习算法](#1432-学习算法)
  - [1.44 AI 安全：价值对齐的其他方法——AI 辩论 (Debate) 与迭代放大 (Iterated Amplification)](#144-ai-安全价值对齐的其他方法ai-辩论-debate-与迭代放大-iterated-amplification)
    - [1.44.1 AI 辩论 (AI Debate)](#1441-ai-辩论-ai-debate)
    - [1.44.2 迭代放大 (Iterated Amplification) / 迭代蒸馏与放大 (Iterated Distillation and Amplification, IDA)](#1442-迭代放大-iterated-amplification--迭代蒸馏与放大-iterated-distillation-and-amplification-ida)
  - [1.45 计算复杂性：P vs NP 问题及其深远影响](#145-计算复杂性p-vs-np-问题及其深远影响)
  - [1.46 MLN 结构学习：基于路径查找的方法](#146-mln-结构学习基于路径查找的方法)
  - [1.47 AI 安全：规范博弈 (Specification Gaming) 的实例与教训](#147-ai-安全规范博弈-specification-gaming-的实例与教训)
  - [1.48 计算复杂性谱系：PSPACE, EXPTIME 及更高](#148-计算复杂性谱系pspace-exptime-及更高)
  - [1.49 随机化算法：应对 NP-难问题的实用策略](#149-随机化算法应对-np-难问题的实用策略)
  - [1.50 AI 安全：可中断性 (Interruptibility) 与可控性 (Controllability)](#150-ai-安全可中断性-interruptibility-与可控性-controllability)
  - [1.51 量子计算对经典复杂性类的影响](#151-量子计算对经典复杂性类的影响)
  - [1.52 BPP 与 P 的关系：去随机化的追求](#152-bpp-与-p-的关系去随机化的追求)
  - [1.53 AI 安全：对齐税 (Alignment Tax) 与规范可学习性 (Specification Learnability)](#153-ai-安全对齐税-alignment-tax-与规范可学习性-specification-learnability)
    - [1.53.1 对齐税 (Alignment Tax)](#1531-对齐税-alignment-tax)
    - [1.53.2 规范可学习性 (Specification Learnability)](#1532-规范可学习性-specification-learnability)
  - [1.54 量子信息论与量子纠错：保护脆弱的量子态](#154-量子信息论与量子纠错保护脆弱的量子态)
  - [1.55 量子算法示例：Deutsch-Jozsa 与 Simon 算法](#155-量子算法示例deutsch-jozsa-与-simon-算法)
    - [1.55.1 Deutsch-Jozsa 算法 (1992)](#1551-deutsch-jozsa-算法-1992)
    - [1.55.2 Simon 算法 (1994)](#1552-simon-算法-1994)
  - [1.56 AI 对齐失败场景：具体思想实验与警示](#156-ai-对齐失败场景具体思想实验与警示)
  - [1.57 计算社会选择理论 (ComSoc)：算法视角下的集体决策](#157-计算社会选择理论-comsoc算法视角下的集体决策)
  - [1.58 量子纠错：表面码 (Surface Code) 详解](#158-量子纠错表面码-surface-code-详解)
    - [1.58.1 基本结构与概念](#1581-基本结构与概念)
    - [1.58.2 错误检测与纠正](#1582-错误检测与纠正)
    - [1.58.3 容错 (Fault Tolerance)](#1583-容错-fault-tolerance)
  - [1.59 AI 对齐：可扩展监督 (Scalable Oversight)](#159-ai-对齐可扩展监督-scalable-oversight)
    - [1.59.1 主要方法](#1591-主要方法)
    - [1.59.2 优势与挑战](#1592-优势与挑战)
  - [1.60 计算拍卖理论与机制设计](#160-计算拍卖理论与机制设计)
    - [1.60.1 关键概念与机制](#1601-关键概念与机制)
  - [1.61 量子纠错：其他编码方案与容错门](#161-量子纠错其他编码方案与容错门)
    - [1.61.1 其他量子纠错码 (QEC Codes)](#1611-其他量子纠错码-qec-codes)
    - [1.61.2 容错逻辑门 (Fault-Tolerant Logical Gates)](#1612-容错逻辑门-fault-tolerant-logical-gates)
  - [1.62 AI 对齐：内在对齐 vs. 外在对齐](#162-ai-对齐内在对齐-vs-外在对齐)
  - [1.63 组合拍卖：获胜者确定问题与算法](#163-组合拍卖获胜者确定问题与算法)
    - [1.63.1 获胜者确定问题 (Winner Determination Problem, WDP)](#1631-获胜者确定问题-winner-determination-problem-wdp)
    - [1.63.2 解决 WDP 的算法方法](#1632-解决-wdp-的算法方法)
  - [1.64 量子 LDPC 码：概览与示例](#164-量子-ldpc-码概览与示例)
    - [1.64.1 表示方法：Tanner 图 (Tanner Graph)](#1641-表示方法tanner-图-tanner-graph)
    - [1.64.2 CSS 构造 (Calderbank-Shor-Steane Construction)](#1642-css-构造-calderbank-shor-steane-construction)
    - [1.64.3 QLDPC 码的参数与性能](#1643-qldpc-码的参数与性能)
    - [1.64.4 示例与研究方向](#1644-示例与研究方向)
    - [1.64.5 解码 (Decoding)](#1645-解码-decoding)
  - [1.65 AI 对齐：可解释性技术概览](#165-ai-对齐可解释性技术概览)
  - [1.66 迭代式组合拍卖：同步上升式拍卖 (SAA)](#166-迭代式组合拍卖同步上升式拍卖-saa)
    - [1.66.1 核心特点](#1661-核心特点)
    - [1.66.2 基本流程](#1662-基本流程)
    - [1.66.3 优势](#1663-优势)
    - [1.66.4 劣势与挑战](#1664-劣势与挑战)
  - [1.67 计算热力学与可逆计算](#167-计算热力学与可逆计算)
  - [1.68 计算认知科学与意识模型](#168-计算认知科学与意识模型)
  - [1.69 算法公平性与偏见](#169-算法公平性与偏见)
  - [1.70 计算热力学：超越兰道尔极限与麦克斯韦妖](#170-计算热力学超越兰道尔极限与麦克斯韦妖)
  - [1.71 计算认知科学：心智建模的层次与挑战](#171-计算认知科学心智建模的层次与挑战)
  - [1.72 算法公平性：定义的冲突与实践的困境](#172-算法公平性定义的冲突与实践的困境)
  - [1.73 计算热力学：量子不确定性与信息引擎的未来](#173-计算热力学量子不确定性与信息引擎的未来)
  - [1.74 计算认知科学：具身认知、神经符号主义与人工通用智能的联系](#174-计算认知科学具身认知神经符号主义与人工通用智能的联系)
  - [1.75 算法公平性：因果推断、交叉性与公平性的情境化理解](#175-算法公平性因果推断交叉性与公平性的情境化理解)
  - [1.76 计算热力学：量子点信息引擎模型](#176-计算热力学量子点信息引擎模型)
    - [1.76.1 单电子量子点信息引擎](#1761-单电子量子点信息引擎)
    - [1.76.2 简化工作循环 (类比西拉德引擎)](#1762-简化工作循环-类比西拉德引擎)
    - [1.76.3 量子效应的潜在作用](#1763-量子效应的潜在作用)
    - [1.76.4 实际挑战与意义](#1764-实际挑战与意义)
  - [1.77 计算认知科学：差分可编程神经计算机 (Differentiable Neural Computer, DNC)](#177-计算认知科学差分可编程神经计算机-differentiable-neural-computer-dnc)
    - [1.77.1 核心组件与机制](#1771-核心组件与机制)
    - [1.77.2 能力与应用](#1772-能力与应用)
    - [1.77.3 优势与局限性](#1773-优势与局限性)
  - [1.78 算法公平性：COMPAS 争议与因果视角下的再犯风险评估](#178-算法公平性compas-争议与因果视角下的再犯风险评估)
    - [1.78.1 ProPublica 的调查与核心争议](#1781-propublica-的调查与核心争议)
    - [1.78.2 公平性定义的冲突](#1782-公平性定义的冲突)
    - [1.78.3 因果视角下的分析](#1783-因果视角下的分析)
    - [1.78.4 结论与启示](#1784-结论与启示)
  - [1.79 DNC 与 Transformer 在记忆机制上的对比](#179-dnc-与-transformer-在记忆机制上的对比)
    - [1.79.1 Differentiable Neural Computer (DNC) 的记忆机制](#1791-differentiable-neural-computer-dnc-的记忆机制)
    - [1.79.2 Transformer 的记忆机制 (主要通过自注意力 Self-Attention)](#1792-transformer-的记忆机制-主要通过自注意力-self-attention)
    - [1.79.3 对比总结](#1793-对比总结)
  - [1.80 COMPAS 案例中具体的因果图构建尝试](#180-compas-案例中具体的因果图构建尝试)
    - [1.80.1 确定关键变量 (Nodes in the DAG)](#1801-确定关键变量-nodes-in-the-dag)
    - [1.80.2 假设因果关系 (Edges in the DAG)](#1802-假设因果关系-edges-in-the-dag)
    - [1.80.3 示例性简化 DAG (部分路径)](#1803-示例性简化-dag-部分路径)
    - [1.80.4 使用因果图进行公平性分析](#1804-使用因果图进行公平性分析)
    - [1.80.5 挑战](#1805-挑战)
  - [1.81 Transformer-XL 的记忆机制：片段级循环与相对位置编码](#181-transformer-xl-的记忆机制片段级循环与相对位置编码)
    - [1.81.1 片段级循环 (Segment-Level Recurrence)](#1811-片段级循环-segment-level-recurrence)
    - [1.81.2 相对位置编码 (Relative Positional Encoding)](#1812-相对位置编码-relative-positional-encoding)
    - [1.81.3 Transformer-XL 记忆机制总结](#1813-transformer-xl-记忆机制总结)
  - [1.82 COMPAS 案例中关于标签偏见的具体研究](#182-compas-案例中关于标签偏见的具体研究)
    - [1.82.1 关键研究问题与发现](#1821-关键研究问题与发现)
    - [1.82.2 结论与影响](#1822-结论与影响)
  - [1.83 人工生命 (ALife)：模拟生命、进化与涌现](#183-人工生命-alife模拟生命进化与涌现)
  - [1.84 去中心化系统与共识机制：信任的算法化](#184-去中心化系统与共识机制信任的算法化)
  - [1.85 计算创造力：算法的艺术与科学发现](#185-计算创造力算法的艺术与科学发现)
  - [1.86 人工生命 (ALife)：开放式进化 (OEE) 的挑战](#186-人工生命-alife开放式进化-oee-的挑战)
  - [1.87 去中心化系统：Layer 2 扩容方案 - Rollups](#187-去中心化系统layer-2-扩容方案---rollups)
  - [1.88 计算创造力：意图、作者身份与评估框架](#188-计算创造力意图作者身份与评估框架)
...
## 1.3 递归论 (Recursion Theory / Computability Theory)
...
### 1.16.2 非经典逻辑 (Non-Classical Logics)
...
### 1.16.3 范畴逻辑 (Categorical Logic) / 范畴论与逻辑 (Category Theory and Logic)
...
## 1.17 Curry-Howard 同构：证明、程序与类型的统一
...
### 1.31.2 回答集编程 (Answer Set Programming, ASP)
...
## 1.37 描述逻辑 (DL) 推理：表算法 (Tableau Algorithm) 详解
...
- **算法过程（以 ALC 为例，检查概念 C₀ 的可满足性）**：
    ...
    2. **扩展规则应用**：反复应用以下扩展规则，直到没有规则可以应用为止。这些规则将概念的要求“向下”传递给节点及其邻居。
        - **与规则 (⊓-rule)**：如果 `(C ⊓ D) ∈ L(x)` 且 `{C, D}` 不都已经在 `L(x)` 中，则将 `C` 和 `D` 都加入 `L(x)`。
            - _例如：如果 L(x) = {Man ⊓ Rich, ...}，则更新为 L(x) = {Man ⊓ Rich, Man, Rich, ...}_
        - **或规则 (⊔-rule)**：如果 `(C ⊔ D) ∈ L(x)` 且 `{C, D}` 中没有一个在 `L(x)` 中，则算法必须**非确定性地**选择：
            - (分支 1) 将 `C` 加入 `L(x)`。
            - (分支 2) 将 `D` 加入 `L(x)`。
            算法需要探索这两个分支。如果任何一个分支最终能成功构建模型（没有遇到矛盾），则原始概念是可满足的。
            - _例如：如果 L(x) = {Doctor ⊔ Lawyer, ...}，则创建两个 tableau，一个 L(x) 中加入 Doctor，另一个加入 Lawyer。_
        - **存在规则 (∃-rule)**：如果 `(∃R.C) ∈ L(x)` 且**不存在**一个节点 `y` 使得边 `(x, y)` 标记为 `R` 并且 `C ∈ L(y)`，则：
            - 创建一个**新的节点** `y`。
            - 添加一条标记为 `R` 的边从 `x` 到 `y`。
            - 设置新节点的标签 `L(y) = {C}`。
            这确保了模型中存在一个满足条件的 R-后继。
            - _例如：如果 L(x) = {∃hasChild.Happy, ...}，并且 x 没有已知的 Happy 的 hasChild 后继，则创建新节点 y，边 (x, y) 标记 hasChild，L(y) = {Happy}。_
        - **全称规则 (∀-rule)**：如果 `(∀R.C) ∈ L(x)` 且存在一个节点 `y` 使得边 `(x, y)` 标记为 `R`，并且 `C ∉ L(y)`，则将 `C` 加入 `L(y)`。
            - _例如：如果 L(x) = {∀hasChild.Doctor, ...} 且存在边 (x, y) 标记 hasChild，则将 Doctor 加入 L(y)。_
...
## 1.39 AI 安全挑战：工具性趋同 (Instrumental Convergence)
...
## 1.40 概率逻辑与马尔可夫逻辑网络 (MLNs)：融合逻辑与概率
...
## 1.44 AI 安全：价值对齐的其他方法——AI 辩论 (Debate) 与迭代放大 (Iterated Amplification)

除了逆向强化学习 (IRL)，AI 安全研究者还提出了其他旨在实现价值对齐或增强 AI 系统安全性的方法，
其中 AI 辩论和迭代放大是两种有前景的思路。

### 1.44.1 AI 辩论 (AI Debate)
...
### 1.44.2 迭代放大 (Iterated Amplification) / 迭代蒸馏与放大 (Iterated Distillation and Amplification, IDA)
...
## 1.47 AI 安全：规范博弈 (Specification Gaming) 的实例与教训
...
## 1.48 计算复杂性谱系：PSPACE, EXPTIME 及更高
...
## 1.50 AI 安全：可中断性 (Interruptibility) 与可控性 (Controllability)
...
### 1.53.2 规范可学习性 (Specification Learnability)
...
## 1.55 量子算法示例：Deutsch-Jozsa 与 Simon 算法
...
## 1.57 计算社会选择理论 (ComSoc)：算法视角下的集体决策
...
## 1.59 AI 对齐：可扩展监督 (Scalable Oversight)
...
### 1.61.2 容错逻辑门 (Fault-Tolerant Logical Gates)
...
1. **外在对齐 (Outer Alignment): 对齐目标函数**
    ...
    - **失败场景 (外在不对齐)**：
        - **规范博弈 (Specification Gaming)**：AI 精确地优化了我们给定的目标函数，但其实现方式却违反了我们的隐含期望或常识，导致不良后果（例如，清洁机器人为了最大化“清理垃圾量”奖励而打翻垃圾桶制造更多垃圾；或者前面提到的回形针最大化器）。我们写下的目标 _字面上_ 被满足了，但 _精神上_ 完全错了。
...
### 1.63.1 获胜者确定问题 (Winner Determination Problem, WDP)
...
### 1.64.1 表示方法：Tanner 图 (Tanner Graph)
...
### 1.64.2 CSS 构造 (Calderbank-Shor-Steane Construction)
...
## 1.74 计算认知科学：具身认知、神经符号主义与人工通用智能的联系
...
## 1.77 计算认知科学：差分可编程神经计算机 (Differentiable Neural Computer, DNC)
...
## 1.78 算法公平性：COMPAS 争议与因果视角下的再犯风险评估
...
3. **反事实公平性的思考**：
    - 一个关键问题是：“如果一个非裔美国人被告在所有其他方面（犯罪史、年龄、教育等，_假设这些因素本身是公平的衡量标准_）都与一个白人被告相同，COMPAS 会给他们不同的风险评分吗？” 或者更进一步，“如果这个非裔美国人被告_反事实地_是白人（其他所有导致他犯罪倾向的因素不变），他的风险评分会改变吗？”
...
### 1.79.2 Transformer 的记忆机制 (主要通过自注意力 Self-Attention)
...
### 1.80.1 确定关键变量 (Nodes in the DAG)
...
### 1.80.2 假设因果关系 (Edges in the DAG)
...
## 1.81 Transformer-XL 的记忆机制：片段级循环与相对位置编码
...
### 1.81.1 片段级循环 (Segment-Level Recurrence)
...
### 1.81.2 相对位置编码 (Relative Positional Encoding)
...
## 1.87 去中心化系统：Layer 2 扩容方案 - Rollups

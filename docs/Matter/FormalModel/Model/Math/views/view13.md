# 1. 数学逻辑中的形式模型：定义、解释、示例与元理论分析

## 目录

- [1. 数学逻辑中的形式模型：定义、解释、示例与元理论分析](#1-数学逻辑中的形式模型定义解释示例与元理论分析)
  - [目录](#目录)
  - [1.1 思维导图 (文本形式)](#11-思维导图-文本形式)
  - [1.2 引言：数学逻辑的魅力](#12-引言数学逻辑的魅力)
  - [1.3 数理逻辑的主要分支与形式模型](#13-数理逻辑的主要分支与形式模型)
    - [1.3.1 模型论 (Model Theory)](#131-模型论-model-theory)
      - [1.3.1.1 模型的定义](#1311-模型的定义)
      - [1.3.1.2 解释与意义](#1312-解释与意义)
      - [1.3.1.3 典型示例](#1313-典型示例)
      - [1.3.1.4 元模型视角：定理与概念](#1314-元模型视角定理与概念)
    - [1.3.2 递归论 (Recursion Theory) / 可计算性理论 (Computability Theory)](#132-递归论-recursion-theory--可计算性理论-computability-theory)
      - [1.3.2.1 可计算函数与计算模型的定义](#1321-可计算函数与计算模型的定义)
      - [1.3.2.2 解释与意义](#1322-解释与意义)
      - [1.3.2.3 典型示例](#1323-典型示例)
      - [1.3.2.4 元理论视角：论题与不可判定性](#1324-元理论视角论题与不可判定性)
    - [1.3.3 证明论 (Proof Theory)](#133-证明论-proof-theory)
      - [1.3.3.1 形式证明与证明系统的定义](#1331-形式证明与证明系统的定义)
      - [1.3.3.2 解释与意义](#1332-解释与意义)
      - [1.3.3.3 典型示例](#1333-典型示例)
      - [1.3.3.4 元理论视角：哥德尔不完备性定理](#1334-元理论视角哥德尔不完备性定理)
    - [1.3.4 集合论 (Set Theory) 作为基础](#134-集合论-set-theory-作为基础)
      - [1.3.4.1 基本概念](#1341-基本概念)
      - [1.3.4.2 公理化集合论 (例如 ZFC)](#1342-公理化集合论-例如-zfc)
      - [1.3.4.3 作为其他理论模型的角色](#1343-作为其他理论模型的角色)
  - [1.4 模型间的关联性分析](#14-模型间的关联性分析)
    - [1.4.1 层次结构分析](#141-层次结构分析)
      - [1.4.1.1 不同抽象层次的模型](#1411-不同抽象层次的模型)
      - [1.4.1.2 层次间的关联](#1412-层次间的关联)
    - [1.4.2 同层模型分析](#142-同层模型分析)
      - [1.4.2.1 各分支内部不同模型间的关系](#1421-各分支内部不同模型间的关系)
      - [1.4.2.2 不同分支同层面模型的比较](#1422-不同分支同层面模型的比较)
  - [1.5 元模型、论证与拓展](#15-元模型论证与拓展)
    - [1.5.1 元模型的概念](#151-元模型的概念)
    - [1.5.2 模型的论证与证明](#152-模型的论证与证明)
    - [1.5.3 模型的拓展与局限性](#153-模型的拓展与局限性)
  - [1.6 视角切换与论证方法 (避免辩证法)](#16-视角切换与论证方法-避免辩证法)
    - [1.6.1 直接展开与充分论证](#161-直接展开与充分论证)
    - [1.6.2 结构化分析与多角度审视](#162-结构化分析与多角度审视)
  - [1.7 总结](#17-总结)
...
### 1.3.2 递归论 (Recursion Theory) / 可计算性理论 (Computability Theory)

递归论研究的是“可计算性”或“算法性”的本质，即哪些函数是可以用算法计算的，哪些问题是可以用算法解决的。

#### 1.3.2.1 可计算函数与计算模型的定义

...
- [人脑认知结构、现实与数学的综合分析框架](#人脑认知结构现实与数学的综合分析框架)
  ...
  - [9 附录](#9-附录)
    - [1 A. 主要数学理论分支与典型模型表 | Main Branches of Mathematical Theory and Typical Models](#1-a-主要数学理论分支与典型模型表-main-branches-of-mathematical-theory-and-typical-models)
      - [1 A.1 **表格说明 | Table Explanation**](#1-a1-表格说明-table-explanation)
      - [2 A.2 **本节小结 | Section Summary**](#2-a2-本节小结-section-summary)
    - [9.2 B. 认知科学常用实验方法简表 | Common Experimental Methods in Cognitive Science](#92-b-认知科学常用实验方法简表-common-experimental-methods-in-cognitive-science)
      - [1 B.1 **表格说明 | Table Explanation**](#1-b1-表格说明-table-explanation)
      - [2 B.2 **本节小结 | Section Summary**](#2-b2-本节小结-section-summary)
    - [9.3 C. 主要术语表 | Glossary of Key Terms](#93-c-主要术语表-glossary-of-key-terms)
      - [1 C.1 **表格说明 | Table Explanation**](#1-c1-表格说明-table-explanation)
      - [2 c.2 **本节小结 | Section Summary**](#2-c2-本节小结-section-summary)
    - [9.4 D. 研究工具与数据资源清单 | List of Research Tools and Data Resources](#94-d-研究工具与数据资源清单-list-of-research-tools-and-data-resources)
      - [1 D.1 **内容说明 | Content Explanation**](#1-d1-内容说明-content-explanation)
      - [2 D.2 **本节小结 | Section Summary**](#2-d2-本节小结-section-summary)
    - [9.5 E. 相关数学符号与定义 | Mathematical Symbols and Definitions](#95-e-相关数学符号与定义-mathematical-symbols-and-definitions)
      - [1 E.1 **表格说明 | Table Explanation**](#1-e1-表格说明-table-explanation)
      - [2 E.2 **本节小结 | Section Summary**](#2-e2-本节小结-section-summary)
  - [10 索引](#10-索引)
    - [1 索引结构示意 | Index Structure Diagram](#1-索引结构示意-index-structure-diagram)
  - [11 致谢 | Acknowledgements](#11-致谢-acknowledgements)

...
- [1. 数学逻辑及其扩展](#数学逻辑及其扩展)
  - [1.1 零、引言与概述 (由助手添加)](#1-零引言与概述-由助手添加)
  - [1.2 一、数理逻辑基础](#2-一数理逻辑基础)
    - [1.2.1 数理逻辑概述](#21-数理逻辑概述)
    - [1.2.2 模型论 (Model Theory)](#22-模型论-model-theory)
      - [1.2.2.1 核心概念：形式语言与结构](#221-核心概念形式语言与结构)
      - [1.2.2.2 定义：模型与满足 (Satisfaction)](#222-定义模型与满足-satisfaction)
      - [1.2.2.3 解释与示例](#223-解释与示例)
      - [1.2.2.4 元理论与主要定理](#224-元理论与主要定理)
        - [1.2.2.4.1 可靠性定理 (Soundness Theorem)**](#2241-可靠性定理-soundness-theorem)
        - [1.2.2.4.2 哥德尔完备性定理 (Gödel's Completeness Theorem, 1929)](#2242-哥德尔完备性定理-godels-completeness-theorem-1929)
        - [1.2.2.4.3 紧致性定理 (Compactness Theorem)](#2243-紧致性定理-compactness-theorem)
        - [1.2.2.4.4 Löwenheim-Skolem 定理 (Löwenheim-Skolem Theorem)](#2244-lowenheim-skolem-定理-lowenheim-skolem-theorem)
      - [1.2.2.5 拓展与分支](#225-拓展与分支)
    - [1.2.3 递归论 (Recursion Theory / Computability Theory)](#23-递归论-recursion-theory-computability-theory)
      - [1.2.3.1 核心概念：算法与可计算性](#231-核心概念算法与可计算性)
      - [1.2.3.2 形式模型 (Equivalent Models of Computation)](#232-形式模型-equivalent-models-of-computation)
        - [1.2.3.2.1 图灵机 (Turing Machine)](#2321-图灵机-turing-machine)
        - [1.2.3.2.2 lambda-演算 (Lambda Calculus)](#2322-lambda-演算-lambda-calculus)
        - [1.2.3.2.3 (通用/原始)递归函数](#2323-通用原始递归函数)
      - [1.2.3.3 元理论与主要成果](#233-元理论与主要成果)
        - [1.2.3.3.1 丘奇-图灵论题 (Church-Turing Thesis)](#2331-丘奇-图灵论题-church-turing-thesis)
        - [1.2.3.3.2 不可判定性 (Undecidability)](#2332-不可判定性-undecidability)
      - [1.2.3.4 拓展](#234-拓展)
    - [1.2.4 证明论 (Proof Theory)](#24-证明论-proof-theory)
      - [1.2.4.1 核心概念：形式证明系统 (Formal Proof System)**](#241-核心概念形式证明系统-formal-proof-system)
      - [1.2.4.2 形式模型 (Different Proof Calculus Styles)](#242-形式模型-different-proof-calculus-styles)
        - [1.2.4.2.1 希尔伯特系统 (Hilbert Systems / Axiomatic Systems)](#2421-希尔伯特系统-hilbert-systems-axiomatic-systems)
        - [1.2.4.2.2 自然演绎 (Natural Deduction)** (Gentzen, Prawitz)](#2422-自然演绎-natural-deduction-gentzen-prawitz)
        - [1.2.4.2.3 相继式演算 (Sequent Calculus)** (Gentzen)](#2423-相继式演算-sequent-calculus-gentzen)
      - [1.2.4.3 元理论与主要成果](#243-元理论与主要成果)
        - [1.2.4.3.1 一致性证明 (Consistency Proofs)](#2431-一致性证明-consistency-proofs)
        - [1.2.4.3.2 哥德尔不完备定理 (Gödel's Incompleteness Theorems, 1931)](#2432-哥德尔不完备定理-godels-incompleteness-theorems-1931)
      - [1.2.4.4 拓展](#244-拓展)
    - [1.2.5 逻辑分支间的关联性](#25-逻辑分支间的关联性)
      - [1.2.5.1 语法 (Syntax) - 语义 (Semantics) - 计算 (Computation) 的核心联系](#251-语法-syntax-语义-semantics-计算-computation-的核心联系)
      - [1.2.5.2 各分支内部的相互促进与应用](#252-各分支内部的相互促进与应用)
  - [1.3 二、逻辑的应用与现代发展](#3-二逻辑的应用与现代发展)
    - [1.3.1 逻辑在特定数学理论中的应用](#31-逻辑在特定数学理论中的应用)
      - [1.3.1.1 集合论 (Set Theory)](#311-集合论-set-theory)
      - [1.3.1.2 代数 (Algebra)](#312-代数-algebra)
    - [1.3.2 关键证明技巧及其哲学意涵](#32-关键证明技巧及其哲学意涵)
      - [1.3.2.1 对角线法 (Diagonalization)](#321-对角线法-diagonalization)
      - [1.3.2.2 超乘积 (Ultraproducts)](#322-超乘积-ultraproducts)
      - [1.3.2.3 切消定理 (Cut-Elimination Theorem)-(Gentzen)](#323-切消定理-cut-elimination-theorem-gentzen)
    - [1.3.3 现代逻辑分支](#33-现代逻辑分支)
    - [1.3.4 数学基础的新探索](#34-数学基础的新探索)
  - [1.4 三、逻辑与计算理论](#4-三逻辑与计算理论)
    - [1.4.1 计算理论的核心交叉](#41-计算理论的核心交叉)
    - [1.4.2 计算的可行性边界](#42-计算的可行性边界)
    - [1.4.3 计算复杂性理论 (Computational Complexity Theory)](#43-计算复杂性理论-computational-complexity-theory)
    - [1.4.4 量子计算与量子信息 (Quantum Computing and Quantum Information)](#44-量子计算与量子信息-quantum-computing-and-quantum-information)
      - [1.4.4.1 量子计算对经典复杂性类的影响](#441-量子计算对经典复杂性类的影响)
      - [1.4.4.2 量子算法示例 (除了Shor和Grover)](#442-量子算法示例-除了shor和grover)
      - [1.4.4.3 量子信息论基础 (Fundamentals of Quantum Information Theory)](#443-量子信息论基础-fundamentals-of-quantum-information-theory)
        - [1.4.4.3.1 量子比特 (Qubit)](#4431-量子比特-qubit)
        - [1.4.4.3.2 叠加 (Superposition)](#4432-叠加-superposition)
        - [1.4.4.3.3 量子门 (Quantum Gates)](#4433-量子门-quantum-gates)
        - [1.4.4.3.4 测量 (Measurement)](#4434-测量-measurement)
        - [1.4.4.3.5 纠缠 (Entanglement)](#4435-纠缠-entanglement)
        - [1.4.4.3.6 不可克隆定理 (No-Cloning Theorem)](#4436-不可克隆定理-no-cloning-theorem)
      - [1.4.4.4 量子纠错 (Quantum Error Correction, QEC)](#444-量子纠错-quantum-error-correction-qec)
        - [1.4.4.4.1 Shor 码 (Shor Code)](#4441-shor-码-shor-code)
        - [1.4.4.4.2 Steane 码 (Steane Code)](#4442-steane-码-steane-code)
        - [1.4.4.4.3 稳定子码 (Stabilizer Codes / CSS Codes)](#4443-稳定子码-stabilizer-codes-css-codes)
        - [1.4.4.4.4 **表面码 (Surface Codes)** 和 **拓扑码 (Topological Codes)**](#4444-表面码-surface-codes-和-拓扑码-topological-codes)
        - [1.4.4.4.5 量子LDPC码 (Quantum Low-Density Parity-Check Codes)](#4445-量子ldpc码-quantum-low-density-parity-check-codes)
      - [1.4.4.5 容错量子计算 (Fault-Tolerant Quantum Computation)](#445-容错量子计算-fault-tolerant-quantum-computation)
    - [1.4.5 计算的物理基础：计算热力学 (Physical Basis of Computation: Thermodynamics of Computation)](#45-计算的物理基础计算热力学-physical-basis-of-computation-thermodynamics-of-computation)
      - [1.4.5.1 兰道尔原理 (Landauer's Principle)** (Rolf Landauer, 1961)](#451-兰道尔原理-landauers-principle-rolf-landauer-1961)
      - [1.4.5.2 可逆计算 (Reversible Computation)](#452-可逆计算-reversible-computation)
      - [1.4.5.3 麦克斯韦妖与信息熵 (Maxwell's Demon and Information Entropy)](#453-麦克斯韦妖与信息熵-maxwells-demon-and-information-entropy)
      - [1.4.5.4 量子热力学 (Quantum Thermodynamics)](#454-量子热力学-quantum-thermodynamics)
      - [1.4.5.5 信息引擎 (Information Engines)](#455-信息引擎-information-engines)
  - [1.5 四、逻辑与人工智能 (AI)](#5-四逻辑与人工智能-ai)
    - [1.5.1 知识表示与推理 (Knowledge Representation and Reasoning, KRR)](#51-知识表示与推理-knowledge-representation-and-reasoning-krr)
      - [1.5.1.1 描述逻辑 (Description Logics, DLs)](#511-描述逻辑-description-logics-dls)
      - [1.5.1.2 非单调逻辑 (Non-Monotonic Logics)](#512-非单调逻辑-non-monotonic-logics)
      - [1.5.1.3 自动推理方法 (Automated Reasoning Methods)](#513-自动推理方法-automated-reasoning-methods)
    - [1.5.2 自动规划 (Automated Planning)](#52-自动规划-automated-planning)
    - [1.5.3 逻辑与机器学习的交叉 (Intersection of Logic and Machine Learning)](#53-逻辑与机器学习的交叉-intersection-of-logic-and-machine-learning)
      - [1.5.3.1 逻辑与自然语言处理 (NLP) (Logic and Natural Language Processing)](#531-逻辑与自然语言处理-nlp-logic-and-natural-language-processing)
      - [1.5.3.2 逻辑与机器学习 (Logic and Machine Learning, general)](#532-逻辑与机器学习-logic-and-machine-learning-general)
        - [1.5.3.2.1 归纳逻辑编程 (Inductive Logic Programming, ILP)](#5321-归纳逻辑编程-inductive-logic-programming-ilp)
        - [1.5.3.2.2 可解释AI (Explainable AI, XAI) 中的逻辑](#5322-可解释ai-explainable-ai-xai-中的逻辑)
      - [1.5.3.3 概率逻辑与马尔可夫逻辑网络 (Probabilistic Logics and Markov Logic Networks, MLNs)](#533-概率逻辑与马尔可夫逻辑网络-probabilistic-logics-and-markov-logic-networks-mlns)
      - [1.5.3.4 神经符号方法 (Neuro-Symbolic Approaches / Neural Symbolic Computing)](#534-神经符号方法-neuro-symbolic-approaches-neural-symbolic-computing)
    - [1.5.4 AI 安全、伦理与对齐 (AI Safety, Ethics, and Alignment)](#54-ai-安全伦理与对齐-ai-safety-ethics-and-alignment)
      - [1.5.4.1 核心挑战 (Core Challenges in AI Safety and Alignment)](#541-核心挑战-core-challenges-in-ai-safety-and-alignment)
        - [1.5.4.1.1 工具性趋同 (Instrumental Convergence)** (Nick Bostrom, Steve Omohundro)](#5411-工具性趋同-instrumental-convergence-nick-bostrom-steve-omohundro)
        - [1.5.4.1.2 规范博弈论 (Normative Game Theory) 与价值规范 (Value Specification)](#5412-规范博弈论-normative-game-theory-与价值规范-value-specification)
        - [1.5.4.1.3 对齐税 (Alignment Tax)](#5413-对齐税-alignment-tax)
        - [1.5.4.1.4 内外在对齐 (Inner and Outer Alignment)](#5414-内外在对齐-inner-and-outer-alignment)
        - [1.5.4.1.5 可扩展的监督 (Scalable Oversight)**](#5415-可扩展的监督-scalable-oversight)
      - [1.5.4.2 价值对齐方法 (Methods for Value Alignment)](#542-价值对齐方法-methods-for-value-alignment)
        - [1.5.4.2.1 从人类反馈中学习 (Learning from Human Feedback)](#5421-从人类反馈中学习-learning-from-human-feedback)
        - [1.5.4.2.2 AI 辩论 (AI Debate)** (OpenAI, Paul Christiano)](#5422-ai-辩论-ai-debate-openai-paul-christiano)
        - [1.5.4.2.3 迭代放大 (Iterated Amplification / Iterated Distillation and Amplification, IDA)-(Paul Christiano, DeepMind)](#5423-迭代放大-iterated-amplification-iterated-distillation-and-amplification-ida-paul-christiano-deepmind)
        - [1.5.4.2.4 可扩展监督的其他方法](#5424-可扩展监督的其他方法)
    - [1.5.5 计算认知科学与AI (Computational Cognitive Science and AI)](#55-计算认知科学与ai-computational-cognitive-science-and-ai)
      - [1.5.5.1 心智的计算模型 (Computational Models of Mind)](#551-心智的计算模型-computational-models-of-mind)
      - [1.5.5.2 认知架构 (Cognitive Architectures)](#552-认知架构-cognitive-architectures)
  - [1.6 五、算法的社会维度 (Social Dimensions of Algorithms)](#6-五算法的社会维度-social-dimensions-of-algorithms)
    - [1.6.1 计算社会选择理论 (Computational Social Choice, ComSoc)](#61-计算社会选择理论-computational-social-choice-comsoc)
      - [1.6.1.1 核心问题与研究领域](#611-核心问题与研究领域)
      - [1.6.1.2 逻辑与形式化方法的作用](#612-逻辑与形式化方法的作用)
    - [1.6.2 计算拍卖理论与机制设计 (Computational Auction Theory and Mechanism Design)](#62-计算拍卖理论与机制设计-computational-auction-theory-and-mechanism-design)
      - [1.6.2.1 机制设计的基本概念](#621-机制设计的基本概念)
      - [1.6.2.2 著名的拍卖机制](#622-著名的拍卖机制)
      - [1.6.2.3 计算方面的挑战与研究](#623-计算方面的挑战与研究)
      - [1.6.2.4 应用领域](#624-应用领域)
    - [1.6.3 算法公平性与偏见 (Algorithmic Fairness and Bias)](#63-算法公平性与偏见-algorithmic-fairness-and-bias)
      - [1.6.3.1 偏见的来源 (Sources of Bias in Algorithmic Systems)](#631-偏见的来源-sources-of-bias-in-algorithmic-systems)
        - [1.6.3.1.1 数据偏见 (Data Bias)](#6311-数据偏见-data-bias)
        - [1.6.3.1.2 算法偏见 (Algorithmic Bias / Model Bias)](#6312-算法偏见-algorithmic-bias-model-bias)
        - [1.6.3.1.3 人机交互偏见 (Human-in-the-loop Bias)](#6313-人机交互偏见-human-in-the-loop-bias)
      - [1.6.3.2 公平性的定义与度量 (Definitions and Metrics of Fairness)](#632-公平性的定义与度量-definitions-and-metrics-of-fairness)
        - [1.6.3.2.1 反歧视 (Anti-Discrimination) / 独立性 (Independence / Demographic Parity)](#6321-反歧视-anti-discrimination-独立性-independence-demographic-parity)
        - [1.6.3.2.2 分离 (Separation) / 均等化机会 (Equalized Odds / Equal Opportunity)](#6322-分离-separation-均等化机会-equalized-odds-equal-opportunity)
        - [1.6.3.2.3 充分性 (Sufficiency) / 校准 (Calibration / Predictive Rate Parity)](#6323-充分性-sufficiency-校准-calibration-predictive-rate-parity)
      - [1.6.3.3 偏见缓解技术 (Bias Mitigation Techniques)](#633-偏见缓解技术-bias-mitigation-techniques)
        - [1.6.3.3.1 预处理技术 (Pre-processing)**：在训练模型之前修改数据](#6331-预处理技术-pre-processing在训练模型之前修改数据)
        - [1.6.3.3.2 在处理技术 (In-processing / In-training)**：在模型训练过程中修改算法](#6332-在处理技术-in-processing-in-training在模型训练过程中修改算法)
        - [1.6.3.3.3 后处理技术 (Post-processing)**：在模型训练完成后修改其输出](#6333-后处理技术-post-processing在模型训练完成后修改其输出)
      - [1.6.3.4 COMPAS 案例研究 (COMPAS Case Study)](#634-compas-案例研究-compas-case-study)
      - [1.6.3.5 逻辑、因果推断与公平性](#635-逻辑因果推断与公平性)
      - [1.6.3.6 算法透明度、可解释性与问责制**](#636-算法透明度可解释性与问责制)
  - [1.7 六、新兴计算与智能范式](#7-六新兴计算与智能范式)
    - [1.7.1 人工生命 (Artificial Life, ALife)](#71-人工生命-artificial-life-alife)
      - [1.7.1.1 核心目标与哲学基础](#711-核心目标与哲学基础)
      - [1.7.1.2 主要研究方法与模型](#712-主要研究方法与模型)
        - [1.7.1.2.1 细胞自动机 (Cellular Automata, CA)](#7121-细胞自动机-cellular-automata-ca)
        - [1.7.1.2.2 进化算法 (Evolutionary Algorithms, EA)](#7122-进化算法-evolutionary-algorithms-ea)
        - [1.7.1.2.3 人工神经网络 (Artificial Neural Networks, ANNs)](#7123-人工神经网络-artificial-neural-networks-anns)
        - [1.7.1.2.4 多智能体系统 (Multi-Agent Systems, MAS) 与群体智能 (Swarm Intelligence)](#7124-多智能体系统-multi-agent-systems-mas-与群体智能-swarm-intelligence)
        - [1.7.1.2.5 人工化学 (Artificial Chemistry, AChem)](#7125-人工化学-artificial-chemistry-achem)
        - [1.7.1.2.6 湿件 ALife (Wet ALife / Synthetic Biology)](#7126-湿件-alife-wet-alife-synthetic-biology)
      - [1.7.1.3 关键概念与现象](#713-关键概念与现象)
      - [1.7.1.4 开放式进化 (Open-Ended Evolution, OEE) 的挑战](#714-开放式进化-open-ended-evolution-oee-的挑战)
    - [1.7.2 去中心化系统与共识机制 (Decentralized Systems and Consensus Mechanisms)](#72-去中心化系统与共识机制-decentralized-systems-and-consensus-mechanisms)
      - [1.7.2.1 动机与目标](#721-动机与目标)
      - [1.7.2.2 核心挑战：拜占庭将军问题 (Byzantine Generals Problem)](#722-核心挑战拜占庭将军问题-byzantine-generals-problem)
      - [1.7.2.3 主要共识机制 (Major Consensus Mechanisms)](#723-主要共识机制-major-consensus-mechanisms)
        - [1.7.2.3.1 工作量证明 (Proof-of-Work, PoW)](#7231-工作量证明-proof-of-work-pow)
        - [1.7.2.3.2 权益证明 (Proof-of-Stake, PoS)](#7232-权益证明-proof-of-stake-pos)
        - [1.7.2.3.3 委托权益证明 (Delegated Proof-of-Stake, DPoS)](#7233-委托权益证明-delegated-proof-of-stake-dpos)
        - [1.7.2.3.4 实用拜占庭容错 (Practical Byzantine Fault Tolerance, PBFT)](#7234-实用拜占庭容错-practical-byzantine-fault-tolerance-pbft)
      - [1.7.2.4 区块链不可能三角 (Blockchain Trilemma)](#724-区块链不可能三角-blockchain-trilemma)
    - [1.7.3 计算创造力 (Computational Creativity, CC)](#73-计算创造力-computational-creativity-cc)
      - [1.7.3.1 定义与评估创造力](#731-定义与评估创造力)
      - [1.7.3.2 计算创造力的方法与技术](#732-计算创造力的方法与技术)
        - [1.7.3.2.1 生成式方法 (Generative Approaches)](#7321-生成式方法-generative-approaches)
        - [1.7.3.2.2 进化算法 (Evolutionary Algorithms, EA) 与遗传编程 (Genetic Programming, GP)](#7322-进化算法-evolutionary-algorithms-ea-与遗传编程-genetic-programming-gp)
        - [1.7.3.2.3 机器学习 (Machine Learning, ML)，尤其是深度学习 (Deep Learning)](#7323-机器学习-machine-learning-ml尤其是深度学习-deep-learning)
        - [1.7.3.2.4 概念混合与类比推理 (Conceptual Blending and Analogy-Making)](#7324-概念混合与类比推理-conceptual-blending-and-analogy-making)
        - [1.7.3.2.5 基于知识的系统 (Knowledge-Based Systems) 与逻辑推理](#7325-基于知识的系统-knowledge-based-systems-与逻辑推理)
        - [1.7.3.2.6 认知架构 (Cognitive Architectures)](#7326-认知架构-cognitive-architectures)
      - [1.7.3.3 应用领域](#733-应用领域)
      - [1.7.3.4 哲学、伦理与社会考量](#734-哲学伦理与社会考量)
  - [1.8 七、思维导图](#8-七思维导图)
## 1.1 零、引言与概述 (由助手添加)

...
- [1. 数学逻辑及其扩展](#1-数学逻辑及其扩展)
  - [目录](#目录)
  - [1.1 零、引言与概述 (由助手添加)](#11-零引言与概述-由助手添加)
  - [1.2 一、数理逻辑基础](#12-一数理逻辑基础)
    - [1.2.1 数理逻辑概述](#121-数理逻辑概述)
    - [1.2.2 模型论 (Model Theory)](#122-模型论-model-theory)
      - [1.2.2.1 核心概念：形式语言与结构](#1221-核心概念形式语言与结构)
      - [1.2.2.2 定义：模型与满足 (Satisfaction)](#1222-定义模型与满足-satisfaction)
      - [1.2.2.3 解释与示例](#1223-解释与示例)
      - [1.2.2.4 元理论与主要定理](#1224-元理论与主要定理)
        - [1.2.2.4.1 可靠性定理 (Soundness Theorem)\*\*](#12241-可靠性定理-soundness-theorem)
        - [1.2.2.4.2 哥德尔完备性定理 (Gödel's Completeness Theorem, 1929)](#12242-哥德尔完备性定理-gödels-completeness-theorem-1929)
        - [1.2.2.4.3 紧致性定理 (Compactness Theorem)](#12243-紧致性定理-compactness-theorem)
        - [1.2.2.4.4 Löwenheim-Skolem 定理 (Löwenheim-Skolem Theorem)](#12244-löwenheim-skolem-定理-löwenheim-skolem-theorem)
      - [1.2.2.5 拓展与分支](#1225-拓展与分支)
    - [1.2.3 递归论 (Recursion Theory / Computability Theory)](#123-递归论-recursion-theory--computability-theory)
      - [1.2.3.1 核心概念：算法与可计算性](#1231-核心概念算法与可计算性)
      - [1.2.3.2 形式模型 (Equivalent Models of Computation)](#1232-形式模型-equivalent-models-of-computation)
        - [1.2.3.2.1 图灵机 (Turing Machine)](#12321-图灵机-turing-machine)
        - [1.2.3.2.2 lambda-演算 (Lambda Calculus)](#12322-lambda-演算-lambda-calculus)
        - [1.2.3.2.3 (通用/原始)递归函数](#12323-通用原始递归函数)
      - [1.2.3.3 元理论与主要成果](#1233-元理论与主要成果)
        - [1.2.3.3.1 丘奇-图灵论题 (Church-Turing Thesis)](#12331-丘奇-图灵论题-church-turing-thesis)
        - [1.2.3.3.2 不可判定性 (Undecidability)](#12332-不可判定性-undecidability)
      - [1.2.3.4 拓展](#1234-拓展)
    - [1.2.4 证明论 (Proof Theory)](#124-证明论-proof-theory)
      - [1.2.4.1 核心概念：形式证明系统 (Formal Proof System)\*\*](#1241-核心概念形式证明系统-formal-proof-system)
      - [1.2.4.2 形式模型 (Different Proof Calculus Styles)](#1242-形式模型-different-proof-calculus-styles)
        - [1.2.4.2.1 希尔伯特系统 (Hilbert Systems / Axiomatic Systems)](#12421-希尔伯特系统-hilbert-systems--axiomatic-systems)
        - [1.2.4.2.2 自然演绎 (Natural Deduction)\*\* (Gentzen, Prawitz)](#12422-自然演绎-natural-deduction-gentzen-prawitz)
        - [1.2.4.2.3 相继式演算 (Sequent Calculus)\*\* (Gentzen)](#12423-相继式演算-sequent-calculus-gentzen)
      - [1.2.4.3 元理论与主要成果](#1243-元理论与主要成果)
        - [1.2.4.3.1 一致性证明 (Consistency Proofs)](#12431-一致性证明-consistency-proofs)
        - [1.2.4.3.2 哥德尔不完备定理 (Gödel's Incompleteness Theorems, 1931)](#12432-哥德尔不完备定理-gödels-incompleteness-theorems-1931)
      - [1.2.4.4 拓展](#1244-拓展)
    - [1.2.5 逻辑分支间的关联性](#125-逻辑分支间的关联性)
      - [1.2.5.1 语法 (Syntax) - 语义 (Semantics) - 计算 (Computation) 的核心联系](#1251-语法-syntax---语义-semantics---计算-computation-的核心联系)
      - [1.2.5.2 各分支内部的相互促进与应用](#1252-各分支内部的相互促进与应用)
  - [1.3 二、逻辑的应用与现代发展](#13-二逻辑的应用与现代发展)
    - [1.3.1 逻辑在特定数学理论中的应用](#131-逻辑在特定数学理论中的应用)
      - [1.3.1.1 集合论 (Set Theory)](#1311-集合论-set-theory)
      - [1.3.1.2 代数 (Algebra)](#1312-代数-algebra)
    - [1.3.2 关键证明技巧及其哲学意涵](#132-关键证明技巧及其哲学意涵)
      - [1.3.2.1 对角线法 (Diagonalization)](#1321-对角线法-diagonalization)
      - [1.3.2.2 超乘积 (Ultraproducts)](#1322-超乘积-ultraproducts)
      - [1.3.2.3 切消定理 (Cut-Elimination Theorem)-(Gentzen)](#1323-切消定理-cut-elimination-theorem-gentzen)
    - [1.3.3 现代逻辑分支](#133-现代逻辑分支)
    - [1.3.4 数学基础的新探索](#134-数学基础的新探索)
  - [1.4 三、逻辑与计算理论](#14-三逻辑与计算理论)
    - [1.4.1 计算理论的核心交叉](#141-计算理论的核心交叉)
    - [1.4.2 计算的可行性边界](#142-计算的可行性边界)
    - [1.4.3 计算复杂性理论 (Computational Complexity Theory)](#143-计算复杂性理论-computational-complexity-theory)
    - [1.4.4 量子计算与量子信息 (Quantum Computing and Quantum Information)](#144-量子计算与量子信息-quantum-computing-and-quantum-information)
      - [1.4.4.1 量子计算对经典复杂性类的影响](#1441-量子计算对经典复杂性类的影响)
      - [1.4.4.2 量子算法示例 (除了Shor和Grover)](#1442-量子算法示例-除了shor和grover)
      - [1.4.4.3 量子信息论基础 (Fundamentals of Quantum Information Theory)](#1443-量子信息论基础-fundamentals-of-quantum-information-theory)
        - [1.4.4.3.1 量子比特 (Qubit)](#14431-量子比特-qubit)
        - [1.4.4.3.2 叠加 (Superposition)](#14432-叠加-superposition)
        - [1.4.4.3.3 量子门 (Quantum Gates)](#14433-量子门-quantum-gates)
        - [1.4.4.3.4 测量 (Measurement)](#14434-测量-measurement)
        - [1.4.4.3.5 纠缠 (Entanglement)](#14435-纠缠-entanglement)
        - [1.4.4.3.6 不可克隆定理 (No-Cloning Theorem)](#14436-不可克隆定理-no-cloning-theorem)
      - [1.4.4.4 量子纠错 (Quantum Error Correction, QEC)](#1444-量子纠错-quantum-error-correction-qec)
        - [1.4.4.4.1 Shor 码 (Shor Code)](#14441-shor-码-shor-code)
        - [1.4.4.4.2 Steane 码 (Steane Code)](#14442-steane-码-steane-code)
        - [1.4.4.4.3 稳定子码 (Stabilizer Codes / CSS Codes)](#14443-稳定子码-stabilizer-codes--css-codes)
        - [1.4.4.4.4 **表面码 (Surface Codes)** 和 **拓扑码 (Topological Codes)**](#14444-表面码-surface-codes-和-拓扑码-topological-codes)
        - [1.4.4.4.5 量子LDPC码 (Quantum Low-Density Parity-Check Codes)](#14445-量子ldpc码-quantum-low-density-parity-check-codes)
      - [1.4.4.5 容错量子计算 (Fault-Tolerant Quantum Computation)](#1445-容错量子计算-fault-tolerant-quantum-computation)
    - [1.4.5 计算的物理基础：计算热力学 (Physical Basis of Computation: Thermodynamics of Computation)](#145-计算的物理基础计算热力学-physical-basis-of-computation-thermodynamics-of-computation)
      - [1.4.5.1 兰道尔原理 (Landauer's Principle)\*\* (Rolf Landauer, 1961)](#1451-兰道尔原理-landauers-principle-rolf-landauer-1961)
      - [1.4.5.2 可逆计算 (Reversible Computation)](#1452-可逆计算-reversible-computation)
      - [1.4.5.3 麦克斯韦妖与信息熵 (Maxwell's Demon and Information Entropy)](#1453-麦克斯韦妖与信息熵-maxwells-demon-and-information-entropy)
      - [1.4.5.4 量子热力学 (Quantum Thermodynamics)](#1454-量子热力学-quantum-thermodynamics)
      - [1.4.5.5 信息引擎 (Information Engines)](#1455-信息引擎-information-engines)
  - [1.5 四、逻辑与人工智能 (AI)](#15-四逻辑与人工智能-ai)
    - [1.5.1 知识表示与推理 (Knowledge Representation and Reasoning, KRR)](#151-知识表示与推理-knowledge-representation-and-reasoning-krr)
      - [1.5.1.1 描述逻辑 (Description Logics, DLs)](#1511-描述逻辑-description-logics-dls)
      - [1.5.1.2 非单调逻辑 (Non-Monotonic Logics)](#1512-非单调逻辑-non-monotonic-logics)
      - [1.5.1.3 自动推理方法 (Automated Reasoning Methods)](#1513-自动推理方法-automated-reasoning-methods)
    - [1.5.2 自动规划 (Automated Planning)](#152-自动规划-automated-planning)
    - [1.5.3 逻辑与机器学习的交叉 (Intersection of Logic and Machine Learning)](#153-逻辑与机器学习的交叉-intersection-of-logic-and-machine-learning)
      - [1.5.3.1 逻辑与自然语言处理 (NLP) (Logic and Natural Language Processing)](#1531-逻辑与自然语言处理-nlp-logic-and-natural-language-processing)
      - [1.5.3.2 逻辑与机器学习 (Logic and Machine Learning, general)](#1532-逻辑与机器学习-logic-and-machine-learning-general)
        - [1.5.3.2.1 归纳逻辑编程 (Inductive Logic Programming, ILP)](#15321-归纳逻辑编程-inductive-logic-programming-ilp)
        - [1.5.3.2.2 可解释AI (Explainable AI, XAI) 中的逻辑](#15322-可解释ai-explainable-ai-xai-中的逻辑)
      - [1.5.3.3 概率逻辑与马尔可夫逻辑网络 (Probabilistic Logics and Markov Logic Networks, MLNs)](#1533-概率逻辑与马尔可夫逻辑网络-probabilistic-logics-and-markov-logic-networks-mlns)
      - [1.5.3.4 神经符号方法 (Neuro-Symbolic Approaches / Neural Symbolic Computing)](#1534-神经符号方法-neuro-symbolic-approaches--neural-symbolic-computing)
    - [1.5.4 AI 安全、伦理与对齐 (AI Safety, Ethics, and Alignment)](#154-ai-安全伦理与对齐-ai-safety-ethics-and-alignment)
      - [1.5.4.1 核心挑战 (Core Challenges in AI Safety and Alignment)](#1541-核心挑战-core-challenges-in-ai-safety-and-alignment)
        - [1.5.4.1.1 工具性趋同 (Instrumental Convergence)\*\* (Nick Bostrom, Steve Omohundro)](#15411-工具性趋同-instrumental-convergence-nick-bostrom-steve-omohundro)
        - [1.5.4.1.2 规范博弈论 (Normative Game Theory) 与价值规范 (Value Specification)](#15412-规范博弈论-normative-game-theory-与价值规范-value-specification)
        - [1.5.4.1.3 对齐税 (Alignment Tax)](#15413-对齐税-alignment-tax)
        - [1.5.4.1.4 内外在对齐 (Inner and Outer Alignment)](#15414-内外在对齐-inner-and-outer-alignment)
        - [1.5.4.1.5 可扩展的监督 (Scalable Oversight)\*\*](#15415-可扩展的监督-scalable-oversight)
      - [1.5.4.2 价值对齐方法 (Methods for Value Alignment)](#1542-价值对齐方法-methods-for-value-alignment)
        - [1.5.4.2.1 从人类反馈中学习 (Learning from Human Feedback)](#15421-从人类反馈中学习-learning-from-human-feedback)
        - [1.5.4.2.2 AI 辩论 (AI Debate)\*\* (OpenAI, Paul Christiano)](#15422-ai-辩论-ai-debate-openai-paul-christiano)
        - [1.5.4.2.3 迭代放大 (Iterated Amplification / Iterated Distillation and Amplification, IDA)-(Paul Christiano, DeepMind)](#15423-迭代放大-iterated-amplification--iterated-distillation-and-amplification-ida-paul-christiano-deepmind)
        - [1.5.4.2.4 可扩展监督的其他方法](#15424-可扩展监督的其他方法)
    - [1.5.5 计算认知科学与AI (Computational Cognitive Science and AI)](#155-计算认知科学与ai-computational-cognitive-science-and-ai)
      - [1.5.5.1 心智的计算模型 (Computational Models of Mind)](#1551-心智的计算模型-computational-models-of-mind)
      - [1.5.5.2 认知架构 (Cognitive Architectures)](#1552-认知架构-cognitive-architectures)
  - [1.6 五、算法的社会维度 (Social Dimensions of Algorithms)](#16-五算法的社会维度-social-dimensions-of-algorithms)
    - [1.6.1 计算社会选择理论 (Computational Social Choice, ComSoc)](#161-计算社会选择理论-computational-social-choice-comsoc)
      - [1.6.1.1 核心问题与研究领域](#1611-核心问题与研究领域)
      - [1.6.1.2 逻辑与形式化方法的作用](#1612-逻辑与形式化方法的作用)
    - [1.6.2 计算拍卖理论与机制设计 (Computational Auction Theory and Mechanism Design)](#162-计算拍卖理论与机制设计-computational-auction-theory-and-mechanism-design)
      - [1.6.2.1 机制设计的基本概念](#1621-机制设计的基本概念)
      - [1.6.2.2 著名的拍卖机制](#1622-著名的拍卖机制)
      - [1.6.2.3 计算方面的挑战与研究](#1623-计算方面的挑战与研究)
      - [1.6.2.4 应用领域](#1624-应用领域)
    - [1.6.3 算法公平性与偏见 (Algorithmic Fairness and Bias)](#163-算法公平性与偏见-algorithmic-fairness-and-bias)
      - [1.6.3.1 偏见的来源 (Sources of Bias in Algorithmic Systems)](#1631-偏见的来源-sources-of-bias-in-algorithmic-systems)
        - [1.6.3.1.1 数据偏见 (Data Bias)](#16311-数据偏见-data-bias)
        - [1.6.3.1.2 算法偏见 (Algorithmic Bias / Model Bias)](#16312-算法偏见-algorithmic-bias--model-bias)
        - [1.6.3.1.3 人机交互偏见 (Human-in-the-loop Bias)](#16313-人机交互偏见-human-in-the-loop-bias)
      - [1.6.3.2 公平性的定义与度量 (Definitions and Metrics of Fairness)](#1632-公平性的定义与度量-definitions-and-metrics-of-fairness)
        - [1.6.3.2.1 反歧视 (Anti-Discrimination) / 独立性 (Independence / Demographic Parity)](#16321-反歧视-anti-discrimination--独立性-independence--demographic-parity)
        - [1.6.3.2.2 分离 (Separation) / 均等化机会 (Equalized Odds / Equal Opportunity)](#16322-分离-separation--均等化机会-equalized-odds--equal-opportunity)
        - [1.6.3.2.3 充分性 (Sufficiency) / 校准 (Calibration / Predictive Rate Parity)](#16323-充分性-sufficiency--校准-calibration--predictive-rate-parity)
      - [1.6.3.3 偏见缓解技术 (Bias Mitigation Techniques)](#1633-偏见缓解技术-bias-mitigation-techniques)
        - [1.6.3.3.1 预处理技术 (Pre-processing)\*\*：在训练模型之前修改数据](#16331-预处理技术-pre-processing在训练模型之前修改数据)
        - [1.6.3.3.2 在处理技术 (In-processing / In-training)\*\*：在模型训练过程中修改算法](#16332-在处理技术-in-processing--in-training在模型训练过程中修改算法)
        - [1.6.3.3.3 后处理技术 (Post-processing)\*\*：在模型训练完成后修改其输出](#16333-后处理技术-post-processing在模型训练完成后修改其输出)
      - [1.6.3.4 COMPAS 案例研究 (COMPAS Case Study)](#1634-compas-案例研究-compas-case-study)
      - [1.6.3.5 逻辑、因果推断与公平性](#1635-逻辑因果推断与公平性)
      - [1.6.3.6 算法透明度、可解释性与问责制\*\*](#1636-算法透明度可解释性与问责制)
  - [1.7 六、新兴计算与智能范式](#17-六新兴计算与智能范式)
    - [1.7.1 人工生命 (Artificial Life, ALife)](#171-人工生命-artificial-life-alife)
      - [1.7.1.1 核心目标与哲学基础](#1711-核心目标与哲学基础)
      - [1.7.1.2 主要研究方法与模型](#1712-主要研究方法与模型)
        - [1.7.1.2.1 细胞自动机 (Cellular Automata, CA)](#17121-细胞自动机-cellular-automata-ca)
        - [1.7.1.2.2 进化算法 (Evolutionary Algorithms, EA)](#17122-进化算法-evolutionary-algorithms-ea)
        - [1.7.1.2.3 人工神经网络 (Artificial Neural Networks, ANNs)](#17123-人工神经网络-artificial-neural-networks-anns)
        - [1.7.1.2.4 多智能体系统 (Multi-Agent Systems, MAS) 与群体智能 (Swarm Intelligence)](#17124-多智能体系统-multi-agent-systems-mas-与群体智能-swarm-intelligence)
        - [1.7.1.2.5 人工化学 (Artificial Chemistry, AChem)](#17125-人工化学-artificial-chemistry-achem)
        - [1.7.1.2.6 湿件 ALife (Wet ALife / Synthetic Biology)](#17126-湿件-alife-wet-alife--synthetic-biology)
      - [1.7.1.3 关键概念与现象](#1713-关键概念与现象)
      - [1.7.1.4 开放式进化 (Open-Ended Evolution, OEE) 的挑战](#1714-开放式进化-open-ended-evolution-oee-的挑战)
    - [1.7.2 去中心化系统与共识机制 (Decentralized Systems and Consensus Mechanisms)](#172-去中心化系统与共识机制-decentralized-systems-and-consensus-mechanisms)
      - [1.7.2.1 动机与目标](#1721-动机与目标)
      - [1.7.2.2 核心挑战：拜占庭将军问题 (Byzantine Generals Problem)](#1722-核心挑战拜占庭将军问题-byzantine-generals-problem)
      - [1.7.2.3 主要共识机制 (Major Consensus Mechanisms)](#1723-主要共识机制-major-consensus-mechanisms)
        - [1.7.2.3.1 工作量证明 (Proof-of-Work, PoW)](#17231-工作量证明-proof-of-work-pow)
        - [1.7.2.3.2 权益证明 (Proof-of-Stake, PoS)](#17232-权益证明-proof-of-stake-pos)
        - [1.7.2.3.3 委托权益证明 (Delegated Proof-of-Stake, DPoS)](#17233-委托权益证明-delegated-proof-of-stake-dpos)
        - [1.7.2.3.4 实用拜占庭容错 (Practical Byzantine Fault Tolerance, PBFT)](#17234-实用拜占庭容错-practical-byzantine-fault-tolerance-pbft)
      - [1.7.2.4 区块链不可能三角 (Blockchain Trilemma)](#1724-区块链不可能三角-blockchain-trilemma)
    - [1.7.3 计算创造力 (Computational Creativity, CC)](#173-计算创造力-computational-creativity-cc)
      - [1.7.3.1 定义与评估创造力](#1731-定义与评估创造力)
      - [1.7.3.2 计算创造力的方法与技术](#1732-计算创造力的方法与技术)
        - [1.7.3.2.1 生成式方法 (Generative Approaches)](#17321-生成式方法-generative-approaches)
        - [1.7.3.2.2 进化算法 (Evolutionary Algorithms, EA) 与遗传编程 (Genetic Programming, GP)](#17322-进化算法-evolutionary-algorithms-ea-与遗传编程-genetic-programming-gp)
        - [1.7.3.2.3 机器学习 (Machine Learning, ML)，尤其是深度学习 (Deep Learning)](#17323-机器学习-machine-learning-ml尤其是深度学习-deep-learning)
        - [1.7.3.2.4 概念混合与类比推理 (Conceptual Blending and Analogy-Making)](#17324-概念混合与类比推理-conceptual-blending-and-analogy-making)
        - [1.7.3.2.5 基于知识的系统 (Knowledge-Based Systems) 与逻辑推理](#17325-基于知识的系统-knowledge-based-systems-与逻辑推理)
        - [1.7.3.2.6 认知架构 (Cognitive Architectures)](#17326-认知架构-cognitive-architectures)
      - [1.7.3.3 应用领域](#1733-应用领域)
      - [1.7.3.4 哲学、伦理与社会考量](#1734-哲学伦理与社会考量)
  - [1.8 七、思维导图](#18-七思维导图)
...
- **形式语言 (Formal Language)** \(L\): 一个形式语言由其**字母表 (alphabet/signature)** \(\Sigma_L\) 和**形成规则 (formation rules)** 定义。
  ...
  - **形成规则**：
    ...
    - **公式 (Formulas / Well-formed Formulas, wffs)**：
                ...
                _(例如，\(\forall x \exists y (R(x,y) \rightarrow \neg(x=y))\) )_
...
##### 1.2.2.4.1 可靠性定理 (Soundness Theorem)**
...
##### 1.2.2.4.2 哥德尔完备性定理 (Gödel's Completeness Theorem, 1929)
...
##### 1.2.2.4.3 紧致性定理 (Compactness Theorem)
...
##### 1.2.2.4.4 Löwenheim-Skolem 定理 (Löwenheim-Skolem Theorem)
...
### 1.2.3 递归论 (Recursion Theory / Computability Theory)

递归论，现在更常称为可计算性理论，
研究**可计算性**的本质、范围和局限性，即哪些函数可以通过机械的、算法的过程来计算。

#### 1.2.3.1 核心概念：算法与可计算性
...
#### 1.2.3.2 形式模型 (Equivalent Models of Computation)

为了精确定义“算法”，数学家提出了多种等价的计算模型：

##### 1.2.3.2.1 图灵机 (Turing Machine)
...
##### 1.2.3.2.2 lambda-演算 (Lambda Calculus)
...
##### 1.2.3.3.1 丘奇-图灵论题 (Church-Turing Thesis)
...
##### 1.2.3.3.2 不可判定性 (Undecidability)
...
### 1.2.4 证明论 (Proof Theory)

证明论研究形式证明的结构、性质和强度。
它将证明本身作为数学对象进行分析。

#### 1.2.4.1 核心概念：形式证明系统 (Formal Proof System)**
...
##### 1.2.4.2.3 相继式演算 (Sequent Calculus)** (Gentzen)
...
##### 1.2.4.3.1 一致性证明 (Consistency Proofs)
...
##### 1.2.4.3.2 哥德尔不完备定理 (Gödel's Incompleteness Theorems, 1931)
...
#### 1.2.5.1 语法 (Syntax) - 语义 (Semantics) - 计算 (Computation) 的核心联系
...
#### 1.3.2.2 超乘积 (Ultraproducts)

- **构造**：
- 给定一个指标集 \(I\)，一个关于 \(I\) 的滤子 (filter) \(\mathcal{F}\)（在某些应用中是一个超滤子 \(\mathcal{U}\)），
- 以及一系列相同语言 \(L\) 的结构 \((\mathcal{M}_i)_{i \in I}\)。
...
#### 1.3.2.3 切消定理 (Cut-Elimination Theorem)-(Gentzen)
...
### 1.4.3 计算复杂性理论 (Computational Complexity Theory)
...
### 1.4.4 量子计算与量子信息 (Quantum Computing and Quantum Information)

量子计算是一种遵循量子力学原理进行运算的新型计算模式。它利用量子比特、叠加和纠缠等量子现象来执行计算，有望解决某些经典计算机难以处理的问题。

#### 1.4.4.1 量子计算对经典复杂性类的影响
...
#### 1.4.4.3 量子信息论基础 (Fundamentals of Quantum Information Theory)

##### 1.4.4.3.1 量子比特 (Qubit)
...
##### 1.4.4.3.6 不可克隆定理 (No-Cloning Theorem)

        不可能创建一个任意未知量子态的完美拷贝。这与经典信息可以被自由复制形成对比。

- **意义**：对量子信息处理和量子密码学的安全性有重要影响。

#### 1.4.4.4 量子纠错 (Quantum Error Correction, QEC)
...
##### 1.4.4.4.4 **表面码 (Surface Codes)** 和 **拓扑码 (Topological Codes)**
...
##### 1.4.4.4.5 量子LDPC码 (Quantum Low-Density Parity-Check Codes)

- 经典LDPC码的量子模拟，具有良好的码率和距离特性，是另一个活跃的研究方向。

#### 1.4.4.5 容错量子计算 (Fault-Tolerant Quantum Computation)
...
### 1.4.5 计算的物理基础：计算热力学 (Physical Basis of Computation: Thermodynamics of Computation)

计算热力学研究计算过程中的能量消耗和信息与熵之间的基本物理联系。它探讨了计算操作的物理极限，特别是与热力学第二定律相关的不可逆性和能量耗散问题。

#### 1.4.5.1 兰道尔原理 (Landauer's Principle)** (Rolf Landauer, 1961)
...
#### 1.4.5.2 可逆计算 (Reversible Computation)
...
#### 1.4.5.3 麦克斯韦妖与信息熵 (Maxwell's Demon and Information Entropy)
...
#### 1.4.5.4 量子热力学 (Quantum Thermodynamics)
...
#### 1.4.5.5 信息引擎 (Information Engines)
...
### 1.5.1 知识表示与推理 (Knowledge Representation and Reasoning, KRR)

KRR是AI的核心领域之一，致力于研究如何用形式化的方式表示关于世界的知识，并基于这些知识进行自动化的推理。

#### 1.5.1.1 描述逻辑 (Description Logics, DLs)
...
#### 1.5.1.2 非单调逻辑 (Non-Monotonic Logics)
...
#### 1.5.1.3 自动推理方法 (Automated Reasoning Methods)
...
- **规划算法**：
  ...
  - **2.1. SATPlan (Planning as Satisfiability)**：
    ...
    - **编码**：
      ...
      2. **公理化初始状态**：\(\text{InitState}_0 \equiv \bigwedge_{P \in \text{Initial}} P_0 \land \bigwedge_{P \notin \text{Initial}} \neg P_0\)。
      3. **公理化目标状态**：\(\text{Goal}_{T} \equiv \bigwedge_{P \in \text{Goal}} P_T\) (其中 \(T \le T_{max}\) 是实际计划长度)。
      4. **公理化动作执行**：
...
### 1.5.3 逻辑与机器学习的交叉 (Intersection of Logic and Machine Learning)

传统上，逻辑AI（符号主义）和机器学习（连接主义、统计学习）被视为AI的两种不同范式。
然而，近年来，越来越多的研究致力于结合两者的优势，以期构建更强大、更鲁棒、更可解释的AI系统。

#### 1.5.3.1 逻辑与自然语言处理 (NLP) (Logic and Natural Language Processing)
...
#### 1.5.3.2 逻辑与机器学习 (Logic and Machine Learning, general)

##### 1.5.3.2.1 归纳逻辑编程 (Inductive Logic Programming, ILP)
...
##### 1.5.3.2.2 可解释AI (Explainable AI, XAI) 中的逻辑
...
#### 1.5.3.3 概率逻辑与马尔可夫逻辑网络 (Probabilistic Logics and Markov Logic Networks, MLNs)
...
#### 1.5.3.4 神经符号方法 (Neuro-Symbolic Approaches / Neural Symbolic Computing)
...
### 1.5.4 AI 安全、伦理与对齐 (AI Safety, Ethics, and Alignment)

随着AI系统能力的不断增强，确保其行为安全、符合伦理规范并与人类意图和价值观对齐变得至关重要。
逻辑可以在形式化这些概念、分析潜在风险以及设计更安全的AI系统中发挥作用。

#### 1.5.4.1 核心挑战 (Core Challenges in AI Safety and Alignment)

##### 1.5.4.1.1 工具性趋同 (Instrumental Convergence)** (Nick Bostrom, Steve Omohundro)
...
##### 1.5.4.1.2 规范博弈论 (Normative Game Theory) 与价值规范 (Value Specification)
...
##### 1.5.4.1.5 可扩展的监督 (Scalable Oversight)**

    - 随着AI系统能力的增长，人类直接监督和评估其复杂行为（尤其是在海量数据或高度专业化领域中）将变得越来越困难。需要开发能够随着AI能力扩展而有效监督的方法。

#### 1.5.4.2 价值对齐方法 (Methods for Value Alignment)

##### 1.5.4.2.1 从人类反馈中学习 (Learning from Human Feedback)
...
##### 1.5.4.2.2 AI 辩论 (AI Debate)** (OpenAI, Paul Christiano)
...
##### 1.5.4.2.3 迭代放大 (Iterated Amplification / Iterated Distillation and Amplification, IDA)-(Paul Christiano, DeepMind)
...
### 1.5.5 计算认知科学与AI (Computational Cognitive Science and AI)
...
#### 1.5.5.1 心智的计算模型 (Computational Models of Mind)
...
- **马尔的三个层次 (Marr's Three Levels of Analysis)** (David Marr, 1982)：一个有影响力的框架，用于分析任何信息处理系统（包括心智）：
    1. **计算理论层次 (Computational Theory Level)**：
       - _目标_：描述系统计算的_目标_是什么，以及为什么这个计算是合适的（即该计算的逻辑和策略）。
       - _问题_：系统解决什么问题？输入和输出是什么？解决该问题的约束是什么？
    2. **表示与算法层次 (Representation and Algorithm Level)**：
       - _目标_：描述系统如何实现计算理论。
       - _问题_：输入和输出是如何表示的？将输入转换为输出的算法是什么？使用了哪些数据结构？
    3. **硬件实现层次 (Hardware Implementation Level)**：
       - _目标_：描述表示和算法如何在物理（或生理）硬件中实现。
       - _问题_：这些表示和算法是如何在神经元、电路或其他物理基底中实现的？
- **认知建模方法**：
...
#### 1.5.5.2 认知架构 (Cognitive Architectures)
...
## 1.6 五、算法的社会维度 (Social Dimensions of Algorithms)
...
### 1.6.1 计算社会选择理论 (Computational Social Choice, ComSoc)
...
### 1.6.2 计算拍卖理论与机制设计 (Computational Auction Theory and Mechanism Design)
...
- **激励相容 (Incentive Compatibility, IC)**：
  ...
  - \(u_i(g(s_i(\theta_i), a_{-i}), \theta_i) \ge u_i(g(a'_i, a_{-i}), \theta_i)\) 对所有 \(\theta_i, a'_i, a_{-i}\) 都成立，其中 \(s_i(\theta_i)\) 是真实报价。
  ...
  - **Vickrey-Clarke-Groves (VCG) 机制**：
    ...
    - **规则**：
        ...
        2. **支付规则 (Clarke Pivot Rule)**：每个智能体 \(i\) 支付其对其他智能体造成的“损害”或“外部性”。即，智能体 \(i\) 的支付额 = (如果没有智能体 \(i\) 参与，其他智能体能获得的最大总估值) - (有智能体 \(i\) 参与的情况下，其他智能体实际获得的总估值)。
           \(p_i = \left( \max_{g'} \sum_{j \neq i} \hat{v}_j(g') \right) - \sum_{j \neq i} \hat{v}_j(g^_)\)，其中 \(\hat{v}_j\) 是报告的估值，\(g^_\) 是基于所有报告选择的实际分配。
...
### 1.6.3 算法公平性与偏见 (Algorithmic Fairness and Bias)

随着算法决策系统（ADS）被广泛用于信贷审批、招聘筛选、刑事司法、医疗诊断等高风险领域，
人们日益关注这些系统可能产生的不公平或歧视性结果，即使它们的设计初衷是中立的。
算法公平性研究旨在理解、量化、缓解和预防算法系统中的偏见和不公平。

#### 1.6.3.1 偏见的来源 (Sources of Bias in Algorithmic Systems)

##### 1.6.3.1.1 数据偏见 (Data Bias)
...
##### 1.6.3.1.2 算法偏见 (Algorithmic Bias / Model Bias)
...
##### 1.6.3.1.3 人机交互偏见 (Human-in-the-loop Bias)
...
#### 1.6.3.2 公平性的定义与度量 (Definitions and Metrics of Fairness)
...
##### 1.6.3.2.1 反歧视 (Anti-Discrimination) / 独立性 (Independence / Demographic Parity)
...
##### 1.6.3.2.2 分离 (Separation) / 均等化机会 (Equalized Odds / Equal Opportunity)
...
##### 1.6.3.2.3 充分性 (Sufficiency) / 校准 (Calibration / Predictive Rate Parity)
...
#### 1.6.3.3 偏见缓解技术 (Bias Mitigation Techniques)

##### 1.6.3.3.1 预处理技术 (Pre-processing)**：在训练模型之前修改数据
...
##### 1.6.3.3.2 在处理技术 (In-processing / In-training)**：在模型训练过程中修改算法
...
##### 1.6.3.3.3 后处理技术 (Post-processing)**：在模型训练完成后修改其输出
...
#### 1.6.3.4 COMPAS 案例研究 (COMPAS Case Study)
...
### 1.7.1 人工生命 (Artificial Life, ALife)
...
##### 1.7.1.2.1 细胞自动机 (Cellular Automata, CA)
...
##### 1.7.1.2.2 进化算法 (Evolutionary Algorithms, EA)
...
##### 1.7.1.2.3 人工神经网络 (Artificial Neural Networks, ANNs)

    - 常被用作人工生物的“大脑”或控制器，使其能够感知环境、学习和做出决策。
    - **进化机器人学 (Evolutionary Robotics)**：使用进化算法来自动设计机器人的身体形态和/或其神经网络控制器，以完成特定任务（如行走、觅食、避障）。

##### 1.7.1.2.4 多智能体系统 (Multi-Agent Systems, MAS) 与群体智能 (Swarm Intelligence)
...
##### 1.7.1.2.5 人工化学 (Artificial Chemistry, AChem)

    - 创建形式化的分子交互系统，研究自催化网络、自组织结构和新陈代谢的起源。
    - **模型**：如\(\lambda\)-演算的变体、图重写系统、抽象分子反应规则。

##### 1.7.1.2.6 湿件 ALife (Wet ALife / Synthetic Biology)
...
#### 1.7.1.4 开放式进化 (Open-Ended Evolution, OEE) 的挑战
...
### 1.7.2 去中心化系统与共识机制 (Decentralized Systems and Consensus Mechanisms)
...
#### 1.7.2.2 核心挑战：拜占庭将军问题 (Byzantine Generals Problem)
...
#### 1.7.2.3 主要共识机制 (Major Consensus Mechanisms)

##### 1.7.2.3.1 工作量证明 (Proof-of-Work, PoW)
...
##### 1.7.2.3.2 权益证明 (Proof-of-Stake, PoS)
...
##### 1.7.2.3.3 委托权益证明 (Delegated Proof-of-Stake, DPoS)
...
##### 1.7.2.3.4 实用拜占庭容错 (Practical Byzantine Fault Tolerance, PBFT)
...
#### 1.7.2.4 区块链不可能三角 (Blockchain Trilemma)
...
### 1.7.3 计算创造力 (Computational Creativity, CC)
...
##### 1.7.3.2.1 生成式方法 (Generative Approaches)
...
##### 1.7.3.2.2 进化算法 (Evolutionary Algorithms, EA) 与遗传编程 (Genetic Programming, GP)
...
##### 1.7.3.2.3 机器学习 (Machine Learning, ML)，尤其是深度学习 (Deep Learning)
...
##### 1.7.3.2.4 概念混合与类比推理 (Conceptual Blending and Analogy-Making)
...
##### 1.7.3.2.5 基于知识的系统 (Knowledge-Based Systems) 与逻辑推理
...
##### 1.7.3.2.6 认知架构 (Cognitive Architectures)

...
- [人脑认知、同伦类型论与软件编程：理论、模型及关联性分析](#人脑认知同伦类型论与软件编程理论模型及关联性分析)
  ...
  - [7 . 文本思维导图](#7-文本思维导图)
  - [8 提问](#8-提问)
    - [1 同伦类型论（HoTT）是否 可以看成是链接 人脑认知 逻辑 证明 软件世界的综合性基础理论?](#1-同伦类型论hott是否-可以看成是链接-人脑认知-逻辑-证明-软件世界的综合性基础理论)
    - [8.2 同伦类型论 是否可以从程序编程的视角来看 是否是链接形式证明 和 程序表达的中介桥接基础概念理论?](#82-同伦类型论-是否可以从程序编程的视角来看-是否是链接形式证明-和-程序表达的中介桥接基础概念理论)
    - [8.3 是否有 其他视角看待 同伦类型论？或者是更深刻的视角？](#83-是否有-其他视角看待-同伦类型论或者是更深刻的视角)

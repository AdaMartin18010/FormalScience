...
- [1. representation](#1-representation)
  - [目录](#目录)
  - [1.10 引言：表示论、认知结构与现实的基本概念](#110-引言表示论认知结构与现实的基本概念)
  - [1.11 表示论（Representational Theory of Mind, RTM）](#111-表示论representational-theory-of-mind-rtm)
    - [1.11.1 核心主张与基本概念](#1111-核心主张与基本概念)
    - [1.11.2 主要理论与模型](#1112-主要理论与模型)
      - [1.11.2.1 经典符号主义表示论（如：思想语言假说）](#11121-经典符号主义表示论如思想语言假说)
      - [1.11.2.2 联结主义表示论](#11122-联结主义表示论)
      - [1.11.2.3 预测编码/处理模型中的表示](#11123-预测编码处理模型中的表示)
    - [1.11.3 表示的类型与特征](#1113-表示的类型与特征)
  - [1.12 认知结构](#112-认知结构)
    - [1.12.1 概念与构成](#1121-概念与构成)
    - [1.12.2 在认知活动中的作用](#1122-在认知活动中的作用)
  - [1.13 表示论与认知结构的映射关系](#113-表示论与认知结构的映射关系)
    - [1.13.1 表示作为认知结构的基石](#1131-表示作为认知结构的基石)
    - [1.13.2 认知过程：基于表示的运算与认知结构的动态交互](#1132-认知过程基于表示的运算与认知结构的动态交互)
    - [1.13.3 映射的复杂性与挑战](#1133-映射的复杂性与挑战)
  - [1.14 形式模型：定义、解释与论证](#114-形式模型定义解释与论证)
    - [1.14.1 符号模型（Symbolic Models）](#1141-符号模型symbolic-models)
    - [1.14.2 联结主义模型（Connectionist Models）](#1142-联结主义模型connectionist-models)
    - [1.14.3 概率/贝叶斯模型（Probabilistic/Bayesian Models）](#1143-概率贝叶斯模型probabilisticbayesian-models)
    - [1.5.4 元模型-模型的层级与论证](#154-元模型-模型的层级与论证)
  - [1.15 表示论与人脑认知结构、思维层次的关联](#115-表示论与人脑认知结构思维层次的关联)
    - [1.15.1 神经基础：表示在人脑中的可能实现](#1151-神经基础表示在人脑中的可能实现)
    - [1.15.2 表示与不同思维层次](#1152-表示与不同思维层次)
    - [1.15.3 表示与现实：意向性、准确性与真理符合论](#1153-表示与现实意向性准确性与真理符合论)
  - [1.16 批判性分析与综合](#116-批判性分析与综合)
    - [1.16.1 表示论的解释力与贡献](#1161-表示论的解释力与贡献)
    - [1.16.2 面临的挑战与批评](#1162-面临的挑战与批评)
    - [1.16.3 综合视角：整合与发展趋势](#1163-综合视角整合与发展趋势)
  - [1.17 结论](#117-结论)
  - [1.9 文本思维导图](#19-文本思维导图)
  - [1.10 引言：表示论、认知结构与现实的基本概念](#110-引言表示论认知结构与现实的基本概念-1)
  - [1.11 表示论（Representational Theory of Mind, RTM）](#111-表示论representational-theory-of-mind-rtm-1)
    - [1.11.1 核心主张与基本概念](#1111-核心主张与基本概念-1)
    - [1.11.2 主要理论与模型](#1112-主要理论与模型-1)
      - [1.11.2.1 经典符号主义表示论（如：思想语言假说）](#11121-经典符号主义表示论如思想语言假说-1)
      - [1.11.2.2 联结主义表示论](#11122-联结主义表示论-1)
      - [1.11.2.3 预测编码/处理模型中的表示](#11123-预测编码处理模型中的表示-1)
    - [1.11.3 表示的类型与特征](#1113-表示的类型与特征-1)
  - [1.12 认知结构](#112-认知结构-1)
    - [1.12.1 概念与构成](#1121-概念与构成-1)
    - [1.12.2 在认知活动中的作用](#1122-在认知活动中的作用-1)
  - [1.13 表示论与认知结构的映射关系](#113-表示论与认知结构的映射关系-1)
    - [1.13.1 表示作为认知结构的基石](#1131-表示作为认知结构的基石-1)
    - [1.13.2 认知过程：基于表示的运算与认知结构的动态交互](#1132-认知过程基于表示的运算与认知结构的动态交互-1)
    - [1.13.3 映射的复杂性与挑战](#1133-映射的复杂性与挑战-1)
  - [1.14 形式模型：定义、解释与论证](#114-形式模型定义解释与论证-1)
    - [1.14.1 符号模型（Symbolic Models）](#1141-符号模型symbolic-models-1)
    - [1.14.2 联结主义模型（Connectionist Models）](#1142-联结主义模型connectionist-models-1)
    - [1.14.3 概率/贝叶斯模型（Probabilistic/Bayesian Models）](#1143-概率贝叶斯模型probabilisticbayesian-models-1)
    - [1.14.4 元模型-模型的层级与论证 (扩展)](#1144-元模型-模型的层级与论证-扩展)
  - [1.15 表示论与人脑认知结构、思维层次的关联](#115-表示论与人脑认知结构思维层次的关联-1)
    - [1.15.1 神经基础：表示在人脑中的可能实现](#1151-神经基础表示在人脑中的可能实现-1)
    - [1.15.2 表示与不同思维层次](#1152-表示与不同思维层次-1)
    - [1.15.3 表示与现实：意向性、准确性与真理符合论](#1153-表示与现实意向性准确性与真理符合论-1)
  - [1.16 批判性分析与综合](#116-批判性分析与综合-1)
    - [1.16.1 表示论的解释力与贡献](#1161-表示论的解释力与贡献-1)
    - [1.16.2 面临的挑战与批评](#1162-面临的挑战与批评-1)
    - [1.16.3 综合视角：整合与发展趋势](#1163-综合视角整合与发展趋势-1)
  - [1.17 结论](#117-结论-1)
  - [1.18 文本思维导图 (此部分保持不变，因其是对原始提纲的结构化呈现)](#118-文本思维导图-此部分保持不变因其是对原始提纲的结构化呈现)

## 1.10 引言：表示论、认知结构与现实的基本概念
...
## 1.11 表示论（Representational Theory of Mind, RTM）
...
## 1.15 表示论与人脑认知结构、思维层次的关联

### 1.15.1 神经基础：表示在人脑中的可能实现
...
- **定义与基础**:
  ...
  - **关键概念**:
    ...
    - **贝叶斯定理**: \(P(H|D) = [P(D|H) _P(H)] / P(D)\) (后验 = (似然性_ 先验) / 证据的边缘概率)
...
## 1.18 文本思维导图 (此部分保持不变，因其是对原始提纲的结构化呈现)

...
- [范畴论 (Category Theory)](#范畴论-category-theory)
  ...
  - [A. 核心概念与定义](#a-核心概念与定义)
    - [1 A.1. 什么是范畴论 (What is Category Theory)?](#1-a1-什么是范畴论-what-is-category-theory)
    - [1.2 A.2. 范畴 (Category) 的定义](#12-a2-范畴-category-的定义)
      - [1 A.2.1. 对象 (Objects)](#1-a21-对象-objects)
      - [2 A.2.2. 态射 (Morphisms / Arrows / Maps)](#2-a22-态射-morphisms-arrows-maps)
      - [3 A.2.3. 态射的复合 (Composition of Morphisms)](#3-a23-态射的复合-composition-of-morphisms)
      - [4 A.2.4. 单位态射 (Identity Morphisms)](#4-a24-单位态射-identity-morphisms)
      - [5 A.2.5. 公理 (Axioms: Associativity and Unit Law)](#5-a25-公理-axioms-associativity-and-unit-law)
    - [1.3 A.3. 范畴的例子 (Examples of Categories)](#13-a3-范畴的例子-examples-of-categories)
      - [1 A.3.1. **Set** (集合范畴)](#1-a31-set-集合范畴)
      - [2 A.3.2. **Grp** (群范畴)](#2-a32-grp-群范畴)
      - [3 A.3.3. **Top** (拓扑空间范畴)](#3-a33-top-拓扑空间范畴)
      - [4 A.3.4. **Vect**_k (域k上的向量空间范畴)](#4-a34-vect_k-域k上的向量空间范畴)
      - [5 A.3.5. 偏序集作为范畴 (Posets as Categories)](#5-a35-偏序集作为范畴-posets-as-categories)
      - [6 A.3.6. 幺半群作为单对象范畴 (Monoids as Single-Object Categories)](#6-a36-幺半群作为单对象范畴-monoids-as-single-object-categories)
      - [7 A.3.7. 离散范畴与无序范畴 (Discrete and Indiscrete Categories)](#7-a37-离散范畴与无序范畴-discrete-and-indiscrete-categories)
    - [1.4 A.4. 特殊类型的态射 (Special Types of Morphisms)](#14-a4-特殊类型的态射-special-types-of-morphisms)
      - [1 A.4.1. 同构 (Isomorphism)](#1-a41-同构-isomorphism)
      - [2 A.4.2. 单态射 (Monomorphism / Mono)](#2-a42-单态射-monomorphism-mono)
      - [3 A.4.3. 满态射 (Epimorphism / Epi)](#3-a43-满态射-epimorphism-epi)
      - [4 A.4.4. 其他 (如 Section, Retraction, Bimorphism)](#4-a44-其他-如-section-retraction-bimorphism)
    - [1.5 A.5. 对偶原理 (Duality Principle)](#15-a5-对偶原理-duality-principle)
      - [1 A.5.1. 对偶范畴](#1-a51-对偶范畴)
    - [1.6 A.6. 函子 (Functor)](#16-a6-函子-functor)
      - [1 A.6.1. 定义 (Definition)](#1-a61-定义-definition)
      - [2 A.6.2. 协变函子与反变函子 (Covariant and Contravariant Functors)](#2-a62-协变函子与反变函子-covariant-and-contravariant-functors)
      - [3 A.6.3. 函子的例子 (Examples of Functors: Power Set, Fundamental Group, Hom Functor)](#3-a63-函子的例子-examples-of-functors-power-set-fundamental-group-hom-functor)
      - [4 A.6.4. 忠实函子与充实函子 (Faithful and Full Functors)](#4-a64-忠实函子与充实函子-faithful-and-full-functors)
    - [1.7 A.7. 自然变换 (Natural Transformation)](#17-a7-自然变换-natural-transformation)
      - [1 A.7.1. 定义 (Definition)](#1-a71-定义-definition)
      - [2 A.7.2. 自然同构 (Natural Isomorphism)](#2-a72-自然同构-natural-isomorphism)
      - [3 A.7.3. 函子范畴 (Functor Category, [C, D])](#3-a73-函子范畴-functor-category-c-d)
    - [1.8 A.8. 泛构造 (Universal Constructions / Universal Properties)](#18-a8-泛构造-universal-constructions-universal-properties)
      - [1 A.8.1. 核心思想 (Core Idea)](#1-a81-核心思想-core-idea)
      - [2 A.8.2. 初始对象与终端对象 (Initial and Terminal Objects)](#2-a82-初始对象与终端对象-initial-and-terminal-objects)
      - [3 A.8.3. 积 (Product) 与余积 (Coproduct / Sum)](#3-a83-积-product-与余积-coproduct-sum)
      - [4 A.8.4. 拉回 (Pullback) 与推出 (Pushout)](#4-a84-拉回-pullback-与推出-pushout)
      - [5 A.8.5. 极限 (Limit) 与余极限 (Colimit)](#5-a85-极限-limit-与余极限-colimit)
    - [1.9 A.9. 伴随函子 (Adjoint Functors / Adjunctions)](#19-a9-伴随函子-adjoint-functors-adjunctions)
      - [1 A.9.1. 定义 (Definition: Hom-set Adjunction, Unit-Counit Adjunction)](#1-a91-定义-definition-hom-set-adjunction-unit-counit-adjunction)
      - [2 A.9.2. 重要性与普遍性 (Importance and Ubiquity)](#2-a92-重要性与普遍性-importance-and-ubiquity)
      - [3 A.9.3. 例子 (Examples: Free Functors and Forgetful Functors)](#3-a93-例子-examples-free-functors-and-forgetful-functors)
    - [1.10 A.10. 幺半范畴与张量积 (Monoidal Categories and Tensor Products)](#110-a10-幺半范畴与张量积-monoidal-categories-and-tensor-products)
  ...
  - [6 F. 在计算机科学与其它领域的应用](#6-f-在计算机科学与其它领域的应用)
  ...
  - [7 G. 哲学反思与数学基础的地位](#7-g-哲学反思与数学基础的地位)

...
- [1. 证明论-认知结构-映射关联](#1-证明论-认知结构-映射关联)
  - [目录](#目录)
  - [1.1 证明论与人脑认知结构的映射与关联](#11-证明论与人脑认知结构的映射与关联)
    - [1.1.1 认知结构视角下的证明论](#111-认知结构视角下的证明论)
      - [1.7.1.1 符号表征与处理](#1711-符号表征与处理)
      - [1.7.1.2 工作记忆与推理链](#1712-工作记忆与推理链)
      - [1.7.1.3 规则学习与内化](#1713-规则学习与内化)
      - [1.7.1.4 启发式与证明策略](#1714-启发式与证明策略)
    - [1.1.2 思维层次与证明论](#112-思维层次与证明论)
      - [1.7.2.1 形式运算思维](#1721-形式运算思维)
      - [1.7.2.2 元认知与证明评估](#1722-元认知与证明评估)
    - [1.1.3 数学理论作为认知类比的工具](#113-数学理论作为认知类比的工具)
  - [1.2 元模型-模型的论证、证明与拓展](#12-元模型-模型的论证证明与拓展)
    - [1.2.1 证明论的元理论一致性、可靠性、完备性与认知评估](#121-证明论的元理论一致性可靠性完备性与认知评估)
    - [1.2.2 模型论语义与证明论句法的认知对应](#122-模型论语义与证明论句法的认知对应)
    - [1.2.3 证明论拓展与复杂认知现象](#123-证明论拓展与复杂认知现象)
  - [1.3 批判性分析与综合](#13-批判性分析与综合)
    - [1.3.1 理想化模型与现实认知的差距](#131-理想化模型与现实认知的差距)
    - [1.3.2 认知负荷与个体差异](#132-认知负荷与个体差异)
    - [1.3.3 研究的局限性与未来展望](#133-研究的局限性与未来展望)
  - [1.4 结论](#14-结论)

## 1.1 证明论与人脑认知结构的映射与关联
...
### 1.6.3 Curry-Howard 同构 (Proofs-as-Programs Propositions-as-Types)

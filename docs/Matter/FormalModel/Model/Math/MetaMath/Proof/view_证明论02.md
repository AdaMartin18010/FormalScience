...
- [1 证明论与人脑认知结构的映射与关联](#1-证明论与人脑认知结构的映射与关联)
  - [1.1 认知结构视角下的证明论](#11-认知结构视角下的证明论)
    - [1.1.1 符号表征与处理](#111-符号表征与处理)
    - [1.1.2 工作记忆与推理链](#112-工作记忆与推理链)
    - [1.1.3 规则学习与内化](#113-规则学习与内化)
    - [1.1.4 启发式与证明策略](#114-启发式与证明策略)
  - [1.2 思维层次与证明论](#12-思维层次与证明论)
    - [2.2.1 形式运算思维](#221-形式运算思维)
    - [2.2.2 元认知与证明评估](#222-元认知与证明评估)
  - [1.3 数学理论作为认知类比的工具](#13-数学理论作为认知类比的工具)
- [2 元模型-模型的论证、证明与拓展](#2-元模型-模型的论证证明与拓展)
  - [2.1 证明论的元理论一致性、可靠性、完备性与认知评估](#21-证明论的元理论一致性可靠性完备性与认知评估)
  - [2.2 模型论语义与证明论句法的认知对应](#22-模型论语义与证明论句法的认知对应)
  - [2.3 证明论拓展与复杂认知现象](#23-证明论拓展与复杂认知现象)
- [3 批判性分析与综合](#3-批判性分析与综合)
  - [3.1 理想化模型与现实认知的差距](#31-理想化模型与现实认知的差距)
  - [3.2 认知负荷与个体差异](#32-认知负荷与个体差异)
  - [3.3 研究的局限性与未来展望](#33-研究的局限性与未来展望)
- [4 结论](#4-结论)
- [5 引言：证明论与认知科学的交汇](#5-引言证明论与认知科学的交汇)
- [6 证明论的核心理论与模型](#6-证明论的核心理论与模型)
  - [6.1 自然演绎 (Natural Deduction)](#61-自然演绎-natural-deduction)
  - [6.2 相继演算 (Sequent Calculus)](#62-相继演算-sequent-calculus)
  - [6.3 Curry-Howard 同构 (Proofs-as-Programs Propositions-as-Types)](#63-curry-howard-同构-proofs-as-programs-propositions-as-types)
  - [6.4 线性逻辑 (Linear Logic)](#64-线性逻辑-linear-logic)
  - [6.5 其他相关理论](#65-其他相关理论)
- [7 证明论与人脑认知结构的映射与关联](#7-证明论与人脑认知结构的映射与关联)
  - [7.1 认知结构视角下的证明论](#71-认知结构视角下的证明论)
    - [1.1.1 符号表征与处理](#111-符号表征与处理)
    - [1.1.2 工作记忆与推理链](#112-工作记忆与推理链)
    - [1.1.3 规则学习与内化](#113-规则学习与内化)
    - [1.1.4 启发式与证明策略](#114-启发式与证明策略)
  - [7.2 思维层次与证明论](#72-思维层次与证明论)
    - [2.2.1 形式运算思维](#221-形式运算思维)
    - [2.2.2 元认知与证明评估](#222-元认知与证明评估)
  - [7.3 数学理论作为认知类比的工具](#73-数学理论作为认知类比的工具)
- [8 元模型-模型的论证、证明与拓展](#8-元模型-模型的论证证明与拓展)
  - [8.1 证明论的元理论一致性、可靠性、完备性与认知评估](#81-证明论的元理论一致性可靠性完备性与认知评估)
  - [8.2 模型论语义与证明论句法的认知对应](#82-模型论语义与证明论句法的认知对应)
  - [8.3 证明论拓展与复杂认知现象](#83-证明论拓展与复杂认知现象)
- [9 批判性分析与综合](#9-批判性分析与综合)
  - [9.1 理想化模型与现实认知的差距](#91-理想化模型与现实认知的差距)
  - [9.2 认知负荷与个体差异](#92-认知负荷与个体差异)
  - [9.3 研究的局限性与未来展望](#93-研究的局限性与未来展望)
- [10 结论](#10-结论)
...
### 7.3 Curry-Howard 同构 (Proofs-as-Programs Propositions-as-Types)

...
- [1. 构造性数学及其在证明论中的逻辑基础](#1-构造性数学及其在证明论中的逻辑基础)
  - [目录](#目录)
  - [1.1 A. 核心概念与定义](#11-a-核心概念与定义)
    - [1.1.1 什么是构造性数学 (What is Constructive Mathematics)？](#111-什么是构造性数学-what-is-constructive-mathematics)
    - [1.1.2 构造性证明 (Constructive Proof)](#112-构造性证明-constructive-proof)
    - [1.1.3 直觉主义逻辑 (Intuitionistic Logic, IL)](#113-直觉主义逻辑-intuitionistic-logic-il)
    - [1.1.4 BHK释义 (Brouwer-Heyting-Kolmogorov Interpretation)](#114-bhk释义-brouwer-heyting-kolmogorov-interpretation)
    - [1.1.5 可实现性 (Realizability)](#115-可实现性-realizability)
    - [1.1.6 选择序列 (Choice Sequences)](#116-选择序列-choice-sequences)
    - [1.1.7 若干构造性原则](#117-若干构造性原则)
      - [1.1.7.1 马尔可夫原理 (Markov's Principle, MP)](#1171-马尔可夫原理-markovs-principle-mp)
      - [1.1.7.2 邱奇论题的构造性版本](#1172-邱奇论题的构造性版本)
  - [1.2 B. 历史渊源与主要人物](#12-b-历史渊源与主要人物)
    - [1.2.1 前构造思想的渊源](#121-前构造思想的渊源)
    - [1.2.2 利奥波德·克罗内克 (Leopold Kronecker, 1823-1891)](#122-利奥波德克罗内克-leopold-kronecker-1823-1891)
    - [1.2.3 亨利·庞加莱 (Henri Poincaré, 1854-1912)](#123-亨利庞加莱-henri-poincaré-1854-1912)
    - [1.2.4 路易斯·布劳威尔 (L.E.J. Brouwer, 1881-1966) 与直觉主义](#124-路易斯布劳威尔-lej-brouwer-1881-1966-与直觉主义)
    - [1.2.5 赫尔曼·外尔 (Hermann Weyl, 1885-1955)](#125-赫尔曼外尔-hermann-weyl-1885-1955)
    - [1.2.6 阿兰德·海廷 (Arend Heyting, 1898-1980)](#126-阿兰德海廷-arend-heyting-1898-1980)
    - [1.2.7 俄罗斯构造递归数学学派](#127-俄罗斯构造递归数学学派)
      - [1.2.7.1 安德烈·马尔可夫 (Andrey Markov Jr., 1903-1979)](#1271-安德烈马尔可夫-andrey-markov-jr-1903-1979)
      - [1.2.7.2 尼古拉·沙宁 (Nikolai Shanin, 1919-2011)](#1272-尼古拉沙宁-nikolai-shanin-1919-2011)
    - [1.2.8 斯蒂芬·克利尼 (Stephen Kleene, 1909-1994)](#128-斯蒂芬克利尼-stephen-kleene-1909-1994)
    - [1.2.9 埃里特·毕晓普 (Errett Bishop, 1928-1983)](#129-埃里特毕晓普-errett-bishop-1928-1983)
    - [1.2.10 佩尔·马丁-洛夫 (Per Martin-Löf, 1942-present)](#1210-佩尔马丁-洛夫-per-martin-löf-1942-present)
  - [1.3 C. 证明论在构造性数学中的作用](#13-c-证明论在构造性数学中的作用)
    - [1.3.1 形式化构造性推理原则](#131-形式化构造性推理原则)
    - [1.3.2 分析构造性证明的结构](#132-分析构造性证明的结构)
    - [1.3.3 提取计算内容 (Program Extraction)](#133-提取计算内容-program-extraction)
    - [1.3.4 研究构造性理论的强度与一致性](#134-研究构造性理论的强度与一致性)
    - [1.3.5 构造性逻辑的语义模型](#135-构造性逻辑的语义模型)
    - [1.3.6 自动化推理与证明助手](#136-自动化推理与证明助手)
  - [1.4 D. 构造性数学的主要分支与成果](#14-d-构造性数学的主要分支与成果)
    - [1.4.1 直觉主义数学 (Brouwer's Intuitionism)](#141-直觉主义数学-brouwers-intuitionism)
    - [1.4.2 构造递归数学 (Constructive Recursive Mathematics)](#142-构造递归数学-constructive-recursive-mathematics)
    - [1.4.3 毕晓普的构造分析 (Bishop's Constructive Analysis - BISH)](#143-毕晓普的构造分析-bishops-constructive-analysis---bish)
    - [1.4.4 构造类型论 (Constructive Type Theory - MLTT)](#144-构造类型论-constructive-type-theory---mltt)
    - [1.4.5 构造性集合论 (Constructive Set Theory - CZF, IZF)](#145-构造性集合论-constructive-set-theory---czf-izf)
    - [1.4.6 其他构造性框架](#146-其他构造性框架)
  - [1.5 E. 与经典数学的关系及哲学意义](#15-e-与经典数学的关系及哲学意义)
    - [1.5.1 构造性数学作为经典数学的子领域？](#151-构造性数学作为经典数学的子领域)
    - [1.5.2 经典数学的构造性重释](#152-经典数学的构造性重释)
    - [1.5.3 构造性数学的独有成果](#153-构造性数学的独有成果)
    - [1.5.4 对数学“真理”和“存在”的哲学反思](#154-对数学真理和存在的哲学反思)
    - [1.5.5 对“证明”的意义的深化](#155-对证明的意义的深化)
    - [1.5.6 计算与数学的联系](#156-计算与数学的联系)
  - [1.6 F. 挑战与未来展望](#16-f-挑战与未来展望)
    - [1.6.1 面临的挑战](#161-面临的挑战)
    - [1.6.2 未来展望](#162-未来展望)
...
### 1.1.1 什么是构造性数学 (What is Constructive Mathematics)？
...
### 1.1.2 构造性证明 (Constructive Proof)
...
### 1.1.3 直觉主义逻辑 (Intuitionistic Logic, IL)
...
### 1.1.4 BHK释义 (Brouwer-Heyting-Kolmogorov Interpretation)
...
#### 1.1.7.1 马尔可夫原理 (Markov's Principle, MP)
...
### 1.2.2 利奥波德·克罗内克 (Leopold Kronecker, 1823-1891)
...
### 1.2.3 亨利·庞加莱 (Henri Poincaré, 1854-1912)
...
### 1.2.4 路易斯·布劳威尔 (L.E.J. Brouwer, 1881-1966) 与直觉主义
...
### 1.2.5 赫尔曼·外尔 (Hermann Weyl, 1885-1955)
...
### 1.2.6 阿兰德·海廷 (Arend Heyting, 1898-1980)
...
#### 1.2.7.1 安德烈·马尔可夫 (Andrey Markov Jr., 1903-1979)
...
#### 1.2.7.2 尼古拉·沙宁 (Nikolai Shanin, 1919-2011)

- 马尔可夫的学生和同事。
- **致力于构造性证明的算法化**：试图发展从构造性证明中自动提取算法的方法，这与后来证明论中的“程序提取”思想有相通之处。
- 对构造性数理逻辑和证明理论有重要贡献。

### 1.2.8 斯蒂芬·克利尼 (Stephen Kleene, 1909-1994)
...
### 1.2.9 埃里特·毕晓普 (Errett Bishop, 1928-1983)
...
### 1.2.10 佩尔·马丁-洛夫 (Per Martin-Löf, 1942-present)
...
### 1.3.3 提取计算内容 (Program Extraction)
...
### 1.4.1 直觉主义数学 (Brouwer's Intuitionism)
...
### 1.4.2 构造递归数学 (Constructive Recursive Mathematics)
...
### 1.4.3 毕晓普的构造分析 (Bishop's Constructive Analysis - BISH)
...
### 1.4.4 构造类型论 (Constructive Type Theory - MLTT)
...
### 1.4.5 构造性集合论 (Constructive Set Theory - CZF, IZF)

...
- [1. 从同伦类型论视角解析工作流引擎系统](#1-从同伦类型论视角解析工作流引擎系统)
  - [目录](#目录)
  - [1.1 引言](#11-引言)
  - [1.2 同伦类型论视角下的工作流系统](#12-同伦类型论视角下的工作流系统)
  ...
  - [1.4 模式之间的组合规则与有效性](#14-模式之间的组合规则与有效性)
    - [1.4.1 组合规则](#141-组合规则)
    - [1.4.2 组合有效性证明](#142-组合有效性证明)
  - [1.5 形式证明与逻辑推理](#15-形式证明与逻辑推理)
    - [1.5.1 Petri网与类型论的结合](#151-petri网与类型论的结合)
    - [1.5.2 工作流性质的形式证明](#152-工作流性质的形式证明)
  - [1.6 总结](#16-总结)

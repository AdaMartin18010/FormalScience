...
- [5 五、综合应用分析](#5-五综合应用分析)
  - [5.1 适用场景比较](#51-适用场景比较)
    - [1.1.1 Cadence最适合](#111-cadence最适合)
    - [1.1.2 Temporal最适合](#112-temporal最适合)
  - [5.2 行业应用案例](#52-行业应用案例)
    - [2.2.1 Cadence](#221-cadence)
    - [2.2.2 Temporal](#222-temporal)
  - [5.3 迁移与互操作性](#53-迁移与互操作性)
    - [3.3.1 从Cadence到Temporal](#331-从cadence到temporal)
    - [3.3.2 与其他系统互操作](#332-与其他系统互操作)

# 1. 工作流的23+模式从范畴论视角的分析

## 目录

- [1. 工作流的23+模式从范畴论视角的分析](#1-工作流的23模式从范畴论视角的分析)
  - [目录](#目录)
  - [1.1 引言：工作流模式与范畴论](#11-引言工作流模式与范畴论)
  - [1.2 工作流模式的范畴论视角](#12-工作流模式的范畴论视角)
    - [1.2.1 基本控制流模式](#121-基本控制流模式)
      - [1.2.1.1 顺序模式（Sequence Pattern）](#1211-顺序模式sequence-pattern)
      - [1.2.1.2 并行分支（Parallel Split）](#1212-并行分支parallel-split)
      - [1.2.1.3 同步（Synchronization）](#1213-同步synchronization)
      - [1.2.1.4 排他选择（Exclusive Choice）](#1214-排他选择exclusive-choice)
      - [1.2.1.5 简单合并（Simple Merge）](#1215-简单合并simple-merge)
    - [1.2.2 高级分支与同步模式](#122-高级分支与同步模式)
      - [1.2.2.1 多选（Multi-Choice）](#1221-多选multi-choice)
      - [1.2.2.2 同步合并（Synchronizing Merge）](#1222-同步合并synchronizing-merge)
    - [1.2.3 多实例模式](#123-多实例模式)
      - [1.2.3.1 多实例并行（Multiple Instances Without Synchronization）](#1231-多实例并行multiple-instances-without-synchronization)
      - [1.2.3.2 多实例同步（Multiple Instances With Synchronization）](#1232-多实例同步multiple-instances-with-synchronization)
    - [1.2.4 基于状态的模式](#124-基于状态的模式)
      - [1.2.4.1 延迟选择（Deferred Choice）](#1241-延迟选择deferred-choice)
      - [1.2.4.2 里程碑（Milestone）](#1242-里程碑milestone)
    - [1.2.5 取消与强制完成模式](#125-取消与强制完成模式)
      - [1.2.5.1 取消任务（Cancel Task）](#1251-取消任务cancel-task)
      - [1.2.5.2 取消区域（Cancel Region）](#1252-取消区域cancel-region)
  - [1.3 模式之间的范畴关系](#13-模式之间的范畴关系)
    - [1.3.1 等价关系](#131-等价关系)
    - [1.3.2 对偶关系](#132-对偶关系)
    - [1.3.3 自然变换](#133-自然变换)
  - [1.4 总结](#14-总结)
...
#### 1.2.2.2 同步合并（Synchronizing Merge）
...
#### 1.2.3.1 多实例并行（Multiple Instances Without Synchronization）
...
#### 1.2.3.2 多实例同步（Multiple Instances With Synchronization）

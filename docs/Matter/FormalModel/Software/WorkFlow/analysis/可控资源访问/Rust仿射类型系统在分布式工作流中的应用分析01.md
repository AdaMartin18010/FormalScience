...
- [1 理论基础类比与映射](#1-理论基础类比与映射)
  ...
  - [1.2 逻辑论证](#12-逻辑论证)
    - [2.2.1 资源唯一所有权原则](#221-资源唯一所有权原则)
    - [2.2.2 借用规则形式化](#222-借用规则形式化)
    - [2.2.3 生命周期约束](#223-生命周期约束)
- [2 分布式工作流中的仿射类型系统实现](#2-分布式工作流中的仿射类型系统实现)
  - [2.1 分布式资源所有权模型](#21-分布式资源所有权模型)
    - [1.1.1 形式化定义与性质](#111-形式化定义与性质)
    - [1.1.2 理论保证](#112-理论保证)
  ...
  - [2.3 工作流生命周期管理](#23-工作流生命周期管理)
    ...
    - [3.3.2 应用机制](#332-应用机制)
    - [3.3.3 实现示例](#333-实现示例)
  - [2.4 分布式移动语义与移动检查](#24-分布式移动语义与移动检查)
    - [4.4.1 理论模型](#441-理论模型)
    - [4.4.2 实现机制](#442-实现机制)
    - [4.4.3 形式化保证](#443-形式化保证)

...
- [1 分析视角：将架构视为一个受管理的、效应驱动的业务能力平台](#1-分析视角将架构视为一个受管理的效应驱动的业务能力平台)
- [2 关联与对比](#2-关联与对比)
  - [2.1 与工作流模式的关联](#21-与工作流模式的关联)
    - [1.1.1 控制流 (Control Flow)](#111-控制流-control-flow)
    - [1.1.2 数据流 (Data Flow)](#112-数据流-data-flow)
    - [1.1.3 执行流 (Execution Flow)](#113-执行流-execution-flow)
    - [1.1.4 Saga 模式](#114-saga-模式)
  - [2.2 与分布式模式的关联](#22-与分布式模式的关联)
    - [2.2.1 微服务 (Microservices)](#221-微服务-microservices)
    - [2.2.2 Actor 模型](#222-actor-模型)
    - [2.2.3 事件溯源 (Event Sourcing) CQRS](#223-事件溯源-event-sourcing-cqrs)
  - [2.3 与设计模式 (GoF 等) 的关联](#23-与设计模式-gof-等-的关联)
...
## 1 分析视角：将架构视为一个受管理的、效应驱动的业务能力平台
...
#### 2.2.3 事件溯源 (Event Sourcing) CQRS

...
- [1. 工作流框架的实现](#1-工作流框架的实现)
  - [目录](#目录)
  - [1.1 **1. 核心模型 (Metal-Model) 的最小实现 (Rust)**](#11-1-核心模型-metal-model-的最小实现-rust)
  - [1.2 **2. 动态观察的基本子集 (路径可视化接口)**](#12-2-动态观察的基本子集-路径可视化接口)
  - [1.3 **3. Web 日志等可交互界面**](#13-3-web-日志等可交互界面)

...
- [1 hydro分析问题](#1-hydro分析问题)
- [2 hydro分析](#2-hydro分析)
  - [2.1 Hydro 架构设计分析 (基于您提供的特性)](#21-hydro-架构设计分析-基于您提供的特性)
    - [1.1.1 核心模型：数据流 (Dataflow)](#111-核心模型数据流-dataflow)
    - [1.1.2 分阶段编译 (Staged Compilation)](#112-分阶段编译-staged-compilation)
    - [1.1.3 Hydroflow 语言](#113-hydroflow-语言)
    - [1.1.4 Hydro Deploy 集成](#114-hydro-deploy-集成)
...
### 2.1 Hydro 架构设计分析 (基于您提供的特性)

#### 1.1.1 核心模型：数据流 (Dataflow)
...
#### 1.1.2 分阶段编译 (Staged Compilation)

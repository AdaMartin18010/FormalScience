# 1. 计算模型与架构形式化：物理实现、控制流与一致性分析

## 目录

- [1. 计算模型与架构形式化：物理实现、控制流与一致性分析](#1-计算模型与架构形式化物理实现控制流与一致性分析)
  - [目录](#目录)
  - [1.1 物理计算模型形式化](#11-物理计算模型形式化)
    - [1.1.1 冯诺依曼架构形式化](#111-冯诺依曼架构形式化)
    - [1.1.2 哈佛架构形式化](#112-哈佛架构形式化)
    - [1.1.3 数据流架构形式化](#113-数据流架构形式化)
    - [1.1.4 异构计算架构形式化](#114-异构计算架构形式化)
  - [1.2 指令级并行与SIMD形式化](#12-指令级并行与simd形式化)
    - [1.2.1 流水线模型](#121-流水线模型)
    - [1.2.2 SIMD计算模型](#122-simd计算模型)
    - [1.2.3 向量处理模型](#123-向量处理模型)
  - [1.3 CPU-GPU异构计算形式化](#13-cpu-gpu异构计算形式化)
    - [1.3.1 GPU计算模型](#131-gpu计算模型)
    - [1.3.2 内存层次模型](#132-内存层次模型)
    - [1.3.3 同步与调度模型](#133-同步与调度模型)
  - [1.4 控制流形式化](#14-控制流形式化)
    - [1.4.1 控制流图模型](#141-控制流图模型)
    - [1.4.2 分支预测形式化](#142-分支预测形式化)
    - [1.4.3 异常处理模型](#143-异常处理模型)
  - [1.5 容错与一致性形式化](#15-容错与一致性形式化)
    - [1.5.1 容错模型](#151-容错模型)
    - [1.5.2 一致性协议](#152-一致性协议)
    - [1.5.3 共识算法形式化](#153-共识算法形式化)
  - [1.6 思维导图](#16-思维导图)

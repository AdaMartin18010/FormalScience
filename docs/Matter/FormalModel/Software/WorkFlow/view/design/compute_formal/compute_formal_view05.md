...
- [1. 数据模型与计算执行的不相容性分析](#1-数据模型与计算执行的不相容性分析)
  - [目录](#目录)
  - [1.1 数据模型的不相容性](#11-数据模型的不相容性)
    - [1.1.1 离散与连续的边界](#111-离散与连续的边界)
    - [1.1.2 线性与非线性结构](#112-线性与非线性结构)
    - [1.1.3 确定性与概率模型](#113-确定性与概率模型)
  - [1.2 分析-执行-表达的映射问题](#12-分析-执行-表达的映射问题)
    - [1.2.1 数据分析模型到执行模型](#121-数据分析模型到执行模型)
    - [1.2.2 执行模型到程序表达](#122-执行模型到程序表达)
    - [1.2.3 跨层次优化冲突](#123-跨层次优化冲突)
  - [1.3 理论框架与实践权衡](#13-理论框架与实践权衡)
    - [1.3.1 现有理论框架评述](#131-现有理论框架评述)
    - [1.3.2 工程实践中的权衡策略](#132-工程实践中的权衡策略)
  - [1.4 思维导图](#14-思维导图)

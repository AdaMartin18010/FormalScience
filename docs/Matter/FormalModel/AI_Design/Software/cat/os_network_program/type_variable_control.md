...
- [1. 范畴论视角下的程序语言基础要素分析](#1-范畴论视角下的程序语言基础要素分析)
  - [目录](#目录)
  - [1.1 类型范畴 (TypeCat)](#11-类型范畴-typecat)
    - [1.1.1 基本类型范畴](#111-基本类型范畴)
    - [1.1.2 类型关系函子](#112-类型关系函子)
    - [1.1.3 类型系统单子](#113-类型系统单子)
  - [1.2 变量范畴 (VarCat)](#12-变量范畴-varcat)
    - [1.2.1 变量状态范畴](#121-变量状态范畴)
    - [1.2.2 变量作用域函子](#122-变量作用域函子)
    - [1.2.3 变量绑定单子](#123-变量绑定单子)
  - [1.3 控制流范畴 (ControlCat)](#13-控制流范畴-controlcat)
    - [1.3.1 控制流基础范畴](#131-控制流基础范畴)
    - [1.3.2 控制流变换函子](#132-控制流变换函子)
    - [1.3.3 控制流单子](#133-控制流单子)
  - [1.4 类型-变量-控制的交互](#14-类型-变量-控制的交互)
    - [1.4.1 交互范畴](#141-交互范畴)
    - [1.4.2 语义函子](#142-语义函子)
  - [1.5 程序变换与优化](#15-程序变换与优化)
    - [1.5.1 变换范畴](#151-变换范畴)
    - [1.5.2 优化函子](#152-优化函子)
  - [1.6 实际应用示例](#16-实际应用示例)
    - [1.6.1 类型系统实现](#161-类型系统实现)
    - [1.6.2 变量作用域处理](#162-变量作用域处理)
    - [1.6.3 控制流分析](#163-控制流分析)
  - [1.7 总结](#17-总结)

...
- [1. 范畴论视角下的程序设计](#1-范畴论视角下的程序设计)
  - [目录](#目录)
  - [1.1 程序范畴基础](#11-程序范畴基础)
    - [1.1.1 类型与值范畴](#111-类型与值范畴)
    - [1.1.2 计算态射](#112-计算态射)
  - [1.2 函子与程序变换](#12-函子与程序变换)
    - [1.2.1 数据转换函子](#121-数据转换函子)
    - [1.2.2 程序转换函子](#122-程序转换函子)
  - [1.3 单子与计算效应](#13-单子与计算效应)
    - [1.3.1 计算单子](#131-计算单子)
    - [1.3.2 效应系统](#132-效应系统)
  - [1.4 类型系统的范畴基础](#14-类型系统的范畴基础)
    - [1.4.1 多态类型函子](#141-多态类型函子)
    - [1.4.2 依赖类型范畴](#142-依赖类型范畴)
  - [1.5 程序组合与抽象](#15-程序组合与抽象)
    - [1.5.1 组合子范畴](#151-组合子范畴)
    - [1.5.2 设计模式的范畴表示](#152-设计模式的范畴表示)
  - [1.6 代数数据类型](#16-代数数据类型)
    - [1.6.1 代数类型构造](#161-代数类型构造)
    - [1.6.2 递归类型和不动点](#162-递归类型和不动点)
  - [1.7 并发与分布式的范畴模型](#17-并发与分布式的范畴模型)
    - [1.7.1 并发计算范畴](#171-并发计算范畴)
    - [1.7.2 分布式系统范畴](#172-分布式系统范畴)
  - [1.8 语义与验证](#18-语义与验证)
    - [1.8.1 程序语义范畴](#181-程序语义范畴)
    - [1.8.2 程序验证范畴](#182-程序验证范畴)
  - [1.9 用范畴论设计编程语言](#19-用范畴论设计编程语言)
    - [1.9.1 语言构造的范畴理论](#191-语言构造的范畴理论)
    - [1.9.2 语言特性的范畴实现](#192-语言特性的范畴实现)
  - [1.10 总结与实践应用](#110-总结与实践应用)

...
- [1. 范畴论视角下的事件流与数据流区别](#1-范畴论视角下的事件流与数据流区别)
  - [目录](#目录)
  - [1.1 基本范畴定义](#11-基本范畴定义)
    - [1.1.1 本质特性对比](#111-本质特性对比)
  - [1.2 形式属性](#12-形式属性)
    - [1.2.1 时序特性](#121-时序特性)
    - [1.2.2 驱动模型](#122-驱动模型)
  - [1.3 代数结构](#13-代数结构)
    - [1.3.1 组合规则](#131-组合规则)
  - [1.4 变换与函子](#14-变换与函子)
    - [1.4.1 事件到数据转换](#141-事件到数据转换)
    - [1.4.2 数据到事件转换](#142-数据到事件转换)
  - [1.5 单子表达](#15-单子表达)
    - [1.5.1 事件流单子](#151-事件流单子)
    - [1.5.2 数据流单子](#152-数据流单子)
  - [1.6 实际应用对比](#16-实际应用对比)
    - [1.6.1 典型场景](#161-典型场景)
    - [1.6.2 技术实现](#162-技术实现)
  - [1.7 范畴论视角的核心差异总结](#17-范畴论视角的核心差异总结)

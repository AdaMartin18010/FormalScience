...
- [范畴论视角下的分布式系统](#范畴论视角下的分布式系统)
  - [📋 目录](#-目录)
  - [1 分布式基础范畴 (DistributedCat)](#1-分布式基础范畴-distributedcat)
    - [1.1 节点范畴](#11-节点范畴)
    - [1.2 通信范畴](#12-通信范畴)
  - [2 一致性范畴 (ConsistencyCat)](#2-一致性范畴-consistencycat)
    - [2.1 一致性模型](#21-一致性模型)
    - [2.2 共识范畴](#22-共识范畴)
  - [3 分布式状态范畴](#3-分布式状态范畴)
    - [3.1 状态管理](#31-状态管理)
  ...
  - [6 分布式事务范畴](#6-分布式事务范畴)
    - [6.1 事务管理](#61-事务管理)
    - [6.2 2 2PC3PC协议](#62-2-2pc3pc协议)
  - [7 分布式存储范畴](#7-分布式存储范畴)
    - [7.1 存储模型](#71-存储模型)
    - [7.2 分区策略](#72-分区策略)
  - [8 实际应用示例](#8-实际应用示例)
    - [8.1 分布式锁实现](#81-分布式锁实现)
    - [8.2 一致性实现](#82-一致性实现)
  - [9 总结](#9-总结)

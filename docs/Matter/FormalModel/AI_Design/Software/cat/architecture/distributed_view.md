...
- [1. 范畴论视角下的分布式系统](#1-范畴论视角下的分布式系统)
  - [目录](#目录)
  - [1.1 分布式基础范畴 (DistributedCat)](#11-分布式基础范畴-distributedcat)
    - [1.1.1 节点范畴](#111-节点范畴)
    - [1.1.2 通信范畴](#112-通信范畴)
  - [1.2 一致性范畴 (ConsistencyCat)](#12-一致性范畴-consistencycat)
    - [1.2.1 一致性模型](#121-一致性模型)
    - [1.2.2 共识范畴](#122-共识范畴)
  - [1.3 分布式状态范畴](#13-分布式状态范畴)
    - [1.3.1 状态管理](#131-状态管理)
    - [1.3.2 复制函子](#132-复制函子)
  - [1.4 故障处理范畴](#14-故障处理范畴)
    - [1.4.1 故障模型](#141-故障模型)
    - [1.4.2 容错机制](#142-容错机制)
  - [1.5 分布式算法范畴](#15-分布式算法范畴)
    - [1.5.1 选举算法](#151-选举算法)
    - [1.5.2 时钟同步](#152-时钟同步)
  - [1.6 分布式事务范畴](#16-分布式事务范畴)
    - [1.6.1 事务管理](#161-事务管理)
    - [1.6.2 2 2PC3PC协议](#162-2-2pc3pc协议)
  - [1.7 分布式存储范畴](#17-分布式存储范畴)
    - [1.7.1 存储模型](#171-存储模型)
    - [1.7.2 分区策略](#172-分区策略)
  - [1.8 实际应用示例](#18-实际应用示例)
    - [1.8.1 分布式锁实现](#181-分布式锁实现)
    - [1.8.2 一致性实现](#182-一致性实现)
  - [1.9 总结](#19-总结)

## 1.1 分布式基础范畴 (DistributedCat)

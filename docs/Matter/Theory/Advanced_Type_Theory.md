# 1. 高级类型理论 (Advanced Type Theory)

## 目录

- [1. 高级类型理论 (Advanced Type Theory)](#1-高级类型理论-advanced-type-theory)
  - [目录](#目录)
  - [1.1 范畴论基础](#11-范畴论基础)
    - [1.1.1 类型作为范畴](#111-类型作为范畴)
    - [1.1.2 函子与自然变换](#112-函子与自然变换)
  - [1.2 高阶类型系统](#12-高阶类型系统)
    - [1.2.1 系统Fω](#121-系统fω)
    - [1.2.2 依赖类型系统](#122-依赖类型系统)
  - [1.3 同伦类型理论](#13-同伦类型理论)
    - [1.3.1 类型作为空间](#131-类型作为空间)
    - [1.3.2 高阶归纳类型](#132-高阶归纳类型)
  - [1.4 线性逻辑与类型](#14-线性逻辑与类型)
    - [1.4.1 线性逻辑基础](#141-线性逻辑基础)
    - [1.4.2 线性类型系统](#142-线性类型系统)
  - [1.5 量子类型理论](#15-量子类型理论)
    - [1.5.1 量子计算基础](#151-量子计算基础)
    - [1.5.2 量子类型系统](#152-量子类型系统)
  - [1.6 类型系统的语义](#16-类型系统的语义)
    - [1.6.1 指称语义](#161-指称语义)
    - [1.6.2 操作语义](#162-操作语义)
  - [1.7 类型推断算法](#17-类型推断算法)
    - [1.7.1 Hindley-Milner类型系统](#171-hindley-milner类型系统)
    - [1.7.2 约束生成](#172-约束生成)
  - [1.8 类型系统的元理论](#18-类型系统的元理论)
    - [1.8.1 强正规化](#181-强正规化)
    - [1.8.2 一致性](#182-一致性)
    - [1.8.3 完备性](#183-完备性)
  - [1.9 结论](#19-结论)

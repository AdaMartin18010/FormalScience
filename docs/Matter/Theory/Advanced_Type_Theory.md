...
- [1 范畴论基础](#1-范畴论基础)
  - [1.1 类型作为范畴](#11-类型作为范畴)
  - [1.2 函子与自然变换](#12-函子与自然变换)
- [2 高阶类型系统](#2-高阶类型系统)
  - [2.1 系统Fω](#21-系统fω)
  - [2.2 依赖类型系统](#22-依赖类型系统)
- [3 同伦类型理论](#3-同伦类型理论)
  - [3.1 类型作为空间](#31-类型作为空间)
  - [3.2 高阶归纳类型](#32-高阶归纳类型)
- [4 线性逻辑与类型](#4-线性逻辑与类型)
  - [4.1 线性逻辑基础](#41-线性逻辑基础)
  - [4.2 线性类型系统](#42-线性类型系统)
- [5 量子类型理论](#5-量子类型理论)
  - [5.1 量子计算基础](#51-量子计算基础)
  - [5.2 量子类型系统](#52-量子类型系统)
- [6 类型系统的语义](#6-类型系统的语义)
  - [6.1 指称语义](#61-指称语义)
  - [6.2 操作语义](#62-操作语义)
- [7 类型推断算法](#7-类型推断算法)
  - [7.1 Hindley-Milner类型系统](#71-hindley-milner类型系统)
  - [7.2 约束生成](#72-约束生成)
- [8 类型系统的元理论](#8-类型系统的元理论)
  - [8.1 强正规化](#81-强正规化)
  - [8.2 一致性](#82-一致性)
  - [8.3 完备性](#83-完备性)
- [9 结论](#9-结论)

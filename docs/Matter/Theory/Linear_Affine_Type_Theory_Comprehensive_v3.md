# 1. 线性与仿射类型理论综合深化：资源管理与类型安全的形式化框架 v3.0

## 目录

- [1. 线性与仿射类型理论综合深化：资源管理与类型安全的形式化框架 v3.0](#1-线性与仿射类型理论综合深化资源管理与类型安全的形式化框架-v30)
  - [目录](#目录)
  - [1.1 理论基础与动机](#11-理论基础与动机)
    - [1.1.1 资源管理的数学基础](#111-资源管理的数学基础)
    - [1.1.2 类型系统的资源视角](#112-类型系统的资源视角)
  - [1.2 线性类型理论](#12-线性类型理论)
    - [1.2.1 线性λ-演算](#121-线性λ-演算)
    - [1.2.2 线性逻辑](#122-线性逻辑)
    - [1.2.3 线性类型系统的语义](#123-线性类型系统的语义)
  - [1.3 仿射类型理论](#13-仿射类型理论)
    - [1.3.1 仿射λ-演算](#131-仿射λ-演算)
    - [1.3.2 仿射逻辑](#132-仿射逻辑)
    - [1.3.3 资源管理语义](#133-资源管理语义)
  - [1.4 时态类型理论](#14-时态类型理论)
    - [1.4.1 时态类型系统](#141-时态类型系统)
    - [1.4.2 时态逻辑与类型](#142-时态逻辑与类型)
  - [1.5 量子类型理论](#15-量子类型理论)
    - [1.5.1 量子类型系统](#151-量子类型系统)
    - [1.5.2 量子逻辑与类型](#152-量子逻辑与类型)
  - [1.6 理论统一性与扩展](#16-理论统一性与扩展)
    - [1.6.1 统一框架](#161-统一框架)
    - [1.6.2 理论扩展](#162-理论扩展)

# 1. 分布式系统与共识理论综合深化：从理论基础到工程实践 v3.0

## 目录

- [1. 分布式系统与共识理论综合深化：从理论基础到工程实践 v3.0](#1-分布式系统与共识理论综合深化从理论基础到工程实践-v30)
  - [目录](#目录)
  - [1.1 分布式系统基础理论](#11-分布式系统基础理论)
    - [1.1.1 分布式系统模型](#111-分布式系统模型)
    - [1.1.2 故障模型](#112-故障模型)
    - [1.1.3 一致性模型](#113-一致性模型)
  - [1.2 共识问题与不可能性](#12-共识问题与不可能性)
    - [1.2.1 共识问题定义](#121-共识问题定义)
    - [1.2.2 部分同步模型](#122-部分同步模型)
  - [1.3 经典共识算法](#13-经典共识算法)
    - [1.3.1 Paxos算法](#131-paxos算法)
    - [1.3.2 Raft算法](#132-raft算法)
    - [1.3.3 PBFT算法](#133-pbft算法)
  - [1.4 拜占庭容错理论](#14-拜占庭容错理论)
    - [1.4.1 拜占庭故障模型](#141-拜占庭故障模型)
    - [1.4.2 拜占庭共识算法](#142-拜占庭共识算法)
  - [1.5 区块链与分布式账本](#15-区块链与分布式账本)
    - [1.5.1 区块链基础](#151-区块链基础)
    - [1.5.2 权益证明](#152-权益证明)
  - [1.6 形式化验证与模型检查](#16-形式化验证与模型检查)
    - [1.6.1 分布式系统建模](#161-分布式系统建模)
    - [1.6.2 形式化证明](#162-形式化证明)
  - [1.7 性能与可扩展性分析](#17-性能与可扩展性分析)
    - [1.7.1 性能指标](#171-性能指标)
    - [1.7.2 可扩展性技术](#172-可扩展性技术)
  - [1.8 批判性分析与展望](#18-批判性分析与展望)

# 1. 时态逻辑控制 (Temporal Logic Control)

## 目录

- [1. 时态逻辑控制 (Temporal Logic Control)](#1-时态逻辑控制-temporal-logic-control)
  - [目录](#目录)
  - [1.1 时态逻辑基础](#11-时态逻辑基础)
    - [1.1.1 线性时态逻辑 (LTL)](#111-线性时态逻辑-ltl)
    - [1.1.2 计算树逻辑 (CTL)](#112-计算树逻辑-ctl)
  - [1.2 模型检查](#12-模型检查)
    - [1.2.1 状态空间表示](#121-状态空间表示)
    - [1.2.2 自动机理论](#122-自动机理论)
  - [1.3 控制系统验证](#13-控制系统验证)
    - [1.3.1 混合系统](#131-混合系统)
    - [1.3.2 安全性质验证](#132-安全性质验证)
  - [1.4 时态逻辑控制](#14-时态逻辑控制)
    - [1.4.1 控制综合](#141-控制综合)
    - [1.4.2 反应性控制](#142-反应性控制)
  - [1.5 实时时态逻辑](#15-实时时态逻辑)
    - [1.5.1 时间约束](#151-时间约束)
    - [1.5.2 实时控制](#152-实时控制)
  - [1.6 概率时态逻辑](#16-概率时态逻辑)
    - [1.6.1 概率CTL](#161-概率ctl)
    - [1.6.2 概率控制](#162-概率控制)
  - [1.7 实际应用](#17-实际应用)
    - [1.7.1 自动驾驶](#171-自动驾驶)

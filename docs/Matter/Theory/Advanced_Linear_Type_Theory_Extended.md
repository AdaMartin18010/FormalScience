# 1. 高级线性类型理论扩展 (Advanced Linear Type Theory Extended)

## 目录

- [1. 高级线性类型理论扩展 (Advanced Linear Type Theory Extended)](#1-高级线性类型理论扩展-advanced-linear-type-theory-extended)
  - [目录](#目录)
  - [1.1 线性逻辑深度分析](#11-线性逻辑深度分析)
    - [1.1.1 线性逻辑公理系统](#111-线性逻辑公理系统)
    - [1.1.2 张量积类型](#112-张量积类型)
  - [1.2 指数类型理论](#12-指数类型理论)
    - [1.2.1 指数类型规则](#121-指数类型规则)
    - [1.2.2 指数类型语义](#122-指数类型语义)
  - [1.3 资源管理理论](#13-资源管理理论)
    - [1.3.1 资源类型系统](#131-资源类型系统)
    - [1.3.2 内存管理](#132-内存管理)
  - [1.4 并发安全理论](#14-并发安全理论)
    - [1.4.1 线性类型与并发](#141-线性类型与并发)
    - [1.4.2 所有权系统](#142-所有权系统)
  - [1.5 线性逻辑语义](#15-线性逻辑语义)
    - [1.5.1 指称语义](#151-指称语义)
    - [1.5.2 操作语义](#152-操作语义)
  - [1.6 高级线性类型构造](#16-高级线性类型构造)
    - [1.6.1 线性单子](#161-线性单子)
    - [1.6.2 线性效应系统](#162-线性效应系统)
  - [1.7 实际应用](#17-实际应用)
    - [1.7.1 Rust所有权系统](#171-rust所有权系统)
    - [1.7.2 函数式编程中的线性类型](#172-函数式编程中的线性类型)
  - [1.8 线性类型系统元理论](#18-线性类型系统元理论)
    - [1.8.1 类型推断](#181-类型推断)
    - [1.8.2 类型等价性](#182-类型等价性)
  - [1.9 结论](#19-结论)
  - [1.10 参考文献](#110-参考文献)

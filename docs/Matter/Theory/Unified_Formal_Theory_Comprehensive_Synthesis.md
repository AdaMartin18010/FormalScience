...
- [1 统一形式理论综合示例片段](#1-统一形式理论综合示例片段)
  - [1.1 形式理论统一框架](#11-形式理论统一框架)
    - [1.1.1 形式系统定义](#111-形式系统定义)
    - [1.1.2 形式语言与编程语言的关系](#112-形式语言与编程语言的关系)
    - [1.1.3 系统设计的形式化](#113-系统设计的形式化)
  - [1.2 类型理论深化](#12-类型理论深化)
    - [2.2.1 类型系统的形式定义](#221-类型系统的形式定义)
    - [2.2.2 线性仿射时态类型的扩展](#222-线性仿射时态类型的扩展)
  - [1.3 Petri网、控制论、分布式系统](#13-petri网控制论分布式系统)
    - [3.3.1 Petri网的形式定义与定理](#331-petri网的形式定义与定理)
    - [3.3.2 控制论与时态逻辑控制](#332-控制论与时态逻辑控制)
    - [3.3.3 分布式系统理论](#333-分布式系统理论)
  - [1.4 形式语言理论](#14-形式语言理论)
  - [1.5 场景化分析与批判性论证](#15-场景化分析与批判性论证)
  - [1.6 结论与展望](#16-结论与展望)
...
### 1.3 Petri网、控制论、分布式系统

#### 3.3.1 Petri网的形式定义与定理

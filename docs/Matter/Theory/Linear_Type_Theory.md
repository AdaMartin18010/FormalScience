...
- [1. 线性类型理论 (Linear Type Theory)](#1-线性类型理论-linear-type-theory)
  - [目录](#目录)
  - [1.1 线性逻辑基础](#11-线性逻辑基础)
    - [1.1.1 线性逻辑公理系统](#111-线性逻辑公理系统)
    - [1.1.2 线性性约束](#112-线性性约束)
  - [1.2 资源管理理论](#12-资源管理理论)
    - [1.2.1 资源类型系统](#121-资源类型系统)
    - [1.2.2 内存管理](#122-内存管理)
  - [1.3 线性逻辑的语义](#13-线性逻辑的语义)
    - [1.3.1 指称语义](#131-指称语义)
    - [1.3.2 操作语义](#132-操作语义)
  - [1.4 指数类型 ()](#14-指数类型-)
    - [1.4.1 指数类型规则](#141-指数类型规则)
    - [1.4.2 指数类型的语义](#142-指数类型的语义)

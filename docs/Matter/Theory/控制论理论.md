# 1. 控制论理论 (Control Theory)

## 目录

- [1. 控制论理论 (Control Theory)](#1-控制论理论-control-theory)
  - [目录](#目录)
  - [1.1 概述](#11-概述)
  - [1.2 基础概念](#12-基础概念)
    - [1.2.1 系统建模](#121-系统建模)
    - [1.2.2 系统特性分析](#122-系统特性分析)
  - [1.3 控制器设计](#13-控制器设计)
    - [1.3.1 状态反馈控制](#131-状态反馈控制)
    - [1.3.2 输出反馈控制](#132-输出反馈控制)
    - [1.3.3 自适应控制](#133-自适应控制)
  - [1.4 鲁棒控制](#14-鲁棒控制)
    - [1.4.1 H控制](#141-h控制)
    - [1.4.2 μ综合](#142-μ综合)
  - [1.5 非线性控制](#15-非线性控制)
    - [1.5.1 反馈线性化](#151-反馈线性化)
    - [1.5.2 滑模控制](#152-滑模控制)
  - [1.6 智能控制](#16-智能控制)
    - [1.6.1 模糊控制](#161-模糊控制)
    - [1.6.2 神经网络控制](#162-神经网络控制)
  - [1.7 应用领域](#17-应用领域)
    - [1.7.1 工业控制](#171-工业控制)

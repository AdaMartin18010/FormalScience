# 1. 高级线性类型理论 (Advanced Linear Type Theory)

## 目录

- [1. 高级线性类型理论 (Advanced Linear Type Theory)](#1-高级线性类型理论-advanced-linear-type-theory)
  - [目录](#目录)
  - [1.1 线性逻辑的代数结构](#11-线性逻辑的代数结构)
    - [1.1.1 线性逻辑作为代数](#111-线性逻辑作为代数)
    - [1.1.2 线性逻辑的范畴语义](#112-线性逻辑的范畴语义)
  - [1.2 高阶线性类型系统](#12-高阶线性类型系统)
    - [1.2.1 线性λ演算](#121-线性λ演算)
    - [1.2.2 线性逻辑编程](#122-线性逻辑编程)
  - [1.3 资源管理理论](#13-资源管理理论)
    - [1.3.1 资源类型系统](#131-资源类型系统)
    - [1.3.2 内存管理](#132-内存管理)
    - [1.3.3 并发资源管理](#133-并发资源管理)
  - [1.4 线性逻辑的语义](#14-线性逻辑的语义)
    - [1.4.1 指称语义](#141-指称语义)
    - [1.4.2 操作语义](#142-操作语义)
  - [1.5 线性类型系统的扩展](#15-线性类型系统的扩展)
    - [1.5.1 仿射类型](#151-仿射类型)
    - [1.5.2 相关类型](#152-相关类型)
  - [1.6 实际应用](#16-实际应用)
    - [1.6.1 Rust所有权系统](#161-rust所有权系统)
    - [1.6.2 函数式编程中的线性类型](#162-函数式编程中的线性类型)
    - [1.6.3 并发编程](#163-并发编程)
  - [1.7 线性类型系统的元理论](#17-线性类型系统的元理论)
    - [1.7.1 强正规化](#171-强正规化)
    - [1.7.2 类型推断](#172-类型推断)
    - [1.7.3 类型检查](#173-类型检查)
  - [1.8 结论](#18-结论)

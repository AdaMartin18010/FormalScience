# 1. 高级类型理论扩展 (Advanced Type Theory Extended)

## 目录

- [1. 高级类型理论扩展 (Advanced Type Theory Extended)](#1-高级类型理论扩展-advanced-type-theory-extended)
  - [目录](#目录)
  - [1.1 依赖类型系统深度分析](#11-依赖类型系统深度分析)
    - [1.1.1 马丁-洛夫类型理论](#111-马丁-洛夫类型理论)
    - [1.1.2 同伦类型理论基础](#112-同伦类型理论基础)
  - [1.2 高阶类型系统](#12-高阶类型系统)
    - [1.2.1 类型构造子](#121-类型构造子)
    - [1.2.2 单子理论](#122-单子理论)
  - [1.3 类型系统元理论](#13-类型系统元理论)
    - [1.3.1 强正规化](#131-强正规化)
    - [1.3.2 类型安全](#132-类型安全)
  - [1.4 高级类型构造](#14-高级类型构造)
    - [1.4.1 存在类型](#141-存在类型)
    - [1.4.2 递归类型](#142-递归类型)
  - [1.5 类型推断算法](#15-类型推断算法)
    - [1.5.1 Hindley-Milner类型系统](#151-hindley-milner类型系统)
    - [1.5.2 合一算法](#152-合一算法)
  - [1.6 类型系统语义](#16-类型系统语义)
    - [1.6.1 指称语义](#161-指称语义)
    - [1.6.2 操作语义](#162-操作语义)
  - [1.7 高级类型系统应用](#17-高级类型系统应用)
    - [1.7.1 类型安全编程](#171-类型安全编程)
    - [1.7.2 抽象数据类型](#172-抽象数据类型)
  - [1.8 结论](#18-结论)
  - [1.9 参考文献](#19-参考文献)

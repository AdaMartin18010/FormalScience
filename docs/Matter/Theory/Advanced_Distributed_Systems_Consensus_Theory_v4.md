# 1. 高级分布式系统与共识理论：形式化基础与系统设计应用

## 目录

- [1. 高级分布式系统与共识理论：形式化基础与系统设计应用](#1-高级分布式系统与共识理论形式化基础与系统设计应用)
  - [目录](#目录)
  - [1.1 引言：分布式系统的挑战与机遇](#11-引言分布式系统的挑战与机遇)
    - [1.1.1 分布式系统的定义与特征](#111-分布式系统的定义与特征)
    - [1.1.2 分布式系统的挑战](#112-分布式系统的挑战)
  - [1.2 分布式系统基础理论](#12-分布式系统基础理论)
    - [1.2.1 系统模型](#121-系统模型)
    - [1.2.2 故障模型](#122-故障模型)
    - [1.2.3 网络模型](#123-网络模型)
  - [1.3 共识问题的形式化](#13-共识问题的形式化)
    - [1.3.1 共识问题定义](#131-共识问题定义)
    - [1.3.2 共识问题的复杂性](#132-共识问题的复杂性)
    - [1.3.3 共识变种](#133-共识变种)
  - [1.4 经典共识算法](#14-经典共识算法)
    - [1.4.1 Paxos算法](#141-paxos算法)
    - [1.4.2 Raft算法](#142-raft算法)
    - [1.4.3 PBFT算法](#143-pbft算法)
  - [1.5 拜占庭容错共识](#15-拜占庭容错共识)
    - [1.5.1 拜占庭问题](#151-拜占庭问题)
    - [1.5.2 拜占庭算法](#152-拜占庭算法)
    - [1.5.3 实用拜占庭容错](#153-实用拜占庭容错)
  - [1.6 区块链共识机制](#16-区块链共识机制)
    - [1.6.1 工作量证明](#161-工作量证明)
    - [1.6.2 权益证明](#162-权益证明)
    - [1.6.3 委托权益证明](#163-委托权益证明)
  - [1.7 分布式系统验证](#17-分布式系统验证)
    - [1.7.1 形式化验证](#171-形式化验证)
    - [1.7.2 模型检查](#172-模型检查)
    - [1.7.3 抽象精化](#173-抽象精化)
  - [1.8 系统设计中的应用](#18-系统设计中的应用)
    - [1.8.1 分布式数据库](#181-分布式数据库)
    - [1.8.2 微服务架构](#182-微服务架构)
    - [1.8.3 容器编排](#183-容器编排)
  - [1.9 结论：分布式理论的批判性综合](#19-结论分布式理论的批判性综合)

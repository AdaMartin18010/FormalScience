...
- [4 仿射逻辑的语义](#4-仿射逻辑的语义)
  - [4.1 指称语义](#41-指称语义)
  - [4.2 操作语义](#42-操作语义)
- [5 与线性类型的比较](#5-与线性类型的比较)
  - [5.1 类型系统对比](#51-类型系统对比)
  - [5.2 表达能力](#52-表达能力)
- [6 实际应用](#6-实际应用)
  - [6.1 Rust 的所有权系统](#61-rust-的所有权系统)
  - [6.2 函数式编程中的仿射类型](#62-函数式编程中的仿射类型)
- [7 仿射类型系统的扩展](#7-仿射类型系统的扩展)
  - [7.1 区域类型](#71-区域类型)
  - [7.2 能力类型](#72-能力类型)
- [8 仿射类型系统的元理论](#8-仿射类型系统的元理论)
  - [8.1 强正规化](#81-强正规化)
  - [8.2 类型推断](#82-类型推断)
- [9 结论](#9-结论)

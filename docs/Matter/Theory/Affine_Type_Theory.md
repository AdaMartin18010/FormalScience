# 1. 仿射类型理论 (Affine Type Theory)

## 目录

- [1. 仿射类型理论 (Affine Type Theory)](#1-仿射类型理论-affine-type-theory)
  - [目录](#目录)
  - [1.1 仿射逻辑基础](#11-仿射逻辑基础)
    - [1.1.1 仿射逻辑公理系统](#111-仿射逻辑公理系统)
    - [1.1.2 仿射性约束](#112-仿射性约束)
  - [1.2 所有权系统](#12-所有权系统)
    - [1.2.1 所有权类型](#121-所有权类型)
    - [1.2.2 生命周期管理](#122-生命周期管理)
  - [1.3 内存管理理论](#13-内存管理理论)
    - [1.3.1 仿射引用](#131-仿射引用)
    - [1.3.2 借用检查](#132-借用检查)
  - [1.4 仿射逻辑的语义](#14-仿射逻辑的语义)
    - [1.4.1 指称语义](#141-指称语义)
    - [1.4.2 操作语义](#142-操作语义)
  - [1.5 与线性类型的比较](#15-与线性类型的比较)
    - [1.5.1 类型系统对比](#151-类型系统对比)
    - [1.5.2 表达能力](#152-表达能力)
  - [1.6 实际应用](#16-实际应用)
    - [1.6.1 Rust 的所有权系统](#161-rust-的所有权系统)
    - [1.6.2 函数式编程中的仿射类型](#162-函数式编程中的仿射类型)
  - [1.7 仿射类型系统的扩展](#17-仿射类型系统的扩展)
    - [1.7.1 区域类型](#171-区域类型)
    - [1.7.2 能力类型](#172-能力类型)
  - [1.8 仿射类型系统的元理论](#18-仿射类型系统的元理论)
    - [1.8.1 强正规化](#181-强正规化)
    - [1.8.2 类型推断](#182-类型推断)
  - [1.9 结论](#19-结论)

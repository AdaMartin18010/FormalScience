# 1. 控制论 (Control Theory)

## 目录

- [1. 控制论 (Control Theory)](#1-控制论-control-theory)
  - [目录](#目录)
  - [1.1 控制系统基础](#11-控制系统基础)
    - [1.1.1 系统定义](#111-系统定义)
    - [1.1.2 线性系统](#112-线性系统)
  - [1.2 稳定性分析](#12-稳定性分析)
    - [1.2.1 李雅普诺夫稳定性](#121-李雅普诺夫稳定性)
    - [1.2.2 线性系统稳定性](#122-线性系统稳定性)
  - [1.3 可控性和可观性](#13-可控性和可观性)
    - [1.3.1 可控性](#131-可控性)
    - [1.3.2 可观性](#132-可观性)
  - [1.4 反馈控制](#14-反馈控制)
    - [1.4.1 状态反馈](#141-状态反馈)
    - [1.4.2 输出反馈](#142-输出反馈)
    - [1.4.3 观测器设计](#143-观测器设计)
  - [1.5 最优控制](#15-最优控制)
    - [1.5.1 线性二次型调节器](#151-线性二次型调节器)
    - [1.5.2 卡尔曼滤波器](#152-卡尔曼滤波器)
  - [1.6 鲁棒控制](#16-鲁棒控制)
    - [1.6.1 H控制](#161-h控制)
    - [1.6.2 μ综合](#162-μ综合)
  - [1.7 自适应控制](#17-自适应控制)
    - [1.7.1 模型参考自适应控制](#171-模型参考自适应控制)
  - [1.8 结论](#18-结论)

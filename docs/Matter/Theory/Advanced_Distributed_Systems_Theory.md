# 1. 高级分布式系统理论 (Advanced Distributed Systems Theory)

## 目录

- [1. 高级分布式系统理论 (Advanced Distributed Systems Theory)](#1-高级分布式系统理论-advanced-distributed-systems-theory)
  - [目录](#目录)
  ...
  - [1.6 分布式事务](#16-分布式事务)
    - [1.6.1 两阶段提交](#161-两阶段提交)
    - [1.6.2 三阶段提交](#162-三阶段提交)
  - [1.7 分布式系统的元理论](#17-分布式系统的元理论)
    - [1.7.1 不可能性结果](#171-不可能性结果)
    - [1.7.2 复杂性结果](#172-复杂性结果)
    - [1.7.3 正确性证明](#173-正确性证明)
  - [1.8 结论](#18-结论)
## 1.1 分布式系统基础

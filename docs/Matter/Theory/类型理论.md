...
- [1. 类型理论 (Type Theory)](#1-类型理论-type-theory)
  - [目录](#目录)
  - [1.1 概述](#11-概述)
  - [1.2 基础类型理论](#12-基础类型理论)
    - [1.2.1 简单类型理论 (Simply Typed Lambda Calculus)](#121-简单类型理论-simply-typed-lambda-calculus)
    - [1.2.2 多态类型理论 (Polymorphic Type Theory)](#122-多态类型理论-polymorphic-type-theory)
  - [1.3 高级类型系统](#13-高级类型系统)
    - [1.3.1 依赖类型理论 (Dependent Type Theory)](#131-依赖类型理论-dependent-type-theory)
    - [1.3.2 线性类型理论 (Linear Type Theory)](#132-线性类型理论-linear-type-theory)
    - [1.3.3 仿射类型理论 (Affine Type Theory)](#133-仿射类型理论-affine-type-theory)
    - [1.3.4 时态类型理论 (Temporal Type Theory)](#134-时态类型理论-temporal-type-theory)
  - [1.4 类型系统应用](#14-类型系统应用)
    - [1.4.1 编程语言类型系统](#141-编程语言类型系统)
      - [1.4.1.1 静态类型系统](#1411-静态类型系统)
      - [1.4.1.2 动态类型系统](#1412-动态类型系统)
    - [1.4.2 类型安全保证](#142-类型安全保证)
      - [1.4.2.1 类型安全定理](#1421-类型安全定理)
  - [1.5 高级主题](#15-高级主题)
    - [1.5.1 类型推导算法](#151-类型推导算法)
      - [1.5.1.1 Hindley-Milner类型推导](#1511-hindley-milner类型推导)
    - [1.5.2 类型系统设计原则](#152-类型系统设计原则)
      - [1.5.2.1 类型系统设计模式](#1521-类型系统设计模式)
  - [1.6 总结](#16-总结)
...
### 1.2.1 简单类型理论 (Simply Typed Lambda Calculus)
...
### 1.2.2 多态类型理论 (Polymorphic Type Theory)
...
### 1.3.1 依赖类型理论 (Dependent Type Theory)
...
### 1.3.2 线性类型理论 (Linear Type Theory)
...
### 1.3.3 仿射类型理论 (Affine Type Theory)
...
### 1.3.4 时态类型理论 (Temporal Type Theory)

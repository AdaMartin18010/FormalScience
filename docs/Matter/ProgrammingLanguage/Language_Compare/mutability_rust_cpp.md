...
- [1. 内部可变性和外部可变性](#1-内部可变性和外部可变性)
  - [目录](#目录)
  - [1.1 内部可变性（Interior Mutability）](#11-内部可变性interior-mutability)
    - [1.1.1 示例](#111-示例)
  - [1.2 外部可变性（External Mutability）](#12-外部可变性external-mutability)
    - [1.2.1 示例](#121-示例)
  - [1.3 区别与联系](#13-区别与联系)
    - [1.3.1 区别](#131-区别)
    - [1.3.2 联系](#132-联系)
  - [1.4 总结](#14-总结)
  - [1.5 对比 1. 内部可变性（Interior Mutability）](#15-对比-1-内部可变性interior-mutability)
    - [1.5.1 Rust 中的内部可变性](#151-rust-中的内部可变性)
    - [1.5.2 C++ 中的内部可变性](#152-c-中的内部可变性)
  - [1.6 对比 2. 外部可变性（External Mutability）](#16-对比-2-外部可变性external-mutability)
    - [1.6.1 Rust 中的外部可变性](#161-rust-中的外部可变性)
    - [1.6.2 C++ 中的外部可变性](#162-c-中的外部可变性)
    - [1.6.3 总结对比](#163-总结对比)
    - [1.6.4 结论](#164-结论)
    - [1.6.5 `mutable` 关键字](#165-mutable-关键字)
    - [1.6.6 常量成员函数](#166-常量成员函数)
    - [1.6.7 示例代码](#167-示例代码)
    - [1.6.8 代码解释](#168-代码解释)
    - [1.6.9 对比示例](#169-对比示例)
    - [1.6.10 总结](#1610-总结)
    - [1.6.11 类型系统](#1611-类型系统)
      - [1.6.11.1 Rust 的类型系统](#16111-rust-的类型系统)
      - [1.6.11.2 C++ 的类型系统](#16112-c-的类型系统)
    - [1.6.12 内存管理](#1612-内存管理)
      - [1.6.12.1 Rust 的内存管理](#16121-rust-的内存管理)
      - [1.6.12.2 C++ 的内存管理](#16122-c-的内存管理)
    - [1.6.13 简约性](#1613-简约性)
      - [1.6.13.1 Rust 的简约性](#16131-rust-的简约性)
      - [1.6.13.2 C++ 的简约性](#16132-c-的简约性)
    - [1.6.14 等效性](#1614-等效性)
      - [1.6.14.1 Rust 的等效性](#16141-rust-的等效性)
      - [1.6.14.2 C++ 的等效性](#16142-c-的等效性)
    - [1.6.15 严谨性](#1615-严谨性)
      - [1.6.15.1 Rust 的严谨性](#16151-rust-的严谨性)
      - [1.6.15.2 C++ 的严谨性](#16152-c-的严谨性)
    - [1.6.16 对比 总结](#1616-对比-总结)
    - [1.6.17 约束变量本身的语义模型](#1617-约束变量本身的语义模型)
      - [1.6.17.1 所有权（Ownership）](#16171-所有权ownership)
      - [1.6.17.2 借用（Borrowing）](#16172-借用borrowing)
      - [1.6.17.3 生命周期（Lifetimes）](#16173-生命周期lifetimes)
    - [1.6.18 约束变量值的语义](#1618-约束变量值的语义)
      - [1.6.18.1 类型系统（Type System）](#16181-类型系统type-system)
      - [1.6.18.2 泛型（Generics）](#16182-泛型generics)
      - [1.6.18.3 Trait（特征）](#16183-trait特征)
    - [1.6.19 对比 _总结_](#1619-对比-总结)
    - [1.6.20 所有权（Ownership）](#1620-所有权ownership)
    - [1.6.21 借用（Borrowing）](#1621-借用borrowing)
    - [1.6.22 生命周期（Lifetimes）](#1622-生命周期lifetimes)
    - [1.6.23 变量所有权、借用和生命周期的关系](#1623-变量所有权借用和生命周期的关系)
    - [1.6.24 示例代码](#1624-示例代码)
    - [1.6.25 _总结_](#1625-总结)

## 1.1 内部可变性（Interior Mutability）
...
## 1.5 对比 1. 内部可变性（Interior Mutability）
...
## 1.6 对比 2. 外部可变性（External Mutability）

...
- [1 C 中的复制语义和移动语义](#1-c-中的复制语义和移动语义)
- [2 Rust 中的所有权和移动语义](#2-rust-中的所有权和移动语义)
- [3 C中的Copy、Clone、Moving语义](#3-c中的copyclonemoving语义)
- [4 Rust中的Copy、Clone、Moving语义](#4-rust中的copyclonemoving语义)
- [5 对比](#5-对比)
  - [5.1 C中的Move语义](#51-c中的move语义)
    - [1.1.1 定义](#111-定义)
  - [5.2 联系和解释](#52-联系和解释)
  - [5.3 Rust中的Move语义](#53-rust中的move语义)
  - [5.4 Rust中的Copy语义](#54-rust中的copy语义)
- [6 类型系统中的变体性：C 与 Rust 对比](#6-类型系统中的变体性c-与-rust-对比)
  - [6.1 一、基本概念定义](#61-一基本概念定义)
    - [1.1.1 可变性 (Mutability)](#111-可变性-mutability)
    - [1.1.2 协变 (Covariance)](#112-协变-covariance)
    - [1.1.3 逆变 (Contravariance)](#113-逆变-contravariance)
    - [1.1.4 不变性 (Invariance)](#114-不变性-invariance)
- [7 二、C 中的变体性](#7-二c-中的变体性)
  - [7.1 可变性](#71-可变性)
  - [7.2 协变](#72-协变)
  - [7.3 逆变](#73-逆变)
  - [7.4 不变性](#74-不变性)
- [8 三、Rust 中的变体性](#8-三rust-中的变体性)
  - [8.1 rust可变性](#81-rust可变性)
  - [8.2 rust协变](#82-rust协变)
  - [8.3 rust逆变](#83-rust逆变)
  - [8.4 rust不变性](#84-rust不变性)
- [9 四、C 与 Rust 对比](#9-四c-与-rust-对比)
  - [9.1 可变性对比](#91-可变性对比)
  - [9.2 协变对比](#92-协变对比)
  - [9.3 逆变对比](#93-逆变对比)
  - [9.4 不变性对比](#94-不变性对比)
- [10 五、应用场景对比](#10-五应用场景对比)
  - [10.1 C 应用场景](#101-c-应用场景)
  - [10.2 Rust 应用场景](#102-rust-应用场景)
- [11 六、总结](#11-六总结)
  - [11.1 C 变体性特点](#111-c-变体性特点)
  - [11.2 Rust 变体性特点](#112-rust-变体性特点)
  - [11.3 核心差异](#113-核心差异)
- [12 Rust 支持的编程范式](#12-rust-支持的编程范式)
  - [12.1 面向过程编程](#121-面向过程编程)
  - [12.2 函数式编程](#122-函数式编程)
  - [12.3 面向对象编程OOP](#123-面向对象编程oop)
  - [12.4 泛型编程](#124-泛型编程)
  - [12.5 并发编程](#125-并发编程)
- [13 Rust 的思维模式](#13-rust-的思维模式)
  - [13.1 安全第一](#131-安全第一)
  - [13.2 零成本抽象](#132-零成本抽象)
  - [13.3 函数式思维](#133-函数式思维)
  - [13.4 组合优先与模块化](#134-组合优先与模块化)
  - [13.5 并发安全](#135-并发安全)
- [14 思维导图](#14-思维导图)
- [15 总结](#15-总结)
...
## 6 类型系统中的变体性：C 与 Rust 对比

### 6.1 一、基本概念定义

#### 1.1.1 可变性 (Mutability)

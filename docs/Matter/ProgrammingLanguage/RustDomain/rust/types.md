...
- [1 Compound Data Types](#1-compound-data-types)
- [2 Composite Data Types](#2-composite-data-types)
- [3 Key Differences](#3-key-differences)
- [4 Compound Data Types in Rust](#4-compound-data-types-in-rust)
- [5 Composite Data Types in Rust](#5-composite-data-types-in-rust)
...
## 4 Compound Data Types in Rust

    array, tuple, enum

## 5 Composite Data Types in Rust

...
- [1 命令式编程Imperative Programming](#1-命令式编程imperative-programming)
- [2 结构化编程Structured Programming](#2-结构化编程structured-programming)
- [3 声明式编程Declarative Programming](#3-声明式编程declarative-programming)
- [4 面向对象编程Object-Oriented Programming OOP](#4-面向对象编程object-oriented-programming-oop)
- [5 函数式编程Functional Programming FP](#5-函数式编程functional-programming-fp)
- [6 逻辑编程Logic Programming](#6-逻辑编程logic-programming)
- [7 并发编程Concurrent Programming](#7-并发编程concurrent-programming)
- [8 事件驱动编程Event-Driven Programming](#8-事件驱动编程event-driven-programming)
- [9 泛型编程Generic Programming](#9-泛型编程generic-programming)
- [10 元编程Metaprogramming](#10-元编程metaprogramming)
- [11 响应式编程Reactive Programming](#11-响应式编程reactive-programming)
- [12 Rust 编程范式](#12-rust-编程范式)
  - [12.1 结构化编程](#121-结构化编程)
  - [12.2 面向对象编程OOP](#122-面向对象编程oop)
  - [12.3 泛型编程](#123-泛型编程)
  - [12.4 函数式编程](#124-函数式编程)
  - [12.5 内存安全](#125-内存安全)
  - [12.6 模式匹配](#126-模式匹配)
  - [12.7 错误处理](#127-错误处理)
  - [12.8 迭代器生成器和闭包](#128-迭代器生成器和闭包)
  - [12.9 智能指针](#129-智能指针)
  - [12.10 模块化](#1210-模块化)
  - [12.11 宏系统](#1211-宏系统)
  - [12.12 并发编程](#1212-并发编程)
    - [12.12.1 多线程并发编程](#12121-多线程并发编程)
    - [12.12.2 异步编程模型](#12122-异步编程模型)
    - [12.12.3 asyncawait语法](#12123-asyncawait语法)
    - [12.12.4 性能与安全性](#12124-性能与安全性)
    - [12.12.5 并发与并行的区别](#12125-并发与并行的区别)
    - [12.12.6 消息传递并发](#12126-消息传递并发)
    - [12.12.7 共享状态并发](#12127-共享状态并发)
    - [12.12.8 Sync和Send trait](#12128-sync和send-trait)
  - [12.13 并行编程](#1213-并行编程)
    - [13.13.1 多线程](#13131-多线程)
    - [13.13.2 线程池](#13132-线程池)
    - [13.13.3 数据并行](#13133-数据并行)
    - [13.13.4 并行算法库](#13134-并行算法库)
    - [13.13.5 crossbeam](#13135-crossbeam)
    - [13.13.6 消息传递](#13136-消息传递)
    - [13.13.7 异步编程](#13137-异步编程)
    - [13.13.8 并行计算框架](#13138-并行计算框架)
    - [13.13.9 SIMD指令](#13139-simd指令)
    - [13.13.10 并行编译](#131310-并行编译)
    - [13.13.11 Rust的所有权和借用规则](#131311-rust的所有权和借用规则)
    - [13.13.12 Send和Sync特性](#131312-send和sync特性)

---

## 1 命令式编程Imperative Programming

...
- [1. 从同伦类型论视角分析Rust、分布式系统与工作流理论](#1-从同伦类型论视角分析rust分布式系统与工作流理论)
  ...
  - [1.1 思维导图](#11-思维导图)
  - [1.2 引言](#12-引言)
  - [1.3 同伦类型论核心概念](#13-同伦类型论核心概念)
    - [1.3.1 路径与恒等类型](#131-路径与恒等类型)
    - [1.3.2 高阶归纳类型(HITs)](#132-高阶归纳类型hits)
    - [1.3.3 同伦层次结构](#133-同伦层次结构)
  - [1.4 Rust编程语言的类型论分析](#14-rust编程语言的类型论分析)
    - [1.4.1 所有权系统的线性类型解读](#141-所有权系统的线性类型解读)
    - [1.4.2 生命周期与依赖类型](#142-生命周期与依赖类型)
    - [1.4.3 代数数据类型与归纳类型](#143-代数数据类型与归纳类型)
  - [1.5 分布式系统的同伦模型](#15-分布式系统的同伦模型)
    - [1.5.1 一致性模型的路径空间解读](#151-一致性模型的路径空间解读)
    - [1.5.2 CALM定理的类型论表达](#152-calm定理的类型论表达)
    - [1.5.3 状态空间作为类型空间](#153-状态空间作为类型空间)
  - [1.6 工作流理论的类型论诠释](#16-工作流理论的类型论诠释)
    - [1.6.1 Petri网与类型转换系统](#161-petri网与类型转换系统)
    - [1.6.2 会话类型与通信过程](#162-会话类型与通信过程)
    - [1.6.3 时间逻辑与同伦逻辑](#163-时间逻辑与同伦逻辑)
  - [1.7 三者之间的关系映射](#17-三者之间的关系映射)
    - [1.7.1 Rust与分布式系统](#171-rust与分布式系统)
    - [1.7.2 分布式系统与工作流](#172-分布式系统与工作流)
    - [1.7.3 工作流与Rust](#173-工作流与rust)
  - [1.8 同构与等价关系](#18-同构与等价关系)
    - [1.8.1 计算过程的路径等价性](#181-计算过程的路径等价性)
    - [1.8.2 不变量与高阶类型](#182-不变量与高阶类型)
    - [1.8.3 统一视角：计算的空间-时间结构](#183-统一视角计算的空间-时间结构)
  - [1.9 结论](#19-结论)
## 1.1 思维导图

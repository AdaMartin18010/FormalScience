...
- [2 Borrow Trait](#2-borrow-trait)
- [3 ToOwned Trait](#3-toowned-trait)
- [4 解释和联系](#4-解释和联系)
- [5 DerefMut Trait](#5-derefmut-trait)
- [6 Drop Trait](#6-drop-trait)
- [7 CovariantType Trait](#7-covarianttype-trait)
- [8 智能指针特定的 trait](#8-智能指针特定的-trait)
- [9 ToOwned](#9-toowned)
  - [9.1 主要特点](#91-主要特点)
  - [9.2 定义示例](#92-定义示例)
  - [9.3 使用示例](#93-使用示例)
  - [9.4 总结](#94-总结)
  - [9.5 ToOwned Trait 的定义](#95-toowned-trait-的定义)
  - [9.6 为什么不区分可变和不可变借用](#96-为什么不区分可变和不可变借用)
  - [9.7 代码示例](#97-代码示例)
    - [7.7.1 示例 1：直接从不可变借用生成拥有数据](#771-示例-1直接从不可变借用生成拥有数据)
    - [7.7.2 示例 2：从可变引用调用 to_owned()](#772-示例-2从可变引用调用-to_owned)
  - [9.8 总结](#98-总结)

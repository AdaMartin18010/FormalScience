# 1. Rust 中的引用（&T 和 &mut T）以及“接引用”

## 目录

- [1. Rust 中的引用（\&T 和 \&mut T）以及“接引用”](#1-rust-中的引用t-和-mut-t以及接引用)
  - [目录](#目录)
  - [1.1 引用与借用的基本概念](#11-引用与借用的基本概念)
  - [1.2 解引用与接引用的等价形式](#12-解引用与接引用的等价形式)
    - [1.2.1 原理说明](#121-原理说明)
  - [1.3 代码示例](#13-代码示例)
    - [1.3.1 不可变引用示例](#131-不可变引用示例)
    - [1.3.2 可变引用示例](#132-可变引用示例)
  - [1.4 自动解引用与重新借用](#14-自动解引用与重新借用)
  - [1.5 等价关系总结](#15-等价关系总结)
  - [1.6 小结](#16-小结)

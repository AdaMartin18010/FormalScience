...
- [1 引用与借用的基本概念](#1-引用与借用的基本概念)
- [2 解引用与接引用的等价形式](#2-解引用与接引用的等价形式)
  - [2.1 原理说明](#21-原理说明)
- [3 代码示例](#3-代码示例)
  - [3.1 不可变引用示例](#31-不可变引用示例)
  - [3.2 可变引用示例](#32-可变引用示例)
- [4 自动解引用与重新借用](#4-自动解引用与重新借用)
- [5 等价关系总结](#5-等价关系总结)
- [6 小结](#6-小结)
- [7 RUST多级引用](#7-rust多级引用)
- [8 Rust 的多级引用有哪些常见错误](#8-rust-的多级引用有哪些常见错误)
  - [8.1 1 1 解引用层数不匹配](#81-1-1-解引用层数不匹配)
  - [8.2 2 2 生命周期不匹配](#82-2-2-生命周期不匹配)
  - [8.3 3 3 可变引用与不可变引用冲突](#83-3-3-可变引用与不可变引用冲突)
  - [8.4 4 4 多级引用的错误使用](#84-4-4-多级引用的错误使用)
  - [8.5 5 5 生命周期结束前的错误引用](#85-5-5-生命周期结束前的错误引用)
  - [8.6 总结](#86-总结)

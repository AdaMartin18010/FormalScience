...
- [1. Rust所有权系统的资源管理分析](#1-rust所有权系统的资源管理分析)
  - [目录](#目录)
  - [1.1 引言](#11-引言)
  - [1.2 所有权与类型系统](#12-所有权与类型系统)
    - [1.2.1 类型设计原则](#121-类型设计原则)
    - [1.2.2 所有权模式分析](#122-所有权模式分析)
    - [1.2.3 类型对称性与非对称处理](#123-类型对称性与非对称处理)
  - [1.3 所有权与控制流](#13-所有权与控制流)
    - [1.3.1 控制流设计原则](#131-控制流设计原则)
    - [1.3.2 借用检查器的工作模式](#132-借用检查器的工作模式)
    - [1.3.3 控制流中的对称与非对称](#133-控制流中的对称与非对称)
  - [1.4 所有权与变量](#14-所有权与变量)
    - [1.4.1 变量设计原则](#141-变量设计原则)
    - [1.4.2 变量生命周期模式](#142-变量生命周期模式)
    - [1.4.3 变量操作的对称性](#143-变量操作的对称性)
  - [1.5 统一模型：对称性法则](#15-统一模型对称性法则)
    - [1.5.1 核心形式模式](#151-核心形式模式)
    - [1.5.2 对称性破缺处理](#152-对称性破缺处理)
  - [1.6 总结](#16-总结)

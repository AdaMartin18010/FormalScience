...
- [Copy和Clone的区别](#copy和clone的区别)
  - [📋 目录](#-目录)
  - [1 所有权机制的基础认知](#1-所有权机制的基础认知)
    - [1.1 Copy Trait的隐式复制](#11-copy-trait的隐式复制)
    - [1.2 Clone Trait的显式深拷贝](#12-clone-trait的显式深拷贝)
  - [2 核心差异对比](#2-核心差异对比)
  - [3 实现模式剖析](#3-实现模式剖析)
    - [3.1 自动派生实现](#31-自动派生实现)
    - [3.2 手动实现Clone](#32-手动实现clone)
    - [3.3 典型应用场景](#33-典型应用场景)
    - [3.4 性能优化实践](#34-性能优化实践)
    - [3.5 设计哲学启示](#35-设计哲学启示)
  - [4 结语](#4-结语)

...
- [1 path](#1-path)
- [2 权限的定义](#2-权限的定义)
  - [2.1 可读Readable R](#21-可读readable-r)
  - [2.2 可写Writable W](#22-可写writable-w)
  - [2.3 可拥有Ownable O](#23-可拥有ownable-o)
- [3 权限的变化](#3-权限的变化)
  - [3.1 变量初始化](#31-变量初始化)
  - [3.2 不可变引用](#32-不可变引用)
  - [3.3 可变引用](#33-可变引用)
  - [3.4 引用结束](#34-引用结束)
  - [3.5 变量移动Move](#35-变量移动move)
  - [3.6 权限的可视化](#36-权限的可视化)
- [4 引用的作用域定义](#4-引用的作用域定义)
  - [4.1 引用的生命周期Lifetime](#41-引用的生命周期lifetime)
  - [4.2 引用的作用域范围](#42-引用的作用域范围)
  - [4.3 引用的作用域与变量的作用域](#43-引用的作用域与变量的作用域)
  - [4.4 引用的作用域与函数调用](#44-引用的作用域与函数调用)
  - [4.5 引用的作用域与返回值](#45-引用的作用域与返回值)
  - [4.6 绕过借用检查器的合法方式](#46-绕过借用检查器的合法方式)
    - [6.6.1 使用 unsafe 块](#661-使用-unsafe-块)
    - [6.6.2 使用 stdcell 和 stdrc 模块](#662-使用-stdcell-和-stdrc-模块)
    - [6.6.3 使用生命周期注解](#663-使用生命周期注解)
  - [4.7 绕过借用检查器的不推荐方式](#47-绕过借用检查器的不推荐方式)
    - [7.7.1 使用 transmute](#771-使用-transmute)
    - [7.7.2 使用 stdptr 模块](#772-使用-stdptr-模块)

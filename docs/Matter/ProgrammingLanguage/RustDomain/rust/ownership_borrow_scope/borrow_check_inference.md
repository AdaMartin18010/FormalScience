...
- [1. Borrow Checker](#1-borrow-checker)
  - [目录](#目录)
  - [1.1 path](#11-path)
  - [1.2 权限的定义](#12-权限的定义)
    - [1.2.1 可读Readable R](#121-可读readable-r)
    - [1.2.2 可写Writable W](#122-可写writable-w)
    - [1.2.3 可拥有Ownable O](#123-可拥有ownable-o)
  - [1.3 权限的变化](#13-权限的变化)
    - [1.3.1 变量初始化](#131-变量初始化)
    - [1.3.2 不可变引用](#132-不可变引用)
    - [1.3.3 可变引用](#133-可变引用)
    - [1.3.4 引用结束](#134-引用结束)
    - [1.3.5 变量移动Move](#135-变量移动move)
    - [1.3.6 权限的可视化](#136-权限的可视化)
  - [1.4 引用的作用域定义](#14-引用的作用域定义)
    - [1.4.1 引用的生命周期Lifetime](#141-引用的生命周期lifetime)

...
- [3 示例说明](#3-示例说明)
  - [3.1 示例1：对象安全的 trait](#31-示例1对象安全的-trait)
  - [3.2 示例2：不符合对象安全要求的 trait](#32-示例2不符合对象安全要求的-trait)
- [4 对象安全的限制与设计权衡](#4-对象安全的限制与设计权衡)
- [5 总结](#5-总结)
- [6 返回 Self 类型的问题](#6-返回-self-类型的问题)
- [7 泛型参数的问题](#7-泛型参数的问题)
- [8 总结](#8-总结)
- [9 什么是对象安全Object Safety](#9-什么是对象安全object-safety)
  - [9.1 对象安全需要满足的主要条件](#91-对象安全需要满足的主要条件)
- [10 为什么需要对象安全](#10-为什么需要对象安全)
- [11 反例与示例](#11-反例与示例)
  - [11.1 反例：返回 Self 的方法](#111-反例返回-self-的方法)
  - [11.2 反例：泛型方法](#112-反例泛型方法)
  - [11.3 对象安全的示例](#113-对象安全的示例)
- [12 思维导图](#12-思维导图)
- [13 总结](#13-总结)
- [14 Trait 对象安全概述](#14-trait-对象安全概述)
- [15 泛型方法与对象安全](#15-泛型方法与对象安全)
  - [15.1 泛型方法不满足对象安全要求](#151-泛型方法不满足对象安全要求)
  - [15.2 理解对象安全规范](#152-理解对象安全规范)
- [16 举例说明](#16-举例说明)
  - [16.1 不对象安全的 trait 示例](#161-不对象安全的-trait-示例)
  - [16.2 对象安全的 trait 示例](#162-对象安全的-trait-示例)
- [17 思维导图](#17-思维导图)
- [18 总结](#18-总结)
  - [18.1 总结](#181-总结)

...
- [1. 孤儿规则 Orphan Rule](#孤儿规则-orphan-rule)
  - [1.1 分离实现的基本情况](#1-分离实现的基本情况)
  - [1.2 示例说明](#2-示例说明)
    - [1.2.1 定义结构体和 trait](#21-定义结构体和-trait)
    - [1.2.2 分离实现 trait](#22-分离实现-trait)
    - [1.2.3 入口文件调用](#23-入口文件调用)
  - [1.3 注意事项](#3-注意事项)
  - [1.4 总结](#4-总结)
  - [1.5 孤儿规则的目的](#5-孤儿规则的目的)
  - [1.6 避免的具体情况](#6-避免的具体情况)
  - [1.7 总结](#7-总结)
  - [1.8 重复实现与名称冲突](#8-重复实现与名称冲突)
  - [1.9 孤儿规则的限制](#9-孤儿规则的限制)
  - [1.10 模块可见性与访问权限](#10-模块可见性与访问权限)
  - [1.11 泛型实现与类型推导](#11-泛型实现与类型推导)
  - [1.12 对象安全、异步方法与 const 方法的限制](#12-对象安全异步方法与-const-方法的限制)
  - [1.13 特化Specialization和默认实现](#13-特化specialization和默认实现)
  - [1.14 总结](#14-总结)
## 1.1 分离实现的基本情况

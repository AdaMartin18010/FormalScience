...
- [4 思维导图示例](#4-思维导图示例)
- [5 总结](#5-总结)
- [6 实现原理与调度方式](#6-实现原理与调度方式)
  - [6.1 Rust 中的 ad-hoc 多态](#61-rust-中的-ad-hoc-多态)
  - [6.2 OOP 中的多态](#62-oop-中的多态)
- [7 性能与安全性的对比](#7-性能与安全性的对比)
  - [7.1 性能考虑](#71-性能考虑)
  - [7.2 安全性与静态检查](#72-安全性与静态检查)
- [8 设计理念与表达](#8-设计理念与表达)
  - [8.1 Rust 的 ad-hoc 多态](#81-rust-的-ad-hoc-多态)
  - [8.2 OOP 的多态](#82-oop-的多态)
- [9 联系与共同点](#9-联系与共同点)
- [10 思维导图示例](#10-思维导图示例)
- [11 总结](#11-总结)

...
- [1. Ad-hoc Polymorphism](#ad-hoc-polymorphism)
  - [1.1 什么是 ad-hoc 多态](#1-什么是-ad-hoc-多态)
  - [1.2 Rust 中 ad-hoc 多态的实现机制](#2-rust-中-ad-hoc-多态的实现机制)
    - [1.2.1 Trait 定义与实现](#21-trait-定义与实现)
      - [1.2.1.1 示例](#211-示例)
    - [1.2.2 静态分发与单态化](#22-静态分发与单态化)
    - [1.2.3 关联函数和方法调用](#23-关联函数和方法调用)
  - [1.3 ad-hoc 多态的优势与设计思路](#3-ad-hoc-多态的优势与设计思路)
  - [1.4 思维导图示例](#4-思维导图示例)
  - [1.5 总结](#5-总结)
  - [1.6 实现原理与调度方式](#6-实现原理与调度方式)
    - [1.6.1 Rust 中的 ad-hoc 多态](#61-rust-中的-ad-hoc-多态)
    - [1.6.2 OOP 中的多态](#62-oop-中的多态)
  - [1.7 性能与安全性的对比](#7-性能与安全性的对比)
    - [1.7.1 性能考虑](#71-性能考虑)
    - [1.7.2 安全性与静态检查](#72-安全性与静态检查)
  - [1.8 设计理念与表达](#8-设计理念与表达)
    - [1.8.1 Rust 的 ad-hoc 多态](#81-rust-的-ad-hoc-多态)
    - [1.8.2 OOP 的多态](#82-oop-的多态)
  - [1.9 联系与共同点](#9-联系与共同点)
  - [1.10 思维导图示例](#10-思维导图示例)
  - [1.11 总结](#11-总结)
## 1.1 什么是 ad-hoc 多态

# 1. Rust 是否有类似 Golang package init 函数的机制？

## 目录

- [1. Rust 是否有类似 Golang package init 函数的机制？](#rust-是否有类似-golang-package-init-函数的机制)
  - [1.1 显式初始化](#1-显式初始化)
  - [1.2 静态变量的延迟初始化](#2-静态变量的延迟初始化)
  - [1.3 使用第三方 crate 实现构造器](#3-使用第三方-crate-实现构造器)
  - [1.4 总结](#4-总结)
## 1.1 显式初始化

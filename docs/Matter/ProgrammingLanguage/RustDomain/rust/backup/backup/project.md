...
- [2. 依赖管理](#依赖管理)
    - [2.0.1 特点](#01-特点)
  - [2.1 模块化项目模式](#1-模块化项目模式)
    - [2.1.1 特点](#11-特点)
  - [2.2 使用特征和 trait 对象的模式](#2-使用特征和-trait-对象的模式)
    - [2.2.1 特点](#21-特点)
  - [2.3 面向函数的编程模式](#3-面向函数的编程模式)
    - [2.3.1 特点](#31-特点)
  - [2.4 面向对象的编程模式](#4-面向对象的编程模式)
    - [2.4.1 特点](#41-特点)
  - [2.5 总结](#5-总结)
## 1.1 二进制项目模式

# 1. RPIT（Reference-Passing In Trait）在 Rust 2024 中的含义、举例和应用

## 目录

- [1. RPIT（Reference-Passing In Trait）在 Rust 2024 中的含义、举例和应用](#rpitreference-passing-in-trait在-rust-2024-中的含义举例和应用)
  - [1.1 含义](#1-含义)
  - [1.2 举例](#2-举例)
    - [1.2.1 旧的 RPIT 用法](#21-旧的-rpit-用法)
    - [1.2.2 Rust 2024 的新用法](#22-rust-2024-的新用法)
  - [1.3 应用](#3-应用)
    - [1.3.1 简化异步编程](#31-简化异步编程)
    - [1.3.2 简化泛型函数](#32-简化泛型函数)
    - [1.3.3 提高代码可读性](#33-提高代码可读性)
  - [1.4 迁移指南](#4-迁移指南)
    - [1.4.1 使用 cargo fix 自动迁移](#41-使用-cargo-fix-自动迁移)
    - [1.4.2 手动迁移](#42-手动迁移)
  - [1.5 总结](#5-总结)
  - [1.6 Rust 2024 对异步编程的具体影响](#6-rust-2024-对异步编程的具体影响)
    - [1.6.1 异步闭包Async Closures](#61-异步闭包async-closures)
    - [1.6.2 改进的错误处理](#62-改进的错误处理)
    - [1.6.3 AsyncFn 特性](#63-asyncfn-特性)
    - [1.6.4 Future 和 IntoFuture 到标准库 Prelude](#64-future-和-intofuture-到标准库-prelude)
    - [1.6.5 改进的生命周期捕获规则](#65-改进的生命周期捕获规则)
    - [1.6.6 总结](#66-总结)
## 1.1 含义
...
### 1.6.4 Future 和 IntoFuture 到标准库 Prelude

...
- [4 迁移指南](#4-迁移指南)
  ...
  - [4.2 手动迁移](#42-手动迁移)
- [5 总结](#5-总结)
- [6 Rust 2024 对异步编程的具体影响](#6-rust-2024-对异步编程的具体影响)
  - [6.1 异步闭包Async Closures](#61-异步闭包async-closures)
  - [6.2 改进的错误处理](#62-改进的错误处理)
  - [6.3 AsyncFn 特性](#63-asyncfn-特性)
  - [6.4 Future 和 IntoFuture 到标准库 Prelude](#64-future-和-intofuture-到标准库-prelude)
  - [6.5 改进的生命周期捕获规则](#65-改进的生命周期捕获规则)
  - [6.6 总结](#66-总结)
...
### 6.4 Future 和 IntoFuture 到标准库 Prelude

...
- [1. Rust 属性（attribute）](#rust-属性attribute)
  - [1.1 属性的定义与基本概念](#1-属性的定义与基本概念)
  - [1.2 常见的内置属性及其作用](#2-常见的内置属性及其作用)
  - [1.3 自定义属性及过程宏](#3-自定义属性及过程宏)
  - [1.4 属性的实际使用示例](#4-属性的实际使用示例)
    - [1.4.1 示例 1：自动派生 trait](#41-示例-1自动派生-trait)
    - [1.4.2 示例 2：条件编译](#42-示例-2条件编译)
    - [1.4.3 示例 3：控制警告](#43-示例-3控制警告)
  - [1.5 总结](#5-总结)
## 1.1 属性的定义与基本概念

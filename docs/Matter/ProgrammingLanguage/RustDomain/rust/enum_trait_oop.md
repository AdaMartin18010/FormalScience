...
- [1. enum\_trait\_oop.md](#1-enum_trait_oopmd)
  - [目录](#目录)
  - [1.1 使用 `enum` 和 `dyn Trait` 实现运行时多态](#11-使用-enum-和-dyn-trait-实现运行时多态)
    - [1.1.1 示例代码](#111-示例代码)
    - [1.1.2 代码解释](#112-代码解释)
    - [1.1.3 总结](#113-总结)
  - [1.2 enum和泛型的结合](#12-enum和泛型的结合)
    - [1.2.1 `enum` 的本质](#121-enum-的本质)
      - [1.2.1.1 示例](#1211-示例)
    - [1.2.2 泛型的本质](#122-泛型的本质)
      - [1.2.2.1 示例](#1221-示例)
    - [1.2.3 `enum` 和泛型的结合](#123-enum-和泛型的结合)
      - [1.2.3.1 示例](#1231-示例)
    - [1.2.4 总结](#124-总结)
    - [1.2.5 定义 `enum`](#125-定义-enum)
    - [1.2.6 多种变体的含义](#126-多种变体的含义)
    - [1.2.7 示例](#127-示例)
    - [1.2.8 使用变体](#128-使用变体)
    - [1.2.9 总结](#129-总结)
    - [1.2.10 定义 Trait](#1210-定义-trait)
    - [1.2.11 实现 Trait](#1211-实现-trait)
    - [1.2.12 使用 `Box<dyn Trait>`](#1212-使用-boxdyn-trait)
    - [1.2.13 使用示例](#1213-使用示例)
    - [1.2.14 **总结**](#1214-总结)

## 1.1 使用 `enum` 和 `dyn Trait` 实现运行时多态

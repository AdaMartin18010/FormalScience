...
- [Rust 的 RTIC (Real-Time Interrupt-driven Concurrency) 主要应用](#rust-的-rtic-real-time-interrupt-driven-concurrency-主要应用)
  ...
  - [3 示例代码](#3-示例代码)
  - [4 总结](#4-总结)
  - [5 RTIC 与 embedded-hal 的关系及当前 Rust 嵌入式生态图景](#5-rtic-与-embedded-hal-的关系及当前-rust-嵌入式生态图景)
  - [6 embedded-hal 硬件抽象层](#6-embedded-hal-硬件抽象层)
  - [7 RTIC 实时任务调度与并发管理](#7-rtic-实时任务调度与并发管理)
  - [8 二者之间的关系和协同工作](#8-二者之间的关系和协同工作)
  - [9 当前 Rust 嵌入式生态图景](#9-当前-rust-嵌入式生态图景)
  - [10 总结](#10-总结)
  - [11 Rust 的 IoT 控制框架](#11-rust-的-iot-控制框架)
  - [12 嵌入式操作系统与实时控制](#12-嵌入式操作系统与实时控制)
    - [12.1 Tock OS](#121-tock-os)
    - [12.2 RTICReal-Time Interrupt-driven Concurrency](#122-rticreal-time-interrupt-driven-concurrency)
  - [13 硬件抽象与设备驱动](#13-硬件抽象与设备驱动)
    - [13.1 embedded-hal](#131-embedded-hal)
  - [14 网络通信与协议支持](#14-网络通信与协议支持)
    - [14.1 MQTT 客户端库](#141-mqtt-客户端库)
    - [14.2 CoAP 库](#142-coap-库)
  - [15 边缘计算与微服务架构](#15-边缘计算与微服务架构)
    - [15.1 异步运行时Tokio async-std](#151-异步运行时tokio-async-std)
    - [15.2 Web 框架Actix、Warp 等](#152-web-框架actixwarp-等)
  - [16 总结与展望](#16-总结与展望)
...
### 12.2 RTICReal-Time Interrupt-driven Concurrency

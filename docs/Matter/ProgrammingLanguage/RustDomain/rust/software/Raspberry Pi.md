...
- [2 通信与网络协议相关](#2-通信与网络协议相关)
  - [2.1 MQTT 客户端库如 rumqttc](#21-mqtt-客户端库如-rumqttc)
- [3 异步与 Web 服务框架](#3-异步与-web-服务框架)
  - [3.1 Tokio 与 async-std](#31-tokio-与-async-std)
  - [3.2 Rocket Actix-web](#32-rocket-actix-web)
- [4 其他生态与支持库](#4-其他生态与支持库)
  - [4.1 embedded-hal](#41-embedded-hal)
  - [4.2 日志与监控工具](#42-日志与监控工具)
- [5 应用场景举例](#5-应用场景举例)
- [6 总结](#6-总结)

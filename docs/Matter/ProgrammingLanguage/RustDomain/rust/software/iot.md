...
- [1. IoT 相关](#1-iot-相关)
  ...
  - [1.2 广泛的实现与驱动支持](#12-广泛的实现与驱动支持)
  - [1.3 版本现状与生态演进](#13-版本现状与生态演进)
  - [1.4 社区活跃度与文档资源](#14-社区活跃度与文档资源)
  - [1.5 典型使用场景](#15-典型使用场景)
  - [1.6 总结](#16-总结)
  - [1.7 Rust 的 embedded-hal 在 Raspberry Pi Pico 上的应用](#17-rust-的-embedded-hal-在-raspberry-pi-pico-上的应用)
  - [1.8 开发环境与依赖配置](#18-开发环境与依赖配置)
  - [1.9 典型示例：LED 闪烁](#19-典型示例led-闪烁)
  - [1.10 扩展应用场景](#110-扩展应用场景)
    - [1.10.1 I2CSPI 通讯](#1101-i2cspi-通讯)
    - [1.10.2 UART串行通信](#1102-uart串行通信)
  - [1.11 总结](#111-总结)
  - [1.12 IoT 行业标准归纳及重要协议规范](#112-iot-行业标准归纳及重要协议规范)
  - [1.13 设备与传感器的标准与分类](#113-设备与传感器的标准与分类)
    - [1.13.1 智能传感器接口标准](#1131-智能传感器接口标准)
    - [1.13.2 传感器数据描述与交换](#1132-传感器数据描述与交换)
  - [1.14 通信协议层面的标准](#114-通信协议层面的标准)
    - [1.14.1 物理层与链路层标准](#1141-物理层与链路层标准)
    - [1.14.2 网络层与传输层标准](#1142-网络层与传输层标准)
  - [1.15 应用层协议与交互模式](#115-应用层协议与交互模式)
    - [1.15.1 消息发布订阅与请求响应模式](#1151-消息发布订阅与请求响应模式)
    - [1.15.2 数据模型与语义互联](#1152-数据模型与语义互联)
    - [1.15.3 数据格式与定义](#1153-数据格式与定义)
  - [1.16 标准化组织与行业规范](#116-标准化组织与行业规范)
  - [1.17 IoT 发展中的重要协议规范](#117-iot-发展中的重要协议规范)
  - [1.18 总结](#118-总结)
    - [1.18.1 IoT 控制信息与交互信息数据格式标准规范](#1181-iot-控制信息与交互信息数据格式标准规范)
  - [1.19 设备与应用层标准](#119-设备与应用层标准)
  ...
  - [1.20 通信协议及数据编码格式](#120-通信协议及数据编码格式)

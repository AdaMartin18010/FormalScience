...
- [1. Rust编程语言的形式模型分析](#1-rust编程语言的形式模型分析)
  - [目录](#目录)
  ...
  - [1.3 Rust中的形式模型](#13-rust中的形式模型)
    - [1.3.1 核心：所有权系统与借用检查器](#131-核心所有权系统与借用检查器)
    - [1.3.2 类型系统](#132-类型系统)
    - [1.3.3 内存模型](#133-内存模型)
    - [1.3.4 并发模型](#134-并发模型)
  - [1.4 形式模型示例](#14-形式模型示例)
    - [1.4.1 简化的所有权转移规则](#141-简化的所有权转移规则)
    - [1.4.2 简化的借用规则](#142-简化的借用规则)
  - [1.5 元模型与模型](#15-元模型与模型)
    - [1.5.1 定义](#151-定义)
  ...
  - [1.6 展开与关联性分析](#16-展开与关联性分析)
    ...
    - [1.6.2 Rust设计哲学与形式化](#162-rust设计哲学与形式化)
  - [1.7 思维导图](#17-思维导图)
  - [1.8 Rust编程语言形式模型分析（续）](#18-rust编程语言形式模型分析续)
  - [1.9 元模型-模型的论证与证明](#19-元模型-模型的论证与证明)
    - [1.9.1 编译器的论证机制](#191-编译器的论证机制)
      - [1.9.1.1 可变借用规则论证示例](#1911-可变借用规则论证示例)
    - [1.9.2 超越编译器的形式化证明](#192-超越编译器的形式化证明)
      - [1.9.2.1 动机](#1921-动机)
      - [1.9.2.2 形式化证明流程](#1922-形式化证明流程)
    - [1.9.3 元模型与模型的拓展](#193-元模型与模型的拓展)
      - [1.9.3.1 语言演化（元模型拓展）](#1931-语言演化元模型拓展)
      - [1.9.3.2 应用程序演化（模型拓展）](#1932-应用程序演化模型拓展)
  - [1.10 形式化面临的挑战](#110-形式化面临的挑战)
    - [1.10.1 `unsafe` Rust的形式化](#1101-unsafe-rust的形式化)
    - [1.10.2 并发与`Send`/`Sync`形式化](#1102-并发与sendsync形式化)
    - [1.10.3 宏系统形式化](#1103-宏系统形式化)
    - [1.10.4 语言演化与规模](#1104-语言演化与规模)
  - [1.11 形式化对Rust开发者的实际意义](#111-形式化对rust开发者的实际意义)
    - [1.11.1 安全保证与信心](#1111-安全保证与信心)
    - [1.11.2 语言理解与发展](#1112-语言理解与发展)
    - [1.11.3 工具与实践改进](#1113-工具与实践改进)
  - [1.12 Rust形式化的未来方向](#112-rust形式化的未来方向)
    - [1.12.1 全面的`unsafe` Rust形式化](#1121-全面的unsafe-rust形式化)
    - [1.12.2 并发形式化深化](#1122-并发形式化深化)
    - [1.12.3 宏系统和元编程形式化](#1123-宏系统和元编程形式化)
    - [1.12.4 形式化工具改进](#1124-形式化工具改进)
  - [1.13 思维导图拓展](#113-思维导图拓展)
...
### 1.10.1 `unsafe` Rust的形式化

- 需要精确的形式化内存模型和机器模型
- RustBelt等项目致力于形式化`unsafe`代码的安全边界
- 证明安全抽象不会破坏整体安全性

### 1.10.2 并发与`Send`/`Sync`形式化

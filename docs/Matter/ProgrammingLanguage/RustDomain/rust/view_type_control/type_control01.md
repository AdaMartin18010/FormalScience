...
- [6. 基本类型](#基本类型)
- [7. 复合类型](#复合类型)
  - [7.1 控制流与类型的关系和区别](#1-控制流与类型的关系和区别)
    - [7.1.1 关系](#11-关系)
    - [7.1.2 区别](#12-区别)
    - [7.1.3 总结](#13-总结)
    - [7.1.4 有向无环图（DAG）的定义](#14-有向无环图dag的定义)
    - [7.1.5 控制流的表示](#15-控制流的表示)
    - [7.1.6 控制流中的循环](#16-控制流中的循环)
    - [7.1.7 控制流图的类型](#17-控制流图的类型)
    - [7.1.8 实际应用](#18-实际应用)
    - [7.1.9 结论](#19-结论)
  - [7.2 编程语言的类型、变量和控制之间的关系](#2-编程语言的类型变量和控制之间的关系)
    - [7.2.1 类型 (Types)](#21-类型-types)
    - [7.2.2 变量 (Variables)](#22-变量-variables)
    - [7.2.3 控制 (Control Structures)](#23-控制-control-structures)
    - [7.2.4 它们之间的关系](#24-它们之间的关系)
    - [7.2.5 举例说明 (Python)](#25-举例说明-python)
- [8. 类型: int (整数)](#类型-int-整数)
- [9. 变量: age](#变量-age)
- [10. 存储年龄的值](#存储年龄的值)
- [11. 控制: if-else](#控制-if-else)
    - [11.0.1 总结](#01-总结)
## 1.1 控制流

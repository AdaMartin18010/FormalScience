...
### 1.7.2 自然变换 (Natural Transformation)
...
### 1.9.1 抽象边界 (Abstract Boundaries)
...
### 1.10.1 类型驱动开发 (Type-Driven Development)
...
## 1.11 十一、类型系统与设计模式的融合

### 1.11.1 设计模式的类型理论表达

### 1.11.2 访问者模式 (Visitor Pattern)
...
## 1.18 十七、类型系统与函数式编程模式

### 1.18.1 函数式编程模式的类型表示

#### 1.18.1.1 函子 (Functor) 模式
...
## 1.19 十八、类型级编程 (Type-Level Programming)
...
### 1.23.1 领域驱动设计 (DDD) 中的类型应用

### 1.23.2 代数数据类型 (ADT) 与领域模型
...
### 1.26.1 代数效应 (Algebraic Effects) 的模拟
...
## 1.34 三十二、渐进类型系统 (Gradual Typing)

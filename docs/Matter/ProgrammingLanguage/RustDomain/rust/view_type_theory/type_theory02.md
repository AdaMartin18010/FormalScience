...
- [1. 类型论（Type Theory）](#类型论type-theory)
  - [1.1 **类型（Type）**](#1-类型type)
  - [1.2 **项（Term）**](#2-项term)
  - [1.3 **上下文（Context）**](#3-上下文context)
  - [1.4 **判断（Judgment）**](#4-判断judgment)
  - [1.5 **函数类型（Function Type）**](#5-函数类型function-type)
  - [1.6 **乘积类型（Product Type）**](#6-乘积类型product-type)
  - [1.7 **和类型（Sum Type）**](#7-和类型sum-type)
  - [1.8 **归纳类型（Inductive Type）**](#8-归纳类型inductive-type)
  - [1.9 **类型检查（Type Checking）**](#9-类型检查type-checking)
  - [1.10 **类型推导（Type Inference）**](#10-类型推导type-inference)
  - [1.11 总结](#11-总结)
  - [1.12 类型论在编程语言中的应用](#12-类型论在编程语言中的应用)
    - [1.12.1 **类型系统设计**](#121-类型系统设计)
    - [1.12.2 **函数式编程**](#122-函数式编程)
    - [1.12.3 **泛型编程**](#123-泛型编程)
    - [1.12.4 **依赖类型**](#124-依赖类型)
    - [1.12.5 **并发和并行编程**](#125-并发和并行编程)
    - [1.12.6 **语言互操作性**](#126-语言互操作性)
    - [1.12.7 **编译器和解释器实现**](#127-编译器和解释器实现)
    - [1.12.8 **教育和研究**](#128-教育和研究)
    - [1.12.9 **总结**](#129-总结)
    - [1.12.10 类型的结构定义](#1210-类型的结构定义)
    - [1.12.11 类型的法则](#1211-类型的法则)
    - [1.12.12 其他重要概念](#1212-其他重要概念)
    - [1.12.13 变量法则](#1213-变量法则)
    - [1.12.14 抽象法则](#1214-抽象法则)
    - [1.12.15 应用法则](#1215-应用法则)
    - [1.12.16 让步法则（Let法则）](#1216-让步法则let法则)
    - [1.12.17 递归法则](#1217-递归法则)
    - [1.12.18 组合法则](#1218-组合法则)
    - [1.12.19 多态法则](#1219-多态法则)
    - [1.12.20 类型等价](#1220-类型等价)
    - [1.12.21 类型定义](#1221-类型定义)
    - [1.12.22 类型别名](#1222-类型别名)
    - [1.12.23 总结](#1223-总结)
    - [1.12.24 运行时等价法则](#1224-运行时等价法则)
      - [1.12.24.1 结构等价法则](#12241-结构等价法则)
      - [1.12.24.2 归纳法则](#12242-归纳法则)
      - [1.12.24.3 替换法则](#12243-替换法则)
      - [1.12.24.4 透明性法则](#12244-透明性法则)
    - [1.12.25 运行时等价推理模型的应用](#1225-运行时等价推理模型的应用)
    - [1.12.26 总结](#1226-总结)
## 1.1 **类型（Type）**

...
- [1. 类型论（Type Theory）](#1-类型论type-theory)
  - [目录](#目录)
  ...
  - [1.11 总结](#111-总结)
  - [1.12 类型论在编程语言中的应用](#112-类型论在编程语言中的应用)
    - [1.12.1 **类型系统设计**](#1121-类型系统设计)
    - [1.12.2 **函数式编程**](#1122-函数式编程)
    - [1.12.3 **泛型编程**](#1123-泛型编程)
    - [1.12.4 **依赖类型**](#1124-依赖类型)
    - [1.12.5 **并发和并行编程**](#1125-并发和并行编程)
    - [1.12.6 **语言互操作性**](#1126-语言互操作性)
    - [1.12.7 **编译器和解释器实现**](#1127-编译器和解释器实现)
    - [1.12.8 **教育和研究**](#1128-教育和研究)
    - [1.12.9 **总结**](#1129-总结)
    - [1.12.10 类型的结构定义](#11210-类型的结构定义)
    - [1.12.11 类型的法则](#11211-类型的法则)
    - [1.12.12 其他重要概念](#11212-其他重要概念)
    - [1.12.13 变量法则](#11213-变量法则)
    - [1.12.14 抽象法则](#11214-抽象法则)
    - [1.12.15 应用法则](#11215-应用法则)
    - [1.12.16 让步法则（Let法则）](#11216-让步法则let法则)
    - [1.12.17 递归法则](#11217-递归法则)
    - [1.12.18 组合法则](#11218-组合法则)
    - [1.12.19 多态法则](#11219-多态法则)
    - [1.12.20 类型等价](#11220-类型等价)
    - [1.12.21 类型定义](#11221-类型定义)
    - [1.12.22 类型别名](#11222-类型别名)
    - [1.12.23 总结](#11223-总结)
    - [1.12.24 运行时等价法则](#11224-运行时等价法则)
      - [1.12.24.1 结构等价法则](#112241-结构等价法则)
      - [1.12.24.2 归纳法则](#112242-归纳法则)
      - [1.12.24.3 替换法则](#112243-替换法则)
      - [1.12.24.4 透明性法则](#112244-透明性法则)
    - [1.12.25 运行时等价推理模型的应用](#11225-运行时等价推理模型的应用)
    - [1.12.26 总结](#11226-总结)

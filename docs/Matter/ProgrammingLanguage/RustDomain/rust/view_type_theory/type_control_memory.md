...
- [1. 堆（Heap）和栈（Stack）是计算机内存管理的基本概念，它们既与硬件体系有关，也与编程语言的实现有关](#1-堆heap和栈stack是计算机内存管理的基本概念它们既与硬件体系有关也与编程语言的实现有关)
  - [目录](#目录)
  - [1.1 一般定义](#11-一般定义)
    - [1.1.1 区分](#111-区分)
    - [1.1.2 联系](#112-联系)
  ...
  - [1.4 生命周期（Lifetimes）](#14-生命周期lifetimes)
  - [1.5 `Drop` Trait](#15-drop-trait)
  - [1.6 `Clone` Trait](#16-clone-trait)
  - [1.7 `Copy` Trait](#17-copy-trait)
  - [1.8 智能指针（Smart Pointers）](#18-智能指针smart-pointers)
  - [1.9 `Deref` Trait](#19-deref-trait)
  - [1.10 `DerefMut` Trait](#110-derefmut-trait)
  - [1.11 裸指针（Raw Pointers）](#111-裸指针raw-pointers)
  - [1.12 内存分配器（Allocators）](#112-内存分配器allocators)
  - [1.13 栈和堆（Stack and Heap）](#113-栈和堆stack-and-heap)
  - [1.14 RUST内存管理定义](#114-rust内存管理定义)
    - [1.14.1 分类](#1141-分类)
  - [1.15 RUST内存管理基本原理与核心概念](#115-rust内存管理基本原理与核心概念)
    - [1.15.1 _所有权（Ownership）_](#1151-所有权ownership)
    - [1.15.2 _借用（Borrowing）_](#1152-借用borrowing)
    - [1.15.3 _生命周期（Lifetimes）_](#1153-生命周期lifetimes)
    - [1.15.4 _RAII 与 Drop 机制_](#1154-raii-与-drop-机制)
    - [1.15.5 _智能指针_](#1155-智能指针)
  - [1.16 RUST内存管理详细用例说明](#116-rust内存管理详细用例说明)
    - [1.16.1 _所有权与自动释放_](#1161-所有权与自动释放)
    - [1.16.2 _借用与生命周期_](#1162-借用与生命周期)
    - [1.16.3 _移动语义_](#1163-移动语义)
  - [1.17 _思维导图_](#117-思维导图)
  - [1.18 `Box<T>`](#118-boxt)
    - [1.18.1 定义与解释](#1181-定义与解释)
    - [1.18.2 用例](#1182-用例)
  - [1.19 `Rc<T>`](#119-rct)
  - [1.20 `Arc<T>`](#120-arct)
  - [1.21 思维导图](#121-思维导图)
  - [1.22 栈内存碎片化](#122-栈内存碎片化)
    - [1.22.1 避免栈碎片化](#1221-避免栈碎片化)
  - [1.23 堆内存碎片化](#123-堆内存碎片化)
    - [1.23.1 避免堆溢出](#1231-避免堆溢出)
    - [1.23.2 避免堆碎片化](#1232-避免堆碎片化)

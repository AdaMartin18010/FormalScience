...
- [1. Rust 中的变体性与多态：关系、证明与安全保证](#rust-中的变体性与多态关系证明与安全保证)
  - [1.1 一、变体性与多态的关系](#1-一变体性与多态的关系)
    - [1.1.1 基本关系](#11-基本关系)
    - [1.1.2 具体联系](#12-具体联系)
  - [1.2 二、变体性规则的推理与证明](#2-二变体性规则的推理与证明)
    - [1.2.1 协变性推理](#21-协变性推理)
    - [1.2.2 逆变性推理](#22-逆变性推理)
    - [1.2.3 不变性推理](#23-不变性推理)
  - [1.3 三、变体性如何保证安全性](#3-三变体性如何保证安全性)
    - [1.3.1 类型安全保证](#31-类型安全保证)
    - [1.3.2 内存安全保证](#32-内存安全保证)
    - [1.3.3 运行时安全保证](#33-运行时安全保证)
  - [1.4 四、形式化证明方法](#4-四形式化证明方法)
    - [1.4.1 类型系统的形式化表示](#41-类型系统的形式化表示)
    - [1.4.2 归纳证明](#42-归纳证明)
    - [1.4.3 反证法](#43-反证法)
  - [1.5 五、实际应用中的安全保证](#5-五实际应用中的安全保证)
    - [1.5.1 实际代码示例](#51-实际代码示例)
    - [1.5.2 实际安全保证](#52-实际安全保证)
  - [1.6 六、总结](#6-六总结)
## 1.1 一、变体性与多态的关系

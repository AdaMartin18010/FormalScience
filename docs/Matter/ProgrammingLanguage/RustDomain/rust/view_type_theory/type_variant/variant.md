...
- [1. Rust 中的变体性与多态的关系](#rust-中的变体性与多态的关系)
  - [1.1 一、基本概念关联](#1-一基本概念关联)
    - [1.1.1 核心关联点](#11-核心关联点)
  - [1.2 二、协变与多态](#2-二协变与多态)
  - [1.3 三、逆变与多态](#3-三逆变与多态)
  - [1.4 四、不变性与多态](#4-四不变性与多态)
  - [1.5 五、变体性与多态的综合应用](#5-五变体性与多态的综合应用)
    - [1.5.1 泛型与 trait bounds](#51-泛型与-trait-bounds)
    - [1.5.2 动态分发与静态分发](#52-动态分发与静态分发)
    - [1.5.3 函数式编程中的多态](#53-函数式编程中的多态)
  - [1.6 六、变体性与多态的关系总结](#6-六变体性与多态的关系总结)
    - [1.6.1 协变与多态的关系](#61-协变与多态的关系)
    - [1.6.2 逆变与多态的关系](#62-逆变与多态的关系)
    - [1.6.3 不变性与多态的关系](#63-不变性与多态的关系)
    - [1.6.4 综合应用](#64-综合应用)
  - [1.7 七、结论](#7-七结论)
## 1.1 一、基本概念关联

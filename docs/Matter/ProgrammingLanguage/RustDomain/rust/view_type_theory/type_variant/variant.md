...
- [1. Rust 中的变体性与多态的关系](#1-rust-中的变体性与多态的关系)
  - [目录](#目录)
  - [1.1 一、基本概念关联](#11-一基本概念关联)
    - [1.1.1 核心关联点](#111-核心关联点)
  - [1.2 二、协变与多态](#12-二协变与多态)
  - [1.3 三、逆变与多态](#13-三逆变与多态)
  - [1.4 四、不变性与多态](#14-四不变性与多态)
  - [1.5 五、变体性与多态的综合应用](#15-五变体性与多态的综合应用)
    - [1.5.1 泛型与 trait bounds](#151-泛型与-trait-bounds)
    - [1.5.2 动态分发与静态分发](#152-动态分发与静态分发)
    - [1.5.3 函数式编程中的多态](#153-函数式编程中的多态)
  - [1.6 六、变体性与多态的关系总结](#16-六变体性与多态的关系总结)
    - [1.6.1 协变与多态的关系](#161-协变与多态的关系)
    - [1.6.2 逆变与多态的关系](#162-逆变与多态的关系)
    - [1.6.3 不变性与多态的关系](#163-不变性与多态的关系)
    - [1.6.4 综合应用](#164-综合应用)
  - [1.7 七、结论](#17-七结论)

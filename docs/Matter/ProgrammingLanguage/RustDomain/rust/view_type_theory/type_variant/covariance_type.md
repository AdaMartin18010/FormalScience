...
- [1. CovariantType](#1-covarianttype)
  - [目录](#目录)
  - [1.1 协变的定义](#11-协变的定义)
  - [1.2 协变的规则](#12-协变的规则)
  - [1.3 协变的应用](#13-协变的应用)
  - [1.4 示例](#14-示例)
  - [1.5 Rust 中如何应用协变特性](#15-rust-中如何应用协变特性)
  - [1.6 Rust 中的协变特性](#16-rust-中的协变特性)
  - [1.7 核心概念](#17-核心概念)
  - [1.8 定义](#18-定义)
  - [1.9 解释](#19-解释)
  - [1.10 引用类型的协变](#110-引用类型的协变)
  - [1.11 生命周期的协变](#111-生命周期的协变)
  - [1.12 函数返回值的协变](#112-函数返回值的协变)
  - [1.13 Trait 对象的协变](#113-trait-对象的协变)
  - [1.14 协变在 Rust 中的应用](#114-协变在-rust-中的应用)
    - [1.14.1 **1. 引用类型的协变**](#1141-1-引用类型的协变)
    - [1.14.2 **2. 生命周期的协变**](#1142-2-生命周期的协变)
    - [1.14.3 **3. Trait 对象的协变**](#1143-3-trait-对象的协变)
  - [1.15 **4. 函数返回值类型的协变**](#115-4-函数返回值类型的协变)
  - [1.16 **5. 泛型类型的协变**](#116-5-泛型类型的协变)
  - [1.17 **6. 结合生命周期和协变**](#117-6-结合生命周期和协变)
  - [1.18 **7. 协变与逆变、不变**](#118-7-协变与逆变不变)
  - [1.19 协变（Covariance）、逆变（Contravariance）和不变（Invariance）核心定义、概念解释及示例](#119-协变covariance逆变contravariance和不变invariance核心定义概念解释及示例)
    - [1.19.1 核心定义](#1191-核心定义)
    - [1.19.2 概念解释](#1192-概念解释)
    - [1.19.3 示例](#1193-示例)
      - [1.19.3.1 协变（Covariance）](#11931-协变covariance)
      - [1.19.3.2 逆变（Contravariance）](#11932-逆变contravariance)
      - [1.19.3.3 不变（Invariance）](#11933-不变invariance)
    - [1.19.4 总结](#1194-总结)
...
## 1.19 协变（Covariance）、逆变（Contravariance）和不变（Invariance）核心定义、概念解释及示例

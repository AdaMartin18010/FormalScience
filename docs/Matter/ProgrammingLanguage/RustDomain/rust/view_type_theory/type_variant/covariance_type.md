...
- [1. CovariantType](#covarianttype)
  - [1.1 协变的定义](#1-协变的定义)
  - [1.2 协变的规则](#2-协变的规则)
  - [1.3 协变的应用](#3-协变的应用)
  - [1.4 示例](#4-示例)
  - [1.5 Rust 中如何应用协变特性](#5-rust-中如何应用协变特性)
  - [1.6 Rust 中的协变特性](#6-rust-中的协变特性)
  - [1.7 核心概念](#7-核心概念)
  - [1.8 定义](#8-定义)
  - [1.9 解释](#9-解释)
  - [1.10 引用类型的协变](#10-引用类型的协变)
  - [1.11 生命周期的协变](#11-生命周期的协变)
  - [1.12 函数返回值的协变](#12-函数返回值的协变)
  - [1.13 Trait 对象的协变](#13-trait-对象的协变)
  - [1.14 协变在 Rust 中的应用](#14-协变在-rust-中的应用)
    - [1.14.1 **1. 引用类型的协变**](#141-1-引用类型的协变)
    - [1.14.2 **2. 生命周期的协变**](#142-2-生命周期的协变)
    - [1.14.3 **3. Trait 对象的协变**](#143-3-trait-对象的协变)
  - [1.15 **4. 函数返回值类型的协变**](#15-4-函数返回值类型的协变)
  - [1.16 **5. 泛型类型的协变**](#16-5-泛型类型的协变)
  - [1.17 **6. 结合生命周期和协变**](#17-6-结合生命周期和协变)
  - [1.18 **7. 协变与逆变、不变**](#18-7-协变与逆变不变)
  - [1.19 协变（Covariance）、逆变（Contravariance）和不变（Invariance）核心定义、概念解释及示例](#19-协变covariance逆变contravariance和不变invariance核心定义概念解释及示例)
    - [1.19.1 核心定义](#191-核心定义)
    - [1.19.2 概念解释](#192-概念解释)
    - [1.19.3 示例](#193-示例)
      - [1.19.3.1 协变（Covariance）](#1931-协变covariance)
      - [1.19.3.2 逆变（Contravariance）](#1932-逆变contravariance)
      - [1.19.3.3 不变（Invariance）](#1933-不变invariance)
    - [1.19.4 总结](#194-总结)
## 1.1 协变的定义

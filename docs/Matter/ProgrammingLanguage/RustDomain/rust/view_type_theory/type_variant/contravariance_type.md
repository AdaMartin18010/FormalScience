...
- [1. 协变和逆变的实际应用](#1-协变和逆变的实际应用)
  - [目录](#目录)
  - [1.1 一、协变（Covariance）](#11-一协变covariance)
  - [1.2 二、逆变（Contravariance）](#12-二逆变contravariance)
  - [1.3 三、实际应用场景](#13-三实际应用场景)
    - [1.3.1 Rust 中的协变与逆变应用](#131-rust-中的协变与逆变应用)
    - [1.3.2 Java 中的协变和逆变](#132-java-中的协变和逆变)
  - [1.4 逆变（Contravariance）在 Rust 中的应用](#14-逆变contravariance在-rust-中的应用)
    - [1.4.1 函数参数的逆变](#141-函数参数的逆变)
    - [1.4.2 生命周期的逆变](#142-生命周期的逆变)
    - [1.4.3 高阶函数的逆变](#143-高阶函数的逆变)
    - [1.4.4 函数指针的逆变](#144-函数指针的逆变)
  - [1.5 总结](#15-总结)
  - [1.6 如何定义逆变类型](#16-如何定义逆变类型)
    - [1.6.1 函数参数](#161-函数参数)
    - [1.6.2 生命周期参数](#162-生命周期参数)
    - [1.6.3 函数参数的逆变](#163-函数参数的逆变)
    - [1.6.4 生命周期的逆变](#164-生命周期的逆变)
...
## 1.4 逆变（Contravariance）在 Rust 中的应用

...
- [1. 协变和逆变的实际应用](#协变和逆变的实际应用)
  - [1.1 一、协变（Covariance）](#1-一协变covariance)
  - [1.2 二、逆变（Contravariance）](#2-二逆变contravariance)
  - [1.3 三、实际应用场景](#3-三实际应用场景)
    - [1.3.1 Rust 中的协变与逆变应用](#31-rust-中的协变与逆变应用)
    - [1.3.2 Java 中的协变和逆变](#32-java-中的协变和逆变)
  - [1.4 逆变（Contravariance）在 Rust 中的应用](#4-逆变contravariance在-rust-中的应用)
    - [1.4.1 函数参数的逆变](#41-函数参数的逆变)
    - [1.4.2 生命周期的逆变](#42-生命周期的逆变)
    - [1.4.3 高阶函数的逆变](#43-高阶函数的逆变)
    - [1.4.4 函数指针的逆变](#44-函数指针的逆变)
  - [1.5 总结](#5-总结)
  - [1.6 如何定义逆变类型](#6-如何定义逆变类型)
    - [1.6.1 函数参数](#61-函数参数)
    - [1.6.2 生命周期参数](#62-生命周期参数)
    - [1.6.3 函数参数的逆变](#63-函数参数的逆变)
    - [1.6.4 生命周期的逆变](#64-生命周期的逆变)
## 1.1 一、协变（Covariance）

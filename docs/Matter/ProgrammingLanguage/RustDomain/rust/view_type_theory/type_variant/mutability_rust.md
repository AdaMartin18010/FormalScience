...
- [1. 从类型论视角看待变量的定义和解释](#1-从类型论视角看待变量的定义和解释)
  - [目录](#目录)
  - [1.1 变量的定义](#11-变量的定义)
  - [1.2 变量的不变性](#12-变量的不变性)
    - [1.2.1 示例](#121-示例)
  - [1.3 可变性](#13-可变性)
    - [1.3.1 外部可变性](#131-外部可变性)
      - [1.3.1.1 示例](#1311-示例)
    - [1.3.2 内部可变性](#132-内部可变性)
      - [1.3.2.1 示例](#1321-示例)
  - [1.4 变量的定义](#14-变量的定义)
  - [1.5 变量的不变性](#15-变量的不变性)
    - [1.5.1 示例](#151-示例)
  - [1.6 可变性](#16-可变性)
    - [1.6.1 外部可变性](#161-外部可变性)
      - [1.6.1.1 示例](#1611-示例)
    - [1.6.2 内部可变性](#162-内部可变性)
      - [1.6.2.1 示例](#1621-示例)
  - [1.7 总结](#17-总结)
  - [1.8 变量的作用域与生命周期](#18-变量的作用域与生命周期)
    - [1.8.1 作用域](#181-作用域)
      - [1.8.1.1 示例](#1811-示例)
    - [1.8.2 生命周期](#182-生命周期)
      - [1.8.2.1 示例](#1821-示例)
  - [1.9 类型安全与变量管理](#19-类型安全与变量管理)
    - [1.9.1 示例](#191-示例)
  - [1.10 总结](#110-总结)
  - [1.11 Rust 的所有权系统](#111-rust-的所有权系统)
    - [1.11.1 所有权](#1111-所有权)
      - [1.11.1.1 示例](#11111-示例)
    - [1.11.2 借用](#1112-借用)
      - [1.11.2.1 示例](#11121-示例)
    - [1.11.3 可变借用](#1113-可变借用)
      - [1.11.3.1 示例](#11131-示例)
  - [1.12 总结](#112-总结)
  - [1.13 并发与数据安全](#113-并发与数据安全)
    - [1.13.1 并发](#1131-并发)
    - [1.13.2 数据竞争](#1132-数据竞争)
      - [1.13.2.1 示例](#11321-示例)
    - [1.13.3 使用 `Arc` 和 `Mutex`](#1133-使用-arc-和-mutex)
      - [1.13.3.1 示例](#11331-示例)
  - [1.14 总结](#114-总结)
  - [1.15 错误处理](#115-错误处理)
    - [1.15.1 Rust 的错误处理机制](#1151-rust-的错误处理机制)
    - [1.15.2 `panic!` 宏](#1152-panic-宏)
      - [1.15.2.1 示例](#11521-示例)
    - [1.15.3 `Result` 类型](#1153-result-类型)
      - [1.15.3.1 示例](#11531-示例)
    - [1.15.4 使用 `?` 运算符](#1154-使用--运算符)
      - [1.15.4.1 示例](#11541-示例)
  - [1.16 总结](#116-总结)

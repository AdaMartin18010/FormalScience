...
- [1. 类型理论对于多态类型的定义和解释](#1-类型理论对于多态类型的定义和解释)
  - [目录](#目录)
  - [1.1 引言](#11-引言)
  ...
  - [1.5 多态类型的优缺点](#15-多态类型的优缺点)
    ...
    - [1.5.2 缺点](#152-缺点)
  - [1.6 总结](#16-总结)
  - [1.7 类型理论对于多态类型的定义和解释](#17-类型理论对于多态类型的定义和解释)
    - [1.7.1 多态类型的实现机制](#171-多态类型的实现机制)
      - [1.7.1.1 静态多态性](#1711-静态多态性)
      - [1.7.1.2 示例](#1712-示例)
    - [1.7.2 动态多态性](#172-动态多态性)
      - [1.7.2.1 示例](#1721-示例)
  - [1.8 多态类型的最佳实践](#18-多态类型的最佳实践)
    - [1.8.1 使用明确的类型约束](#181-使用明确的类型约束)
    - [1.8.2 避免过度使用多态](#182-避免过度使用多态)
    - [1.8.3 文档化](#183-文档化)
    - [1.8.4 测试](#184-测试)
    - [1.8.5 考虑性能](#185-考虑性能)
  - [1.9 总结](#19-总结)
  - [1.10 类型理论对于多态类型的定义和解释](#110-类型理论对于多态类型的定义和解释)
    - [1.10.1 多态类型的实际案例](#1101-多态类型的实际案例)
      - [1.10.1.1 C++中的模板](#11011-c中的模板)
      - [1.10.1.2 Java中的接口](#11012-java中的接口)
      - [1.10.1.3 Python中的鸭子类型](#11013-python中的鸭子类型)
    - [1.10.2 总结](#1102-总结)
  - [1.11 类型理论对于多态类型的定义和解释](#111-类型理论对于多态类型的定义和解释)
    - [1.11.1 多态类型的相关概念](#1111-多态类型的相关概念)
      - [1.11.1.1 类型安全](#11111-类型安全)
      - [1.11.1.2 类型推导](#11112-类型推导)
      - [1.11.1.3 接口与抽象类](#11113-接口与抽象类)
      - [1.11.1.4 类型参数](#11114-类型参数)
      - [1.11.1.5 类型约束](#11115-类型约束)
    - [1.11.2 总结](#1112-总结)

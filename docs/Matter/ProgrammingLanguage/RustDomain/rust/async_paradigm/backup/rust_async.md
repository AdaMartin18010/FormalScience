...
- [1. Rust异步编程的实现原理](#1-rust异步编程的实现原理)
  - [目录](#目录)
  - [1.1 同步过程到状态机的转换](#11-同步过程到状态机的转换)
    - [1.1.1 状态机转换](#111-状态机转换)
    - [1.1.2 保存执行上下文](#112-保存执行上下文)
  - [1.2 重组调用关系成树形递归](#12-重组调用关系成树形递归)
    - [1.2.1 树形依赖结构](#121-树形依赖结构)
    - [1.2.2 状态机调度顺序](#122-状态机调度顺序)
  - [1.3 总结说明](#13-总结说明)
    - [1.3.1 拆分与重组](#131-拆分与重组)
    - [1.3.2 树形递归结构](#132-树形递归结构)
  - [1.4 生命周期与资源释放](#14-生命周期与资源释放)
    - [1.4.1 异步函数与状态机转换](#141-异步函数与状态机转换)
    - [1.4.2 生命周期的管理和借用检查](#142-生命周期的管理和借用检查)
  - [1.5 资源释放的细节](#15-资源释放的细节)
  - [1.6 示例代码解析](#16-示例代码解析)
  - [1.7 总结](#17-总结)

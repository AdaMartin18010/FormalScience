...
- [1. Rust异步编程设计权衡](#1-rust异步编程设计权衡)
  - [目录](#目录)
  - [1.1 多线程与异步编程的基本特点](#11-多线程与异步编程的基本特点)
    - [1.1.1 异步编程asyncawait 模型](#111-异步编程asyncawait-模型)
    - [1.1.2 多线程编程](#112-多线程编程)
  - [1.2 权衡与设计决策的各个层次](#12-权衡与设计决策的各个层次)
    - [1.2.1 任务类型分析](#121-任务类型分析)
    - [1.2.2 任务切换与调度开销](#122-任务切换与调度开销)
    - [1.2.3 数据共享与同步](#123-数据共享与同步)
    - [1.2.4 整体架构层次决策](#124-整体架构层次决策)
  - [1.3 性能平衡与决策的常见措施](#13-性能平衡与决策的常见措施)
  - [1.4 思维导图总结](#14-思维导图总结)
  - [1.5 总结](#15-总结)
  - [1.6 混合模型设计思路](#16-混合模型设计思路)
  - [1.7 示例代码](#17-示例代码)
    - [1.7.1 代码说明](#171-代码说明)
  - [1.8 思维导图总结](#18-思维导图总结)
  - [1.9 设计建议](#19-设计建议)
  - [1.10 5 总结](#110-5-总结)
  - [1.11 工具与背景](#111-工具与背景)
  ...
  - [1.17 添加依赖](#117-添加依赖)
  - [1.18 安装 Recorder 并启动 HTTP 服务](#118-安装-recorder-并启动-http-服务)
  - [1.19 代码说明](#119-代码说明)
  - [1.20 运行与监控](#120-运行与监控)
  - [1.21 5 总结](#121-5-总结)

## 1.1 多线程与异步编程的基本特点

### 1.1.1 异步编程asyncawait 模型

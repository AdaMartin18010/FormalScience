...
- [1. 类型代数在 Rust 中的应用](#1-类型代数在-rust-中的应用)
  - [目录](#目录)
  - [1.1 类型代数的核心定义](#11-类型代数的核心定义)
    - [1.1.1 类型](#111-类型)
    - [1.1.2 积类型](#112-积类型)
    - [1.1.3 和类型](#113-和类型)
    - [1.1.4 指数类型](#114-指数类型)
  - [1.2 Rust 的类型机制](#12-rust-的类型机制)
    - [1.2.1 基本类型](#121-基本类型)
    - [1.2.2 复合类型](#122-复合类型)
    - [1.2.3 泛型](#123-泛型)
    - [1.2.4 Trait](#124-trait)
  - [1.3 类型代数的法则](#13-类型代数的法则)
    - [1.3.1 分配法则](#131-分配法则)
    - [1.3.2 结合法则](#132-结合法则)
  - [1.4 对比与示例](#14-对比与示例)
    - [1.4.1 类型代数与 Rust 类型机制的对比](#141-类型代数与-rust-类型机制的对比)
    - [1.4.2 示例代码](#142-示例代码)
    - [1.4.3 总结](#143-总结)

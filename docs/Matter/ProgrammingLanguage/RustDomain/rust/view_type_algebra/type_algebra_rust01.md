...
- [1. 类型代数在 Rust 中的应用](#类型代数在-rust-中的应用)
  - [1.1 类型代数的核心定义](#1-类型代数的核心定义)
    - [1.1.1 类型](#11-类型)
    - [1.1.2 积类型](#12-积类型)
    - [1.1.3 和类型](#13-和类型)
    - [1.1.4 指数类型](#14-指数类型)
  - [1.2 Rust 的类型机制](#2-rust-的类型机制)
    - [1.2.1 基本类型](#21-基本类型)
    - [1.2.2 复合类型](#22-复合类型)
    - [1.2.3 泛型](#23-泛型)
    - [1.2.4 Trait](#24-trait)
  - [1.3 类型代数的法则](#3-类型代数的法则)
    - [1.3.1 分配法则](#31-分配法则)
    - [1.3.2 结合法则](#32-结合法则)
  - [1.4 对比与示例](#4-对比与示例)
    - [1.4.1 类型代数与 Rust 类型机制的对比](#41-类型代数与-rust-类型机制的对比)
    - [1.4.2 示例代码](#42-示例代码)
    - [1.4.3 总结](#43-总结)
## 1.1 类型代数的核心定义

# 1. 类型代数（Type Algebra）理论基础与形式化推理

## 目录

- [1. 类型代数（Type Algebra）理论基础与形式化推理](#1-类型代数type-algebra理论基础与形式化推理)
  - [目录](#目录)
  - [1.1 类型代数基础](#11-类型代数基础)
    - [1.1.1 类型与命题对应](#111-类型与命题对应)
    - [1.1.2 代数数据类型的形式定义](#112-代数数据类型的形式定义)
    - [1.1.3 类型构造器的代数结构](#113-类型构造器的代数结构)
    - [1.1.4 初始代数与终余代数](#114-初始代数与终余代数)
  - [1.2 和类型与积类型](#12-和类型与积类型)
    - [1.2.1 积类型的形式化](#121-积类型的形式化)
    - [1.2.2 和类型的形式化](#122-和类型的形式化)
    - [1.2.3 类型间的分配律](#123-类型间的分配律)
    - [1.2.4 同构证明与规约](#124-同构证明与规约)
  - [1.3 递归类型与不动点](#13-递归类型与不动点)
    - [1.3.1 F-代数与递归类型](#131-f-代数与递归类型)
    - [1.3.2 不动点算子](#132-不动点算子)
    - [1.3.3 递归类型的结构归纳法](#133-递归类型的结构归纳法)
    - [1.3.4 余递归与无限数据结构](#134-余递归与无限数据结构)
  - [1.4 函数类型与指数运算](#14-函数类型与指数运算)
    - [1.4.1 函数类型的代数表示](#141-函数类型的代数表示)
    - [1.4.2 柯里化的类型同构](#142-柯里化的类型同构)
    - [1.4.3 函数空间的代数性质](#143-函数空间的代数性质)
    - [1.4.4 多态函数的类型代数](#144-多态函数的类型代数)
  - [1.5 类型系统中的代数法则](#15-类型系统中的代数法则)
    - [1.5.1 类型代数的等式系统](#151-类型代数的等式系统)
    - [1.5.2 类型代数的同构定理](#152-类型代数的同构定理)
    - [1.5.3 参数化类型与自然变换](#153-参数化类型与自然变换)
    - [1.5.4 类型系统的完备性与一致性](#154-类型系统的完备性与一致性)
  - [1.6 依赖类型中的代数结构](#16-依赖类型中的代数结构)
    - [1.6.1 依赖积类型](#161-依赖积类型)
    - [1.6.2 依赖和类型](#162-依赖和类型)
    - [1.6.3 依赖类型的代数规则](#163-依赖类型的代数规则)
    - [1.6.4 证明即程序的形式化](#164-证明即程序的形式化)
  - [1.7 线性类型和资源敏感类型代数](#17-线性类型和资源敏感类型代数)
    - [1.7.1 线性逻辑与线性类型](#171-线性逻辑与线性类型)
    - [1.7.2 资源敏感运算规则](#172-资源敏感运算规则)
    - [1.7.3 子结构规则的代数解释](#173-子结构规则的代数解释)
  - [1.8 高级类型代数应用](#18-高级类型代数应用)
    - [1.8.1 类型级编程与类型族](#181-类型级编程与类型族)
    - [1.8.2 类型类的代数结构](#182-类型类的代数结构)
    - [1.8.3 代数效应与处理器](#183-代数效应与处理器)
    - [1.8.4 高阶抽象的类型代数](#184-高阶抽象的类型代数)
...
1. \(\Pi_{x:1} B(x) \cong B(_)\)（其中 \(_\) 是 \(1\) 的唯一元素）

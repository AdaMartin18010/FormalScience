...
- [1. 类型代数（Type Algebra）的核心定义与解释](#1-类型代数type-algebra的核心定义与解释)
  - [目录](#目录)
  - [1.1 积类型（Product Type）](#11-积类型product-type)
    - [1.1.1 示例代码](#111-示例代码)
    - [1.1.2 数学解释](#112-数学解释)
  - [1.2 和类型（Sum Type）](#12-和类型sum-type)
    - [1.2.1 示例代码](#121-示例代码)
    - [1.2.2 数学解释](#122-数学解释)
  - [1.3 指数类型（Exponential Type）](#13-指数类型exponential-type)
    - [1.3.1 示例代码](#131-示例代码)
    - [1.3.2 数学解释](#132-数学解释)
  - [1.4 单位类型和空类型](#14-单位类型和空类型)
    - [1.4.1 Rust 中的示例代码](#141-rust-中的示例代码)
      - [1.4.1.1 单位类型（Unit Type）](#1411-单位类型unit-type)
      - [1.4.1.2 空类型（Void Type）](#1412-空类型void-type)
      - [1.4.1.3 总结](#1413-总结)
    - [1.4.2 数学解释](#142-数学解释)
  - [1.5 依赖类型](#15-依赖类型)
    - [1.5.1 Rust 中的示例代码](#151-rust-中的示例代码)
      - [1.5.1.1 模拟依赖类型的示例](#1511-模拟依赖类型的示例)
      - [1.5.1.2 总结](#1512-总结)
      - [1.5.1.3 模拟依赖类型](#1513-模拟依赖类型)
      - [1.5.1.4 依赖和类型（Dependent Sum Type）](#1514-依赖和类型dependent-sum-type)
      - [1.5.1.5 依赖积类型（Dependent Product Type）](#1515-依赖积类型dependent-product-type)
      - [1.5.1.6 总结](#1516-总结)
    - [1.5.2 数学解释](#152-数学解释)
  - [1.6 类型代数在编程语言中的应用](#16-类型代数在编程语言中的应用)
  - [1.7 指数类型的定义](#17-指数类型的定义)
    - [1.7.1 **指数类型的定义**](#171-指数类型的定义)
    - [1.7.2 **数学上的解释**](#172-数学上的解释)
    - [1.7.3 示例](#173-示例)
    - [1.7.4 **编程语言中的体现**](#174-编程语言中的体现)
    - [1.7.5 示例](#175-示例)
    - [1.7.6 **更深入的理解**](#176-更深入的理解)
  - [1.8 总结](#18-总结)

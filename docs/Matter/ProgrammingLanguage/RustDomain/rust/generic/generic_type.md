# 1. Rust 中的泛型类：使用方法、解释和示例

## 目录

- [1. Rust 中的泛型类：使用方法、解释和示例](#1-rust-中的泛型类使用方法解释和示例)
  - [目录](#目录)
  - [1.1 一、泛型基础](#11-一泛型基础)
  - [1.2 二、泛型的应用](#12-二泛型的应用)
    - [1.2.1 （一）泛型函数](#121-一泛型函数)
    - [1.2.2 （二）泛型结构体](#122-二泛型结构体)
    - [1.2.3 （三）泛型枚举](#123-三泛型枚举)
    - [1.2.4 （四）泛型与 Trait 约束](#124-四泛型与-trait-约束)
  - [1.3 三、泛型的零成本抽象](#13-三泛型的零成本抽象)
  - [1.4 四、总结](#14-四总结)

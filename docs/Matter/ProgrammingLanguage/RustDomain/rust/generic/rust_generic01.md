...
- [1. Rust 泛型](#1-rust-泛型)
  - [目录](#目录)
    - [1.0.1 引言](#101-引言)
    - [1.0.2 Rust 泛型基础 (Rust Generics Fundamentals)](#102-rust-泛型基础-rust-generics-fundamentals)
      - [1.0.2.1 什么是泛型？](#1021-什么是泛型)
      - [1.0.2.2 泛型语法](#1022-泛型语法)
        - [1.0.2.2.1 泛型函数](#10221-泛型函数)
        - [1.0.2.2.2 泛型结构体](#10222-泛型结构体)
        - [1.0.2.2.3 泛型枚举](#10223-泛型枚举)
        - [1.0.2.2.4 泛型方法](#10224-泛型方法)
      - [1.0.2.3 Trait 与 Trait Bounds](#1023-trait-与-trait-bounds)
        - [1.0.2.3.1 基本约束](#10231-基本约束)
        - [1.0.2.3.2 `where` 子句](#10232-where-子句)
        - [1.0.2.3.3 标记 Trait (Marker Traits)](#10233-标记-trait-marker-traits)
      - [1.0.2.4 类型推导](#1024-类型推导)
      - [1.0.2.5 单态化 (Monomorphization)](#1025-单态化-monomorphization)
      - [1.0.2.6 `const` 泛型](#1026-const-泛型)
      - [1.0.2.7 关联类型 (Associated Types)](#1027-关联类型-associated-types)
        - [1.0.2.7.1 定义与使用](#10271-定义与使用)
        - [1.0.2.7.2 与泛型参数对比](#10272-与泛型参数对比)
      - [1.0.2.8 泛型生命周期](#1028-泛型生命周期)
        - [1.0.2.8.1 生命周期省略规则 (Lifetime Elision)](#10281-生命周期省略规则-lifetime-elision)
        - [1.0.2.8.2 显式生命周期](#10282-显式生命周期)
        - [1.0.2.8.3 生命周期约束](#10283-生命周期约束)
        - [1.0.2.8.4 高阶 Trait Bounds (HRTBs - Higher-Rank Trait Bounds)](#10284-高阶-trait-bounds-hrtbs---higher-rank-trait-bounds)
    - [1.0.3 Rust 泛型进阶与应用 (Advanced Rust Generics and Applications)](#103-rust-泛型进阶与应用-advanced-rust-generics-and-applications)
      - [1.0.3.1 设计模式](#1031-设计模式)
        - [1.0.3.1.1 类型状态模式 (Type State Pattern)](#10311-类型状态模式-type-state-pattern)
        - [1.0.3.1.2 构建器模式 (Builder Pattern)](#10312-构建器模式-builder-pattern)
        - [1.0.3.1.3 Newtype 模式](#10313-newtype-模式)
      - [1.0.3.2 编程技巧](#1032-编程技巧)
        - [1.0.3.2.1 零成本抽象](#10321-零成本抽象)
        - [1.0.3.2.2 代码复用](#10322-代码复用)
        - [1.0.3.2.3 静态分发 vs 动态分发](#10323-静态分发-vs-动态分发)
      - [1.0.3.3 库代码设计](#1033-库代码设计)
        - [1.0.3.3.1 设计灵活的 API](#10331-设计灵活的-api)
        - [1.0.3.3.2 平衡泛型与具体实现](#10332-平衡泛型与具体实现)
        - [1.0.3.3.3 使用关联类型优化 API](#10333-使用关联类型优化-api)
      - [1.0.3.4 程序应用设计](#1034-程序应用设计)
      - [1.0.3.5 多线程设计](#1035-多线程设计)
        - [1.0.3.5.1 `Send` 与 `Sync` 约束](#10351-send-与-sync-约束)
        - [1.0.3.5.2 泛型并发数据结构](#10352-泛型并发数据结构)
      - [1.0.3.6 异步/同步设计](#1036-异步同步设计)
        - [1.0.3.6.1 `async` 中的泛型](#10361-async-中的泛型)
        - [1.0.3.6.2 泛型 Future](#10362-泛型-future)
      - [1.0.3.7 算法设计](#1037-算法设计)
      - [1.0.3.8 迭代与递归](#1038-迭代与递归)
        - [1.0.3.8.1 泛型迭代器](#10381-泛型迭代器)
        - [1.0.3.8.2 泛型递归结构与函数](#10382-泛型递归结构与函数)
    - [1.0.4 总结 (Conclusion)](#104-总结-conclusion)
...
### 1.0.2 Rust 泛型基础 (Rust Generics Fundamentals)
...
##### 1.0.2.3.3 标记 Trait (Marker Traits)
...
##### 1.0.2.8.1 生命周期省略规则 (Lifetime Elision)
...
##### 1.0.2.8.4 高阶 Trait Bounds (HRTBs - Higher-Rank Trait Bounds)
...
### 1.0.3 Rust 泛型进阶与应用 (Advanced Rust Generics and Applications)

#### 1.0.3.1 设计模式

泛型和 Trait 是 Rust 实现许多设计模式的基础。

##### 1.0.3.1.1 类型状态模式 (Type State Pattern)
...
##### 1.0.3.1.2 构建器模式 (Builder Pattern)

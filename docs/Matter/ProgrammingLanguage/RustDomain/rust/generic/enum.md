...
- [1. rust generic type](#1-rust-generic-type)
  - [目录](#目录)
  - [1.1 Rust 的 `enum` 支持泛型吗？](#11-rust-的-enum-支持泛型吗)
    - [1.1.1 示例](#111-示例)
    - [1.1.2 `enum` 是否可以像结构体一样实现某个 trait？](#112-enum-是否可以像结构体一样实现某个-trait)
    - [1.1.3 -示例-](#113--示例-)
    - [1.1.4 总结](#114-总结)
    - [1.1.5 `enum` 支持泛型吗？](#115-enum-支持泛型吗)
    - [1.1.6 支持 `impl Trait` 吗？](#116-支持-impl-trait-吗)
    - [1.1.7 \*总结](#117-总结)
    - [1.1.8 Rust 的 Enum 支持泛型吗？](#118-rust-的-enum-支持泛型吗)
    - [1.1.9 例子](#119-例子)
      - [1.1.9.1 泛型枚举](#1191-泛型枚举)
      - [1.1.9.2 自定义的泛型枚举](#1192-自定义的泛型枚举)
    - [1.1.10 使用](#1110-使用)
    - [1.1.11 \*\*总结](#1111-总结)

## 1.1 Rust 的 `enum` 支持泛型吗？
...
### 1.1.2 `enum` 是否可以像结构体一样实现某个 trait？

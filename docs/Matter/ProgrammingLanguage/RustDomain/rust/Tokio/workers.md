...
- [1. Rust异步多线程](#1-rust异步多线程)
  - [目录](#目录)
  - [1.1 项目依赖配置](#11-项目依赖配置)
    - [1.1.1 任务定义和状态](#111-任务定义和状态)
    - [1.1.2 工作者池实现](#112-工作者池实现)
    - [1.1.3 异步队列实现](#113-异步队列实现)
    - [1.1.4 观察者模式实现](#114-观察者模式实现)
    - [1.1.5 任务生成器实现](#115-任务生成器实现)
    - [1.1.6 任务调度器实现](#116-任务调度器实现)
    - [1.1.7 使用示例](#117-使用示例)
    - [1.1.8 自定义观察者示例](#118-自定义观察者示例)
    - [1.1.9 任务优先级队列实现](#119-任务优先级队列实现)

...
- [1. 依赖注入 (DI) 机制深度解析](#1-依赖注入-di-机制深度解析)
  - [目录](#目录)
  - [1.1 依赖注入 (DI) 核心概念](#11-依赖注入-di-核心概念)
    - [1.1.1 定义与解释](#111-定义与解释)
      - [1.1.1.1 控制反转 (IoC - Inversion of Control)](#1111-控制反转-ioc---inversion-of-control)
      - [1.1.1.2 依赖倒置原则 (DIP - Dependency Inversion Principle)](#1112-依赖倒置原则-dip---dependency-inversion-principle)
      - [1.1.1.3 DI, IoC, DIP 之间的关系](#1113-di-ioc-dip-之间的关系)
      - [1.1.1.4 DI 的实现方式](#1114-di-的实现方式)
        - [1.1.1.4.1 构造函数注入 (Constructor Injection)](#11141-构造函数注入-constructor-injection)
        - [1.1.1.4.2 Setter 方法注入 (Setter Injection)](#11142-setter-方法注入-setter-injection)
        - [1.1.1.4.3 接口注入 (Interface Injection)](#11143-接口注入-interface-injection)
      - [1.1.1.5 DI 的优缺点](#1115-di-的优缺点)
    - [1.1.2 DI 与设计模式](#112-di-与设计模式)
    - [1.1.3 DI 与架构模式](#113-di-与架构模式)
    - [1.1.4 DI 与形式化验证](#114-di-与形式化验证)
    - [1.1.5 元层次与分层视角](#115-元层次与分层视角)
    - [1.1.6 总结与思维导图](#116-总结与思维导图)
      - [1.1.6.1 核心关联性总结](#1161-核心关联性总结)
      - [1.1.6.2 思维导图 (Text)](#1162-思维导图-text)
    - [1.1.7 DI 容器与框架 (尤其在 Rust 中)](#117-di-容器与框架-尤其在-rust-中)
      - [1.1.7.1 DI 容器的角色与职责](#1171-di-容器的角色与职责)
      - [1.1.7.2 主流语言中的 DI 框架](#1172-主流语言中的-di-框架)
      - [1.1.7.3 Rust 中的 DI 现状](#1173-rust-中的-di-现状)
        - [1.1.7.3.1 为何 Rust 中 DI 框架不普遍？](#11731-为何-rust-中-di-框架不普遍)
        - [1.1.7.3.2 Rust 中实现 DI 的常见模式 (无框架)](#11732-rust-中实现-di-的常见模式-无框架)
        - [1.1.7.3.3 Rust 生态中的尝试](#11733-rust-生态中的尝试)
    - [1.1.8 DI 与面向切面编程 (AOP - Aspect-Oriented Programming)](#118-di-与面向切面编程-aop---aspect-oriented-programming)
      - [1.1.8.1 AOP 核心概念](#1181-aop-核心概念)
      - [1.1.8.2 AOP 与横切关注点 (Cross-Cutting Concerns)](#1182-aop-与横切关注点-cross-cutting-concerns)
      - [1.1.8.3 DI 与 AOP 的关系](#1183-di-与-aop-的关系)
    - [1.1.9 DI 与配置管理](#119-di-与配置管理)
      - [1.1.9.1 外部化配置的重要性](#1191-外部化配置的重要性)
      - [1.1.9.2 DI 如何与配置结合](#1192-di-如何与配置结合)
      - [1.1.9.3 Rust 中的配置管理实践](#1193-rust-中的配置管理实践)
    - [1.1.10 DI 的高级主题与模式](#1110-di-的高级主题与模式)
    - [1.1.11 重新审视：不同视角下的 DI](#1111-重新审视不同视角下的-di)
    - [1.1.12 扩展思维导图 (Text)](#1112-扩展思维导图-text)
...
#### 1.1.1.1 控制反转 (IoC - Inversion of Control)
...
#### 1.1.1.2 依赖倒置原则 (DIP - Dependency Inversion Principle)
...
##### 1.1.1.4.1 构造函数注入 (Constructor Injection)
...
##### 1.1.1.4.2 Setter 方法注入 (Setter Injection)
...
##### 1.1.1.4.3 接口注入 (Interface Injection)
...
#### 1.1.7.3 Rust 中的 DI 现状

##### 1.1.7.3.1 为何 Rust 中 DI 框架不普遍？
...
##### 1.1.7.3.2 Rust 中实现 DI 的常见模式 (无框架)
...
### 1.1.8 DI 与面向切面编程 (AOP - Aspect-Oriented Programming)
...
#### 1.1.8.2 AOP 与横切关注点 (Cross-Cutting Concerns)

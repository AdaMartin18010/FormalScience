...
- [2 异步编程中的应用](#2-异步编程中的应用)
  - [2.1 简化异步流处理](#21-简化异步流处理)
  - [2.2 异步迭代器模式](#22-异步迭代器模式)
  - [2.3 函数式编程增强](#23-函数式编程增强)
    - [3.3.1 组合器模式](#331-组合器模式)
    - [3.3.2 惰性求值](#332-惰性求值)
    - [3.3.3 函数式流处理](#333-函数式流处理)
  - [2.4 高级使用技巧](#24-高级使用技巧)
    - [4.4.1 错误处理集成](#441-错误处理集成)
    - [4.4.2 异步资源管理](#442-异步资源管理)
    - [4.4.3 并发控制模式](#443-并发控制模式)
  - [2.5 实践建议](#25-实践建议)
    - [5.5.1 性能优化](#551-性能优化)
    - [5.5.2 组合多个生成器](#552-组合多个生成器)
    - [5.5.3 基础定义与语法](#553-基础定义与语法)
      - [3.5.3.1 gen](#3531-gen)
      - [3.5.3.2 yield](#3532-yield)
      - [3.5.3.3 next](#3533-next)
    - [5.5.4 高级特性组合](#554-高级特性组合)
      - [4.5.4.1 与泛型结合](#4541-与泛型结合)
      - [4.5.4.2 与生命周期结合](#4542-与生命周期结合)
      - [4.5.4.3 与trait bounds结合](#4543-与trait-bounds结合)
  - [2.6 6 3 异步编程模式](#26-6-3-异步编程模式)
    - [6.6.1 异步流处理](#661-异步流处理)
    - [6.6.2 并发控制](#662-并发控制)
  - [2.7 -4 函数式编程模式-](#27--4-函数式编程模式)
    - [7.7.1 映射和过滤](#771-映射和过滤)
    - [7.7.2 组合器模式-](#772-组合器模式)
  - [2.8 8 5 错误处理模式](#28-8-5-错误处理模式)
    - [8.8.1 Result处理](#881-result处理)
    - [8.8.2 Option处理](#882-option处理)
  - [2.9 9 6 资源管理模式](#29-9-6-资源管理模式)
    - [9.9.1 RAII模式](#991-raii模式)
    - [9.9.2 异步资源管理](#992-异步资源管理)
  - [2.10 10 7 最佳实践建议](#210-10-7-最佳实践建议)
    - [10.10.1 性能优化](#10101-性能优化)
    - [10.10.2 调试辅助](#10102-调试辅助)
  - [2.11 编程建议](#211-编程建议)
  - [2.12 注意事项](#212-注意事项)

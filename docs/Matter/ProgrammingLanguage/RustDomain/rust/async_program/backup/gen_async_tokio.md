...
- [1 基础定义与语法](#1-基础定义与语法)
  ...
  - [1.2 yield 关键字](#12-yield-关键字)
  - [1.3 next 方法](#13-next-方法)
- [2 高级特性组合](#2-高级特性组合)
  - [2.1 与泛型结合](#21-与泛型结合)
  - [2.2 与生命周期结合](#22-与生命周期结合)
  - [2.3 与 trait bounds 结合](#23-与-trait-bounds-结合)
- [3 异步编程模式](#3-异步编程模式)
  - [3.1 异步流处理](#31-异步流处理)
  - [3.2 并发控制](#32-并发控制)
- [4 函数式编程模式](#4-函数式编程模式)
  ...
  - [4.2 组合器模式](#42-组合器模式)
- [5 错误处理模式](#5-错误处理模式)
  - [5.1 Result 处理](#51-result-处理)
  - [5.2 Option 处理](#52-option-处理)
- [6 资源管理模式](#6-资源管理模式)
  - [6.1 RAII 模式](#61-raii-模式)
  - [6.2 异步资源管理](#62-异步资源管理)
- [7 最佳实践建议](#7-最佳实践建议)
- [8 与 Tokio 等异步库的兼容性](#8-与-tokio-等异步库的兼容性)
  - [8.1 匹配与兼容](#81-匹配与兼容)
  - [8.2 潜在的错误使用](#82-潜在的错误使用)

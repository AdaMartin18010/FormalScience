...
- [1. RPIT（Reference-Passing In Trait）在 Rust 2024 中的含义、举例和应用](#1-rpitreference-passing-in-trait在-rust-2024-中的含义举例和应用)
  - [目录](#目录)
  - [1.1 含义](#11-含义)
  - [1.2 举例](#12-举例)
    ...
    - [1.2.6 Rust 2024 对异步编程的具体影响](#126-rust-2024-对异步编程的具体影响)
      - [1.2.6.1 异步闭包Async Closures](#1261-异步闭包async-closures)
      - [1.2.6.2 改进的错误处理](#1262-改进的错误处理)
      - [1.2.6.3 AsyncFn 特性](#1263-asyncfn-特性)
      - [1.2.6.4 Future 和 IntoFuture 到标准库 Prelude](#1264-future-和-intofuture-到标准库-prelude)
      - [1.2.6.5 改进的生命周期捕获规则](#1265-改进的生命周期捕获规则)
  - [1.3 总结](#13-总结)
...
#### 1.2.6.4 Future 和 IntoFuture 到标准库 Prelude

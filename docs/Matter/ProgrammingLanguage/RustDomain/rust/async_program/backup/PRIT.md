...
- [2 举例](#2-举例)
  ...
  - [2.3 应用](#23-应用)
    - [3.3.1 简化异步编程](#331-简化异步编程)
    - [3.3.2 简化泛型函数](#332-简化泛型函数)
    - [3.3.3 提高代码可读性](#333-提高代码可读性)
  - [2.4 迁移指南](#24-迁移指南)
    - [4.4.1 使用 cargo fix 自动迁移](#441-使用-cargo-fix-自动迁移)
    - [4.4.2 手动迁移](#442-手动迁移)
  - [2.5 总结](#25-总结)
  - [2.6 Rust 2024 对异步编程的具体影响](#26-rust-2024-对异步编程的具体影响)
    - [6.6.1 异步闭包Async Closures](#661-异步闭包async-closures)
    - [6.6.2 改进的错误处理](#662-改进的错误处理)
    - [6.6.3 AsyncFn 特性](#663-asyncfn-特性)
    - [6.6.4 Future 和 IntoFuture 到标准库 Prelude](#664-future-和-intofuture-到标准库-prelude)
    - [6.6.5 改进的生命周期捕获规则](#665-改进的生命周期捕获规则)
- [3 总结](#3-总结)
...
#### 6.6.4 Future 和 IntoFuture 到标准库 Prelude

...
- [Rust 编程语言的形式模型、元模型与关联分析](#rust-编程语言的形式模型元模型与关联分析)
  ...
  - [9 深入元模型-模型的论证、证明与拓展](#9-深入元模型-模型的论证证明与拓展)
    - [1 . 编译器的“论证”：模型对元模型的一致性检查](#1-编译器的论证模型对元模型的一致性检查)
    - [2 . 超越编译器的“证明”：形式化验证的应用](#2-超越编译器的证明形式化验证的应用)
    - [3 . 元模型与模型的“拓展”](#3-元模型与模型的拓展)
  - [10 Rust 形式化面临的挑战](#10-rust-形式化面临的挑战)
  - [11 形式化对日常 Rust 开发者的实际意义](#11-形式化对日常-rust-开发者的实际意义)
  - [12 Rust 形式化的未来可能方向](#12-rust-形式化的未来可能方向)

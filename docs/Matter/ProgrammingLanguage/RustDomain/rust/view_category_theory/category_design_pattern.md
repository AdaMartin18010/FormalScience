...
- [1. Category Design Pattern](#1-category-design-pattern)
  - [目录](#目录)
  - [1.1 创建型设计模式Creational Patterns](#11-创建型设计模式creational-patterns)
    - [1.1.1 范畴论视角下的创建型模式](#111-范畴论视角下的创建型模式)
    - [1.1.2 结构型设计模式Structural Patterns](#112-结构型设计模式structural-patterns)
      - [1.1.2.1 范畴论视角下的结构型模式](#1121-范畴论视角下的结构型模式)
    - [1.1.3 行为型设计模式Behavioral Patterns](#113-行为型设计模式behavioral-patterns)

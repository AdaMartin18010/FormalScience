...
- [1 创建型设计模式Creational Patterns](#1-创建型设计模式creational-patterns)
  - [1.1 范畴论视角下的创建型模式](#11-范畴论视角下的创建型模式)
  - [1.2 结构型设计模式Structural Patterns](#12-结构型设计模式structural-patterns)
    - [2.2.1 范畴论视角下的结构型模式](#221-范畴论视角下的结构型模式)
  - [1.3 行为型设计模式Behavioral Patterns](#13-行为型设计模式behavioral-patterns)

---

## 1 创建型设计模式Creational Patterns
...
### 1.2 结构型设计模式Structural Patterns
...
### 1.3 行为型设计模式Behavioral Patterns

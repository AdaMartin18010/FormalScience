...
- [1 一、范畴论基础概念](#1-一范畴论基础概念)
- [2 二、Rust 泛型编程与范畴论的联系](#2-二rust-泛型编程与范畴论的联系)
  - [2.1 一类型系统作为范畴](#21-一类型系统作为范畴)
  - [2.2 二泛型作为函子](#22-二泛型作为函子)
  - [2.3 三Trait 作为态射规则](#23-三trait-作为态射规则)
  - [2.4 四Impl 作为态射实现](#24-四impl-作为态射实现)
- [3 三、设计模式](#3-三设计模式)
  - [3.1 一泛型编程模式](#31-一泛型编程模式)
  - [3.2 二Trait 对象模式](#32-二trait-对象模式)
  - [3.3 三生命周期模式](#33-三生命周期模式)
- [4 四、总结](#4-四总结)

# 1. 范畴论（Category Theory）理论基础与形式化推理

## 目录

- [1. 范畴论（Category Theory）理论基础与形式化推理](#1-范畴论category-theory理论基础与形式化推理)
  - [目录](#目录)
  - [1.1 范畴论基础定义](#11-范畴论基础定义)
    - [1.1.1 范畴的形式化定义](#111-范畴的形式化定义)
    - [1.1.2 态射与组合律](#112-态射与组合律)
    - [1.1.3 同构与等价关系](#113-同构与等价关系)
    - [1.1.4 特殊对象与态射](#114-特殊对象与态射)
  - [1.2 函子理论](#12-函子理论)
    - [1.2.1 函子的定义与性质](#121-函子的定义与性质)
    - [1.2.2 函子范畴](#122-函子范畴)
    - [1.2.3 特殊函子类型](#123-特殊函子类型)
    - [1.2.4 表示函子](#124-表示函子)
  - [1.3 自然变换](#13-自然变换)
    - [1.3.1 自然变换的形式化定义](#131-自然变换的形式化定义)
    - [1.3.2 自然同构](#132-自然同构)
    - [1.3.3 交换图与自然性条件](#133-交换图与自然性条件)
    - [1.3.4 水平与垂直组合](#134-水平与垂直组合)
  - [1.4 伴随函子](#14-伴随函子)
    - [1.4.1 伴随函子的定义与性质](#141-伴随函子的定义与性质)
    - [1.4.2 单位与余单位变换](#142-单位与余单位变换)
    - [1.4.3 伴随对的等价表示](#143-伴随对的等价表示)
    - [1.4.4 伴随函子基本定理](#144-伴随函子基本定理)
  - [1.5 极限理论](#15-极限理论)
    - [1.5.1 图与函子](#151-图与函子)
    - [1.5.2 极限的普遍性质](#152-极限的普遍性质)
    - [1.5.3 余极限](#153-余极限)
    - [1.5.4 极限的存在条件](#154-极限的存在条件)
  - [1.6 单子与余单子](#16-单子与余单子)
    - [1.6.1 单子的代数定义](#161-单子的代数定义)
    - [1.6.2 克莱斯利范畴](#162-克莱斯利范畴)
    - [1.6.3 单子代数与余代数](#163-单子代数与余代数)
    - [1.6.4 单子的组合定理](#164-单子的组合定理)
  - [1.7 高级定理与推论](#17-高级定理与推论)
    - [1.7.1 Yoneda引理及其证明](#171-yoneda引理及其证明)
    - [1.7.2 可表函子定理](#172-可表函子定理)
    - [1.7.3 伴随函数定理](#173-伴随函数定理)
    - [1.7.4 巴尔加定理](#174-巴尔加定理)
  - [1.8 笛卡尔闭范畴](#18-笛卡尔闭范畴)
    - [1.8.1 笛卡尔积与终对象](#181-笛卡尔积与终对象)
    - [1.8.2 指数对象与内部Hom](#182-指数对象与内部hom)
    - [1.8.3 闭性质与柯里化](#183-闭性质与柯里化)
    - [1.8.4 笛卡尔闭范畴的性质定理](#184-笛卡尔闭范畴的性质定理)

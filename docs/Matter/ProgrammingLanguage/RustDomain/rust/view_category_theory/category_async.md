...
- [1. Rust 异步编程与范畴论的结合](#rust-异步编程与范畴论的结合)
  - [1.1 异步函数与 Future](#1-异步函数与-future)
    - [1.1.1 **异步函数作为态射**](#11-异步函数作为态射)
    - [1.1.2 **Future 的态射**](#12-future-的态射)
  - [1.2 `async/await` 与态射的合成](#2-asyncawait-与态射的合成)
    - [1.2.1 **态射的合成**](#21-态射的合成)
  - [1.3 事件循环与函子](#3-事件循环与函子)
    - [1.3.1 **事件循环作为函子**](#31-事件循环作为函子)
  - [1.4 异步任务与自然变换](#4-异步任务与自然变换)
    - [1.4.1 **自然变换与任务转换**](#41-自然变换与任务转换)
  - [1.5 形式化推理](#5-形式化推理)
  - [1.6 总结](#6-总结)
## 1.1 异步函数与 Future

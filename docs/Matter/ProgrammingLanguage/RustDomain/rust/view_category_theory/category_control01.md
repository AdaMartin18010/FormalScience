...
- [1. 范畴论看待控制流](#范畴论看待控制流)
  - [1.1 引言](#1-引言)
  - [1.2 执行流与控制流的基本概念](#2-执行流与控制流的基本概念)
    - [1.2.1 执行流的定义](#21-执行流的定义)
    - [1.2.2 控制流的定义](#22-控制流的定义)
  - [1.3 范畴论视角下的执行流和控制流](#3-范畴论视角下的执行流和控制流)
    - [1.3.1 对象和态射的视角](#31-对象和态射的视角)
    - [1.3.2 函数式编程与范畴论的联系](#32-函数式编程与范畴论的联系)
      - [1.3.2.1 高阶函数和函子](#321-高阶函数和函子)
      - [1.3.2.2 单子与控制流](#322-单子与控制流)
    - [1.3.3 控制流的分支与范畴论的自然变换](#33-控制流的分支与范畴论的自然变换)
    - [1.3.4 循环与态射的反复应用](#34-循环与态射的反复应用)
    - [1.3.5 协程与范畴论的异步控制](#35-协程与范畴论的异步控制)
  - [1.4 范畴论视角的优势](#4-范畴论视角的优势)
    - [1.4.1 抽象与简化](#41-抽象与简化)
    - [1.4.2 统一视角](#42-统一视角)
    - [1.4.3 可组合性](#43-可组合性)
    - [1.4.4 灵活的状态管理](#44-灵活的状态管理)
  - [1.5 总结](#5-总结)
## 1.1 引言

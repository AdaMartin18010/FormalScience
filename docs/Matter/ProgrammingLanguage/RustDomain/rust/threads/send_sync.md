...
- [2 编译器如何处理 Send 和 Sync](#2-编译器如何处理-send-和-sync)
  - [2.1 自动实现Auto Trait](#21-自动实现auto-trait)
  - [2.2 编译器生成的代码](#22-编译器生成的代码)
- [3 总结](#3-总结)
- [4 thread-safe](#4-thread-safe)
  - [4.1 -基本概念](#41--基本概念)
    - [1.1.1 -Send Trait](#111--send-trait)
    - [1.1.2 -Sync Trait](#112--sync-trait)
  - [4.2 -编译器如何处理 Send 和 Sync](#42--编译器如何处理-send-和-sync)
    - [2.2.1 -自动实现Auto Trait](#221--自动实现auto-trait)
    - [2.2.2 -编译器生成的代码](#222--编译器生成的代码)
  - [4.3 -总结](#43--总结)
- [5 thread-safe type](#5-thread-safe-type)
  - [5.1 不同访问方式下的情况](#51-不同访问方式下的情况)
    - [1.1.1 不可变共享T](#111-不可变共享t)
    - [1.1.2 可变共享mut T](#112-可变共享mut-t)
    - [1.1.3 跨线程修改：使用同步原语和原子类型](#113-跨线程修改使用同步原语和原子类型)
  - [5.2 总结](#52-总结)
...
### 4.2 -编译器如何处理 Send 和 Sync

#### 2.2.1 -自动实现Auto Trait

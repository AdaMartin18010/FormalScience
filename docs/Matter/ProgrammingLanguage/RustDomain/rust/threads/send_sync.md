# 1. rust threads trait send and sync

## 目录

- [1. rust threads trait send and sync](#1-rust-threads-trait-send-and-sync)
  - [目录](#目录)
  - [1.1 基本概念](#11-基本概念)
    - [1.1.1 Send Trait](#111-send-trait)
    - [1.1.2 Sync Trait](#112-sync-trait)
  - [1.2 编译器如何处理 Send 和 Sync](#12-编译器如何处理-send-和-sync)
    - [1.2.1 自动实现Auto Trait](#121-自动实现auto-trait)
  ...
  - [1.4 thread-safe](#14-thread-safe)
    ...
    - [1.4.2 -编译器如何处理 Send 和 Sync](#142--编译器如何处理-send-和-sync)
      - [1.4.2.1 -自动实现Auto Trait](#1421--自动实现auto-trait)
      - [1.4.2.2 -编译器生成的代码](#1422--编译器生成的代码)
    - [1.4.3 -总结](#143--总结)
  - [1.5 thread-safe type](#15-thread-safe-type)
    - [1.5.1 不同访问方式下的情况](#151-不同访问方式下的情况)
      - [1.5.1.1 不可变共享T](#1511-不可变共享t)
      - [1.5.1.2 可变共享mut T](#1512-可变共享mut-t)
...
## 1.2 编译器如何处理 Send 和 Sync

### 1.2.1 自动实现Auto Trait
...
### 1.4.2 -编译器如何处理 Send 和 Sync

#### 1.4.2.1 -自动实现Auto Trait

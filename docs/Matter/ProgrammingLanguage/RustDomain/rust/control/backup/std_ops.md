...
- [1. Rust std::ops](#rust-stdops)
  ...
  - [1.5 索引操作符](#5-索引操作符)
    - [1.5.1 示例代码](#51-示例代码)
      - [1.5.1.1 实现 Add 和 Sub](#511-实现-add-和-sub)
      - [1.5.1.2 实现 BitAnd 和 BitOr](#512-实现-bitand-和-bitor)
      - [1.5.1.3 实现 AddAssign 和 SubAssign](#513-实现-addassign-和-subassign)
      - [1.5.1.4 实现 Index 和 IndexMut](#514-实现-index-和-indexmut)
    - [1.5.2 总结](#52-总结)
    - [1.5.3 Rust 中 Neg 和 Not 的用法示例](#53-rust-中-neg-和-not-的用法示例)
      - [1.5.3.1 Neg一元负号](#531-neg一元负号)
      - [1.5.3.2 Not逻辑非](#532-not逻辑非)
    - [1.5.4 总结](#54-总结)
    - [1.5.5 Neg 可用的数据类型](#55-neg-可用的数据类型)
    - [1.5.6 Not 可用的数据类型](#56-not-可用的数据类型)
    - [1.5.7 总结](#57-总结)
## 1.1 算术操作符
...
#### 1.5.1.3 实现 AddAssign 和 SubAssign

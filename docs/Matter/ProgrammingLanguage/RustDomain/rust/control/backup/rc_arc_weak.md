# 1. Rc 和 Arc 的 Weak 指针

## 目录

- [1. Rc 和 Arc 的 Weak 指针](#rc-和-arc-的-weak-指针)
  - [1.1 Weak 的实现原理](#1-weak-的实现原理)
    - [1.1.1 upgrade 和 downgrade 的区别](#11-upgrade-和-downgrade-的区别)
      - [1.1.1.1 upgrade](#111-upgrade)
      - [1.1.1.2 downgrade](#112-downgrade)
    - [1.1.2 总结](#12-总结)
  - [1.2 结合使用 Arc、Rc 和 Weak](#2-结合使用-arcrc-和-weak)
    - [1.2.1 使用场景](#21-使用场景)
    - [1.2.2 示例代码](#22-示例代码)
    - [1.2.3 代码解释](#23-代码解释)
  - [1.3 Rc 和 Weak 的对比](#3-rc-和-weak-的对比)
    - [1.3.1 Rc 和 Weak 的对比](#31-rc-和-weak-的对比)
    - [1.3.2 使用实例](#32-使用实例)
  - [1.4 代码解释](#4-代码解释)
  - [1.5 总结](#5-总结)
## 1.1 Weak 的实现原理

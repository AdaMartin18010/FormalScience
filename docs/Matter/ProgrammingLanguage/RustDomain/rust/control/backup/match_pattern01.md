...
- [1 在模式匹配中的用途](#1-在模式匹配中的用途)
  - [1.1 示例：在 match 中使用](#11-示例在-match-中使用)
    - [1.1.1 示例：在元组中使用](#111-示例在元组中使用)
  - [1.2 与变量绑定的关系](#12-与变量绑定的关系)
  - [1.3 的语法](#13-的语法)
  - [1.4 注意事项](#14-注意事项)
  - [1.5 总结](#15-总结)
  - [1.6 6 1 省略符号](#16-6-1-省略符号)
  - [1.7 7 2 _通配符](#17-7-2-_通配符)
  - [1.8 8 3 ref 和 ref mut](#18-8-3-ref-和-ref-mut)
  - [1.9 9 4 宏中的占位符](#19-9-4-宏中的占位符)
  - [1.10 10 5 管符](#110-10-5-管符)
  - [1.11 11 6 绑定操作符](#111-11-6-绑定操作符)
  - [1.12 总结](#112-总结)
  - [1.13 13 1 在 match 中使用 ref mut](#113-13-1-在-match-中使用-ref-mut)
  - [1.14 14 2 在 if let 或 while let 中使用 ref mut](#114-14-2-在-if-let-或-while-let-中使用-ref-mut)
  - [1.15 15 3 在函数中使用 ref mut](#115-15-3-在函数中使用-ref-mut)
  - [1.16 16 4 在解构赋值中使用 ref mut](#116-16-4-在解构赋值中使用-ref-mut)
  - [1.17 总结](#117-总结)
  - [1.18 18 1 在解构赋值中使用 ref mut](#118-18-1-在解构赋值中使用-ref-mut)
    - [18.18.1 -示例](#18181--示例)
  - [1.19 19 2 在函数参数中使用 ref mut](#119-19-2-在函数参数中使用-ref-mut)
    - [19.19.1 示例](#19191-示例)
  - [1.20 20 3 在 if let 或 while let 中使用 ref mut](#120-20-3-在-if-let-或-while-let-中使用-ref-mut)
    - [20.20.1 --示例](#20201---示例)
  - [1.21 -总结-](#121--总结)
  - [1.22 match 语法](#122-match-语法)
    - [22.22.1 示例代码](#22221-示例代码)
  - [1.23 组合类型](#123-组合类型)
  - [1.24 所有权与绑定关系](#124-所有权与绑定关系)
  - [1.25 范畴论视角](#125-范畴论视角)
    - [25.25.1 对象与态射](#25251-对象与态射)
    - [25.25.2 模式匹配与同态](#25252-模式匹配与同态)
    - [25.25.3 绑定关系](#25253-绑定关系)
  - [1.26 总结](#126-总结)
...
### 1.14 2 在 if let 或 while let 中使用 ref mut
...
### 1.20 3 在 if let 或 while let 中使用 ref mut

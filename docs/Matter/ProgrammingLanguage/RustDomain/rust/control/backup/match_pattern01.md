# 1. rust match pattern

## 目录

- [1. rust match pattern](#rust-match-pattern)
  - [1.1 在模式匹配中的用途](#1-在模式匹配中的用途)
    - [1.1.1 示例：在 match 中使用](#11-示例在-match-中使用)
      - [1.1.1.1 示例：在元组中使用](#111-示例在元组中使用)
    - [1.1.2 与变量绑定的关系](#12-与变量绑定的关系)
    - [1.1.3 的语法](#13-的语法)
    - [1.1.4 注意事项](#14-注意事项)
    - [1.1.5 总结](#15-总结)
    - [1.1.6 1 省略符号](#16-1-省略符号)
    - [1.1.7 2 _通配符](#17-2-_通配符)
    - [1.1.8 3 ref 和 ref mut](#18-3-ref-和-ref-mut)
    - [1.1.9 4 宏中的占位符](#19-4-宏中的占位符)
    - [1.1.10 5 管符](#110-5-管符)
    - [1.1.11 6 绑定操作符](#111-6-绑定操作符)
    - [1.1.12 总结](#112-总结)
    - [1.1.13 1 在 match 中使用 ref mut](#113-1-在-match-中使用-ref-mut)
    - [1.1.14 2 在 if let 或 while let 中使用 ref mut](#114-2-在-if-let-或-while-let-中使用-ref-mut)
    - [1.1.15 3 在函数中使用 ref mut](#115-3-在函数中使用-ref-mut)
    - [1.1.16 4 在解构赋值中使用 ref mut](#116-4-在解构赋值中使用-ref-mut)
    - [1.1.17 总结](#117-总结)
    - [1.1.18 1 在解构赋值中使用 ref mut](#118-1-在解构赋值中使用-ref-mut)
      - [1.1.18.1 -示例](#1181-示例)
    - [1.1.19 2 在函数参数中使用 ref mut](#119-2-在函数参数中使用-ref-mut)
      - [1.1.19.1 示例](#1191-示例)
    - [1.1.20 3 在 if let 或 while let 中使用 ref mut](#120-3-在-if-let-或-while-let-中使用-ref-mut)
      - [1.1.20.1 --示例](#1201-示例)
    - [1.1.21 -总结-](#121-总结)
    - [1.1.22 match 语法](#122-match-语法)
      - [1.1.22.1 示例代码](#1221-示例代码)
    - [1.1.23 组合类型](#123-组合类型)
    - [1.1.24 所有权与绑定关系](#124-所有权与绑定关系)
    - [1.1.25 范畴论视角](#125-范畴论视角)
      - [1.1.25.1 对象与态射](#1251-对象与态射)
      - [1.1.25.2 模式匹配与同态](#1252-模式匹配与同态)
      - [1.1.25.3 绑定关系](#1253-绑定关系)
    - [1.1.26 总结](#126-总结)
## 1.1 在模式匹配中的用途

...
- [1. 匿名函数和闭包](#匿名函数和闭包)
  - [1.1 示例](#1-示例)
    ...
    - [1.1.2 总结](#12-总结)
    - [1.1.3 总结](#13-总结)
    - [1.1.4 闭包的实现机制](#14-闭包的实现机制)
    - [1.1.5 运行时机制](#15-运行时机制)
    - [1.1.6 C 语言的缺乏](#16-c-语言的缺乏)
    - [1.1.7 总结](#17-总结)
    - [1.1.8 Fn Trait](#18-fn-trait)
    - [1.1.9 FnMut Trait](#19-fnmut-trait)
    - [1.1.10 FnOnce Trait](#110-fnonce-trait)
    - [1.1.11 总结](#111-总结)
    - [1.1.12 Trait 对象](#112-trait-对象)
      - [1.1.12.1 示例](#1121-示例)
    - [1.1.13 泛型](#113-泛型)
      - [1.1.13.1 示例](#1131-示例)
    - [1.1.14 多态行为的实现](#114-多态行为的实现)
    - [1.1.15 总结](#115-总结)
    - [1.1.16 async fn](#116-async-fn)
    - [1.1.17 async fn mut](#117-async-fn-mut)
    - [1.1.18 async fn once](#118-async-fn-once)
    - [1.1.19 总结](#119-总结)
    - [1.1.20 策略模式](#120-策略模式)
    - [1.1.21 观察者模式](#121-观察者模式)
    - [1.1.22 命令模式](#122-命令模式)
    - [1.1.23 适配器模式](#123-适配器模式)
    - [1.1.24 状态模式](#124-状态模式)
    - [1.1.25 组合模式](#125-组合模式)
    - [1.1.26 总结](#126-总结)
## 1.1 示例

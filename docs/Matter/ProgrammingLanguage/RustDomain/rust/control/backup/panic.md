...
- [1. Rust panic](#rust-panic)
  - [1.1 引发 panic](#1-引发-panic)
  - [1.2 栈展开Stack Unwinding](#2-栈展开stack-unwinding)
  - [1.3 panicabort 策略](#3-panicabort-策略)
- [2. Cargo.toml](#cargotoml)
  - [2.1 捕获 panic](#1-捕获-panic)
  - [2.2 小结](#2-小结)
## 1.1 引发 panic

...
- [1. marker trait](#1-marker-trait)
  - [目录](#目录)
  - [1.1 标记 trait 的特点](#11-标记-trait-的特点)
  - [1.2 标记 trait 的使用场景](#12-标记-trait-的使用场景)
  - [1.19 总结](#119-总结)
  - [1.4 编译时静态检查](#14-编译时静态检查)
  - [1.5 标记 Trait：Send 与 Sync](#15-标记-traitsend-与-sync)
  - [1.6 运行时同步原语](#16-运行时同步原语)
  - [1.7 整体安全保证](#17-整体安全保证)
  - [1.8 自动 trait 的工作原理](#18-自动-trait-的工作原理)
  - [1.9 示例说明](#19-示例说明)
  - [1.19 总结](#119-总结-1)
  - [1.11 自动 trait 的基本原理](#111-自动-trait-的基本原理)
  - [1.12 编译器中的实现机制](#112-编译器中的实现机制)
  - [1.13 举例说明](#113-举例说明)
  - [1.14 小结](#114-小结)
  - [1.15 确保线程安全](#115-确保线程安全)
  - [1.16 使用 `unsafe impl` 的谨慎性](#116-使用-unsafe-impl-的谨慎性)
  - [1.17 注意负实现（Negative impl）](#117-注意负实现negative-impl)
  - [1.18 编译器的自动推导与局限性](#118-编译器的自动推导与局限性)
  - [1.19 总结](#119-总结-2)

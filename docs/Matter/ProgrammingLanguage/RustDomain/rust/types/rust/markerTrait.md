...
- [1. marker trait](#marker-trait)
  - [1.1 标记 trait 的特点](#1-标记-trait-的特点)
  - [1.2 标记 trait 的使用场景](#2-标记-trait-的使用场景)
  - [1.3 总结](#3-总结)
  - [1.4 编译时静态检查](#4-编译时静态检查)
  - [1.5 标记 Trait：Send 与 Sync](#5-标记-traitsend-与-sync)
  - [1.6 运行时同步原语](#6-运行时同步原语)
  - [1.7 整体安全保证](#7-整体安全保证)
  - [1.8 自动 trait 的工作原理](#8-自动-trait-的工作原理)
  - [1.9 示例说明](#9-示例说明)
  - [1.10 总结](#10-总结)
  - [1.11 自动 trait 的基本原理](#11-自动-trait-的基本原理)
  - [1.12 编译器中的实现机制](#12-编译器中的实现机制)
  - [1.13 举例说明](#13-举例说明)
  - [1.14 小结](#14-小结)
  - [1.15 确保线程安全](#15-确保线程安全)
  - [1.16 使用 `unsafe impl` 的谨慎性](#16-使用-unsafe-impl-的谨慎性)
  - [1.17 注意负实现（Negative impl）](#17-注意负实现negative-impl)
  - [1.18 编译器的自动推导与局限性](#18-编译器的自动推导与局限性)
  - [1.19 总结](#19-总结)
## 1.1 标记 trait 的特点

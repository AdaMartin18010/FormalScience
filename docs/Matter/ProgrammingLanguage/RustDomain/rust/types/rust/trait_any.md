...
- [1. Any 类型与显式类型转换](#any-类型与显式类型转换)
  - [1.1 示例 1：使用 `Any` trait 进行类型检查](#1-示例-1使用-any-trait-进行类型检查)
    - [1.1.1 输出](#11-输出)
  - [1.2 示例 2：使用 `Any` trait 获取具体的类型](#2-示例-2使用-any-trait-获取具体的类型)
    - [1.2.1 *输出*](#21-输出)
    - [1.2.2 示例 3：`Any` trait 和结构体](#22-示例-3any-trait-和结构体)
    - [1.2.3 -输出](#23-输出)
    - [1.2.4 总结](#24-总结)
    - [1.2.5 用户定义的结构体和枚举](#25-用户定义的结构体和枚举)
    - [1.2.6 基本类型和容器类型](#26-基本类型和容器类型)
    - [1.2.7 实现 `Any` trait 的必要条件](#27-实现-any-trait-的必要条件)
    - [1.2.8 注意事项](#28-注意事项)
    - [1.2.9 替代方案](#29-替代方案)
    - [1.2.10 **定义和设计目的**](#210-定义和设计目的)
    - [1.2.11 **实现方式**](#211-实现方式)
    - [1.2.12 **用途**](#212-用途)
    - [1.2.13 **类型约束**](#213-类型约束)
    - [1.2.14 **性能**](#214-性能)
    - [1.2.15 **运行时/编译时**](#215-运行时编译时)
    - [1.2.16 -总结](#216-总结)
    - [1.2.17 示例说明](#217-示例说明)
    - [1.2.18 运行时错误](#218-运行时错误)
    - [1.2.19 错误的行为](#219-错误的行为)
    - [1.2.20 调试困难](#220-调试困难)
    - [1.2.21 性能问题](#221-性能问题)
    - [1.2.22 代码复杂性](#222-代码复杂性)
    - [1.2.23 示例](#223-示例)
    - [1.2.24 --输出](#224-输出)
    - [1.2.25 --总结](#225-总结)
## 1.1 示例 1：使用 `Any` trait 进行类型检查

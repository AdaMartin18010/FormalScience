...
- [1. 类型等价与类型相等](#1-类型等价与类型相等)
  - [目录](#目录)
  - [1.1 类型等价与类型相等](#11-类型等价与类型相等)
    - [1.1.1 类型等价Type Equivalence](#111-类型等价type-equivalence)
    - [1.1.2 类型相等](#112-类型相等)
  - [1.2 新类型Newtype Pattern](#12-新类型newtype-pattern)
  - [1.3 类型转换](#13-类型转换)
    - [1.3.1 (1) 显式转换Explicit Conversion](#131-1-显式转换explicit-conversion)
    - [1.3.2 (2) 利用 FromInto Trait](#132-2-利用-frominto-trait)
    - [1.3.3 (3) 自动解引用转换Deref Coercion](#133-3-自动解引用转换deref-coercion)
  - [1.4 类型上下转换Coercion 与 Subtyping 转换](#14-类型上下转换coercion-与-subtyping-转换)
    - [1.4.1 (1) 尺寸转换Unsized Coercion](#141-1-尺寸转换unsized-coercion)

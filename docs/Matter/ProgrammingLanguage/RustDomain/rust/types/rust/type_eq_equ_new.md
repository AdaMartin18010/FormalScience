...
- [1 类型等价与类型相等](#1-类型等价与类型相等)
  - [1.1 类型等价Type Equivalence](#11-类型等价type-equivalence)
  - [1.2 类型相等](#12-类型相等)
- [2 新类型Newtype Pattern](#2-新类型newtype-pattern)
- [3 类型转换](#3-类型转换)
  - [3.1 (1) 显式转换Explicit Conversion](#31-1-显式转换explicit-conversion)
  - [3.2 (2) 利用 FromInto Trait](#32-2-利用-frominto-trait)
  - [3.3 (3) 自动解引用转换Deref Coercion](#33-3-自动解引用转换deref-coercion)
- [4 类型上下转换Coercion 与 Subtyping 转换](#4-类型上下转换coercion-与-subtyping-转换)
  - [4.1 (1) 尺寸转换Unsized Coercion](#41-1-尺寸转换unsized-coercion)
  - [4.2 (2) Trait 对象转换](#42-2-trait-对象转换)
  - [4.3 (3) 生命周期转换](#43-3-生命周期转换)
- [5 总结](#5-总结)

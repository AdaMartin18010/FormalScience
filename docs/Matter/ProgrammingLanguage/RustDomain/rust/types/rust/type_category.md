...
- [1. 类型系统分类](#1-类型系统分类)
  - [目录](#目录)
  - [1.1 静态类型系统](#11-静态类型系统)
  - [1.2 数据类型的分类](#12-数据类型的分类)
    - [1.2.1 标量类型](#121-标量类型)
    - [1.2.2 复合类型](#122-复合类型)
    ...
    - [1.2.7 动态大小类型DST](#127-动态大小类型dst)
  - [1.3 所有权与借用Affine 类型系统](#13-所有权与借用affine-类型系统)
  - [1.4 Nominal 与 Structural 类型系统](#14-nominal-与-structural-类型系统)
  - [1.5 总结](#15-总结)

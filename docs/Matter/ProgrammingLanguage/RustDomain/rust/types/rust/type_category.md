...
- [1. 类型系统分类](#类型系统分类)
  - [1.1 静态类型系统](#1-静态类型系统)
  - [1.2 数据类型的分类](#2-数据类型的分类)
    - [1.2.1 标量类型](#21-标量类型)
    - [1.2.2 复合类型](#22-复合类型)
    - [1.2.3 用户自定义类型](#23-用户自定义类型)
    - [1.2.4 指针与引用](#24-指针与引用)
    - [1.2.5 函数与闭包类型](#25-函数与闭包类型)
    - [1.2.6 泛型与 trait](#26-泛型与-trait)
    - [1.2.7 动态大小类型DST](#27-动态大小类型dst)
  - [1.3 所有权与借用Affine 类型系统](#3-所有权与借用affine-类型系统)
  - [1.4 Nominal 与 Structural 类型系统](#4-nominal-与-structural-类型系统)
  - [1.5 总结](#5-总结)
## 1.1 静态类型系统

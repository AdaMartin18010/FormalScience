...
- [1. 关联类型](#1-关联类型)
  ...
  - [1.2 关联类型在泛型编程中的优势](#12-关联类型在泛型编程中的优势)
    - [1.2.1 (1) 简化泛型接口](#121-1-简化泛型接口)
    - [1.2.2 (2) 表达类型之间的语义关系](#122-2-表达类型之间的语义关系)
    - [1.2.3 (3) 自动类型推导](#123-3-自动类型推导)
  - [1.3 关联类型的示例和应用](#13-关联类型的示例和应用)
  - [1.4 总结](#14-总结)
  - [1.5 关联类型的概念](#15-关联类型的概念)
  - [1.6 关联类型与泛型参数的比较](#16-关联类型与泛型参数的比较)
    - [1.6.1 使用泛型参数定义接口](#161-使用泛型参数定义接口)
    - [1.6.2 使用关联类型定义接口](#162-使用关联类型定义接口)
  - [1.7 关联类型的实际应用示例](#17-关联类型的实际应用示例)
  - [1.8 关联类型在 trait 中的扩展](#18-关联类型在-trait-中的扩展)
  - [1.9 小结](#19-小结)

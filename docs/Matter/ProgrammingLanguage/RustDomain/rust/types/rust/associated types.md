...
- [2 关联类型在泛型编程中的优势](#2-关联类型在泛型编程中的优势)
  - [2.1 (1) 简化泛型接口](#21-1-简化泛型接口)
  - [2.2 (2) 表达类型之间的语义关系](#22-2-表达类型之间的语义关系)
  - [2.3 (3) 自动类型推导](#23-3-自动类型推导)
- [3 关联类型的示例和应用](#3-关联类型的示例和应用)
- [4 总结](#4-总结)
- [5 关联类型的概念](#5-关联类型的概念)
- [6 关联类型与泛型参数的比较](#6-关联类型与泛型参数的比较)
  - [6.1 使用泛型参数定义接口](#61-使用泛型参数定义接口)
  - [6.2 使用关联类型定义接口](#62-使用关联类型定义接口)
- [7 关联类型的实际应用示例](#7-关联类型的实际应用示例)
- [8 关联类型在 trait 中的扩展](#8-关联类型在-trait-中的扩展)
- [9 小结](#9-小结)

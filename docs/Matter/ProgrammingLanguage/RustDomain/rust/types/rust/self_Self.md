...
- [1. Self 与 self](#1-self-与-self)
  ...
  - [1.4 总结](#14-总结)
  - [1.5 基本概念](#15-基本概念)
    - [1.5.1 `self`（小写）](#151-self小写)
    - [1.5.2 `Self`（大写）](#152-self大写)
  - [1.6 详细解释与区别](#16-详细解释与区别)
    - [1.6.1 `self` 的作用](#161-self-的作用)
    - [1.6.2 `Self` 的作用](#162-self-的作用)
  - [1.7 应用总结](#17-应用总结)
  - [1.8 示例代码](#18-示例代码)
  - [1.9 总结](#19-总结)

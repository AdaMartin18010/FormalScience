...
- [1. Self 与 self](#self-与-self)
  - [1.1 `self`（小写）](#1-self小写)
  - [1.2 `Self`（大写）](#2-self大写)
  - [1.3 示例代码](#3-示例代码)
  - [1.4 总结](#4-总结)
  - [1.5 基本概念](#5-基本概念)
    - [1.5.1 `self`（小写）](#51-self小写)
    - [1.5.2 `Self`（大写）](#52-self大写)
  - [1.6 详细解释与区别](#6-详细解释与区别)
    - [1.6.1 `self` 的作用](#61-self-的作用)
    - [1.6.2 `Self` 的作用](#62-self-的作用)
  - [1.7 应用总结](#7-应用总结)
  - [1.8 示例代码](#8-示例代码)
  - [1.9 总结](#9-总结)
## 1.1 `self`（小写）

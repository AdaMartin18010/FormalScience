...
- [6 泛型生命周期](#6-泛型生命周期)
- [7 类型系统](#7-类型系统)
  - [7.1 标量类型 (Scalar Types)](#71-标量类型-scalar-types)
  - [7.2 复合类型 (Composite Types)](#72-复合类型-composite-types)
  - [7.3 复合类型 (Aggregate Types)](#73-复合类型-aggregate-types)
  - [7.4 枚举 (Enums)](#74-枚举-enums)
  - [7.5 智能指针 (Smart Pointers)](#75-智能指针-smart-pointers)
  - [7.6 函数指针 (Function Pointers)](#76-函数指针-function-pointers)
  - [7.7 切片 (Slices)](#77-切片-slices)
  - [7.8 字符串 (Strings)](#78-字符串-strings)
  - [7.9 选项和结果 (Option and Result)](#79-选项和结果-option-and-result)
  - [7.10 特征 (Traits)](#710-特征-traits)
  - [7.11 泛型 (Generics)](#711-泛型-generics)
  - [7.12 生命周期 (Lifetimes)](#712-生命周期-lifetimes)
- [8 泛型](#8-泛型)
  - [8.1 泛型定义](#81-泛型定义)
  - [8.2 泛型与具体类型的关系](#82-泛型与具体类型的关系)
- [9 Trait](#9-trait)

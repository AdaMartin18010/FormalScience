...
- [1. 泛型](#1-泛型)
  ...
  - [1.4 泛型约束](#14-泛型约束)
  - [1.5 高级泛型](#15-高级泛型)
  - [1.6 泛型生命周期](#16-泛型生命周期)
  - [1.7 类型系统](#17-类型系统)
    - [1.7.1 标量类型 (Scalar Types)](#171-标量类型-scalar-types)
    - [1.7.2 复合类型 (Composite Types)](#172-复合类型-composite-types)
    - [1.7.3 复合类型 (Aggregate Types)](#173-复合类型-aggregate-types)
    - [1.7.4 枚举 (Enums)](#174-枚举-enums)
    - [1.7.5 智能指针 (Smart Pointers)](#175-智能指针-smart-pointers)
    - [1.7.6 函数指针 (Function Pointers)](#176-函数指针-function-pointers)
    - [1.7.7 切片 (Slices)](#177-切片-slices)
    - [1.7.8 字符串 (Strings)](#178-字符串-strings)
    - [1.7.9 选项和结果 (Option and Result)](#179-选项和结果-option-and-result)
    - [1.7.10 特征 (Traits)](#1710-特征-traits)
    - [1.7.11 泛型 (Generics)](#1711-泛型-generics)
    - [1.7.12 生命周期 (Lifetimes)](#1712-生命周期-lifetimes)
  - [1.8 泛型](#18-泛型)
    - [1.8.1 泛型定义](#181-泛型定义)
    - [1.8.2 泛型与具体类型的关系](#182-泛型与具体类型的关系)
  - [1.9 Trait](#19-trait)

...
- [目录](#目录)
  - [目录](#目录-1)
  - [0.1 PartialEq、Eq、PartialOrd 和 Ord](#01-partialeqeqpartialord-和-ord)
    - [0.1.1 PartialEq (部分相等)](#011-partialeq-部分相等)
    - [0.1.2 Eq (相等)](#012-eq-相等)
    - [0.1.3 PartialOrd (部分排序)](#013-partialord-部分排序)
    - [0.1.4 Ord (排序)](#014-ord-排序)
  - [0.2 区别和联系](#02-区别和联系)
  - [0.3 解释](#03-解释)
  - [0.4 偏序和全序](#04-偏序和全序)
    - [0.4.1 偏序Partial Order](#041-偏序partial-order)
    - [0.4.2 全序Total Order或线性序Linear Order](#042-全序total-order或线性序linear-order)
    - [0.4.3 证明一个集合具有偏序或全序](#043-证明一个集合具有偏序或全序)
    - [0.4.4 示例](#044-示例)

## 0.1 PartialEq、Eq、PartialOrd 和 Ord

在 Rust 中，`PartialEq`、`Eq`、`PartialOrd` 和 `Ord` 是四个基本的 trait，它们定义了类型之间的比较操作。

### 0.1.1 PartialEq (部分相等)
...
### 0.4.2 全序Total Order或线性序Linear Order

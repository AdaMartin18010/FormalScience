...
- [1 PartialEq、Eq、PartialOrd 和 Ord](#1-partialeqeqpartialord-和-ord)
  - [1.1 PartialEq (部分相等)](#11-partialeq-部分相等)
  - [1.2 Eq (相等)](#12-eq-相等)
  - [1.3 PartialOrd (部分排序)](#13-partialord-部分排序)
  - [1.4 Ord (排序)](#14-ord-排序)
- [2 区别和联系](#2-区别和联系)
- [3 解释](#3-解释)
- [4 偏序和全序](#4-偏序和全序)
  - [4.1 偏序Partial Order](#41-偏序partial-order)
  - [4.2 全序Total Order或线性序Linear Order](#42-全序total-order或线性序linear-order)
  - [4.3 证明一个集合具有偏序或全序](#43-证明一个集合具有偏序或全序)
  - [4.4 示例](#44-示例)

---

## 1 PartialEq、Eq、PartialOrd 和 Ord
...
### 4.2 全序Total Order或线性序Linear Order

# 1. Marker Trait 与 Auto Trait

## 目录

- [1. Marker Trait 与 Auto Trait](#1-marker-trait-与-auto-trait)
  - [目录](#目录)
  - [1.1 Marker Trait 定义与 Auto Trait](#11-marker-trait-定义与-auto-trait)
  - [1.2 自动实现 Auto Trait 的机制](#12-自动实现-auto-trait-的机制)
  - [1.3 编译器内部检查流程与源码解析](#13-编译器内部检查流程与源码解析)
  - [1.4 小结](#14-小结)

## 1.1 Marker Trait 定义与 Auto Trait

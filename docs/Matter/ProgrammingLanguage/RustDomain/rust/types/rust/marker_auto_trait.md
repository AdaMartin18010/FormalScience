...
- [1. Marker Trait 与 Auto Trait](#marker-trait-与-auto-trait)
  - [1.1 Marker Trait 定义与 Auto Trait](#1-marker-trait-定义与-auto-trait)
  - [1.2 自动实现 Auto Trait 的机制](#2-自动实现-auto-trait-的机制)
  - [1.3 编译器内部检查流程与源码解析](#3-编译器内部检查流程与源码解析)
  - [1.4 小结](#4-小结)

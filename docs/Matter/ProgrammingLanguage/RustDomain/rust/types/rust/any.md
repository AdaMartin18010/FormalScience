...
- [1 Any 类型](#1-any-类型)
  ...
  - [1.2 示例](#12-示例)
- [2 显式类型转换](#2-显式类型转换)
  - [2.1 主要转换方式](#21-主要转换方式)
  - [2.2 (1) 使用 as 操作符](#22-1-使用-as-操作符)
  - [2.3 (2) 利用 FromInto 与 TryFromTryInto Trait](#23-2-利用-frominto-与-tryfromtryinto-trait)
  - [2.4 (3) 自动解引用转换Deref Coercion](#24-3-自动解引用转换deref-coercion)
- [3 总结](#3-总结)
  - [3.1 解释](#31-解释)
...
### 2.3 (2) 利用 FromInto 与 TryFromTryInto Trait

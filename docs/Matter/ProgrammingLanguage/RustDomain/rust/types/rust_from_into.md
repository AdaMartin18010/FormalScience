...
- [1. From 和 Into](#from-和-into)
  - [1.1 `From` Trait](#1-from-trait)
  - [1.2 `Into` Trait](#2-into-trait)
  - [1.3 使用 `From` 和 `Into` 的示例](#3-使用-from-和-into-的示例)
    - [1.3.1 示例 1：基本类型转换](#31-示例-1基本类型转换)
    - [1.3.2 示例 2：自定义类型转换](#32-示例-2自定义类型转换)
    - [1.3.3 示例 3：泛型转换](#33-示例-3泛型转换)
  - [1.4 总结](#4-总结)
## 1.1 `From` Trait

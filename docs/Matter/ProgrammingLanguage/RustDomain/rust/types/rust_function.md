...
- [1. 函数](#1-函数)
  - [目录](#目录)
  - [1.1 函数声明 (Function Declaration)](#11-函数声明-function-declaration)
  - [1.2 函数定义 (Function Definition)](#12-函数定义-function-definition)
  - [1.3 函数实现 (Function Implementation)](#13-函数实现-function-implementation)
  - [1.4 抽象和默认实现](#14-抽象和默认实现)
  - [1.5 默认实现](#15-默认实现)
  - [1.6 分离定义和实现](#16-分离定义和实现)
  - [1.7 示例](#17-示例)
  - [1.8 普通函数](#18-普通函数)
  - [1.9 匿名函数](#19-匿名函数)
  - [1.10 闭包](#110-闭包)
...
## 1.3 函数实现 (Function Implementation)

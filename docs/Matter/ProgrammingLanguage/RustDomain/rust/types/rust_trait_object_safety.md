# 1. Rust Object Safety

## 目录

- [1. Rust Object Safety](#1-rust-object-safety)
  - [目录](#目录)
  - [1.1 对象安全的定义](#11-对象安全的定义)
  - [1.2 对象安全的必要条件](#12-对象安全的必要条件)
  - [1.3 示例说明](#13-示例说明)
    - [1.3.1 示例1：对象安全的 trait](#131-示例1对象安全的-trait)
    - [1.3.2 示例2：不符合对象安全要求的 trait](#132-示例2不符合对象安全要求的-trait)
  - [1.4 对象安全的限制与设计权衡](#14-对象安全的限制与设计权衡)
  - [1.5 总结](#15-总结)
  - [1.6 返回 `Self` 类型的问题](#16-返回-self-类型的问题)
  - [1.7 泛型参数的问题](#17-泛型参数的问题)
  - [1.8 总结](#18-总结)
  - [1.9 什么是对象安全（Object Safety）](#19-什么是对象安全object-safety)
    - [1.9.1 对象安全需要满足的主要条件](#191-对象安全需要满足的主要条件)
  - [1.10 为什么需要对象安全](#110-为什么需要对象安全)
  - [1.11 反例与示例](#111-反例与示例)
    - [1.11.1 反例：返回 `Self` 的方法](#1111-反例返回-self-的方法)
    - [1.11.2 反例：泛型方法](#1112-反例泛型方法)
    - [1.11.3 对象安全的示例](#1113-对象安全的示例)
  - [1.12 思维导图](#112-思维导图)
  - [1.13 总结](#113-总结)
  - [1.14 Trait 对象安全概述](#114-trait-对象安全概述)
  - [1.15 泛型方法与对象安全](#115-泛型方法与对象安全)
    - [1.15.1 泛型方法不满足对象安全要求](#1151-泛型方法不满足对象安全要求)
    - [1.15.2 理解对象安全规范](#1152-理解对象安全规范)
  - [1.16 举例说明](#116-举例说明)
    - [1.16.1 不对象安全的 trait 示例](#1161-不对象安全的-trait-示例)
    - [1.16.2 对象安全的 trait 示例](#1162-对象安全的-trait-示例)
  - [1.17 思维导图](#117-思维导图)
  - [1.18 --总结](#118---总结)
    - [1.18.1 -总结](#1181--总结)

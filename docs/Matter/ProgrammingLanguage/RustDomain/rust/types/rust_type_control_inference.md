...
- [1. 类型控制推理](#1-类型控制推理)
  - [目录](#目录)
  - [1.1 类型代数与执行流的关系](#11-类型代数与执行流的关系)
  - [1.2 函数调用链的推理](#12-函数调用链的推理)
    - [1.2.1 示例：函数调用链](#121-示例函数调用链)
    - [1.2.2 推理执行流的可能性](#122-推理执行流的可能性)
  - [1.3 结论](#13-结论)
  - [1.4 类型理论](#14-类型理论)
  - [1.5 逻辑推理](#15-逻辑推理)
  - [1.6 代数语义](#16-代数语义)
  - [1.7 过程语义](#17-过程语义)
  - [1.8 形式化验证工具](#18-形式化验证工具)
  - [1.9 结论](#19-结论)
  - [1.10 Rust 中的形式化验证理论](#110-rust-中的形式化验证理论)
    - [1.10.1 类型系统](#1101-类型系统)
    - [1.10.2 霍尔逻辑（Hoare Logic）](#1102-霍尔逻辑hoare-logic)
    - [1.10.3 依赖类型](#1103-依赖类型)
    - [1.10.4 形式化验证工具](#1104-形式化验证工具)
    - [1.10.5 逻辑推理](#1105-逻辑推理)
    - [1.10.6 代码审查和测试](#1106-代码审查和测试)
    - [1.10.7 结论](#1107-结论)
  - [1.11 Rust 的形式化验证工具](#111-rust-的形式化验证工具)
    - [1.11.1 Miri](#1111-miri)
    - [1.11.2 Rust Analyzer](#1112-rust-analyzer)
    - [1.11.3 Clippy](#1113-clippy)
  - [1.12 形式化验证的实践](#112-形式化验证的实践)
    - [1.12.1 编写文档和注释](#1121-编写文档和注释)
    - [1.12.2 使用类型系统进行设计](#1122-使用类型系统进行设计)
    - [1.12.3 编写单元测试](#1123-编写单元测试)
  - [1.13 结论](#113-结论)
  - [1.14 形式化验证的高级技术](#114-形式化验证的高级技术)
    - [1.14.1 依赖类型的模拟](#1141-依赖类型的模拟)
    - [1.14.2 使用模型检查](#1142-使用模型检查)
  - [1.15 代码审查和团队协作](#115-代码审查和团队协作)
    - [1.15.1 代码审查的最佳实践](#1151-代码审查的最佳实践)
    - [1.15.2 结合文档和注释](#1152-结合文档和注释)
    - [1.15.3 编写清晰的文档](#1153-编写清晰的文档)
  - [1.16 结论](#116-结论)
  - [1.17 未来的学习方向](#117-未来的学习方向)

...
- [1. Rust 中的具体类型和抽象类型](#1-rust-中的具体类型和抽象类型)
  - [目录](#目录)
  - [1.1 具体类型（Concrete Types）](#11-具体类型concrete-types)
  - [1.2 抽象类型（Abstract Types）](#12-抽象类型abstract-types)
  - [1.3 总结](#13-总结)
    - [1.3.1 类型别名（Type Alias）](#131-类型别名type-alias)
      - [1.3.1.1 示例](#1311-示例)
    - [1.3.2 新类型（Newtype）](#132-新类型newtype)
      - [1.3.2.1 示例](#1321-示例)
    - [1.3.3 总结](#133-总结)
    - [1.3.4 `impl Trait` 是抽象类型](#134-impl-trait-是抽象类型)
      - [1.3.4.1 示例](#1341-示例)
    - [1.3.5 `impl Trait` 是否可以用于类型别名](#135-impl-trait-是否可以用于类型别名)
      - [1.3.5.1 _示例_](#1351-示例)
    - [1.3.6 _总结_](#136-总结)

## 1.1 具体类型（Concrete Types）

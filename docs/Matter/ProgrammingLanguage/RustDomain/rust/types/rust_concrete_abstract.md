...
- [1. Rust 中的具体类型和抽象类型](#rust-中的具体类型和抽象类型)
  - [1.1 具体类型（Concrete Types）](#1-具体类型concrete-types)
  - [1.2 抽象类型（Abstract Types）](#2-抽象类型abstract-types)
  - [1.3 总结](#3-总结)
    - [1.3.1 类型别名（Type Alias）](#31-类型别名type-alias)
      - [1.3.1.1 示例](#311-示例)
    - [1.3.2 新类型（Newtype）](#32-新类型newtype)
      - [1.3.2.1 示例](#321-示例)
    - [1.3.3 总结](#33-总结)
    - [1.3.4 `impl Trait` 是抽象类型](#34-impl-trait-是抽象类型)
      - [1.3.4.1 示例](#341-示例)
    - [1.3.5 `impl Trait` 是否可以用于类型别名](#35-impl-trait-是否可以用于类型别名)
      - [1.3.5.1 *示例*](#351-示例)
    - [1.3.6 *总结*](#36-总结)

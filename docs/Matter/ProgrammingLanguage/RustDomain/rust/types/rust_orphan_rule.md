...
- [6 避免的具体情况](#6-避免的具体情况)
- [7 总结](#7-总结)
- [8 重复实现与名称冲突](#8-重复实现与名称冲突)
- [9 孤儿规则的限制](#9-孤儿规则的限制)
- [10 模块可见性与访问权限](#10-模块可见性与访问权限)
- [11 泛型实现与类型推导](#11-泛型实现与类型推导)
- [12 对象安全、异步方法与 const 方法的限制](#12-对象安全异步方法与-const-方法的限制)
- [13 特化Specialization和默认实现](#13-特化specialization和默认实现)
- [14 总结](#14-总结)

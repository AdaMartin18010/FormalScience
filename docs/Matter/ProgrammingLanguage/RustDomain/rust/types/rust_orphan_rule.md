...
- [1. 孤儿原则和分离实现](#1-孤儿原则和分离实现)
  - [目录](#目录)
  - [1.1 分离实现的基本情况](#11-分离实现的基本情况)
  - [1.2 示例说明](#12-示例说明)
  ...
  - [1.3 注意事项](#13-注意事项)
  - [1.4 总结](#14-总结)
  - [1.5 孤儿规则的目的](#15-孤儿规则的目的)
  - [1.6 避免的具体情况](#16-避免的具体情况)
  - [1.7 总结](#17-总结)
  - [1.8 重复实现与名称冲突](#18-重复实现与名称冲突)
  - [1.9 孤儿规则的限制](#19-孤儿规则的限制)
  - [1.10 模块可见性与访问权限](#110-模块可见性与访问权限)
  - [1.11 泛型实现与类型推导](#111-泛型实现与类型推导)
  - [1.12 对象安全、异步方法与 const 方法的限制](#112-对象安全异步方法与-const-方法的限制)
  - [1.13 特化Specialization和默认实现](#113-特化specialization和默认实现)
  - [1.14 总结](#114-总结)

# 1. Rust Trait 和泛型对程序可扩展性的影响

## 目录

- [1. Rust Trait 和泛型对程序可扩展性的影响](#1-rust-trait-和泛型对程序可扩展性的影响)
  - [目录](#目录)
  - [1.1 一、引言](#11-一引言)
  - [1.2 二、泛型对可扩展性的影响](#12-二泛型对可扩展性的影响)
    - [1.2.1 （一）代码通用性](#121-一代码通用性)
    - [1.2.2 （二）减少重复代码](#122-二减少重复代码)
  - [1.3 三、Trait 对可扩展性的影响](#13-三trait-对可扩展性的影响)
    - [1.3.1 （一）定义共享行为](#131-一定义共享行为)
    - [1.3.2 （二）实现多态性](#132-二实现多态性)
    - [1.3.3 （三）与其他特性结合使用](#133-三与其他特性结合使用)
  - [1.4 四、泛型和 Trait 的结合使用](#14-四泛型和-trait-的结合使用)
    - [1.4.1 （一）泛型函数与 Trait 约束](#141-一泛型函数与-trait-约束)
    - [1.4.2 （二）泛型结构体与 Trait 实现](#142-二泛型结构体与-trait-实现)
  - [1.5 五、总结](#15-五总结)
...
## 1.4 四、泛型和 Trait 的结合使用

### 1.4.1 （一）泛型函数与 Trait 约束

...
- [1. Rust Trait 和泛型对程序可扩展性的影响](#rust-trait-和泛型对程序可扩展性的影响)
  - [1.1 一、引言](#1-一引言)
  - [1.2 二、泛型对可扩展性的影响](#2-二泛型对可扩展性的影响)
    - [1.2.1 （一）代码通用性](#21-一代码通用性)
    - [1.2.2 （二）减少重复代码](#22-二减少重复代码)
  - [1.3 三、Trait 对可扩展性的影响](#3-三trait-对可扩展性的影响)
    - [1.3.1 （一）定义共享行为](#31-一定义共享行为)
    - [1.3.2 （二）实现多态性](#32-二实现多态性)
    - [1.3.3 （三）与其他特性结合使用](#33-三与其他特性结合使用)
  - [1.4 四、泛型和 Trait 的结合使用](#4-四泛型和-trait-的结合使用)
    - [1.4.1 （一）泛型函数与 Trait 约束](#41-一泛型函数与-trait-约束)
    - [1.4.2 （二）泛型结构体与 Trait 实现](#42-二泛型结构体与-trait-实现)
  - [1.5 五、总结](#5-五总结)
## 1.1 一、引言

...
- [1. 类型系统](#类型系统)
  - [1.1 静态类型系统与动态类型系统](#1-静态类型系统与动态类型系统)
    - [1.1.1 静态类型系统](#11-静态类型系统)
    - [1.1.2 动态类型系统](#12-动态类型系统)
  - [1.2 强类型系统与弱类型系统](#2-强类型系统与弱类型系统)
    - [1.2.1 强类型系统](#21-强类型系统)
    - [1.2.2 弱类型系统](#22-弱类型系统)
  - [1.3 显式类型系统与隐式类型系统](#3-显式类型系统与隐式类型系统)
    - [1.3.1 显式类型系统](#31-显式类型系统)
    - [1.3.2 隐式类型系统](#32-隐式类型系统)
  - [1.4 线性类型系统](#4-线性类型系统)
    - [1.4.1 线性类型系统](#41-线性类型系统)
  - [1.5 仿射类型系统](#5-仿射类型系统)
    - [1.5.1 仿射类型系统](#51-仿射类型系统)
  - [1.6 子类型系统](#6-子类型系统)
    - [1.6.1 子类型系统](#61-子类型系统)
  - [1.7 结构化类型系统与名义类型系统](#7-结构化类型系统与名义类型系统)
    - [1.7.1 结构化类型系统](#71-结构化类型系统)
    - [1.7.2 名义类型系统](#72-名义类型系统)
  - [1.8 依赖类型系统](#8-依赖类型系统)
    - [1.8.1 依赖类型系统](#81-依赖类型系统)
  - [1.9 无类型系统](#9-无类型系统)
    - [1.9.1 无类型系统](#91-无类型系统)
  - [1.10 总结](#10-总结)
## 1.1 静态类型系统与动态类型系统

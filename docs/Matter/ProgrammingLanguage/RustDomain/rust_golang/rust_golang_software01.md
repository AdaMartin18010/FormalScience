# 1. Rust与Golang软件工程生态对比分析

## 目录

- [1. Rust与Golang软件工程生态对比分析](#1-rust与golang软件工程生态对比分析)
  - [目录](#目录)
  - [1.1 引言](#11-引言)
  - [1.2 核心特性对比](#12-核心特性对比)
  - [1.3 软件工程生态对比](#13-软件工程生态对比)
    - [1.3.1 分布式应用](#131-分布式应用)
    - [1.3.2 分层架构](#132-分层架构)
    - [1.3.3 数学库](#133-数学库)
    - [1.3.4 消息队列](#134-消息队列)
    - [1.3.5 软件组件](#135-软件组件)
    - [1.3.6 Web开发](#136-web开发)
  - [1.4 分布式开发开源框架](#14-分布式开发开源框架)
    - [1.4.1 Golang框架](#141-golang框架)
    - [1.4.2 Rust框架](#142-rust框架)
    - [1.4.3 适用范围对比](#143-适用范围对比)
  - [1.5 分布式开发与应用架构趋势](#15-分布式开发与应用架构趋势)
  - [1.6 编程语言生态趋势](#16-编程语言生态趋势)
  - [1.7 选择与构建策略](#17-选择与构建策略)
  - [1.8 结论](#18-结论)

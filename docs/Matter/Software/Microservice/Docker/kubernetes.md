# 1. Kubernetes 与 Docker 容器编排架构模型解析

## 目录

- [1. Kubernetes 与 Docker 容器编排架构模型解析](#1-kubernetes-与-docker-容器编排架构模型解析)
  - [目录](#目录)
  - [1.1 思维导图](#11-思维导图)
  - [1.2 容器技术基础概念](#12-容器技术基础概念)
    - [1.2.1 Docker: 容器化的先驱](#121-docker-容器化的先驱)
    - [1.2.2 Kubernetes: 容器编排平台](#122-kubernetes-容器编排平台)
  - [1.3 Kubernetes 架构模型](#13-kubernetes-架构模型)
    - [1.3.1 控制平面组件](#131-控制平面组件)
    - [1.3.2 节点组件](#132-节点组件)
    - [1.3.3 核心资源对象](#133-核心资源对象)
  - [1.4 从工作流编排角度理解 Kubernetes](#14-从工作流编排角度理解-kubernetes)
    - [1.4.1 声明式API与工作流编排](#141-声明式api与工作流编排)
    - [1.4.2 控制循环与状态转换](#142-控制循环与状态转换)
    - [1.4.3 Kubernetes 编排生命周期](#143-kubernetes-编排生命周期)
  - [1.5 Kubernetes 与 Docker 的组合关系](#15-kubernetes-与-docker-的组合关系)
    - [1.5.1 历史演变：从紧密耦合到解耦](#151-历史演变从紧密耦合到解耦)
    - [1.5.2 CRI 接口与容器运行时](#152-cri-接口与容器运行时)
  - [1.6 以 Rust 代码示例理解核心概念](#16-以-rust-代码示例理解核心概念)
    - [1.6.1 声明式配置的表达](#161-声明式配置的表达)
    - [1.6.2 控制器模式的实现](#162-控制器模式的实现)
  - [1.7 总结与未来趋势](#17-总结与未来趋势)
    - [1.7.1 Kubernetes 与 Docker 之间的关系总结](#171-kubernetes-与-docker-之间的关系总结)
    - [1.7.2 未来发展趋势](#172-未来发展趋势)
...
### 1.7.1 Kubernetes 与 Docker 之间的关系总结

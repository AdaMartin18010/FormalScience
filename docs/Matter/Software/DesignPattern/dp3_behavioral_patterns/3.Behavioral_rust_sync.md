...
- [1 同步实现](#1-同步实现)
  - [1.1 责任链模式Chain of Responsibility Pattern](#11-责任链模式chain-of-responsibility-pattern)
  - [1.2 命令模式Command Pattern](#12-命令模式command-pattern)
  - [1.3 解释器模式Interpreter Pattern](#13-解释器模式interpreter-pattern)
  - [1.4 迭代器模式Iterator Pattern](#14-迭代器模式iterator-pattern)
  - [1.5 中介者模式Mediator Pattern](#15-中介者模式mediator-pattern)
  - [1.6 备忘录模式Memento Pattern](#16-备忘录模式memento-pattern)
  - [1.7 观察者模式Observer Pattern](#17-观察者模式observer-pattern)
  - [1.8 状态模式State Pattern](#18-状态模式state-pattern)
  - [1.9 策略模式Strategy Pattern](#19-策略模式strategy-pattern)
  - [1.10 模板方法模式Template Method Pattern](#110-模板方法模式template-method-pattern)
  - [1.11 访问者模式Visitor Pattern](#111-访问者模式visitor-pattern)
  - [1.12 空对象模式Null Object Pattern](#112-空对象模式null-object-pattern)
  - [1.13 总结](#113-总结)
...
### 1.1 责任链模式Chain of Responsibility Pattern
...
### 1.10 模板方法模式Template Method Pattern

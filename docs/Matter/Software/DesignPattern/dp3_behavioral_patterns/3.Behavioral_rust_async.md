...
- [1. 行为型模式(Behavioral Patterns)](#1-行为型模式behavioral-patterns)
  - [目录](#目录)
  - [1.1 异步实现](#11-异步实现)
    - [1.1.1 责任链模式Chain of Responsibility Pattern](#111-责任链模式chain-of-responsibility-pattern)
    - [1.1.2 命令模式Command Pattern](#112-命令模式command-pattern)
    - [1.1.3 解释器模式Interpreter Pattern](#113-解释器模式interpreter-pattern)
    - [1.1.4 迭代器模式Iterator Pattern](#114-迭代器模式iterator-pattern)
    - [1.1.5 中介者模式Mediator Pattern](#115-中介者模式mediator-pattern)
    - [1.1.6 备忘录模式Memento Pattern](#116-备忘录模式memento-pattern)
    - [1.1.7 观察者模式Observer Pattern](#117-观察者模式observer-pattern)
    - [1.1.8 状态模式State Pattern](#118-状态模式state-pattern)
    - [1.1.9 策略模式Strategy Pattern](#119-策略模式strategy-pattern)
    - [1.1.10 模板方法模式Template Method Pattern](#1110-模板方法模式template-method-pattern)
    - [1.1.11 访问者模式Visitor Pattern](#1111-访问者模式visitor-pattern)
    - [1.1.12 空对象模式Null Object Pattern](#1112-空对象模式null-object-pattern)
    - [1.1.13 总结](#1113-总结)
...
### 1.1.1 责任链模式Chain of Responsibility Pattern
...
### 1.1.3 解释器模式Interpreter Pattern
...
### 1.1.10 模板方法模式Template Method Pattern
...
### 1.1.12 空对象模式Null Object Pattern

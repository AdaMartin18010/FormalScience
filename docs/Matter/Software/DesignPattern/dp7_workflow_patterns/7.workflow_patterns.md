# 1. Rust实现的23种工作流设计模式全解析

## 目录

- [1. Rust实现的23种工作流设计模式全解析](#1-rust实现的23种工作流设计模式全解析)
  - [目录](#目录)
  - [1.1 基本控制流模式](#11-基本控制流模式)
    - [1.1.1 序列模式](#111-序列模式)
    - [1.1.2 并行拆分模式](#112-并行拆分模式)
    - [1.1.3 同步模式](#113-同步模式)
    - [1.1.4 独占选择模式](#114-独占选择模式)
    - [1.1.5 简单合并模式](#115-简单合并模式)
  - [1.2 高级分支合并模式](#12-高级分支合并模式)
    - [1.2.1 多选模式](#121-多选模式)
    - [1.2.2 同步合并模式](#122-同步合并模式)
    - [1.2.3 多合并模式](#123-多合并模式)
    - [1.2.4 结构化判别模式](#124-结构化判别模式)
    - [1.2.5 通用判别模式](#125-通用判别模式)
  - [1.3 结构模式](#13-结构模式)
    - [1.3.1 任意循环模式](#131-任意循环模式)
    - [1.3.2 隐式终止模式](#132-隐式终止模式)
  - [1.4 多实例模式](#14-多实例模式)
    - [1.4.1 无同步多实例模式](#141-无同步多实例模式)
    - [1.4.2 设计时多实例模式](#142-设计时多实例模式)
    - [1.4.3 运行时多实例模式](#143-运行时多实例模式)
    - [1.4.4 无先验知识多实例模式](#144-无先验知识多实例模式)
  - [1.5 状态基础模式](#15-状态基础模式)
    - [1.5.1 延迟选择模式](#151-延迟选择模式)
    - [1.5.2 交错并行路由模式](#152-交错并行路由模式)
    - [1.5.3 里程碑模式](#153-里程碑模式)
  - [1.6 取消和触发模式](#16-取消和触发模式)
    - [1.6.1 取消活动模式](#161-取消活动模式)
    - [1.6.2 取消案例模式](#162-取消案例模式)
    - [1.6.3 瞬时触发模式](#163-瞬时触发模式)
    - [1.6.4 持久触发模式](#164-持久触发模式)
  - [1.7 模式组合应用](#17-模式组合应用)
    - [1.7.1 订单处理工作流](#171-订单处理工作流)
    - [1.7.2 审批工作流](#172-审批工作流)
  - [1.8 Rust开源工作流库](#18-rust开源工作流库)
    - [1.8.1 流行库概述](#181-流行库概述)
    - [1.8.2 Swirl 工作流引擎](#182-swirl-工作流引擎)
      - [1.8.2.1 基本概念](#1821-基本概念)
      - [1.8.2.2 安装和基本使用](#1822-安装和基本使用)
      - [1.8.2.3 高级功能](#1823-高级功能)
    - [1.8.3 实现自定义工作流库](#183-实现自定义工作流库)
      - [1.8.3.1 核心组件设计](#1831-核心组件设计)
      - [1.8.3.2 使用示例](#1832-使用示例)
  - [1.9 总结](#19-总结)
    - [1.9.1 工作流模式选择指南](#191-工作流模式选择指南)
    - [1.9.2 Rust工作流实践中的最佳实践](#192-rust工作流实践中的最佳实践)

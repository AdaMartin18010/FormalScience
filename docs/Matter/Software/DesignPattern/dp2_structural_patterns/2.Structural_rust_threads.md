...
- [1. 结构型模式(Structural Patterns)](#1-结构型模式structural-patterns)
  - [目录](#目录)
  - [1.1 多线程实现](#11-多线程实现)
    - [1.1.1 适配器模式Adapter Pattern](#111-适配器模式adapter-pattern)
    - [1.1.2 桥接模式Bridge Pattern](#112-桥接模式bridge-pattern)
    - [1.1.3 组合模式Composite Pattern](#113-组合模式composite-pattern)
    - [1.1.4 装饰器模式Decorator Pattern](#114-装饰器模式decorator-pattern)
    - [1.1.5 外观模式Facade Pattern](#115-外观模式facade-pattern)
    - [1.1.6 享元模式Flyweight Pattern](#116-享元模式flyweight-pattern)
    - [1.1.7 代理模式Proxy Pattern](#117-代理模式proxy-pattern)
    - [1.1.8 私有类模式Protected Variant Pattern](#118-私有类模式protected-variant-pattern)
    - [1.1.9 代理模式的变体](#119-代理模式的变体)
    - [1.1.10 组合模式的变体安全组合模式](#1110-组合模式的变体安全组合模式)
    - [1.1.11 总结](#1111-总结)
...
### 1.1.8 私有类模式Protected Variant Pattern

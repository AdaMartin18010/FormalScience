...
- [1 异步实现](#1-异步实现)
  - [1.1 适配器模式Adapter Pattern](#11-适配器模式adapter-pattern)
  - [1.2 桥接模式Bridge Pattern](#12-桥接模式bridge-pattern)
  - [1.3 组合模式Composite Pattern](#13-组合模式composite-pattern)
  - [1.4 装饰器模式Decorator Pattern](#14-装饰器模式decorator-pattern)
  - [1.5 外观模式Facade Pattern](#15-外观模式facade-pattern)
  - [1.6 享元模式Flyweight Pattern](#16-享元模式flyweight-pattern)
  - [1.7 代理模式Proxy Pattern](#17-代理模式proxy-pattern)
  - [1.8 私有类模式Protected Variant Pattern](#18-私有类模式protected-variant-pattern)
  - [1.9 代理模式的变体](#19-代理模式的变体)
  - [1.10 组合模式的变体](#110-组合模式的变体)
  - [1.11 总结](#111-总结)
...
### 1.8 私有类模式Protected Variant Pattern

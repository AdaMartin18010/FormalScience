...
- [1. 设计模式详解](#1-设计模式详解)
  - [目录](#目录)
  - [1.1 设计模式 (GoF)](#11-设计模式-gof)
    - [1.1.1 概念与定义](#111-概念与定义)
    - [1.1.2 分类](#112-分类)
    - [1.1.3 创建型模式 (Creational Patterns)](#113-创建型模式-creational-patterns)
      - [1.1.3.1 单例模式 (Singleton)](#1131-单例模式-singleton)
      - [1.1.3.2 工厂方法模式 (Factory Method)](#1132-工厂方法模式-factory-method)
      - [1.1.3.3 抽象工厂模式 (Abstract Factory)](#1133-抽象工厂模式-abstract-factory)
      - [1.1.3.4 建造者模式 (Builder)](#1134-建造者模式-builder)
      - [1.1.3.5 原型模式 (Prototype)](#1135-原型模式-prototype)
    - [1.1.4 结构型模式 (Structural Patterns)](#114-结构型模式-structural-patterns)
      - [1.1.4.1 适配器模式 (Adapter)](#1141-适配器模式-adapter)
      - [1.1.4.2 桥接模式 (Bridge)](#1142-桥接模式-bridge)
      - [1.1.4.3 组合模式 (Composite)](#1143-组合模式-composite)
      - [1.1.4.4 装饰器模式 (Decorator)](#1144-装饰器模式-decorator)
      - [1.1.4.5 外观模式 (Facade)](#1145-外观模式-facade)
      - [1.1.4.6 享元模式 (Flyweight)](#1146-享元模式-flyweight)
      - [1.1.4.7 代理模式 (Proxy)](#1147-代理模式-proxy)
    - [1.1.5 行为型模式 (Behavioral Patterns)](#115-行为型模式-behavioral-patterns)
      - [1.1.5.1 责任链模式 (Chain of Responsibility)](#1151-责任链模式-chain-of-responsibility)
      - [1.1.5.2 命令模式 (Command)](#1152-命令模式-command)
      - [1.1.5.3 解释器模式 (Interpreter)](#1153-解释器模式-interpreter)
      - [1.1.5.4 迭代器模式 (Iterator)](#1154-迭代器模式-iterator)
      - [1.1.5.5 中介者模式 (Mediator)](#1155-中介者模式-mediator)
      - [1.1.5.6 备忘录模式 (Memento)](#1156-备忘录模式-memento)
      - [1.1.5.7 观察者模式 (Observer)](#1157-观察者模式-observer)
      - [1.1.5.8 状态模式 (State)](#1158-状态模式-state)
      - [1.1.5.9 策略模式 (Strategy)](#1159-策略模式-strategy)
      - [1.1.5.10 模板方法模式 (Template Method)](#11510-模板方法模式-template-method)
      - [1.1.5.11 访问者模式 (Visitor)](#11511-访问者模式-visitor)
  - [1.2 并发并行设计模式](#12-并发并行设计模式)
    - [1.2.1 概念与定义](#121-概念与定义)
    - [1.2.2 常见模式](#122-常见模式)
      - [1.2.2.1 活动对象模式 (Active Object)](#1221-活动对象模式-active-object)
      - [1.2.2.2 管程模式 (Monitor)](#1222-管程模式-monitor)
      - [1.2.2.3 线程池模式 (Thread Pool)](#1223-线程池模式-thread-pool)
      - [1.2.2.4 生产者-消费者模式 (Producer-Consumer)](#1224-生产者-消费者模式-producer-consumer)
      - [1.2.2.5 读写锁模式 (Readers-Writer Lock)](#1225-读写锁模式-readers-writer-lock)
      - [1.2.2.6 Future/Promise 模式](#1226-futurepromise-模式)
      - [1.2.2.7 Actor 模型](#1227-actor-模型)
  - [1.3 分布式设计模式](#13-分布式设计模式)
    - [1.3.1 概念与定义](#131-概念与定义)
    - [1.3.2 常见模式](#132-常见模式)
      - [1.3.2.1 服务发现 (Service Discovery)](#1321-服务发现-service-discovery)
      - [1.3.2.2 熔断器模式 (Circuit Breaker)](#1322-熔断器模式-circuit-breaker)
      - [1.3.2.3 API 网关 (API Gateway)](#1323-api-网关-api-gateway)
      - [1.3.2.4 Saga 模式](#1324-saga-模式)
      - [1.3.2.5 领导者选举 (Leader Election)](#1325-领导者选举-leader-election)
      - [1.3.2.6 分片/分区 (Sharding/Partitioning)](#1326-分片分区-shardingpartitioning)
      - [1.3.2.7 复制 (Replication)](#1327-复制-replication)
      - [1.3.2.8 消息队列 (Message Queue)](#1328-消息队列-message-queue)
  - [1.4 工作流设计模式](#14-工作流设计模式)
    - [1.4.1 概念与定义](#141-概念与定义)
    - [1.4.2 常见模式](#142-常见模式)
      - [1.4.2.1 状态机模式 (State Machine)](#1421-状态机模式-state-machine)
      - [1.4.2.2 工作流引擎 (Workflow Engine)](#1422-工作流引擎-workflow-engine)
      - [1.4.2.3 任务队列 (Task Queue)](#1423-任务队列-task-queue)
      - [1.4.2.4 编排 (Orchestration) vs. 协同 (Choreography)](#1424-编排-orchestration-vs-协同-choreography)
  - [1.5 思维导图 (Text)](#15-思维导图-text)
...
### 1.1.3 创建型模式 (Creational Patterns)

#### 1.1.3.1 单例模式 (Singleton)
...
#### 1.1.3.3 抽象工厂模式 (Abstract Factory)
...
### 1.1.4 结构型模式 (Structural Patterns)

#### 1.1.4.1 适配器模式 (Adapter)
...
### 1.1.5 行为型模式 (Behavioral Patterns)

#### 1.1.5.1 责任链模式 (Chain of Responsibility)
...
#### 1.1.5.10 模板方法模式 (Template Method)
...
#### 1.2.2.4 生产者-消费者模式 (Producer-Consumer)
...
#### 1.2.2.5 读写锁模式 (Readers-Writer Lock)
...
#### 1.3.2.1 服务发现 (Service Discovery)
...
#### 1.3.2.6 分片/分区 (Sharding/Partitioning)
...
#### 1.4.2.4 编排 (Orchestration) vs. 协同 (Choreography)

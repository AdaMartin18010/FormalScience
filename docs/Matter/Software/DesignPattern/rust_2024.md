# 1. Rust 2024 设计模式实现指南

## 目录

- [1. Rust 2024 设计模式实现指南](#1-rust-2024-设计模式实现指南)
  - [目录](#目录)
  - [1.1 同步设计模式](#11-同步设计模式)
    - [1.1.1 单例模式Singleton Pattern](#111-单例模式singleton-pattern)
    - [1.1.2 工厂模式Factory Pattern](#112-工厂模式factory-pattern)
    - [1.1.3 观察者模式Observer Pattern](#113-观察者模式observer-pattern)
  - [1.2 异步设计模式](#12-异步设计模式)
    - [1.2.1 异步单例模式](#121-异步单例模式)
    - [1.2.2 异步工厂模式](#122-异步工厂模式)
    - [1.2.3 异步观察者模式](#123-异步观察者模式)
  - [1.3 总结](#13-总结)

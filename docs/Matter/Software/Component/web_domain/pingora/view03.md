...
- [1. Pingora 设计框架综合分析](#1-pingora-设计框架综合分析)
  - [目录](#目录)
  - [1.1 元模型与元理论](#11-元模型与元理论)
    - [1.1.1 形式化分析](#111-形式化分析)
    - [1.1.2 源代码分析（概念性）](#112-源代码分析概念性)
    - [1.1.3 设计模式、算法与技术](#113-设计模式算法与技术)
    - [1.1.4 周边软件堆栈与应用生态](#114-周边软件堆栈与应用生态)
    - [1.1.5 思维导图 (Text)](#115-思维导图-text)

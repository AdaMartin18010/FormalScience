...
- [3 系统组成](#3-系统组成)
  - [3.1 网络与 IO 层](#31-网络与-io-层)
  - [3.2 业务逻辑层](#32-业务逻辑层)
  - [3.3 数据处理与通信层](#33-数据处理与通信层)
  - [3.4 可观测性与监控层](#34-可观测性与监控层)
- [4 总结](#4-总结)
- [5 Pingora 模块划分与源代码分析](#5-pingora-模块划分与源代码分析)
- [6 整体架构概述](#6-整体架构概述)
- [7 模块划分详情](#7-模块划分详情)
  - [7.1 核心入口模块](#71-核心入口模块)
  - [7.2 网络与 IO 层](#72-网络与-io-层)
  - [7.3 协议解析层](#73-协议解析层)
  - [7.4 业务处理层](#74-业务处理层)
  - [7.5 数据存储层](#75-数据存储层)
  - [7.6 可观测性与监控层](#76-可观测性与监控层)
  - [7.7 配置及工具模块](#77-配置及工具模块)
- [8 总结](#8-总结)

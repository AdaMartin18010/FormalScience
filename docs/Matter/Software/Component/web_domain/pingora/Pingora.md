# 1. Pingora Rust 的设计和核心概念

## 目录

- [1. Pingora Rust 的设计和核心概念](#1-pingora-rust-的设计和核心概念)
  - [目录](#目录)
  - [1.1 设计理念与核心概念](#11-设计理念与核心概念)
  - [1.2 使用到的主要开源库](#12-使用到的主要开源库)
  - [1.3 系统组成](#13-系统组成)
    - [1.3.1 网络与 IO 层](#131-网络与-io-层)
    - [1.3.2 业务逻辑层](#132-业务逻辑层)
    - [1.3.3 数据处理与通信层](#133-数据处理与通信层)
    - [1.3.4 可观测性与监控层](#134-可观测性与监控层)
  - [1.4 总结](#14-总结)
  - [1.5 Pingora 模块划分与源代码分析](#15-pingora-模块划分与源代码分析)
  - [1.6 整体架构概述](#16-整体架构概述)
  - [1.7 模块划分详情](#17-模块划分详情)
    - [1.7.1 核心入口模块](#171-核心入口模块)
    - [1.7.2 网络与 IO 层](#172-网络与-io-层)

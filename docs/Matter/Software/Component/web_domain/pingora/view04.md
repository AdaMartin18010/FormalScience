# 1. Pingora 设计框架与综合分析报告

## 目录

- [1. Pingora 设计框架与综合分析报告](#1-pingora-设计框架与综合分析报告)
  - [目录](#目录)
    - [1.0.1 引言](#101-引言)
    - [1.0.2 元模型与元理论](#102-元模型与元理论)
      - [1.0.2.1 核心设计哲学](#1021-核心设计哲学)
      - [1.0.2.2 为何选择 Rust](#1022-为何选择-rust)
      - [1.0.2.3 与现有模型的对比](#1023-与现有模型的对比)
    - [1.0.3 形式化分析](#103-形式化分析)
      - [1.0.3.1 核心概念定义](#1031-核心概念定义)
      - [1.0.3.2 请求处理生命周期 (逻辑模型)](#1032-请求处理生命周期-逻辑模型)
    - [1.0.4 源代码分析](#104-源代码分析)
      - [1.0.4.1 控制流](#1041-控制流)
      - [1.0.4.2 执行流](#1042-执行流)
      - [1.0.4.3 数据流](#1043-数据流)
    ...
    - [1.0.6 周边软件堆栈与应用生态](#106-周边软件堆栈与应用生态)
      - [1.0.6.1 核心依赖](#1061-核心依赖)
      - [1.0.6.2 集成能力](#1062-集成能力)
      - [1.0.6.3 典型应用场景](#1063-典型应用场景)
      - [1.0.6.4 与同类项目对比](#1064-与同类项目对比)
    - [1.0.7 总结](#107-总结)

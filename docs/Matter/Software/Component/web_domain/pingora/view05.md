...
- [1. Pingora设计框架与综合分析](#1-pingora设计框架与综合分析)
  - [目录](#目录)
  ...
  - [1.2 形式化分析](#12-形式化分析)
    ...
    - [1.2.2 请求处理生命周期](#122-请求处理生命周期)
    - [1.2.3 形式化证明与保证](#123-形式化证明与保证)
  - [1.3 流分析](#13-流分析)
    - [1.3.1 控制流](#131-控制流)
    - [1.3.2 执行流](#132-执行流)
    - [1.3.3 数据流](#133-数据流)
  - [1.4 设计模式、算法与技术](#14-设计模式算法与技术)
    - [1.4.1 设计模式](#141-设计模式)
    - [1.4.2 核心算法](#142-核心算法)
    - [1.4.3 关键技术](#143-关键技术)
  - [1.5 周边软件堆栈与应用生态](#15-周边软件堆栈与应用生态)
    - [1.5.1 核心依赖](#151-核心依赖)
    - [1.5.2 集成能力](#152-集成能力)
    - [1.5.3 典型应用场景](#153-典型应用场景)
    - [1.5.4 与同类项目对比](#154-与同类项目对比)
  - [1.6 思维导图](#16-思维导图)

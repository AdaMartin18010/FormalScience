...
- [1. n8n工作流编排架构模型详解](#1-n8n工作流编排架构模型详解)
  - [目录](#目录)
  - [1.1 n8n架构概述](#11-n8n架构概述)
  ...
  - [1.6 工作流形式转换](#16-工作流形式转换)
    - [1.6.1 可视化到代码的映射](#161-可视化到代码的映射)
    - [1.6.2 跨平台工作流迁移](#162-跨平台工作流迁移)
  - [1.7 高级特性与模式](#17-高级特性与模式)
    - [1.7.1 事件驱动模式](#171-事件驱动模式)
    - [1.7.2 异步执行模式](#172-异步执行模式)
    - [1.7.3 数据转换与聚合模式](#173-数据转换与聚合模式)
  - [1.8 演化与发展趋势](#18-演化与发展趋势)

...
- [1. n8n工作流平台架构分析](#1-n8n工作流平台架构分析)
  - [目录](#目录)
  - [1.1 引言](#11-引言)
  - [1.2 n8n概述](#12-n8n概述)
  - [1.3 软件架构分析](#13-软件架构分析)
    - [1.3.1 总体架构](#131-总体架构)
    - [1.3.2 前端架构](#132-前端架构)
    - [1.3.3 后端架构](#133-后端架构)
    - [1.3.4 数据存储](#134-数据存储)
    - [1.3.5 执行引擎](#135-执行引擎)
  - [1.4 工作流模型](#14-工作流模型)
    - [1.4.1 节点与连接模型](#141-节点与连接模型)
    - [1.4.2 数据传递模型](#142-数据传递模型)
    - [1.4.3 触发器模型](#143-触发器模型)
    - [1.4.4 执行模型](#144-执行模型)
  - [1.5 支持的工作流模式](#15-支持的工作流模式)
    - [1.5.1 API集成模式](#151-api集成模式)
    - [1.5.2 数据处理模式](#152-数据处理模式)
    - [1.5.3 事件驱动模式](#153-事件驱动模式)
    - [1.5.4 定时调度模式](#154-定时调度模式)
    - [1.5.5 人机交互模式](#155-人机交互模式)
  - [1.6 构建与部署模式](#16-构建与部署模式)
    - [1.6.1 本地部署](#161-本地部署)
    - [3.0.1 Docker容器化](#301-docker容器化)
    - [4.0.1 云服务部署](#401-云服务部署)
    - [4.0.2 集群部署](#402-集群部署)
